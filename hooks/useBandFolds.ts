...
// contract homeSectionExpanded already set.
//
...
// Home's own handler. Until the load lands every band reads as folded,
// which is the resting state anyway, so nothing springs open and shut.
