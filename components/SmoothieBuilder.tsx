            ...
            <View style={[styles.formCard, { borderColor: tabColor }]}>
              ...
              {nutritionHighlights.length > 0 ? (
                <View style={[styles.recipeNutritionBox, { borderColor: tabColor }]}>
                  <Text style={[styles.recipeNutritionLabel, { color: tabColor }]}>What This Smoothie Gives You</Text>
...
const styles = StyleSheet.create({
  ...
  // "What This Smoothie Gives You" -- matches RecipeCardDetail's own real
