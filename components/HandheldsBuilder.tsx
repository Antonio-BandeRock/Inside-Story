...
// The Handheld/Ingredients summary card's own fixed footprint (see its own
...
export function HandheldsBuilder({
  ...
  // padding, and the divider plus its own two handheld gaps -- split evenly,
  ...
  function renderSummaryCard(squareBottom: boolean) {
    return (
      ...
      >
        ...
        >
          <Text style={[styles.summaryHandheldName, { color: tabColor }]} numberOfLines={2}>
        ...
        <View style={styles.summaryRightColumn}>
          ...
          <View style={styles.summaryDoneRow}>
            {/* Edit mode: this card only ever shows while addingIngredient
                ...
                ingredients.length > 0 gate) -- a handheld being edited already
      ...
      {!servingsConfirmed ? (
        <View style={[styles.formCard, { borderColor: tabColor }]}>
          ...
          <View style={styles.prepNoteLabelRow}>
            ...
            <VoiceInputButton onResult={(transcript) => handleHandheldNameChange(transcript)} size={16} />
          </View>
          <AppTextInput
        ...
        <>
          ...
          {pendingResolved ? (
            ...
            // which doesn't exist in this branch). finishHandheld is called
            ...
            <View style={[styles.formCard, { borderColor: tabColor }]}>
              <Text style={styles.emptyText}>
                {(handheldName.trim() || 'Handheld')} ready with {ingredients.length} ingredient
              ...
              >
                <Text style={styles.primaryButtonText}>{editHandheldId ? 'Save Changes' : 'Save & Finish Handheld'}</Text>
              </TouchableOpacity>
            </View>
          )}
        </>
...
const styles = StyleSheet.create({
  ...
  // 2026-07-28, explicitly requested -- handheld name pinned to the top of
  ...
  // site (was 1), explicitly requested so a longer handheld name wraps to a
