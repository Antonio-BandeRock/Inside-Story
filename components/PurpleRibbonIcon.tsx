...
// Exported 2026-09-13 so PageIdentityLabel can size a spacer to the ribbon's
// true width for a given height.
export const RIBBON_ASPECT = RIBBON_SHAPE_HEIGHT / RIBBON_VIEWBOX_WIDTH;
const RIBBON_PATH =
