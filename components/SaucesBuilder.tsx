...
// The Sauce/Ingredients summary card's own fixed footprint (see its own
...
export function SaucesBuilder({
  ...
  // padding, and the divider plus its own two sauce gaps -- split evenly,
  ...
  function renderSummaryCard(squareBottom: boolean) {
    return (
      ...
      >
        ...
        >
          <Text style={[styles.summarySauceName, { color: tabColor }]} numberOfLines={2}>
        ...
        <View style={styles.summaryRightColumn}>
          ...
          <View style={styles.summaryDoneRow}>
            {/* Edit mode: this card only ever shows while addingIngredient
                ...
                ingredients.length > 0 gate) -- a sauce being edited already
        ...
        <>
          ...
          {pendingResolved ? (
            <View style={[styles.formCard, { borderColor: tabColor }]}>
              ...
              {editSauceId ? null : renderFavoriteToggle()}
            ...
            // which doesn't exist in this branch). finishSauce is called
            ...
            <View style={[styles.formCard, { borderColor: tabColor }]}>
              ...
              >
                <Text style={styles.primaryButtonText}>{editSauceId ? 'Save Changes' : 'Save & Finish Sauce'}</Text>
              </TouchableOpacity>
            </View>
          )}
        </>
...
const styles = StyleSheet.create({
  ...
  // Two columns (sauce info, scrollable ingredients) divided by a thin
  ...
  // 2026-07-28, explicitly requested -- sauce name pinned to the top of
  ...
  // site (was 1), explicitly requested so a longer sauce name wraps to a
