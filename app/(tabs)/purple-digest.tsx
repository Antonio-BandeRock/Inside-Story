...
const DIGEST_LENS_HELP: Record<DigestCategoryKey, HelpSection> = {
  ...
  earthMatters: {
    ...
    body: 'Everything in this Digest about the planet the food system actually runs on, moved out of Basic Health since it describes the food system itself rather than the human body. Covers soil health and real depletion, water use and the Ogallala Aquifer, the pesticide industry (DDT as a resolved case, glyphosate as a genuinely live dispute, and antibiotic resistance from livestock), the current pollinator crisis and which crops depend on pollinators most, seed diversity and industry consolidation, several real, dated international case studies in regenerative farming (Brazil, Niger, China), the lobbying and policy fights shaping all of this, and concrete, real ways an individual can act on any of it, through voting, purchasing, shareholder activism, or direct investment.',
  },
