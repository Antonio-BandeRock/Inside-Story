...
const FOOD_LENS_COPY: Record<FoodLens, string> = {
  ...
  snackBuilder:
    "In progress. Same builder flow as Sides, including the \"no cooking oil/fat or seasoning\" nudge (kept here, unlike Beverages -- spiced nuts or oil-popped popcorn can involve either). For anything that isn't already a full meal or a side on its own. Saving as a reusable favorite isn't wired up yet, same as the others.",
  bakedGoodsBuilder:
    "In progress. Same builder flow as Sides, including the \"no cooking oil/fat or seasoning\" nudge (kept here, same reasoning as Snacks -- butter/oil and cinnamon/salt are both common). Bread, muffins, and other home-baked items -- distinct from Meal/Sides since a baked good is usually made once and portioned out over several separate sittings (already what Servings/Serving Size capture). Saving as a reusable favorite isn't wired up yet, same as the others.",
  soupBuilder:
