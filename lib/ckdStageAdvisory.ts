...
export function getCkdStageAdvisory(scores: FoodScore[], stage: CkdStage | null): CkdStageAdvisory | null {
  ...
  return {
    ...
    message:
      reasons.join('\n\n') +
      "\n\nThis is advisory only. Nothing in Inside Story hides or blocks a food based on your stage. See Chronic Kidney Disease in Life > Conditions for the full, cited evidence.",
  };
}
