...
export const POPULAR_DIETS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'Research keeps finding the same benefit shows up gradually as meat intake drops, without needing to eliminate it entirely, good news for anyone put off by strict veganism\'s honest deficiency risks.',
  ...
  },
  {
    ...
    teaser: 'Protein\'s well-documented satiety and muscle-preserving role holds up well for most healthy people. The one honest exception: anyone with existing kidney disease, where the already-covered research says otherwise.',
