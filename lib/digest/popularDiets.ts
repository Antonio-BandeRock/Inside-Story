...
export const POPULAR_DIETS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'Protein\'s own real, well-documented satiety and muscle-preserving role holds up well for most healthy people. The one real, honest exception: anyone with existing kidney disease, where the already-covered research says otherwise.',
    summary: "Prioritizing higher protein intake, sometimes called 'proteinmaxxing' in current usage, especially to protect muscle mass while eating less or as part of aging, rests on real, already-established nutrition science the Essential Nutrients research already covers directly: protein carries a real, well-documented satiety effect (helping someone feel fuller on fewer total calories) and a real, direct role in preserving lean muscle mass, particularly relevant during weight loss or as part of normal aging, when muscle loss becomes a real, documented health risk in its own right. For people with already-healthy kidneys, real, current nutrition science doesn't find higher protein intake within normal higher-end ranges causing kidney harm. Worth knowing directly and honestly, the one real, important exception: the already-covered chronic kidney disease research finds real, different guidance applies once kidney function is already reduced, where a real, specific, lower protein target (0.6 to 0.8g/kg/day) and a real, plant-forward protein source both show real, documented benefit over higher intake. The real, practical takeaway: 'more protein' is a real, reasonable, well-supported general goal for most healthy people, but not a universal rule, anyone with known kidney disease should follow the already-covered, real, different guidance instead.",
    citations: [
  ...
  },
  {
    ...
    summary: "'Fibermaxxing,' a current, informal name for deliberately increasing fiber intake to support gut health, isn't introducing a new, unproven claim, it's a real, current label for something the already-covered research already establishes as genuinely strong science. The Essential Nutrients research already documents a real, striking gap: roughly 94% of Americans don't meet the real, established fiber RDA (38 grams/day for men, 25 for women, ages 19-50), one of the largest, most consistent nutrient-intake shortfalls the research has found anywhere. The real reason this matters directly ties to the already-covered gut-microbiome research: when gut bacteria ferment dietary fiber, they produce short-chain fatty acids, real, potent signaling molecules with real, independently-confirmed evidence (two separate real studies, from two different research angles, reaching the same real conclusion) of directly training the immune system toward tolerance rather than attack, described elsewhere as the single most food-controllable lever in its entire research base. Worth knowing directly: 'fibermaxxing' as a trend name is genuinely just a renewed push toward hitting a real, already-established, evidence-backed target most people are already falling well short of, not a new or unproven idea needing its own separate justification.",
    citations: [
  ...
  },
  {
    ...
    summary: "This whole category is deliberately honest about real evidence, some of these eating styles carry strong support, some carry real, honest, open questions, and this app takes the same real, unbiased approach to actually tracking whichever one someone follows. The eleven Food-tab builders (Meal, Sides, Salads & Bowls, Smoothies, Fermentation, Beverages, Snacks, Baked Goods, Soups, Sauces, Handhelds) are built from real, raw ingredients, meaning they work identically whether someone is eating keto, carnivore, vegan, Mediterranean, or anything else, the app doesn't assume or require any one eating style to function. Whatever someone actually builds and logs, the Insights tab already shows a real, direct nutrient breakdown against real, established DRI targets, whether that reveals a real, keto-style low-carb pattern, a real, vegan-style protein-and-B12 gap already named directly in this category's own vegan entry, or anything in between. For anyone tracking a real, specific condition too, the real, condition-specific food-scoring (already covered) layers on top of whatever eating style someone actually follows, real, useful data regardless of the diet label attached to it. Worth knowing honestly: the Trends tab, the real, deeper, automated pattern-and-correlation-finding feature this whole approach is ultimately building toward, is still mostly a stub today, not yet delivering the full, real trend analysis this entry's own title gestures toward. What's real and working right now is real, accurate, day-to-day nutrient and ingredient data, however someone eats, with real trend-finding remaining a genuine, named, not-yet-complete goal, not a feature to overclaim today. This entry itself is a real, standing example of this whole app's own broader promise: staying honest about what's actually built versus what's still ahead, the same discipline applied everywhere else.",
    citations: [],
    overallTier: 'strong',
