...
export const POPULAR_DIETS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'For celiac disease, gluten-free is the only treatment that works, covered in full elsewhere in this Digest. For anyone without celiac disease or a diagnosed sensitivity, a systematic review found no proven benefit to cutting gluten at all.',
    summary:
