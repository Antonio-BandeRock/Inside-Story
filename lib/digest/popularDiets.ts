...
export const POPULAR_DIETS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'Protein\'s well-documented satiety and muscle-preserving role holds up well for most healthy people. The one exception: anyone with existing kidney disease, where the already-covered research says otherwise.',
