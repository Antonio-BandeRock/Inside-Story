...
export const POPULAR_DIETS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "The ketogenic diet, a very low-carbohydrate, high-fat eating pattern designed to shift the body into fat-burning ketosis, has established medical roots: it has been used clinically for intractable epilepsy, including in children, for decades-long, well-documented benefit, not a recent wellness trend. For weight loss specifically, research finds it works, largely through the same mechanism as any other approach that reduces total calorie intake, not a unique metabolic advantage keto alone provides. A 2026 review names an emerging clinical concern directly in its own title, ketogenic diets can produce large increases in LDL cholesterol specifically in adults with a normal body weight, a documented pattern (sometimes called the 'lean mass hyper-responder' phenomenon) raising honest questions about long-term cardiovascular risk that the field itself is still actively working through, not a settled question either way. Additional honest complications: the diet is hard to sustain long-term, an initial 'keto flu' adjustment period is real and commonly reported, and its own very low carbohydrate intake can make it difficult to reach the already-covered fiber intake most people already fall short of without careful planning.",
    citations: [
