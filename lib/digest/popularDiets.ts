...
export const POPULAR_DIETS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Of every eating style covered in this category, the Mediterranean diet carries the deepest, most consistent evidence, and the research across multiple conditions (cardiovascular disease, RA, psoriasis, fatty liver disease) keeps landing on the same pattern independently. It traces back to the Seven Countries Study, the first major research effort to directly compare cardiovascular disease rates across different countries and diets, which found Mediterranean, olive-oil-and-produce-heavy populations carrying roughly half the cardiovascular disease rate of northern European populations eating more saturated fat. That observational finding has since been confirmed in randomized controlled trials: the landmark PREDIMED trial found a Mediterranean diet supplemented with extra-virgin olive oil or nuts measurably reducing cardiovascular events in a randomized, controlled setting, not just an association. The research finds the same pattern repeating across RA (a randomized trial finding a 76% drop in disease-activity score), psoriasis (a randomized 2025 trial reducing severity), and fatty liver disease (performing as well as a low-fat diet in head-to-head testing). No single food defines it, whole-food eating built around olive oil, vegetables, legumes, fish, and whole grains, low in processed food and added sugar, is the consistent thread across every one of these trials.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Eating both plant and animal foods without a defined restriction, omnivorous eating, differs from every other entry in this category in one specific way: it's rarely the thing a randomized trial tests directly, it's the comparison group other diets (vegetarian, vegan, Mediterranean, keto) get measured against instead. That means omnivorous eating carries no single outcome by itself; its documented health effect depends entirely on which foods actually make up the pattern rather than on the category label. The most consistent finding that applies specifically within omnivorous eating: the International Agency for Research on Cancer classifies processed meat as a confirmed human carcinogen and red meat as a probable one, both tied to colorectal cancer risk, a food-specific finding an omnivorous diet is the only one in this category actually able to trigger, since every other entry here already limits or eliminates these foods outright. The throughline this category keeps returning to: an omnivorous diet built around whole foods, and the Mediterranean entry is itself one well-evidenced version of exactly that, captures much of the same benefit documented elsewhere here, while an omnivorous diet built around ultra-processed and processed-meat-heavy eating carries the specific risks this category's anti-processed-focus entry covers.",
    citations: [
      { source: 'IARC Monographs evaluate consumption of red meat and processed meat, International Agency for Research on Cancer', url: 'https://www.iarc.who.int/wp-content/uploads/2018/07/pr240_E.pdf' },
    ],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    summary:
      "Gluten-free eating splits cleanly into two different situations this category treats as separate. For celiac disease, strict, lifelong gluten avoidance is the only treatment that stops ongoing intestinal damage, not a lifestyle preference. For anyone without celiac disease or a physician-diagnosed gluten sensitivity, the evidence points a different direction: a systematic review and meta-analysis of re-challenge studies, deliberately reintroducing gluten under blinded conditions, found many people who believe they react to gluten specifically don't, once the test is actually controlled, a pattern consistent with a placebo or nocebo effect rather than an actual reaction to gluten itself. What going gluten-free without a medical reason actually costs, already established in this app's celiac research: commercial gluten-free products often run lower in protein and fiber and higher in sugar and price than their gluten-containing equivalents, an avoidable downside for anyone cutting gluten without a diagnosed reason to.",
    citations: [
      { source: 'Re-challenge Studies in Non-celiac Gluten Sensitivity: A Systematic Review and Meta-Analysis, PMID 28928668', url: 'https://pubmed.ncbi.nlm.nih.gov/28928668/' },
    ],
    overallTier: 'moderate',
  ...
  },
  {
    id: 'diet-dairy-free',
    category: 'basicHealth',
    title: 'Dairy-Free: Usually Lactose Intolerance, Not an Allergy, With a Calcium Gap to Plan Around',
  ...
  },
  {
    id: 'diet-paleo',
    category: 'basicHealth',
    title: 'Paleo: Trial-Backed Cardiometabolic Gains, With a Caveat on How Well They Hold Up',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'High-Protein / "Proteinmaxxing": Solid Basics, With One Exception',
  ...
  },
  {
    id: 'diet-aip',
    category: 'basicHealth',
    title: 'AIP (Autoimmune Protocol): a Structured Elimination Framework Tiered Below Its Individual Pieces',
  ...
  },
  {
    ...
    summary: "'Gut-friendly eating,' incorporating prebiotics, probiotics, and fermented foods like yogurt, kimchi, and sourdough, is a current eating-style trend the Fermented Foods research backs with specific evidence, not a vague, generic wellness gesture. The research verifies specific bacterial strains by name (Lactobacillus reuteri, L. Gasseri, L. Plantarum, B. Coagulans, and others), each with its individually-cited effects, timing and fermentation-temperature requirements, and limitations (home fermentation offers no guaranteed CFU count or strain-identity verification the way a commercial, tested product does). Additional evidence covers fermented foods beyond yogurt directly: kimchi and sauerkraut-style brine ferments show a documented bacterial succession as they age, and traditional fermentation (soaking, sprouting) measurably reduces phytates, documented anti-nutrients that otherwise block mineral absorption. 'Gut-friendly eating' as a current trend name maps onto some of the most specific, individually-verified research in this whole app, a meaningful step beyond simply eating more fiber (covered directly in this category's fibermaxxing entry), toward actually cultivating the specific bacteria that do the work.",
    citations: [
  ...
  },
  {
    ...
    summary: "Deliberately cutting ultra-processed, convenience food with long, artificial-sounding ingredient lists is a current eating-style focus the research backs with some of the largest evidence in its entire library. A 2024 umbrella review pooling data on nearly 10 million people found ultra-processed food consistently tied to 32 different adverse health outcomes, a broad, consistent finding, not one narrow claim. The research adds concrete scale: ultra-processed food's share of total US adult caloric intake rose from 53.5% in 2001-02 to 57.0% by 2017-18, with minimally-processed whole food specifically displaced, falling from 32.7% to 27.4% of calories over the same period, not simply extra calories added on top of an otherwise unchanged diet. This is directly why the twelve Food-tab builders exist in the first place, to assemble meals from individually-chosen ingredients rather than defaulting to a pre-made stand-in. This is a well-evidenced, different concern from any single food or nutrient covered elsewhere in this category, the issue here is the degree of processing itself, not any one specific ingredient in isolation.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This app doesn't pick a side among these diets. Its eleven Food-tab builders work identically no matter which eating style someone follows, data either way.",
    summary: "This whole category reports evidence as it stands, some of these eating styles carry strong support, some carry open questions, and this app takes the same unbiased approach to actually tracking whichever one someone follows. The eleven Food-tab builders (Meal, Sides, Salads & Bowls, Smoothies, Fermentation, Beverages, Snacks, Baked Goods, Soups, Sauces, Handhelds) are built from raw ingredients, meaning they work identically whether someone is eating keto, carnivore, vegan, Mediterranean, or anything else, the app doesn't assume or require any one eating style to function. Whatever someone actually builds and logs, the Insights tab already shows a direct nutrient breakdown against established DRI targets, whether that reveals a keto-style low-carb pattern, a vegan-style protein-and-B12 gap already named directly in this category's vegan entry, or anything in between. For anyone tracking a specific condition too, the condition-specific food-scoring (covered) layers on top of whatever eating style someone actually follows, useful data regardless of the diet label attached to it. The Trends tab, the deeper, automated pattern-and-correlation-finding feature this whole approach is ultimately building toward, is still mostly a stub today, not yet delivering the full trend analysis this entry's title gestures toward. What works right now is accurate, day-to-day nutrient and ingredient data, however someone eats, with trend-finding remaining a named, not-yet-complete goal, not a feature to overclaim today. This entry itself is a standing example of this whole app's broader promise: naming what's actually built versus what's still ahead, the same discipline applied everywhere else.",
    citations: [],
    overallTier: 'strong',
