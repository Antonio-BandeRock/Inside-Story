...
export const IBD_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'ibd',
    title: "IBS-Type Symptoms During IBD Remission: A Different Problem, With a Different Fix",
  ...
  },
  {
    ...
    teaser: "Not every autoimmune condition pair shows the same strong overlap. This one is a more mixed picture.",
    summary: "The Type 1 Diabetes and Celiac Disease categories both cover strong, quantified overlaps with Hashimoto's. IBD's picture is more mixed than those stronger findings. A large, recent German primary care study found no significant overall association between IBD (either Crohn's or ulcerative colitis) and autoimmune thyroiditis. That's a meaningful null result from a study that went looking. The same study did find one specific exception: among patients 65 and older, IBD was associated with a significantly higher risk specifically of Graves' disease, not Hashimoto's, roughly tripled in both Crohn's and ulcerative colitis patients in that age group. IBD doesn't carry the same broad, quantified Hashimoto's-comorbidity signal that T1D and celiac disease do, and pretending otherwise just because these conditions all share the word \"autoimmune\" would misrepresent the actual research. This especially matters for anyone assuming every autoimmune diagnosis automatically raises Hashimoto's risk the same amount.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Azathioprine, a common immunomodulator used in IBD, is broken down in the body largely by an enzyme called TPMT (thiopurine methyltransferase), and how well someone's TPMT gene works determines how safely a standard dose gets processed. The FDA specifically recommends TPMT genotyping or activity testing before starting azathioprine, not just as routine caution. The reason: severe, sudden myelosuppression (a dangerous drop in blood cell production) can develop in an estimated 3% of patients, more likely with reduced TPMT function, and more likely in the first eight weeks of treatment. A related gene, NUDT15, matters especially for patients of Asian or Hispanic descent, where it's a more common cause of thiopurine intolerance than TPMT variants alone. A normal TPMT/NUDT15 result doesn't mean monitoring stops. Regular complete blood counts remain necessary throughout treatment regardless of genetic test results, since the genetic test predicts risk, it doesn't replace watching for the thing directly.",
    citations: [
  ...
  // independently verified via WebSearch.
  {
    ...
    teaser: "The Montreal classification sorts Crohn's by age, location, and behavior, and ulcerative colitis by how far the inflammation actually reaches, not just \"mild\" or \"severe.\"",
    summary:
      "IBD is formally classified using the Montreal classification, widely used at initial diagnosis to guide treatment. For Crohn's disease, three dimensions are recorded: age at diagnosis (under 16, 17-40, or over 40), location (ileal, colonic, ileocolonic, or isolated upper-GI disease), and behavior (non-stricturing/non-penetrating, stricturing, or penetrating, with a separate marker for perianal disease). For ulcerative colitis, the classification is about how far inflammation extends: E1 (proctitis, limited to the rectum), E2 (left-sided, up to the splenic flexure), or E3 (extensive, reaching beyond it). A person's specific classification (a penetrating Crohn's pattern, say, versus a non-stricturing one) directly shapes which treatment (immunomodulators, biologics, or surgery) a gastroenterologist actually recommends, useful vocabulary rather than an opaque chart note.",
    citations: [
  ...
  },
  {
    ...
    category: 'ibd',
    title: "Joint, Skin, and Eye Involvement Appears in 24% of IBD Patients, Split by Disease",
    teaser: "A direct, more granular follow-up to this category's PSC entry: a meta-analysis breaks joint, skin, and eye involvement down by exact percentage and by which of the two diseases carries the higher risk.",
  ...
  },
  {
    ...
    category: 'ibd',
    title: "IBD's History: Two Separately Discovered Diseases That Took Decades to Be Told Apart",
    ...
    summary: "IBD's two distinct diseases were discovered decades apart. Ulcerative colitis came first, in 1875, when English physicians Wilks and Moxon distinguished it from infectious diarrheal disease. Crohn's disease wasn't formally described until 1932, when Burrill Crohn, Leon Ginzberg, and Gordon Oppenheimer published a landmark 14-case paper describing what they initially called \"regional ileitis,\" an advance over the era's default assumption that any small-intestine disease must be tuberculosis. Earlier isolated case observations actually predate the 1932 paper (Morgagni in the 1700s, Berg in 1898, Lesniowski in 1904, Dalziel in 1913), meaning the disease existed in medical records well before it was formally named and understood as its condition. The modern genetic turning point came in the early 2000s: discovery of the NOD2/CARD15 gene mutation gave the first molecular explanation for Crohn's genetic susceptibility, opening the door to the TNF-alpha-targeting biologic therapies (infliximab, adalimumab, both covered in the medication research) that transformed treatment in the years that followed.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Research names active disease at the moment of conception as one of the clearest, most consistent risk factors for a flare throughout pregnancy, best known before, not after, conceiving.',
    summary: "IBD pregnancy outcomes trace back to a specific, actionable timing fact: research consistently names active disease AT CONCEPTION, not just at some point during pregnancy, as one of the clearest risk factors for a flare throughout the pregnancy that follows, alongside having ulcerative colitis specifically (rather than Crohn's) and a history of active disease during a previous pregnancy. This makes preconception planning more consequential here than in many other conditions covered: guidance is to achieve disease remission before conception whenever possible, and, even though it runs against a common, understandable instinct, to KEEP taking IBD medication through pregnancy rather than stopping it out of caution, since stopping is what actually raises flare risk. The reassuring medication-safety finding: anti-TNF biologics (covered in the medication research) are considered safe across multiple registries and observational studies, with continuing them through the third trimester specifically linked to a lower flare risk and no increased infant infection risk in the first year of life from in-utero exposure.",
    citations: [
  ...
  // verified via WebSearch.
  {
    ...
    category: 'ibd',
    title: 'Fecal Microbiota Transplantation Shows Measurable, if Still Developing, Promise for Ulcerative Colitis',
  ...
  },
  {
    ...
    category: 'ibd',
    title: 'Anti-TNF Biologics Can Stop Working Over Time, a Common and Manageable Problem With a Formal Name',
    ...
    summary: "Anti-TNF biologics (covered by name for both RA and IBD elsewhere in the medication research) can stop working over time in a well-documented, and specifically named phenomenon: secondary loss of response. Research finds this affects 13-21% of patients per year, on top of primary non-response (the drug never working in the first place) affecting up to a third of patients from the start. The most common underlying cause is immunogenicity, the body developing its antibodies against the biologic drug (called anti-drug antibodies), which directly lowers the actual drug level in the blood and blocks its biological activity. Practical solutions exist once this is identified: therapeutic drug monitoring (measuring both the drug's blood level and any anti-drug antibodies present) can guide treatment adjustments, and research finds adding an immunomodulator medication alongside the biologic can help reverse antibody-driven loss of response in some patients. A large UK study (13,222 patients) found people who lost response to their first anti-TNF drug had better outcomes switching to a different class of biologic entirely rather than trying a second anti-TNF. If an IBD medication that used to work well starts losing effectiveness, this is a well-understood, and named clinical phenomenon with testable next steps, not a sign that IBD itself has simply become untreatable, and it's worth raising directly with a gastroenterologist rather than assuming nothing more can be done.",
    citations: [
  ...
  },
  {
    ...
    category: 'ibd',
    title: 'Checking a Biologic\'s Blood Level Cuts Relapse, Even When Symptoms Don\'t Change',
    ...
    summary:
      "The biologic research (the SONIC combination trial, anti-TNF loss of response) raises a practical follow-up question: once someone's on a biologic like infliximab, how does a doctor actually know if the dose is right? Therapeutic drug monitoring (TDM) answers this by directly measuring the medication's blood level (trough concentration) rather than relying on symptoms alone, since a meaningful share of apparent treatment failure turns out to be a dosing problem rather than a lack of response. The landmark TAXIT trial tested a PROACTIVE version of this (a scheduled blood-level check adjusting dose toward a target range of 3 to 7 micrograms per milliliter, before problems appear) against a REACTIVE approach (checking blood levels only after symptoms return). The result: no significant difference in remission rates at 1 year between the two approaches, but the proactive group had significantly fewer relapses during the full follow-up period (7% versus 17%). Major gastroenterology associations still mostly recommend the simpler, reactive approach as standard, with proactive monitoring considered more useful but more debated, this is a worth-raising question for anyone whose biologic seems to be working less well than expected: has an actual blood level ever been checked, or has the dose only ever been adjusted based on symptoms alone?",
    citations: [
  ...
  },
  {
    ...
    summary: "The smoking-paradox research establishes that smoking worsens Crohn's disease specifically (the opposite of its documented protective effect in ulcerative colitis). What that entry doesn't cover directly is the concrete payoff for actually quitting, more than a general 'smoking is bad' statement. A prospective multicenter cohort study of 573 Crohn's patients, followed for a median of 3.25 years, found smoking an independent predictor of disease relapse, with continuing smokers facing a 1.6-times-higher relapse risk than nonsmokers, alongside a doubled rate of hospitalization and a shorter time before needing steroid treatment. The important, practical finding: patients who QUIT smoking had a relapse risk that dropped to match lifelong nonsmokers, essentially fully reversing the excess risk, not just partially reducing it. An earlier intervention study described this benefit as comparable in magnitude to starting an immunosuppressant medication. For someone with Crohn's disease who smokes, the research already names WHY smoking matters here specifically, this is the concrete, motivating number for WHAT quitting actually does, an achievable, medication-free lever with a quantified, disease-modifying payoff.",
    citations: [
  ...
  },
  {
    ...
    teaser: "India's IBD prevalence is projected to quadruple by 2035, part of a documented pattern where newly industrializing regions are picking up IBD at the same time their diets shift toward the West's.",
    summary: "Inflammatory bowel disease has a distinct geographic story: it rose first and became common in North America and Northern Europe across the 20th century, and its prevalence there has now largely stabilized at a high level. Meanwhile, current projections find IBD accelerating sharply in newly industrializing regions: India's IBD prevalence is projected to rise fourfold by 2035, West Asia's by 2.3 to 2.5 times, and East and Southeast Asia's by 1.6 to 1.7 times over the same window. This isn't happening randomly. Research ties the rise directly to the same regions' own rapid shift toward a Westernized diet, specifically higher consumption of red meat, processed foods, and refined sugar, alongside urbanization, industrialization, and the broader hygiene and lifestyle changes that come with rapid economic development. For anyone in a region where IBD has historically been rare, that historical rarity is a documented pattern tied to a traditional diet and lifestyle, not a permanent biological immunity, and IBD risk appears to rise measurably as a population's everyday eating pattern shifts toward the same processed, Western-style diet already linked to IBD risk everywhere else in the research.",
    citations: [
  ...
  },
  {
    ...
    category: 'ibd',
    title: 'A Striking Study Found Second-Generation Immigrants Picking Up Their New Country\'s IBD Risk',
    teaser: "UK data found second-generation South Asian immigrants developing ulcerative colitis at rates matching the UK-born population, despite South Asia's much lower native rates, direct evidence environment can override a whole generation's original low risk.",
    summary:
      "The westernization research explains why IBD is rising in newly industrializing countries; a separate migrant study shows the same mechanism playing out within a single family across two generations. A British study of ulcerative colitis patients found second-generation South Asian immigrants (people born in the UK to South Asian immigrant parents) developing UC at rates that closely matched the UK's Caucasian population, a striking finding given South Asia's native IBD rates run substantially lower. This wasn't unique to the UK: research found the same pattern in Canada, individuals migrating from a low-prevalence region like South Asia to a high-prevalence country show an elevated IBD risk that continues rising across the first AND second generation, evidence that a whole new environment (diet, hygiene, gut microbiome exposure from birth) reshapes risk across a generation raised entirely in the new setting, beyond what one adult adopting a new diet would account for. This is some of the strongest evidence anywhere that IBD risk is substantially environmental rather than fixed by ancestry, a family's IBD risk can shift to match a new home country within a single generation, not slowly over many.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Emerging blood and stool biomarkers are moving IBD treatment toward matching each drug to the person most likely to actually respond, replacing the current trial-and-error approach this category\'s therapeutic-drug-monitoring research already works around.',
    summary:
      "The therapeutic-drug-monitoring and biologic-loss-of-response research exists partly because current IBD treatment still works largely by trial and error, trying one biologic, then switching if it doesn't work well enough. The active direction the whole field is moving toward: precision medicine, matching a specific drug to a specific person's disease biology from the start. Several biomarkers are now close to clinical use: an antibody test (αvβ6) and a blood marker (oncostatin M) are both described directly in current research as potentially near-ready for clinical practice, alongside microRNA panels and stool-based markers still in development. This builds on already-approved newer treatments (etrasimod, upadacitinib, mirikizumab, risankizumab) that already offer more mechanism-specific options than IBD care had even a few years ago. Comprehensive, clinically validated biomarkers remain an acknowledged gap in the field today, this is an active direction rather than a solved problem, with AI-assisted prediction of treatment response also named directly as part of where the field expects this to head next.",
    citations: [
  ...
  },
  {
    ...
    category: 'ibd',
    title: "An Already-Approved Stem Cell Therapy Is Healing One of Crohn's Most Stubborn Complications",
  ...
  },
  {
    ...
    summary: 'Research finds roughly 30 percent of people with IBD were exposed to oral glucocorticoids (prednisone and similar drugs, covered directly in the IBD medication research) within just the preceding 12 months, since they remain a major treatment for moderate-to-severe flares despite progress with biologic therapies. Broader research on glucocorticoid use finds hypertension a dose-related risk of this drug class, with over 30 percent of long-term users developing measurably elevated blood pressure, a direct medication effect rather than a coincidental overlap. The current gap: dedicated research measuring hypertension prevalence specifically within IBD populations (as opposed to glucocorticoid users generally) is sparse in the literature, so the precise IBD-specific number isn\'t yet well established, even though the underlying mechanism (glucocorticoid exposure) clearly is. Anyone on repeated or extended prednisone courses for IBD flares has a concrete, medication-driven reason to have blood pressure checked as part of that treatment, not assumed unrelated to a bowel-focused diagnosis.',
    citations: [
  ...
  },
  {
    ...
    summary:
      "The extraintestinal-manifestations research names complications reaching beyond the gut itself; perianal fistulas (abnormal tunnels forming between the bowel and skin near the anus) are a common, and often under-discussed complication of Crohn's disease specifically. Research finds roughly 35% of Crohn's patients develop at least one fistula, with 70-80% of these classified as complex. An international patient survey found the impact reaching well past physical symptoms into relationships, social life, and work life, with pain, scarring, discharge, fecal incontinence, and sexual difficulties all named directly as contributing factors to a measurable drop in quality of life. Even with the best current medical and surgical therapy combined, only about a third of patients remain in sustained remission at one year, with research finding ACTIVE INFLAMMATION itself, not simply the fistula's presence, the biggest driver of quality of life, a direct reason staying on top of disease control matters even when a fistula itself can't be fully resolved.",
    citations: [
  ...
  },
  {
    ...
    category: 'ibd',
    title: "IBD's Bone-Loss Risk Starts With Inflammation Itself, Not Just Steroid Treatment",
  ...
  },
  {
    ...
    summary:
      "The corticosteroid and extraintestinal research names systemic effects beyond the gut, and venous thromboembolism (blood clots in the veins, including deep vein thrombosis and the more dangerous pulmonary embolism) is a serious, directly quantified one. Meta-analyses consistently find IBD patients carrying two to three times the general population's risk of developing a blood clot. The most clinically useful finding is WHEN that risk peaks: research found the hazard ratio for a clot reaching 8.4 during an active disease flare compared to controls, still elevated (2.1-fold) even during remission, direct evidence the underlying inflammation itself, not just hospitalization or surgery, drives the risk. Identified contributing factors include a prior clot (a 4.44-fold risk multiplier), urgent surgery, blood transfusions, low blood albumin, and corticosteroid use, each independently raising risk further. A useful, reassuring finding: anti-TNF therapy, one of the biologic treatments, was NOT associated with increased clot risk, unlike corticosteroids. This elevated risk is exactly why hospitalized IBD patients, especially during a flare or after surgery, are often given preventive blood thinners as a matter of course, an evidence-based practice, not a surprising one.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The anti-TNF and combination-therapy research covers one drug class, direct comparative studies of two newer biologics, ustekinumab and vedolizumab, find them broadly comparable, except in one specific quantified case.",
    summary:
      "The anti-TNF and SONIC combination-therapy research names one biologic class, and ustekinumab and vedolizumab (two newer, differently-targeted biologics) have their own, direct head-to-head comparative data. A multicenter GETAID cohort study directly comparing the two in ulcerative colitis patients who had already failed anti-TNF therapy (covered elsewhere in this category as a common scenario) found no significant difference between them after adjusting for other confounding factors. A separate study in the elderly IBD population found both comparably effective and safe, useful data for a population often excluded from the original approval trials. The worth-knowing exception: a study in pediatric and young-adult patients found vedolizumab producing significantly higher 1-year steroid-free remission specifically in ulcerative colitis and IBD-unclassified patients (61 percent versus 32 percent for ustekinumab), while the same study found the two performing comparably in Crohn's disease patients (63 versus 68 percent at 6 months), direct evidence the right choice can depend on which specific IBD subtype is being treated, not just biologic availability or cost. This is useful, evidence-backed detail worth discussing directly with a gastroenterologist when choosing between the two, rather than assuming they're interchangeable across every IBD presentation.",
    citations: [
  ...
  },
  {
    ...
    category: 'ibd',
    title: "Crohn's Physical Narrowing (Strictures) Is Common, and Data Names a High Eventual Surgery Rate",
    teaser: "The perianal-fistula entry names one Crohn's complication, data finds intestinal strictures (physical narrowing from scarring) affecting a majority of patients within a decade, with a high cumulative surgery rate once they develop.",
    summary: "The fistula and colonoscopy-surveillance research names physical complications specific to Crohn's disease, and intestinal strictures, physical narrowing of the bowel caused by chronic inflammation and scarring, deserve their direct coverage. Data finds this common: roughly 50 to 70 percent of Crohn's patients develop stricturing or penetrating (fistula-forming) complications within 10 years of diagnosis, evidence this isn't a rare, unusual outcome but a common trajectory of the disease left to progress. The most direct, practical number: a study found the cumulative risk of Crohn's-related surgery in patients with stricturing disease climbing steadily, from 18.0 percent at year 1 to 46.4 percent by year 5, and a separate comparison found patients with a stricturing-penetrating phenotype needing surgery at a striking 77.7 percent rate versus just 12.2 percent for patients with purely inflammatory (non-stricturing) Crohn's, direct evidence of how much this specific disease behavior changes the practical outlook. Research also finds patients with strictures facing significantly higher rates of hospitalization, steroid dependency, and repeated endoscopy along the way, not just eventual surgery. This higher-stakes trajectory is exactly why the early, aggressive treatment approach (matching the already-established window-of-opportunity research for other conditions) matters specifically for Crohn's disease, worth discussing directly with a gastroenterologist rather than waiting to see how the disease behaves on its own.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The corticosteroid and combination-therapy research names infection-risk considerations, Clostridioides difficile infection specifically carries a four- to five-fold higher risk in IBD, and can look identical to a flare.",
    summary:
      "The immunosuppressive-medication research already names general infection-risk tradeoffs, and Clostridioides difficile infection (C. Diff, a common cause of severe diarrhea) deserves direct coverage as an elevated, IBD-specific risk. Pooled data finds IBD patients carrying a four- to five-fold higher risk of C. Diff infection than the general population, with more severe courses once infected, higher rates of hospitalization, colectomy (surgical bowel removal), recurrence, and mortality. Testing during an active IBD flare finds C. Diff toxins present in 5.5 to 20 percent of cases, an important number given how directly this complicates clinical decision-making: a person with IBD experiencing worsening diarrhea could be having a disease flare (which treatment escalates immunosuppression to control) or a C. Diff infection (which treatment requires antibiotics and REDUCING immunosuppression), two opposite treatment directions that look clinically identical without a direct stool test to distinguish them. Research names the specific, elevated-risk factors directly: active colonic inflammation itself, broad-spectrum antibiotic exposure, prolonged hospitalization, and corticosteroid or combined immunosuppressive therapy, all identifiable risk multipliers. This is exactly why a C. Diff stool test is a standard, recommended step before assuming worsening symptoms during a hospitalization or flare are simply the underlying disease getting worse, an important distinction the fecal calprotectin research doesn't fully resolve on its own.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The extraintestinal-manifestation research already names joint and eye involvement, a large 2,402-patient cohort quantifies the skin's two distinct manifestations directly: erythema nodosum in 4.0%, pyoderma gangrenosum in a rarer 0.75%.",
    summary:
      "The extraintestinal-manifestation research already establishes joint, eye, and liver involvement beyond the gut itself, and the skin carries its two distinct manifestations worth their direct, quantified coverage. A large cohort study of 2,402 IBD patients found erythema nodosum, tender, red nodules typically on the shins, evidence of inflammation in the fat layer beneath the skin, present in 4.0 percent of patients, evidence this is a common, if still minority, extraintestinal sign. Pyoderma gangrenosum, a much rarer but far more serious skin condition (painful, rapidly enlarging ulcers that can develop from even minor skin trauma), was present in 0.75 percent of the same cohort. The useful, practical distinction: erythema nodosum tends to track closely with active intestinal inflammation and often improves as the underlying IBD itself is brought under control, while pyoderma gangrenosum can behave more independently, sometimes appearing even during disease remission, and research names it as having the most debilitating disease course of the two. Research also found both conditions more commonly associated with Crohn's disease than with ulcerative colitis specifically. Erythema nodosum's common, largely reassuring pattern is different from pyoderma gangrenosum's rarer, more serious one: a new, unexplained, rapidly worsening skin ulcer deserves urgent evaluation rather than being assumed to be a minor, self-resolving IBD-related skin change.",
    citations: [
  ...
  },
  {
    ...
    category: 'ibd',
    title: 'Gut Inflammation Itself Directly Suppresses New-Neuron Growth in the Brain, a Specific Mechanism',
    teaser: "The depression/anxiety research names inflammatory cytokines as a plausible mechanism, a mouse colitis model traced that mechanism directly to the hippocampus itself, finding measurably suppressed new-neuron production during both active and ongoing gut inflammation.",
    summary:
      "The depression and anxiety research names inflammatory cytokines, vagal signaling, and gut dysbiosis as plausible mechanisms; a more specific study traces one of those mechanisms directly into the hippocampus. A mouse model of colitis (induced with dextran sodium sulfate, a standard, well-established way to model IBD-like intestinal inflammation) found that intestinal inflammation directly triggered a measurable inflammatory response in the hippocampus itself, including activation of the brain's immune cells (microglia) and increased inflammatory signaling genes, alongside measurable deficits in hippocampal neurogenesis markers after both a single, acute flare and after chronic, repeated inflammation. The proposed mechanism is direct and specific: the same neural progenitor cells that would otherwise become new neurons carry receptors for the pro-inflammatory cytokines gut inflammation produces, and a sustained inflammatory environment in that cell niche directly works against normal neurogenic activity, rather than the gut and brain effects being separate, coincidental problems. This is animal research, not yet directly confirmed in human IBD patients, but it offers a specific, mechanistic explanation connecting active gut inflammation to the brain changes that plausibly underlie the mood and cognitive symptoms covered in this category's research, a biological throughline rather than two separate, loosely-associated conditions.",
    citations: [
