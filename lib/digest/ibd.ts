...
export const IBD_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'ibd',
    title: "Which Extraintestinal Symptoms Are More Common in Crohn's Versus Ulcerative Colitis",
  ...
  },
  {
    ...
    teaser: "This category's already-covered perianal-fistula entry names one Crohn's complication, data finds intestinal strictures (physical narrowing from scarring) affecting a majority of patients within a decade, with a high cumulative surgery rate once they develop.",
    summary: "This category's already-covered fistula and colonoscopy-surveillance research names physical complications specific to Crohn's disease, and intestinal strictures, physical narrowing of the bowel caused by chronic inflammation and scarring, deserve their direct coverage. Data finds this common: roughly 50 to 70 percent of Crohn's patients develop stricturing or penetrating (fistula-forming) complications within 10 years of diagnosis, evidence this isn't a rare, unusual outcome but a common trajectory of the disease left to progress. The most direct, practical number: a study found the cumulative risk of Crohn's-related surgery in patients with stricturing disease climbing steadily, from 18.0 percent at year 1 to 46.4 percent by year 5, and a separate comparison found patients with a stricturing-penetrating phenotype needing surgery at a striking 77.7 percent rate versus just 12.2 percent for patients with purely inflammatory (non-stricturing) Crohn's, direct evidence of how much this specific disease behavior changes the practical outlook. Research also finds patients with strictures facing significantly higher rates of hospitalization, steroid dependency, and repeated endoscopy along the way, not just eventual surgery. This higher-stakes trajectory is exactly why this category's already-covered early, aggressive treatment approach (matching the already-established window-of-opportunity research for other conditions) matters specifically for Crohn's disease, worth discussing directly with a gastroenterologist rather than waiting to see how the disease behaves on its own.",
    citations: [
