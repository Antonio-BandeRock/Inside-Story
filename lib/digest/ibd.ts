...
export const IBD_ENTRIES: DigestEntry[] = [
  {
    ...
    summary: "Inflammatory bowel disease is an umbrella term for two real, genuinely different autoimmune conditions. Ulcerative colitis causes continuous inflammation limited to the colon and rectum. Crohn's disease can affect any part of the digestive tract from mouth to anus, often in patchy \"skip lesions\" rather than one continuous stretch, and can penetrate deeper into the intestinal wall than ulcerative colitis typically does. This distinction isn't academic. Several of the real findings in this category, most strikingly how smoking affects each disease, run in genuinely different, even opposite, directions depending on which one someone actually has. The Gut & Microbiome category already covers real, direct evidence from IBD research: an endoscopically-confirmed AIP diet trial and documented depletion of the same short-chain-fatty-acid-producing bacteria the whole gut-repair argument is built around. This category covers what's specific to actually living with and managing either disease.",
    citations: [
  ...
  },
  {
    ...
    summary: "Line up everything in this category and IBD reads as a condition where precision about which disease, and which real number, matters more than almost anywhere else. Smoking is a real, opposite-direction risk factor depending on whether it's Crohn's or ulcerative colitis, not a single, uniform IBD finding. Exclusive enteral nutrition is a genuinely strong, food-based, first-line therapy for pediatric Crohn's specifically, real remission rates rivaling steroids. The low-fiber-during-a-flare advice, repeated constantly, turns out to have real, surprisingly thin support, while adequate fiber intake carries real evidence for reducing flare risk over time. The two self-advocacy entries carry the same kind of precise numbers already established as the standard: fecal calprotectin's own real sensitivity/specificity and deep-remission threshold, and azathioprine's real, FDA-recommended genetic test before the first dose. And the honest, quantified null result on Hashimoto's comorbidity, alongside the real, specific Graves' exception in older patients, is exactly the kind of finding worth reporting accurately rather than smoothing into a pattern that isn't actually there.",
    citations: [
      { source: 'Crohn\'s Disease, National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK)', url: 'https://www.niddk.nih.gov/health-information/digestive-diseases/crohns-disease' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary: 'A real, large systematic review and meta-analysis finds a genuinely high prevalence of anxiety and depression symptoms across IBD broadly (up to a third affected by anxiety, a quarter by depression), with real, substantially higher rates specifically during active disease periods -- half of patients meeting criteria for anxiety and a third for depression when their IBD is flaring, more common in Crohn\'s disease than ulcerative colitis, and more common in women. The real, genuinely bidirectional relationship: IBD itself raises anxiety and depression risk by a real 48 and 55 percent respectively, while a real, separate meta-analysis found people with depression carry roughly double the risk of later developing IBD -- a real, two-way street, not psychiatric symptoms simply reacting to a physical illness. Real, proposed mechanisms tie directly into the already-covered gut-brain research: increased inflammatory cytokines, vagal nerve signaling, and gut dysbiosis all plausibly connect the two. Real, longitudinal evidence finds comorbid depression and anxiety genuinely worsen IBD\'s own subsequent disease course, a real, direct clinical reason treating the mental-health side isn\'t separate from managing the physical disease.',
    citations: [
