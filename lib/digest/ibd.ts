...
export const IBD_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "This category's already-covered extraintestinal-manifestation research already names joint and eye involvement, a large 2,402-patient cohort quantifies the skin's own two distinct manifestations directly: erythema nodosum in 4.0%, pyoderma gangrenosum in a rarer 0.75%.",
    summary:
