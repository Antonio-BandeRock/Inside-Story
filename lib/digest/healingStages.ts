...
export const HEALING_STAGES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Bone broth has picked up an almost mythical reputation in gut-healing circles. The evidence supports something more modest, and more honest, than a miracle cure. Bone broth's own cited mechanism is its glutamine, glycine, and proline content, all supporting gut-barrier function. The caveat: measured amino-acid content varies enormously by recipe, and commercial versions run measurably lower than a real homemade batch. Worth including as one reasonable Stage 1 food, not treating as a singular fix. A genuinely useful ingredient with a modest role, not the centerpiece some wellness content makes it out to be.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "This app spends an entire category, Fermented Foods, making the case for fermented foods and gut repair. Stage 1 asks someone to hold off on most of them anyway, and that tension deserves a direct explanation, not a quiet contradiction. Fermented foods are the single most consistently flagged high-histamine food category across low-histamine-diet literature. Since Stage 1 deliberately keeps histamine load low while a possibly-inflamed gut's own DAO clearance capacity is still unknown, most ferments wait for Stage 2. Neither claim is wrong. They're optimizing for different things at different points in the timeline. This app's own fermented-food research and Stage 1's own caution are both correct, just aimed at different moments in the same journey.",
    citations: [
  ...
  },
  {
    ...
    summary:
      '"Eat more fiber" is generically true advice that says nothing about how, or how fast, to actually do it during a real recovery process. IBD evidence supports a specific progression: fiber introduced during a genuinely stable period, not an active flare, with texture-modified sources (cooked, pureed) coming first and raw or varied sources following only as tolerance is directly confirmed through tracking rather than assumed. This is disease-adjacent evidence, IBD, not Hashimoto\'s directly, included as corroborating support for a reasonable progression rather than a Hashimoto\'s-specific finding.',
    citations: [
  ...
  },
  {
    ...
    summary:
      "Stage 2's own milestones lean less on symptoms alone and more on a physiological clock this app's own research has already established elsewhere. A documented tolerance map: a growing, individually-confirmed list of successfully reintroduced foods. The 12-24 week gut-barrier repair window, already established elsewhere in this Digest's own Gut & Microbiome research, having passed, giving the mechanisms this stage relies on real physiological time to actually take effect rather than just masking symptoms. And a 3-month and/or 6-month checkpoint, matching the actual interval Hashimoto's dietary-intervention trials use as their own standard measurement points. Checkable time windows borrowed directly from this app's own established research elsewhere, not a separate guess invented just for this stage.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "It would be easy to assume \"well-healed\" means logging even more carefully, forever. The intended shift runs the opposite direction. Tracking becomes optional and periodic rather than constant, matching this app's own core purpose directly: the goal was always personal pattern-discovery, not permanent daily logging as an end in itself. Occasional flexibility with lower-tier concerns, a \"chronic, cumulative\" category additive, in genuine moderation, becomes reasonable once a stable baseline exists to notice a real deviation against. And periodic re-baseline checks: a real flare, a new symptom, or a genuine life disruption (illness, high stress, an antibiotic course) is a legitimate reason to step back toward Stage 1 or 2 temporarily, not a failure of this stage. Stepping back isn't starting over. It's the same system working exactly as designed, responding to a new signal rather than ignoring one.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      '"Detoxing" gets used constantly in exactly this kind of elimination-diet conversation. It\'s worth saying directly: nothing in this app\'s own research actually supports it as a distinct phase. No evidence anywhere in this app\'s own research supports a literal "detox" period distinct from ordinary elimination-diet adaptation. Early symptom changes during Stage 1 are more plausibly explained by mechanisms already documented elsewhere in this Digest: gut-microbiome composition shifts measurable within days to two weeks of a dietary change, withdrawal-type effects from reducing caffeine or sugar, or simply the genuine adjustment period of eating a meaningfully different way. This framework deliberately avoids "detox" language anywhere in its own reasoning, not because early changes aren\'t real, but because they have specific, already-understood explanations that don\'t need a separate, unproven concept invented to explain them.',
    citations: [
      {
