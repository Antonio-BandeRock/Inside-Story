...
export const HEALING_STAGES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Bone broth has picked up an almost mythical reputation in gut-healing circles. The evidence supports something more modest than a miracle cure. Bone broth's cited mechanism is its glutamine, glycine, and proline content, all supporting gut-barrier function. The caveat: measured amino-acid content varies enormously by recipe, and commercial versions run measurably lower than a homemade batch. Worth including as one reasonable Stage 1 food, not treating as a singular fix. A useful ingredient with a modest role, not the centerpiece some wellness content makes it out to be.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The direct resolution to Stage 1's histamine tension.",
    summary: "Stage 1 asked most fermented foods to wait. Stage 2 is where that wait actually ends, and it ends on purpose, not just because enough time has passed. This is where the two-yogurt system and Fermented Foods bacterial-strain research become directly actionable. Stage 2 is specifically the point where a controlled, single-strain DIY ferment, known ingredients, known strain, a known histamine profile from that strain's fermentation behavior, is a deliberate reintroduction target, not a blind \"just eat probiotic foods\" gesture. The gut-barrier evidence for probiotic strains applies once histamine tolerance itself is no longer an unknown variable. The wait in Stage 1 was never about avoiding fermented foods forever, just about sequencing them correctly.",
    citations: [
  ...
  },
  {
    ...
    summary: "Stage 2's milestones lean less on symptoms alone and more on a physiological clock the research has already established elsewhere. A documented tolerance map: a growing, individually-confirmed list of successfully reintroduced foods. The 12-24 week gut-barrier repair window, already established elsewhere in the Gut & Microbiome research, having passed, giving the mechanisms this stage relies on physiological time to actually take effect rather than just masking symptoms. And a 3-month and/or 6-month checkpoint, matching the actual interval Hashimoto's dietary-intervention trials use as their standard measurement points. Checkable time windows borrowed directly from the established research elsewhere, not a separate guess invented just for this stage.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: "A common claim in this exact space, but not one the research actually supports.",
    summary: '"Detoxing" gets used constantly in exactly this kind of elimination-diet conversation. It\'s a common claim in this exact space, but nothing in the research actually supports it as a distinct phase. No evidence anywhere in the research supports a literal "detox" period distinct from ordinary elimination-diet adaptation. Early symptom changes during Stage 1 are more plausibly explained by mechanisms already documented elsewhere: gut-microbiome composition shifts measurable within days to two weeks of a dietary change, withdrawal-type effects from reducing caffeine or sugar, or simply the adjustment period of eating a meaningfully different way. This framework deliberately avoids "detox" language anywhere in its reasoning, because those early changes have specific, already-understood explanations that don\'t need a separate, unproven concept invented to explain them.',
    citations: [
      {
  ...
  },
  {
    ...
    teaser: 'Three stages, milestones at each, and it moves at the pace your data shows, not a calendar.',
    summary: "Read end to end, these entries describe a sequenced journey, narrow and restrictive in Stage 1, systematically widening in Stage 2, broad and mostly self-monitoring by Stage 3, built on elimination-diet, gut-barrier-repair, and Hashimoto's-specific trial timelines, not guesswork. The throughline across all three stages: the tracking is what actually shows which stage someone is really in, not a fixed number of weeks on a calendar. The milestones in each stage (symptom stability, a tolerance map, a declining antibody trend) are checkable signals to look for in logged data, and a flare or disruption is a legitimate reason to step back a stage temporarily, and does not mean the process failed. A healing gut, like any system being brought back online, gets checked at checkpoints, not simply declared fixed on a fixed schedule.",
    citations: [
      {
        source: 'The Autoimmune Protocol diet: a systematic review of the literature: the 6-week elimination + 5-week reintroduction clinical protocol structure',
        url: 'https://pubmed.ncbi.nlm.nih.gov/31832627/',
