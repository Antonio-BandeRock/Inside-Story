...
export const FERMENTED_FOODS_ENTRIES: DigestEntry[] = [
  {
    ...
    citations: [{ source: 'Kim et al., lactose digestion/L. acidophilus review' }],
  ...
  },
  {
    ...
    citations: [{ source: 'Ducrotté et al. 2012, World Journal of Gastroenterology (Lp299v IBS RCT)' }],
    overallTier: 'moderate',
  },
  {
    ...
    citations: [{ source: 'Bifidobacterium/occludin restoration studies, gut barrier literature' }],
    overallTier: 'moderate',
  },
  {
    ...
    citations: [{ source: 'Standard dairy microbiology references (Codex Alimentarius yogurt standard)' }],
    overallTier: 'moderate',
  },
  {
    ...
    citations: [{ source: 'Fermentation microbiology: cabbage fermentation succession studies' }],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    citations: [{ source: 'McFarland 2010, World Journal of Gastroenterology (meta-analysis)' }],
    overallTier: 'strong',
  },
  {
    ...
    citations: [{ source: 'Cabbage fermentation succession, food microbiology literature' }],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    citations: [{ source: 'Jayabalan et al. 2014, kombucha microbiology review' }],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    citations: [{ source: 'Water kefir microbiology, comparative ferment studies' }],
    overallTier: 'weak',
  },
  {
    ...
    citations: [{ source: 'Kefir grain microbial diversity, culture-independent sequencing studies' }],
    overallTier: 'moderate',
  },
  {
    ...
    summary:
      'Fermented beet brine (whole beets, salt, water, lacto-fermented several days to weeks) carries a long traditional-medicine reputation for liver/digestive support in Eastern European folk practice. The plausible mechanism -- lactic acid bacteria plus beets\' own nitrate content -- is real, but direct clinical trial data on kvass specifically is thin; most of the supporting evidence is extrapolated from lacto-fermentation research generally rather than kvass itself being separately studied. Presented honestly as tradition-plus-plausible-mechanism, not proven.',
    citations: [{ source: 'Traditional fermentation ethnobotany reviews' }],
    overallTier: 'weak',
  },
  {
    ...
    citations: [{ source: 'Comparative lacto-fermentation substrate chemistry' }],
    overallTier: 'weak',
  },
  {
    ...
    citations: [{ source: 'Probiotic dosing meta-analyses, strain-specificity reviews' }],
    overallTier: 'moderate',
  },
  {
    ...
    citations: [{ source: 'Dairy/probiotic product labeling standards, FDA and Codex Alimentarius' }],
    overallTier: 'moderate',
  },
];
