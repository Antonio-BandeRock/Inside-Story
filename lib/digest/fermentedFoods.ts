...
export const FERMENTED_FOODS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Most of the strains on this list showed up first in dairy. L. plantarum's home is vegetables. A hardy, salt-tolerant strain that thrives in vegetable ferments specifically, unlike most dairy-associated strains. The commercially studied sub-strain Lp299v has completed randomized trial data showing improved iron absorption and reduced markers of intestinal inflammation in IBS patients. General L. plantarum is also documented, in separate research covered elsewhere, to help maintain gut-barrier tight-junction proteins. A versatile strain doing separately-documented work in two very different corners of the research.",
    citations: [
      {
  ...
  },
  {
    ...
    summary: "Most fermented foods on this list are built around one or two named strains. Milk kefir is built differently, on purpose. Traditional milk kefir grains host a complex symbiotic community, often 30 or more distinct bacterial and yeast species living together in one starter culture, far beyond the handful of strains in a typical commercial yogurt. That diversity is exactly what the gut-microbiome research keeps identifying as the real target: diversity itself, not any single \"best\" strain. Kefir is one of the most direct, practical ways to work toward that diversity through food rather than through a supplement.",
    citations: [
      {
