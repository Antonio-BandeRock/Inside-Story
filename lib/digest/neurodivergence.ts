...
export const NEURODIVERGENCE_ENTRIES: DigestEntry[] = [
  // ---------------------------------------------------------------- framing
  {
    ...
    title: 'Autism, ADHD and Dyslexia Are Here for Two Honest Reasons, and Neither of Them Is Treatment',
    ...
    summary:
      'This app covers autism, ADHD and dyslexia for two reasons, and it is worth naming both plainly before anything else in this topic is read. The first is nutritional: narrow eating, sensory-driven food refusal and specific measurable shortfalls are well documented in autism, and the research on ADHD and diet is a substantial body of work with modest but measurable findings. That is a nutrition topic and it belongs here. The second reason has nothing to do with food at all. Most of what this app is, holding reminders, routines, appointments, bills, upkeep, a place to put a thought before it is gone, is the kind of outside scaffolding that helps anybody whose daily details will not stay in their head. What this topic does not do, anywhere, is claim that changing what you eat treats autism, ADHD or dyslexia. The trials that tested that are covered below, including the ones that found nothing, and the honest summary of them is that diet is not a treatment for any of the three. Nutrition supports a person. It does not treat these.',
    citations: [],
    overallTier: 'strong',
  ...
  // ---------------------------------------------------------- autism, eating
  {
    ...
    summary:
      'Sharp and colleagues pooled the available comparative research and found feeding problems roughly five times more common in autistic children than in peers, an odds ratio of 5.11 with a confidence interval of 3.74 to 6.97, which is a wide margin above no difference rather than a marginal finding. The same analysis found the nutritional consequence rather than just the behaviour: calcium intake lower by a standardised mean difference of 0.65 and protein intake lower by 0.58. What this is not is picky eating in the ordinary sense that most children grow out of. The pattern described in the research is narrower and more stable, driven by how a food feels, smells, sounds and looks rather than by whether it is liked, and it commonly holds to specific brands, specific temperatures and specific presentations. Treating it as a discipline problem does not work and makes mealtimes worse. What the research supports is watching the nutrition rather than the behaviour: knowing which nutrients a narrow range is actually short on, and widening from what is already accepted rather than replacing it.',
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'The Shortfalls That Actually Turn Up, and Why Normal Growth Does Not Rule Them Out',
    ...
    summary:
      'Where narrow eating persists, specific deficiencies follow, and they are not random. Reviews of nutritional status in autistic children report vitamin D deficiency at around 25.0%, vitamin A at 24.8%, B vitamins at 18.0%, calcium at 10.8% and iron at 9.6%. The sharp end of this is documented in a case series of 76 children admitted with a nutritional deficiency in the context of restrictive eating: 69.7% had scurvy from vitamin C deficiency, 17.1% had vitamin A-related eye disorders, and 70% had more than one deficiency at once. The finding worth carrying from that series is that a number of these children had normal growth parameters. Height and weight tracking normally is the reassurance most often relied on, and it is the wrong instrument: a diet of crackers, chips and one brand of chicken nugget supplies enough energy to grow on while supplying almost no vitamin C, vitamin A or calcium. Scurvy in a well-grown child is not a historical curiosity, it is a regularly reported presentation, and the first signs (sore legs, refusing to walk, bleeding gums, bruising) are commonly attributed to something else for months. If eating is narrow, the thing to watch is which nutrients the accepted foods do not contain, and the thing to raise with a clinician is a blood test rather than the growth chart.',
    citations: [
  ...
  },
  {
    ...
    summary:
      'Across the feeding research, the property that predicts whether a food is accepted is most often texture rather than flavour: how it resists the teeth, whether it is uniform or mixed, whether it is wet, whether it changes as it is chewed. Mixed textures in one mouthful are the most commonly refused, which is why a casserole fails where each of its parts might have been eaten separately. This is worth knowing because it changes the strategy. Offering a completely different food and hoping is close to random. Offering something that matches an already-accepted food on texture, and changing one property at a time, is the approach that feeding therapists use, and it is usually called food chaining: a crisp, dry, pale cracker leads more easily to a different crisp, dry, pale cracker than to anything soft or wet, whatever the nutritional argument for the soft wet thing. Two more things the research supports. Repeated neutral exposure with no pressure to eat does more than any single mealtime, and pressure reliably makes acceptance worse rather than better. And the point of widening a range is coverage of the nutrients the current range misses, not variety for its own sake, so it is worth knowing which nutrients are actually thin before deciding what to aim at.',
    citations: [
      { source: 'Feeding problems and nutrient intake in children with autism spectrum disorders: a meta-analysis and comprehensive review of the literature, Journal of Autism and Developmental Disorders', url: 'https://pubmed.ncbi.nlm.nih.gov/23408090/' },
    ],
    overallTier: 'moderate',
  ...
  // ------------------------------------------------------------ ADHD, eating
  {
    ...
    category: 'basicHealth',
    title: 'Elimination Diets for ADHD Have a Real but Small Pooled Effect',
  ...
  },
  {
    ...
    summary:
      'The Southampton trial in The Lancet found a mixture of artificial colours with sodium benzoate measurably increased hyperactivity in the general child population, which is an important result and is why this question stayed open. Pooling the wider literature gives a smaller number: Nigg and colleagues found a standardised effect of about 0.18 for synthetic food colours, dropping to roughly 0.12 after adjusting for publication bias, the tendency of studies that found nothing to never appear. The regulatory response is worth reading carefully, because it is often reported as having gone one way or the other and it went both. The European Food Safety Authority reviewed the evidence and did not consider a causal link to ADHD substantiated, and separately lowered the acceptable daily intakes for three of the colours involved on other grounds. The practical position that follows is neither alarm nor dismissal: the effect at population level is small, it is plausibly larger in a subset, avoiding synthetic colours is one of the few dietary changes that costs essentially nothing nutritionally, and it should not be expected to do much on its own.',
    citations: [
  ...
  },
  {
    ...
    summary:
      'Tseng and colleagues pooled the comparative studies and found serum ferritin measurably lower in children with ADHD than in controls, while serum iron and transferrin showed no significant difference. The mixed pattern is the finding. Ferritin reflects stored iron and is also an inflammatory marker, so a lower ferritin with normal circulating iron is not the same picture as iron-deficiency anaemia and does not have the same answer. The practical reading is that iron status is worth measuring in a child with ADHD, particularly one whose eating is narrow or who eats little meat, and that iron supplementation without a measured deficiency is not supported by this evidence and is not harmless: iron overload is a clinical problem and iron tablets are a leading cause of poisoning in young children. Test, then treat what the test shows. The same caution applies to the wider supplement literature for ADHD, where micronutrient trials have produced mixed results and the strongest case for supplementing anything remains a measured shortfall in that specific person.',
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'What This App Lets You Change About Its Own Text, and What Your Phone Already Does',
  ...
  },
  {
    ...
    summary:
      'Hollocks and colleagues pooled the available studies of autistic adults and found current anxiety in about 27% and lifetime anxiety in about 42%, with current depression at about 23% and lifetime depression at about 37%. All four figures sit well above general-population rates. The reason these get missed is worth stating, because it affects whether anybody asks: anxiety and depression often present differently here, and the presentation can be read as part of the autism rather than as a separate treatable thing. Increased rigidity, more repetitive behaviour, withdrawal from things previously enjoyed, more frequent shutdowns, or a change in eating or sleeping can all be a mood or anxiety disorder rather than a change in the autism, and they respond to treatment when they are recognised. This app’s Mental Health & Food topic covers the general biology, and it is worth being explicit that none of it is a substitute for asking a clinician directly. If something has changed and stayed changed, that is the thing to raise.',
    citations: [
  ...
  },
  {
    ...
    summary:
      'A recent meta-analysis of 22 studies covering 3,771 children and adolescents put the prevalence of sleep disorders in autism at 60%, and the wider literature spans roughly 40% to 80% depending on whether the measure is broad sleep disturbance or a formal diagnosis. Typically developing children sit around 20% to 30% by comparable measures. This matters beyond being tiring, because poor sleep amplifies almost everything else in this topic: sensory sensitivity increases, irritability and shutdowns increase, eating gets narrower rather than wider, and attention and mood both worsen. Which means sleep is often the highest-value thing to address first, before anything dietary is attempted. The evidence-based approaches are the ordinary ones, a consistent schedule, a predictable wind-down, light exposure in the morning and less of it at night, and they are worth doing properly before anything else. Melatonin has an evidence base in autism specifically, and it is a medication decision for a clinician rather than a supplement choice, because dose and timing both matter and the timing matters more than most people expect.',
    citations: [
  ...
  },
  {
    ...
    summary:
      'Xu and colleagues analysed the US National Health Interview Survey across 1997 to 2016 for children aged 3 to 17 and found food allergy, respiratory allergy and skin allergy each reported more often among children with autism or ADHD than among other children. The limits need stating with the finding rather than after it. Every diagnosis and every allergy in that dataset is parent-reported rather than clinically confirmed, and the design is cross-sectional, so it captures both conditions at one moment and can say nothing about which came first or whether either caused the other. A shared inflammatory or immune pathway is one plausible explanation, and differences in who gets assessed for what is another that this design cannot rule out. The practical use is narrow and worth having anyway: a diagnosed food allergy is a separate thing from sensory food refusal and needs separate handling, and if a food is causing a reaction rather than being disliked, that is a clinical question. This app keeps declared food allergies in Profile, and the matching it does is allergen-aware rather than allergy-safe: it flags what it recognises by name, which is not the same as a guarantee.',
    citations: [
  ...
  },
  {
    ...
    summary:
      'Meta-analysis across the available studies finds maternal autoimmune disease associated with autism in offspring at a pooled odds ratio of 1.34, with a confidence interval of 1.23 to 1.46, and maternal thyroid disease specifically at around 1.29. These are small effects on top of a low baseline rate, which is the framing that keeps them in proportion: a 34% increase in a risk of roughly 1 in 50 is not a large absolute change. They are also observational, which means an association and not a cause, and several mechanisms could produce the same numbers, including shared genetics between the mother and child, maternal antibodies crossing the placenta, and inflammation during pregnancy. What this is not is a reason to change anything. Untreated autoimmune disease in pregnancy carries known risks that are considerably better established than this association, and the treated condition is the safer one. This app tracks nine autoimmune conditions among its nineteen, so it seemed worth naming here rather than leaving to be discovered somewhere less careful, and the condition-specific findings are in the condition categories themselves.',
    citations: [
