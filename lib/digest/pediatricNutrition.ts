...
export const PEDIATRIC_NUTRITION_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: 'Real research on choline and DHA (a real, specific omega-3 fatty acid concentrated in brain and eye tissue) consistently frames their strongest developmental effect around "the first 1,000 days," the real, specific span from conception through roughly age 2, with real, continued relevance to synapse formation up through age 6 or 7. The already-existing Choline research covers real adult liver/cardiovascular findings in depth -- this entry names the real, separate, earlier-life story: choline is a genuine building block for the phospholipids that make up brain-cell membranes and for acetylcholine, a real neurotransmitter, while DHA directly supports real neuron and retinal development, with reduced DHA levels linked in real research to impaired neuron growth. Both nutrients matter well before the broader tracking scope typically applies (pregnancy and early infancy), a real, genuine reason this specific window deserves its own separate mention rather than folding quietly into general "eat healthy" advice.',
    citations: [
      {
