...
export const LABS_MEDICATION_ENTRIES: DigestEntry[] = [
  {
    ...
    citations: [{ source: 'Biotin interference in immunoassays, endocrinology lab methodology reviews' }],
    overallTier: 'strong',
  },
  {
    ...
    citations: [{ source: 'FDA levothyroxine labeling, calcium/iron interaction guidance' }],
    overallTier: 'strong',
  },
  {
    ...
    citations: [{ source: 'Grapefruit juice/levothyroxine crossover RCT, systematic review' }],
  ...
  },
  {
    ...
    citations: [{ source: 'TSH circadian rhythm studies' }],
    overallTier: 'strong',
  },
  {
    ...
    citations: [{ source: 'Bedtime vs. morning levothyroxine dosing, crossover comparison studies' }],
    overallTier: 'moderate',
  },
  {
    ...
    citations: [{ source: 'Levothyroxine absorption interaction summary, endocrinology practice guidelines' }],
    overallTier: 'strong',
