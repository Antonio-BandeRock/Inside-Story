...
export const LABS_MEDICATION_ENTRIES: DigestEntry[] = [
  {
    ...
    summary: "Someone starts a popular \"hair, skin & nails\" supplement, feels good about it, and a few weeks later their thyroid labs come back looking alarming, a frightening moment that, in a specific subset of cases, has nothing to do with their actual thyroid function at all. Most thyroid immunoassays rely on streptavidin-biotin technology to actually run the test, and high-dose biotin, present in nearly every one of those popular hair/skin/nails blends as well as in standalone supplements, interferes directly with that exact chemistry. The result is a well-replicated pattern: falsely elevated free T4 and T3 readings, and falsely suppressed thyroglobulin readings, with a documented serum concentration cutoff above which this interference becomes likely. It isn't the thyroid getting worse. It's the lab test itself being fooled by an unrelated vitamin. This is a lab-methodology issue, not a true change in thyroid function, and it's directly relevant to the still-unbuilt lab-tracking feature, where knowing to ask \"have you taken biotin recently\" before trusting an alarming result could spare someone a lot of unnecessary worry.",
    citations: [
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'Calcium and Iron Bind Levothyroxine in the Gut, So the Two Need Hours Between Them',
    ...
    summary: "Of everything in the Labs & Medication Timing research, this is the one with the least room for scientific debate, and, ironically, still one of the most commonly broken rules in everyday practice. Calcium and iron both form insoluble complexes with levothyroxine directly in the gut, substantially reducing how much of the actual dose gets absorbed. This isn't an emerging or contested finding. It's well-established enough to be standard FDA labeling guidance. The fix is just as well-studied: taking levothyroxine at least 4 hours apart from calcium supplements, iron supplements, or calcium-fortified foods restores normal absorption completely. A four-hour buffer is all it takes to neutralize one of the best-documented interactions in this entire category, since \"take your vitamins together to save time\" is exactly the habit that quietly undoes it.",
    citations: [
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'Grapefruit Juice Has a Measured but Modest Effect on Levothyroxine Absorption',
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'TSH Has a Daily Rhythm, Which Is Why "Morning, Fasting" Is Not an Arbitrary Rule',
    teaser: "The same person's blood, drawn at two different times of day, can tell two different stories.",
    summary:
      "A doctor's instruction to get a morning, fasting blood draw can feel like an arbitrary inconvenience, one more hoop before the information shows up. It isn't arbitrary at all. TSH follows a circadian pattern, typically peaking in the late night and early morning hours and dropping to its lowest point in the afternoon, a large enough swing that the actual time of day a sample is drawn can meaningfully change the number that comes back. That's exactly why morning, fasting draws became the standard clinical convention in the first place, and why comparing two TSH results drawn at very different times of day, rather than at a consistent time, can introduce noise that looks like a change in thyroid status but isn't one. A small, easy habit, getting blood drawn at roughly the same time each time, is what keeps a trend actually readable as a trend, rather than buried in noise the clock itself quietly introduced.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A huge question in every Hashimoto\'s community: "my labs are normal but I still feel awful, should I ask for T3 or natural desiccated thyroid?" The answer is more complicated than either side of that argument usually admits.',
    summary:
      "Levothyroxine (synthetic T4) works well enough for most people that a normal TSH is treated as the finish line, but an acknowledged minority of patients stay symptomatic even once their labs look perfect. That gap is exactly what drives two of the most common questions in Hashimoto's patient communities: should I ask for liothyronine (synthetic T3) added to my levothyroxine, or switch to natural desiccated thyroid (NDT, e.g. Armour Thyroid), which contains both T4 and T3 from pig thyroid gland? The answer, built from trial data rather than either side's talking points: a 2006 meta-analysis of 11 randomized trials (1,216 patients) found no measurable difference between combination T4/T3 and T4 alone across mood, cognition, bodily pain, fatigue, weight, or cholesterol, and a 2013 randomized crossover trial specifically comparing NDT to levothyroxine (70 patients) found the same thing: no significant overall difference in symptoms or quality of life, though NDT did cause a modest ~3-pound weight loss. Here's the twist: despite trials not measuring a group-level symptom difference, patients themselves keep preferring the combination anyway. That same 2013 NDT trial found 48.6% of patients preferred NDT versus 18.6% preferring levothyroxine, and a larger 2025 systematic review of 11 RCTs (1,135 patients) found 52% preferred combination therapy versus 24% for T4 alone. That is an unresolved gap between what a trial can measure at the group level and what an individual person actually experiences, and it's exactly why a 2024 review states plainly that a minority of levothyroxine-treated patients remain symptomatic despite normal labs. Worth a direct conversation with a doctor specifically framed around that patient-preference data, shared decision-making, not needing to prove the symptoms exist rather than either dismissing the request outright or assuming NDT/combination therapy is a guaranteed fix current trials simply haven't found evidence for yet.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "Amiodarone, a commonly prescribed heart-rhythm medication, is structurally similar to thyroid hormone itself and carries an iodine load. ETA clinical guidelines put the rate of resulting thyroid dysfunction (both hypo- and hyperthyroid forms) at roughly 15-20% of patients taking it. Lithium, a standard mood-stabilizing medication, works differently but reaches a similar destination. It directly slows the same peripheral deiodination process (covered elsewhere in this app as the main route T4 becomes active T3) and acts as an immune stimulant specifically in people who already carry thyroid antibodies, a direct, mechanistic reason someone with existing Hashimoto's antibodies may be more susceptible to lithium's thyroid effects than someone without them. Data puts lithium-induced goiter/hypothyroidism at around 8% of patients. Neither of these facts means avoiding a necessary heart or mood medication. Both are often irreplaceable for what they treat. But both are well-documented reasons thyroid function specifically deserves its periodic check while taking either one, not just a general assumption that any new fatigue or mood shift is \"just the Hashimoto's again.\"",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "This category's core timing rules (calcium, iron, coffee, soy, fiber) cover food-level interference. A comprehensive 2017 review pooling the existing literature confirms a longer list of medications that interfere with levothyroxine absorption through the same general mechanism, \"established and clinically significant\": cholestyramine and colesevelam (cholesterol-lowering bile-acid binders), lanthanum and sevelamer (phosphate binders used in kidney disease), calcium and iron supplements, ciprofloxacin (a commonly prescribed antibiotic), aluminum hydroxide (an antacid ingredient), and proton pump inhibitors, a common class of heartburn/reflux medication (omeprazole and similar) taken daily by a huge number of people, often without ever connecting it to their thyroid dose. The same review's practical fix applies across this whole list: separating levothyroxine from any of these by enough time resolves the interference, the identical principle behind this category's calcium/iron timing rule, just applied to a longer list of medications than food alone. Worth a direct question for anyone on a stable levothyroxine dose who's also started one of these medications and later finds their TSH has drifted. The cause may be the newer medication, not a change in Hashimoto's itself.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'The TSH Target Itself Is Supposed to Shift With Age, an Often-Missed Adjustment',
    teaser: "Thyroid-society guidance recommends a higher TSH target, 4-6 mIU/L, for people age 70-80, because normal TSH itself rises with age and the standard target can lead to overtreatment.",
    summary:
      "This category's self-advocacy content covers overtreatment risk (bone loss, atrial fibrillation) at length, and one of the clearest, most concrete ways to avoid it is often simply missed: the TSH target itself is supposed to change with age. Population data finds normal TSH reference ranges shift upward with age, one study of adults 65 to 84 finding the typical (2.5th to 97.5th percentile) range running from 0.49 to 5.56 mIU/L, measurably higher than the range used for younger adults, evidence that mild TSH elevations often labeled 'subclinical hypothyroidism' in an older person may simply reflect normal aging rather than a condition needing treatment. Current thyroid-society guidance reflects this directly: the recommended TSH target for people age 70 to 80 is raised to roughly 4 to 6 mIU/L, meaningfully higher than the target typically used in a 30- or 40-year-old, and treatment in older adults is meant to start at a lower dose with slower, more careful titration specifically because thyroid hormone requirements often decrease with age. An older adult whose levothyroxine dose was set years earlier, using a younger-adult target, may be carrying an avoidable overtreatment risk simply because the target itself was never re-adjusted for age, a concrete, specific question worth raising directly at a next appointment.",
    citations: [
