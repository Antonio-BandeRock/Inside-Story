...
export const RHEUMATOID_ARTHRITIS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "JAK inhibitors (tofacitinib, baricitinib, upadacitinib) are a newer class of oral RA medication, and they carry a serious, FDA-mandated boxed warning, distinct from the biologics already covered in the RA research. The ORAL Surveillance trial specifically studied this safety question in roughly 4,300 RA patients aged 50 or older with at least one cardiovascular risk factor, comparing tofacitinib against TNF inhibitors over an average 4-year follow-up. Results found a serious, increased risk across multiple outcomes with JAK inhibitor use: heart attack and stroke, cancer, blood clots, serious infections, and death, all compared to the TNF-inhibitor comparison group. Based directly on these findings, the FDA required a class-wide boxed warning (the strongest warning label the FDA issues) across all JAK inhibitors used for RA and other inflammatory conditions, and similar action followed internationally. Ongoing analysis of this trial (\"the theory of relativity\" as one academic review calls it) has debated how much of this risk applies broadly versus concentrates specifically in the older, cardiovascular-risk-factor-carrying population the trial actually studied. This is a worth-naming-by-name safety conversation to have before starting a JAK inhibitor, especially for anyone with existing cardiovascular risk factors already covered elsewhere in the research, JAK inhibitors remain an effective RA option, but not a risk-free alternative to be chosen without this specific conversation.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's already-covered TNF-inhibitor and JAK-inhibitor research covers two distinct drug classes, rituximab targets a different immune cell type entirely, and direct trial data finds its effectiveness tracks with how thoroughly it clears that cell type out.",
    summary:
      "This category's already-covered biologic research names TNF inhibitors and JAK inhibitors as two established drug classes, and rituximab (a B-cell-depleting biologic, working through a different immune mechanism) deserves direct coverage. A landmark randomized trial (published in the New England Journal of Medicine) found rituximab, given as two infusions, alone or combined with cyclophosphamide or continued methotrexate, produced significant improvement in RA symptoms at both 24 and 48 weeks in patients whose disease hadn't responded to methotrexate alone. The useful mechanistic finding: research directly establishes that the DEGREE of B-cell depletion, not simply the dose of rituximab given, is what actually determines clinical response, with complete B-cell depletion tracking with clinical improvement and longer-term maintained benefit. Research also identifies who responds best: low pretreatment plasmablast counts, concurrent DMARD use, no smoking history, presence of the anticitrullinated-protein antibodies or rheumatoid factor this category's already-covered serology research names, and a low interferon signature all predict achieving that complete B-cell depletion and clinical response. A useful finding for anyone whose response fades over time: about half of patients who initially achieve complete depletion and respond eventually lose that response with further rounds of treatment, but three-quarters of those patients regain it in their NEXT treatment cycle, direct evidence that a lost response to rituximab is often reversible rather than permanent. Rituximab is a different mechanistic option from this category's already-covered TNF and JAK-inhibitor classes, worth discussing directly for RA that hasn't responded well to either.",
    citations: [
  ...
  // WebSearch.
  {
    ...
    overallTier: 'moderate',
    stageNote: 'A meta-analysis found a consistent but modest positive correlation; at least one individual study found none, an inconsistency rather than a uniform finding.',
