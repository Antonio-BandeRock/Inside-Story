...
export const RHEUMATOID_ARTHRITIS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'Not an assumed side effect of getting older. A elevated risk tied to the disease itself, worth its direct conversation.',
    summary:
  ...
  },
  {
    ...
    teaser: 'A 17,320-patient Danish cohort found NSAID-related cardiovascular risk in RA patients lower than in the general population, an honest, reassuring nuance to RA\'s already-elevated heart risk.',
