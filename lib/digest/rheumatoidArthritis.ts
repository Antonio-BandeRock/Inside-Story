...
export const RHEUMATOID_ARTHRITIS_ENTRIES: DigestEntry[] = [
  {
    ...
    title: 'Rheumatoid Arthritis Ranks as the Most Prevalent Autoimmune Disease Measured',
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: 'The Fasting-Then-Vegetarian Trial That Only Worked for Some Patients',
  ...
  },
  {
    ...
    summary:
      "Methotrexate is the first-line disease-modifying drug for RA, and it works partly by blocking how the body uses folate. That sounds like a reason to cut folate out entirely, but the clinical picture is more specific than that. Folic acid is frequently prescribed deliberately, taken on methotrexate's off-days, specifically to reduce side effects like nausea and mouth sores without blunting the drug's effect on disease activity. The actual risk sits in the gap between what a prescriber accounted for and what a person does on their own: raising or lowering folate intake independently, through diet or supplements, without factoring in what the prescribed dose already assumes. Once weekly dosing (not daily, a distinct pattern from most other medications a person might take) makes this even easier to lose track of.",
    citations: [
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: 'Where the Alcohol Threshold on Methotrexate Actually Sits',
  ...
  },
  {
    ...
    teaser: 'A specific, guideline-set interval exists for catching liver and blood-count problems before they become serious, and it is a concrete number.',
    summary:
      "Methotrexate's liver-toxicity and bone-marrow-suppression risk, isn't monitored on a vague \"come back if something feels wrong\" basis. American College of Rheumatology guidance recommends checking liver enzymes at 8-to-12-week intervals for the duration of methotrexate treatment, with closer monitoring, weekly for the first month, then at least every other month, during the early weeks after starting or increasing a dose, when bone-marrow suppression risk is highest. A complete blood count and kidney-function check typically ride alongside the same liver-enzyme draw, not as a separate, extra visit. One practical detail: testing within a day or two of the actual weekly methotrexate dose can show a transient liver-enzyme bump that isn't the same as sustained toxicity, so timing the draw a few days clear of the most recent dose gives a truer reading.",
    citations: [
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: 'RA Roughly Doubles Cardiovascular Risk. Ask for It to Be Assessed Separately.',
    teaser: 'Not an assumed side effect of getting older. An elevated risk tied to the disease itself, worth its direct conversation.',
    summary:
  ...
  },
  {
    ...
    teaser: 'Two food levers with strong trial evidence, one landmark finding that only applies to part of the population, and two medication interactions, not just generally.',
    summary:
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: "RA's History: Named by a Son, Defined by a Father, Transformed by Two Drug Discoveries",
    ...
    summary: "RA's history runs through a specific family: in 1859, physician Alfred Garrod wrote the first treatise distinguishing this condition from gout, calling it \"rheumatic gout\"; in 1890, his son Archibald Garrod gave it the name still used today, rheumatoid arthritis. The 20th century brought two transformative treatment discoveries: cortisone's 1948 introduction, hailed at the time as a miracle drug for inflammation, and methotrexate's formal 1988 FDA approval for RA specifically (used off-label somewhat earlier), a foundational disease-modifying drug still first-line today, covered in the self-advocacy research. The most recent turning point: 1998's approval of etanercept, the first biologic disease-modifying drug for RA, directly targeting TNF, a specific inflammatory signaling molecule, rather than suppressing the immune system broadly the way earlier drugs did, a different, more targeted treatment era that biologics like adalimumab (covered in the medication research) continue today.",
    citations: [
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: 'JAK Inhibitors: A Newer RA Drug Class With a Serious Safety Story Behind Its Boxed Warning',
    ...
    summary: "JAK inhibitors (tofacitinib, baricitinib, upadacitinib) are a newer class of oral RA medication, and they carry a serious, FDA-mandated boxed warning, distinct from the biologics covered in the RA research. The ORAL Surveillance trial specifically studied this safety question in roughly 4,300 RA patients aged 50 or older with at least one cardiovascular risk factor, comparing tofacitinib against TNF inhibitors over an average 4-year follow-up. Results found a serious, increased risk across multiple outcomes with JAK inhibitor use: heart attack and stroke, cancer, blood clots, serious infections, and death, all compared to the TNF-inhibitor comparison group. Based directly on these findings, the FDA required a class-wide boxed warning (the strongest warning label the FDA issues) across all JAK inhibitors used for RA and other inflammatory conditions, and similar action followed internationally. Ongoing analysis of this trial (\"the theory of relativity\" as one academic review calls it) has debated how much of this risk applies broadly versus concentrates specifically in the older, cardiovascular-risk-factor-carrying population the trial actually studied. This is a worth-naming-by-name safety conversation to have before starting a JAK inhibitor, especially for anyone with existing cardiovascular risk factors covered elsewhere in the research, JAK inhibitors remain an effective RA option, but not a risk-free alternative to be chosen without this specific conversation.",
    citations: [
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: 'A Specific Gum-Disease Bacterium Carries a Unique Enzyme That Directly Triggers RA\'s Core Mechanism',
    ...
    summary:
      "This category's already-built research covers how smoking triggers citrullination, a chemical change to certain proteins that the immune system can then mistakenly attack, driving RA's core autoimmune mechanism. Periodontal disease (gum disease) offers a second, independent route to that exact same mechanism. Porphyromonas gingivalis, a common bacterium behind chronic gum disease, is the only known bacterium carrying its version of the enzyme (peptidylarginine deiminase, or PAD) that performs this citrullination, and laboratory research found it can citrullinate several of the exact same proteins already implicated as RA autoantigens (fibrinogen, alpha-enolase, vimentin). A controlled animal study found infection with this bacterium directly worsened arthritis severity and measurably increased citrullinated-protein antibodies, and this effect depended specifically on the bacterium's unique enzyme being present and active. Human research has independently found periodontal disease a documented risk factor for developing RA, consistent with this same direct mechanism rather than just a coincidental shared risk factor. This gives practical weight to something easy to treat as a minor, unrelated health habit, routine dental care and periodontal treatment is a low-cost, low-risk piece of RA management, not just general oral hygiene advice.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A 17,320-patient Danish cohort found NSAID-related cardiovascular risk in RA patients lower than in the general population, a reassuring detail set against RA\'s already-elevated heart risk.',
    summary: "This category's already-built research covers RA's independently elevated cardiovascular risk (roughly 2 to 5 times higher than the general population), and RA's treatment regularly involves NSAIDs, medications the cardiovascular research already documents as carrying cardiovascular risk on their own. Put together, that raises a reasonable worry: does using NSAIDs regularly for RA symptom control compound an already-elevated risk? A large Danish nationwide cohort study (17,320 RA patients matched against 69,280 controls) tested this directly, and found something reassuring: the cardiovascular risk associated with overall NSAID use was significantly LOWER in RA patients than in the matched control group (a hazard ratio of 1.22 in RA patients versus 1.51 in controls). This isn't a blanket clearance, though: the same study found this protective difference didn't hold for every individual NSAID, specific drugs (rofecoxib and diclofenac by name) still showed elevated cardiovascular risk in RA patients specifically. This is useful, two-sided context: NSAID use for RA symptom control isn't automatically compounding the elevated RA cardiovascular risk the way a first, worried assumption might suggest, but which specific NSAID gets used still matters, a concrete detail worth raising directly when discussing symptom management with a rheumatologist.",
    citations: [
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: "This Category's Biologic Research Reaches a Vastly Uneven Share of the World's RA Patients",
    ...
    summary:
      "The biologic research (the infection-risk cautions, the periodontal/cardiovascular connections) assumes access to these medications in the first place, and international data finds that access itself varies enormously by country. An international cohort study found biologic and targeted-DMARD usage correlating directly with a country's Human Development Index, ranging from just 2.7% of RA patients in low-HDI countries up to 38.8% in very-high-HDI countries, a roughly fourteenfold gap that held up even after adjusting for disease severity and other patient-level factors. The structural reason: in roughly half of countries studied, public health systems cover biologic DMARDs for fewer than 10% of patients, driven by high medication costs relative to average income, alongside regulatory and market barriers specific to lower-income health systems. RA's disease biology and treatment research doesn't change by country, but whether a given person can actually access the treatments this category covers in depth often does, a structural gap in outcomes that has nothing to do with how well RA itself responds to treatment.",
    chart: {
  ...
  },
  {
    ...
    summary:
      "For RA patients who've already worked through the biologic and JAK-inhibitor options without lasting relief, a new treatment class is now in early human testing: CAR-T cell therapy, engineering a patient's immune cells to specifically target and reset the immune process driving their disease. Current trials are showing promise: KYV-101, tested in a Phase 1/2 trial in patients who had already failed multiple prior therapies, showed a rapid decline in key disease biomarkers, supporting the trial's move into a larger, randomized Phase 2 stage now underway. A separate fourth-generation CAR-T study published in 2025 found significant improvement in tender and swollen joint counts in treatment-resistant RA patients, and a distinct CAR-Treg (regulatory T-cell) approach has completed its first human safety trial. But data across this whole approach for autoimmune rheumatic disease remains overwhelmingly early-stage, roughly 64% of trials are still Phase 1, only about 7% have reached Phase 2, and most current trial activity concentrates on lupus rather than RA specifically. This is a promising direction for the hardest-to-treat cases, not yet an available option.",
    citations: [
  ...
  },
  {
    ...
    teaser: "Every current RA treatment, including this category's CAR-T research, works by suppressing or resetting the immune system broadly. A distinct research direction is trying something narrower: retraining it to specifically tolerate the one target driving RA.",
    summary:
      "The CAR-T and biologic research all works by broadly suppressing or resetting immune activity. A more targeted research direction, antigen-specific tolerizing immunotherapy, is trying something narrower: teaching the immune system to specifically stop attacking one target (citrullinated proteins, the same antigen covered in this category's smoking-citrullination research) while leaving the rest of the immune system untouched. A randomized Phase 1 trial tested peptide/calcitriol liposomes (DEN-181) in people with antibody-positive RA already on methotrexate, and found the treatment well tolerated, with a measurable drop in the specific immune cells that react to citrullinated proteins. A separate Phase 1/2 trial (TOLERANT) is testing a related approach using the patient's dendritic cells, engineered to promote tolerance rather than attack. This whole research direction remains early-stage, Phase 1 safety and immune-marker data, not yet evidence of joint-damage prevention or symptom reversal, but it represents a different goal than every other treatment, tolerance instead of suppression.",
    citations: [
  ...
  },
  {
    ...
    summary: "The extra-articular manifestations research establishes RA as a whole-body disease; the eyes are one of its most commonly affected organs, and numbers make the case directly. Ocular involvement appears in a 25-39% of RA patients, making RA the most common rheumatic disease associated with eye disease at all. Keratoconjunctivitis sicca (dry eye, from the same exocrine-gland dysfunction the Sjögren's research covers in depth) is the most frequent finding at 15-28%. Episcleritis, inflammation of the eye's outer surface layer, affects 1-5% and is usually mild; scleritis, a deeper and more serious inflammation of the eye's structural wall, affects around 5% of RA patients with eye involvement and carries a risk of vision loss if untreated. A new, persistent red or painful eye in someone with RA is worth mentioning to a doctor specifically, not assumed to be an unrelated, ordinary eye irritation.",
    citations: [
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: "RA's Cardiac Risk Reaches Beyond Generic Cardiovascular Disease, Into the Heart's Structure",
    ...
    summary:
      "The cardiovascular-risk research names the elevated general heart-disease risk in RA; a more specific finding is that chronic inflammation directly damages cardiac STRUCTURES, not just arteries. Echocardiographic and post-mortem studies find pericardial involvement (inflammation of the sac surrounding the heart) in 30-50% of RA patients, yet it's clinically noticeable in under 10% of even severe cases, a mostly silent process. RA also carries a quantified 10.7-times higher odds of pericardial fluid buildup and over 10 times higher risk of nodules forming directly on heart valves, both driven by the same chronic inflammatory cell and cytokine activity, not by accelerated plaque buildup alone. This is a separate mechanism from the atherosclerosis-driven heart attack risk, meaning RA's cardiac risk is broader than \"watch your cholesterol.\"",
    citations: [
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: 'DAS28 and CDAI Can Score the Same Disease Activity Differently, and Which One a Doctor Uses Matters',
    ...
    summary:
      "The Treat-to-Target research depends on a measured disease-activity SCORE to know whether treatment is actually working; DAS28 and CDAI are the two tools most commonly used to produce that number, and they aren't interchangeable. A large validation study of 2,864 RA patients found both tools valid and strongly correlated with each other overall, but disagreeing on which specific activity category (remission, low, moderate, high) the same patient falls into a meaningful share of the time. The practical difference: CDAI is a pure clinical count (joint exam plus patient/doctor global assessments) needing no lab work at all, while DAS28 also factors in an ESR or CRP blood-inflammation marker. If a treatment decision hinges on \"my score,\" it's worth knowing which of the two tools produced it, since a borderline case could read differently depending on which one was used.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "The Window of Opportunity research argues for treating RA early and aggressively; imaging evidence explains a big part of why waiting for an X-ray to show damage is often too late. A study using CT scanning as the gold-standard reference found MRI detecting bone erosions with 61% sensitivity, against just 24% for a standard X-ray of the identical joint, meaning conventional X-rays miss roughly three out of every four erosions MRI can already see. Even more striking: in wrist joints that looked completely normal on X-ray, MRI still found erosions in 59% of cases. A clean X-ray early in RA does not necessarily mean joint damage hasn't already started, and asking specifically about ultrasound or MRI imaging, not just X-ray, is a legitimate question to raise if early, aggressive treatment decisions are on the table.",
    citations: [
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: 'Biosimilars Work as Well as the Original Biologics, but Adoption Has Been Slow',
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: 'Gold Salts: an Effective 1929 RA Treatment That Its Toxicity Eventually Retired',
  ...
  },
  {
    ...
    teaser: 'Finland, the UK, Ireland, and New Zealand all exceed 1,628 cases per 100,000 people; East Asia\'s regional rate sits at 745.5, with declining prevalence now showing up in several of the highest-rate countries too.',
    summary:
      "The Indigenous-population research shows one striking regional extreme; a broader global-burden analysis adds a second, useful comparison: wealthy Northern European countries against East Asia. Finland, the UK, Ireland, and New Zealand all show a prevalence above 1,628 cases per 100,000 people, while East Asia's regional rate sits at 745.5 per 100,000, notably lower. The most-cited explanation centers on diet and lifestyle rather than genetics alone: higher red-meat and high-protein-diet intake, higher salt/fat/sugar consumption, and higher obesity rates in wealthy Western populations. An encouraging complication to this pattern: several of the highest-prevalence countries, including Finland, Norway, and Japan, are now showing DECLINING prevalence, attributed directly to earlier detection and the same widespread modern DMARD and biologic treatment.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Structural biology has now shown exactly how HLA-DR4\'s risk allele works: it preferentially grips citrullinated proteins at one specific position, giving a T-cell receptor exactly the target this category\'s smoking research already names as the trigger.',
    summary:
      "The smoking-and-citrullination research names WHAT drives RA's central immune trigger; a more recent structural-biology finding explains HOW one specific genetic risk factor plugs directly into that same mechanism. Individual HLA-DRB1 \"shared epitope\" gene variants carry quantified risk multipliers for developing antibody-positive RA specifically, not RA in general, one variant alone (HLA-DRB1*04:08) carries a 10.3-times higher odds, with certain combined genotypes reaching as high as 28 times. A 2024 structural study went further and solved the actual molecular mechanism directly: this gene variant's protein pocket preferentially binds citrullinated (chemically altered) fragments of the body's own proteins, and a T-cell receptor specifically locks onto the citrulline sitting at one precise position on that fragment. This is a direct, physical explanation connecting this category's smoking/citrullination and genetic-risk research into one single mechanism, not two separate coincidental risk factors.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The methotrexate/folate entry names standard dosing, direct pharmacokinetic and trial data finds the same dose delivers meaningfully more drug, and better disease control, as a subcutaneous injection than as a pill.",
    summary:
      "The methotrexate research assumes oral dosing as the default, and direct comparative research finds a meaningful difference in a different delivery route. A pharmacokinetic study found oral methotrexate's bioavailability (how much of the drug actually reaches the bloodstream) averaged just 64 percent of what the identical subcutaneous dose achieved, at a standard 30mg weekly dose, with the gap growing even larger at higher doses (above 15mg/week). A direct, 6-month, multicenter, randomized, double-blind trial (Braun et al.) found this pharmacokinetic difference translating into a measurable clinical gap: 85 percent of patients started on subcutaneous methotrexate achieved an ACR20 response (a formal 20 percent improvement measure) at 16 weeks, versus 77 percent of those started on oral methotrexate at the same nominal dose. This useful, actionable finding means someone whose RA isn't responding as well as expected on oral methotrexate has an evidence-backed option, switching to a subcutaneous injection at the SAME dose, before assuming the drug itself has failed or jumping straight to the biologic options.",
    citations: [
  ...
  },
  {
    ...
    category: 'rheumatoidArthritis',
    title: 'How COMPLETELY Rituximab Depletes B-Cells Predicts Whether It Helps',
    teaser: "The TNF-inhibitor and JAK-inhibitor research covers two distinct drug classes, rituximab targets a different immune cell type entirely, and direct trial data finds its effectiveness tracks with how thoroughly it clears that cell type out.",
    summary:
      "The biologic research names TNF inhibitors and JAK inhibitors as two established drug classes, and rituximab (a B-cell-depleting biologic, working through a different immune mechanism) deserves direct coverage. A landmark randomized trial (published in the New England Journal of Medicine) found rituximab, given as two infusions, alone or combined with cyclophosphamide or continued methotrexate, produced significant improvement in RA symptoms at both 24 and 48 weeks in patients whose disease hadn't responded to methotrexate alone. The useful mechanistic finding: research directly establishes that the DEGREE of B-cell depletion, not simply the dose of rituximab given, is what actually determines clinical response, with complete B-cell depletion tracking with clinical improvement and longer-term maintained benefit. Research also identifies who responds best: low pretreatment plasmablast counts, concurrent DMARD use, no smoking history, presence of the anticitrullinated-protein antibodies or rheumatoid factor the serology research names, and a low interferon signature all predict achieving that complete B-cell depletion and clinical response. A useful finding for anyone whose response fades over time: about half of patients who initially achieve complete depletion and respond eventually lose that response with further rounds of treatment, but three-quarters of those patients regain it in their NEXT treatment cycle, direct evidence that a lost response to rituximab is often reversible rather than permanent. Rituximab is a different mechanistic option from the TNF and JAK-inhibitor classes, worth discussing directly for RA that hasn't responded well to either.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Curcumin, the compound behind this app\'s turmeric fermentation recipes, has randomized trial data in rheumatoid arthritis specifically, not just a general anti-inflammatory reputation, though the overall picture across trials is mixed.',
    summary: 'This app\'s Wild-Fermented Tart Cherry, Ginger & Turmeric Tonic and Fermented Turmeric Drink (both in Recipes) lean on curcumin and gingerol, the two compounds behind most of the anti-inflammatory interest in ginger and turmeric. Curcumin specifically has been tested in RA patients directly: a randomized, double-blind trial of a highly bioavailable curcumin formulation found measurable improvement in inflammatory markers (ESR, CRP) and disease activity scores at a dose comparable to what a concentrated tonic can approach over time, though a separate trial found curcumin didn\'t meaningfully extend flare-free survival during medication tapering. The picture across the full body of trials is mixed, not settled, so treat these tonics as a worthwhile addition alongside prescribed treatment, not a replacement for it. Black pepper is included in both recipes specifically because it measurably improves how much curcumin the body actually absorbs.',
    citations: [
