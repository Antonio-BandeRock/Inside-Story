...
export const RHEUMATOID_ARTHRITIS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Polyautoimmunity, having more than one autoimmune disease at once, shows up in roughly a third of everyone diagnosed with any autoimmune condition. Among the specific pairings researchers name most often, rheumatoid arthritis together with autoimmune thyroiditis stands out as one of the most common. That's a real, practical reason already supported selecting more than one condition in Profile at once, rather than treating each diagnosis as its own separate silo: a meaningful share of people managing one of these two conditions are managing the other too, diagnosed or not. Practically, this means someone managing both needs both sets of food and medication guidance checked together, not just one or the other. The multi-condition Profile now supports exactly that.",
    citations: [
  ...
  },
  {
    ...
    summary: "RA's own real history runs through a real, specific family: in 1859, physician Alfred Garrod wrote the first treatise distinguishing this condition from gout, calling it \"rheumatic gout\"; in 1890, his son Archibald Garrod gave it the name still used today, rheumatoid arthritis. The 20th century brought two real, transformative treatment discoveries: cortisone's 1948 introduction, hailed at the time as a genuine miracle drug for inflammation, and methotrexate's formal 1988 FDA approval for RA specifically (used off-label somewhat earlier), a real, foundational disease-modifying drug still first-line today, already covered in the self-advocacy research. The most recent real turning point: 1998's approval of etanercept, the first biologic disease-modifying drug for RA, directly targeting TNF, a specific inflammatory signaling molecule, rather than suppressing the immune system broadly the way earlier drugs did -- a genuinely different, more targeted treatment era that real biologics like adalimumab (already covered in the medication research) continue today.",
    citations: [
  ...
  // verified via WebSearch.
  {
    ...
    summary: "Smoking is the real, most consistently identified environmental risk factor for developing rheumatoid arthritis, and the mechanism behind it is now genuinely well understood rather than just statistically observed. Real research shows cigarette smoke triggers citrullination, a chemical alteration of certain proteins, inside the lungs of a real, susceptible person. In someone carrying specific genetic variants, most notably the HLA-DRB1 \"shared epitope\" and PADI4 gene variants, the immune system can start treating these altered proteins as foreign, producing anti-citrullinated protein antibodies (ACPA, also called anti-CCP) years before joint symptoms ever appear. Real research finds this isn't just an additive risk, it's a genuine gene-environment interaction: smoking's own effect on ACPA-positive RA risk is significantly amplified specifically in people who already carry these genetic variants, and a real, large study found smoking most strongly associated with the presence of all three major RA-related antibodies together (rheumatoid factor, ACPA, and anti-carbamylated protein antibodies) rather than any one alone. Worth knowing directly, this connects straight back to the already-built RF/anti-CCP self-advocacy research: someone who smokes and tests positive for these antibodies is looking at a real, mechanistically explained elevated risk, not just a correlation, and quitting remains one of the few real, modifiable levers over that risk profile.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Porphyromonas gingivalis, a real, common cause of gum disease, is the only known bacterium carrying an enzyme that citrullinates proteins, the exact same process the smoking research already names as RA\'s central trigger.',
    summary:
