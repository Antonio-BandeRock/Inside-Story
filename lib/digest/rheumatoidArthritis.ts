...
export const RHEUMATOID_ARTHRITIS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'Curcumin, the compound behind this app\'s own turmeric fermentation recipes, has randomized trial data in rheumatoid arthritis specifically, not just a general anti-inflammatory reputation, though the overall picture across trials is mixed.',
