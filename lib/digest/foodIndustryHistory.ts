...
export const FOOD_INDUSTRY_HISTORY_ENTRIES: DigestEntry[] = [
  ...
  // honestly rather than picking the more dramatic single explanation.
  {
    ...
    summary:
      "Three documented, structural reasons sit underneath why no government has simply mandated soil regeneration, distinct from the lobbying dynamics covered in this cluster's dedicated entries. First, and most direct: the US Federal Crop Insurance Program covers 90% of American cropland and prices risk on a single-year basis, with USDA's Risk Management Agency not adequately recognizing conservation practices, soil type, or crop diversity as risk-reducing factors, and even where it partially does, there is a multi-year lag before soil-health improvements show up in a farm's official risk rating. This means a farmer taking on the transition-year yield risk documented in this cluster's Rodale Institute entry gets no corresponding discount on their insurance premium for it, a structural disincentive economists and farmers alike have directly named, not a hidden agenda. Second, \"regenerative agriculture\" has no legal, government-enforced definition anywhere (see this cluster's greenwashing-critique entry), there is no fixed legal target to write a mandate against, part of why private, voluntary certification (ROC) emerged instead of a public standard. Third, and not just an industry failing: farmers themselves report concerns about regulatory overreach and land-tenure insecurity discouraging voluntary adoption, a tension the Netherlands case study elsewhere in this cluster shows playing out at political cost when a government tries to force the pace regardless.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'earthMatters',
    title: 'B Corp Certification: An Accountability Model, With Documented Weak Spots',
  ...
  },
  {
    ...
    summary:
      'This is the direct multiplier on this cluster\'s FAO soil-degradation baseline entry: every acre of soil degraded, every gallon of aquifer water pumped, and every managed pollinator trucked to an orchard is being spent, in part, on food that never actually gets eaten. The widely-cited estimate, based on FAO and UNEP data, holds that roughly one-third of all food produced worldwide, about 1.3 billion tons a year, is lost or wasted. A complication: that classic figure may itself UNDERSTATE the true scale, since it largely excludes losses that happen before food ever leaves the farm (crops left unharvested, spoiled in storage), a more complete accounting from Tesco and the World Wildlife Fund, folding in those on-farm losses, put total food waste closer to 40% of the entire world food supply. The downstream costs are substantial and directly connect to other entries in this cluster: food loss and waste is responsible for a 8-10% of total global greenhouse gas emissions, a $1 trillion in annual economic cost, and, most directly relevant to this cluster\'s land-use and water research, 28% of the world\'s arable land is used to grow food that is never actually eaten by anyone.',
    citations: [
      {
  ...
  },
  {
    ...
    category: 'earthMatters',
    title: 'Kenya: Rangeland Recovery, With a Complication About Carbon',
  ...
  },
  {
    ...
    category: 'earthMatters',
    title: 'The Mechanism Behind "Legumes Add Nitrogen to Soil": A Bacterium Living Inside the Root Itself',
