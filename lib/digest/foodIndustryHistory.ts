...
export const FOOD_INDUSTRY_HISTORY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'A honest complication to Brazil\'s no-till success story: industrial no-till very often means MORE herbicide, not less, and major agrochemical companies are branding around exactly that.',
  ...
  // --- The Opinion ---
  {
    ...
    teaser: 'A explicit attribution: this is Claude, the AI assistant that helped research and build this app, giving its considered opinion, not a personal statement from the person who built Inside Story.',
