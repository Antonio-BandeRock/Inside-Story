...
export const FOOD_INDUSTRY_HISTORY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "This is the question the connection between Earth Matters and a food-and-health app ultimately rests on, and the answer is more complicated than either \"regenerative food is definitively more nutritious\" or \"there's no effect.\" A 2023 systematic scoping review screened 4,463 papers down to 367 field studies across seven major crop categories specifically asking whether regenerative-aligned practices raise micronutrient concentration in the edible part of a crop. The per-crop-per-nutrient findings varied sharply: rice grown with organic inputs showed higher zinc in 94% of studies and higher iron in 80%, and maize showed increased iron and zinc in all four studies reviewed, both strong, consistent signals, but wheat grown with organic inputs showed higher zinc in only 48% of studies and higher iron in just 22%, a much weaker and less consistent effect for the same practice in a different crop. The review's authors were direct about why: most studies were statistically underpowered to detect a modest effect size, results were dependent on local growing conditions, and no formal meta-analysis existed to quantify a single overall effect size across the whole body of evidence. The working synthesis: evidence supports a nutrient-density effect for some crop-and-practice combinations, not yet a confirmed, general rule that regenerative or organic farming reliably makes all food more nutritious.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'earthMatters',
    title: 'The Five-Year Grape Boycott Won Contracts With 140 Growers, Proof That Buying Power Reaches Farm Labor Too',
  ...
  },
  {
    ...
    category: 'earthMatters',
    title: 'Divestment Moves Where the Money Sits, Not Just What You Buy, and Now Targets Factory-Farm Financing',
  ...
  },
  {
    ...
    summary:
      "Every mechanism covered elsewhere in this topic works by pressuring, punishing, or formally challenging an EXISTING company. A distinct, positive alternative exists too: investing directly in the farms and food businesses already practicing what the rest of Earth Matters describes. Steward, a SEC-regulated crowdfunding platform, lets any US investor put in as little as $100 through the Steward Farm Trust, a pooled portfolio of loans made directly to small and regenerative farms, paying investors dividends from the farmers' own loan interest payments, the platform has directed more than $2.2 million across 16 farms to date, mostly in the US. Harvest Returns, a separate equity-crowdfunding platform, connects both accredited and non-accredited investors directly with individual farming and agribusiness projects, and has facilitated roughly $30 million of investment across about 50 projects as of 2023, spanning sustainable agriculture, hemp, and hydroponic vertical farms. This is a different kind of \"buying power\" than anything else covered in this topic, not a reward or punishment aimed at an existing company's behavior, but capital flowing directly to the specific kind of farming whose benefits Earth Matters has already spent dozens of entries documenting.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      'This is the direct multiplier on the FAO soil-degradation baseline entry in Earth Matters: every acre of soil degraded, every gallon of aquifer water pumped, and every managed pollinator trucked to an orchard is being spent, in part, on food that never actually gets eaten. The widely-cited estimate, based on FAO and UNEP data, holds that roughly one-third of all food produced worldwide, about 1.3 billion tons a year, is lost or wasted. A complication: that classic figure may itself UNDERSTATE the true scale, since it largely excludes losses that happen before food ever leaves the farm (crops left unharvested, spoiled in storage), a more complete accounting from Tesco and the World Wildlife Fund, folding in those on-farm losses, put total food waste closer to 40% of the entire world food supply. The downstream costs are substantial and directly connect to other entries in Earth Matters: food loss and waste is responsible for a 8-10% of total global greenhouse gas emissions, a $1 trillion in annual economic cost, and, most directly relevant to the land-use and water research in Earth Matters, 28% of the world\'s arable land is used to grow food that is never actually eaten by anyone.',
    citations: [
      {
  ...
  // later fix.
  {
    ...
    summary:
      "the smallholder-vulnerability entry in Earth Matters covers a distinct food-access problem in the Global South. A different vulnerability exists inside wealthy nations too, not the same story at a smaller scale. USDA defines a specific \"low-access\" threshold (living more than half a mile from a supermarket in a poor urban area, or more than 10 miles in a rural one, combined with income/poverty criteria), and by that measure, about 39 million Americans, roughly 13% of the US population, live in a low-income, low-food-access area, with close to 19 million having limited supermarket access specifically. The complication, checking a popular policy assumption rather than just repeating it: a careful study (the RAND-affiliated PHRESH Project, following Pittsburgh's Hill District after a new, full-service supermarket opened) found modest improvements in some measures (222 fewer average daily calories, less added sugar) but no significant overall improvement in dietary quality and no change in average body mass index, and, most tellingly, the improvements that did happen weren't even related to whether people actually used the new store. This has led researchers toward a more complete framing than \"food desert\" alone: \"food swamps,\" areas with abundant access to cheap, energy-dense fast food and convenience-store options that can crowd out healthier choices even where a grocery store does exist, with affordability, not just physical distance, doing much of the work.",
    citations: [
      {
