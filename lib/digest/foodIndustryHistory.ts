...
export const FOOD_INDUSTRY_HISTORY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    citations: [
      ...
      { source: 'FDA final determination on partially hydrogenated oils (2015): margarine\'s own real trans-fat harm, already covered in the Food Additives research', url: 'https://www.fda.gov/food/food-additives-petitions/final-determination-regarding-partially-hydrogenated-oils-removing-trans-fat' },
  ...
  },
  {
    ...
    teaser: "Why dietary cholesterol from eggs doesn't move blood cholesterol much for most people is already covered elsewhere. That's a defense. The real, positive case is separate.",
    summary: "The existing research already covers the real, official reversal on eggs and dietary cholesterol (see that entry directly), but that's fundamentally a defense, evidence that eggs aren't guilty of the specific harm they were long blamed for. The real, separate, positive case is genuinely strong on its own terms. A real, current (2025) nutrition review describes eggs as providing \"high-quality protein content, together with essential nutrients such as choline and vitamins D and E, as well as antioxidants such as lutein and zeaxanthin,\" a real, specific nutrient combination that supports muscle, bone, and cognitive health. Choline (a real, tracked nutrient in the reference database) is genuinely hard to get in adequate amounts from a typical diet, and eggs are one of the single most concentrated real dietary sources of it, directly relevant to the core mission given choline's role in liver and cell-membrane function. Lutein and zeaxanthin are real, specific antioxidants concentrated in the retina, with a well-established role in eye health that few other common whole foods deliver in meaningful amounts. The same 2025 review states plainly that \"moderate egg consumption as part of a balanced diet does not increase cardiovascular risk,\" a real, current, independent confirmation of what the existing eggs entry already covers from the 2020 AHA advisory. Worth knowing directly: the real case for eating eggs isn't just that the old warning turned out overstated, it's that eggs are a genuinely dense source of several real, specific nutrients that are otherwise easy to fall short on.",
    citations: [
  ...
  },
  {
    ...
    summary: "This is the direct, three-way tie between this category's own Soil and Pesticides sections and the rest of the research. Selenium and iodine (both genuinely soil-dependent, both already covered in the Nutrients research as protective nutrients against thyroid autoimmunity specifically) are exactly the kind of trace mineral the soil-depletion research documents declining under intensive, synthetic-fertilizer-only farming, meaning a genuinely nutrient-thinner food supply may be providing measurably less of the specific defensive nutrients someone with Hashimoto's most needs, at the same historical moment processed food and gut-barrier disruption are asking more of the immune system, not less. Whether pesticide residue itself adds a direct, additional hit to gut-microbiome diversity remains a weak-to-moderate, still-developing piece of evidence, not yet a settled one.",
    citations: [
      {
  ...
  },
  {
    ...
    overallTier: 'strong',
    stageNote: 'A real, official CDC-sourced mechanism directly connecting industrial livestock practice to human infectious disease -- the clearest, most direct link to the core gut-microbiome-and-autoimmune-disease research anywhere in this whole cluster.',
