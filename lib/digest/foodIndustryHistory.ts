...
export const FOOD_INDUSTRY_HISTORY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    overallTier: 'strong',
    stageNote: 'A large-scale global meta-analysis, the strongest evidence tier in this cluster besides the Rodale Institute\'s controlled trial, and it reports an honest tradeoff, not just benefits.',
  ...
  },
  {
    ...
    teaser: 'An honest complication to Brazil\'s no-till success story: industrial no-till very often means MORE herbicide, not less, and major agrochemical companies are branding around exactly that.',
    summary: 'A credible, and directly relevant complication to this cluster\'s earlier, more favorable framing: "regenerative agriculture" has no single, official, legally enforced definition anywhere, unlike the third-party-audited ROC standard covered elsewhere in this cluster. That gap creates room for the term to be applied loosely, and a Friends of the Earth report (April 2025) documents a specific, named version of the problem directly relevant to this cluster\'s Brazil case study: over 100 million US acres of no-till corn and soybean production, and a 93% of those acres still rely on chemical herbicides, since removing mechanical tillage as a weed-control method very often means substituting chemical weed control instead, not eliminating it. The report names Bayer (which acquired Monsanto, the original developer of glyphosate) and Syngenta directly, both offering per-acre payments and marketing partnerships built around "regenerative" branding for herbicide-tolerant no-till systems. This directly qualifies Brazil\'s no-till success (see this category\'s dedicated entry): its adoption is real and its erosion-reduction results are real, but it is built substantially on glyphosate-resistant genetically modified soy, the same still-disputed chemistry the Pesticides research already covers, not a chemical-free system.',
    citations: [
      {
  ...
  // honest look at the leading technological stopgap being developed.
  {
    ...
    overallTier: 'strong',
    stageNote: 'A current, large-scale meta-analysis, the strongest evidence tier this pollinator sub-cluster has for the direct organic-farming-to-pollinator-abundance question, reported with its honest context-dependence rather than a blanket claim.',
  ...
  },
  {
    ...
    overallTier: 'moderate',
    stageNote: 'A honest, both-sides treatment, the model\'s structural strength (a legally binding stakeholder requirement) and its documented, now-being-fixed weakness are both stated directly, consistent with this whole cluster\'s standing discipline.',
  ...
  // existing company at all.
  {
    ...
    overallTier: 'strong',
    stageNote: 'A honest complication to this sub-cluster\'s more favorable boycott-effectiveness entry, reported directly rather than letting "vote with your dollar" read as a uniformly reliable lever either way.',
    relatedIds: ['foodhistory-regen-boycott-effectiveness-evidence', 'foodhistory-regen-nestle-boycott-case-study'],
  },
  {
  ...
  },
  {
    ...
    overallTier: 'strong',
    stageNote: 'A positive institutional response to the diversity-loss problem, reported alongside its honest complication rather than only the reassuring half of the story.',
  ...
  // later fix.
  {
    ...
    summary:
      "This cluster's smallholder-vulnerability entry covers a distinct food-access problem in the Global South. A different vulnerability exists inside wealthy nations too, not the same story at a smaller scale. USDA defines a specific \"low-access\" threshold (living more than half a mile from a supermarket in a poor urban area, or more than 10 miles in a rural one, combined with income/poverty criteria), and by that measure, about 39 million Americans, roughly 13% of the US population, live in a low-income, low-food-access area, with close to 19 million having limited supermarket access specifically. The honest complication, checking a popular policy assumption rather than just repeating it: a careful study (the RAND-affiliated PHRESH Project, following Pittsburgh's Hill District after a new, full-service supermarket opened) found modest improvements in some measures (222 fewer average daily calories, less added sugar) but no significant overall improvement in dietary quality and no change in average body mass index, and, most tellingly, the improvements that did happen weren't even related to whether people actually used the new store. This has led researchers toward a more complete framing than \"food desert\" alone: \"food swamps,\" areas with abundant access to cheap, energy-dense fast food and convenience-store options that can crowd out healthier choices even where a grocery store does exist, with affordability, not just physical distance, doing much of the work.",
    citations: [
      {
    ...
    overallTier: 'strong',
    stageNote: 'An honest complication to a popular, intuitive policy assumption (build a grocery store, diets improve): the research found it more complicated than that.',
  ...
  },
  {
    ...
    overallTier: 'moderate',
    stageNote: 'A current scientific hypothesis with supporting pieces, honestly reported at the same confidence level its authors give it, not yet proven end to end.',
  ...
  // via WebSearch/WebFetch before being written in.
  {
    ...
    overallTier: 'moderate',
    stageNote: 'A well-established, actively-developed framework in immunology, the specific molecular mechanisms by which each organism does this are still being characterized, stated honestly by the framework\'s originators.',
