...
export const FOOD_INDUSTRY_HISTORY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "France launched the international \"4 per 1000\" initiative on December 1, 2015, at the COP21 climate conference in Paris, proposing a specific target: increasing the carbon stored in the world's agricultural soils (in the top 30-40cm) by just 0.4% a year, a rate its founders argued could meaningfully offset human carbon emissions given how much more carbon farmland and forest soils hold worldwide than the atmosphere itself. The initiative has broad institutional support, over 300 governments, research institutions, and agricultural and civil-society organizations. It has also drawn a credible scientific critique that goes beyond the initiative's own framing: researchers at Rothamsted Research, using some of the world's longest-running soil experiments, concluded the 0.4%-per-year target is not realistically achievable across most of the world's farmland, since soil carbon naturally moves toward a new equilibrium and then plateaus rather than climbing indefinitely, and separately flagged that reaching the target's implied nitrogen-uptake requirements is itself unrealistic in practice. The honest, working synthesis: soil carbon can and should be rebuilt, but the specific 0.4%-a-year figure looks more like a symbolically powerful policy target than a rigorously modeled scientific one.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: 'The paper\'s own authors call the evidence "largely circumstantial and hypothetical", not a settled fact, even though the individual pieces underneath it are.',
    summary:
