...
export const PRODUCE_PROFILES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    overallTier: 'strong',
    stageNote:
      'The foundational sprout-concentration finding and its underlying Keap1-Nrf2 mechanism are both well-established and widely replicated. The clinical asthma trial adds a quantified example of how that mechanism plays out in actual patients, including its limit: the benefit only showed up in six of every ten participants tested, not all of them.',
  ...
  },
  {
    ...
    overallTier: 'moderate',
    stageNote:
      "The mustard-and-broccoli finding comes from a randomized, controlled human trial, small at twelve participants, the reason this sits at moderate rather than strong. The daikon-radish alternative is Fahey's stated professional practice from building broccoli-sprout extracts, not itself a separate controlled trial, and is presented here at that lower confidence level rather than treated as equally settled.",
