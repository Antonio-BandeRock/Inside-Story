...
export const CELIAC_ENTRIES: DigestEntry[] = [
  {
    ...
    teaser: 'No medication substitutes for a strict gluten-free diet here. That makes the real, practical questions genuinely different from every other condition.',
  ...
  },
  {
    ...
    summary: "Celiac disease's own real, non-digestive effects are genuinely wide-ranging, a direct consequence of the malabsorption Marsh-stage gut damage causes. Dermatitis herpetiformis, an intensely itchy, blistering rash, is real and pathognomonic for celiac, meaning its presence alone can point to the diagnosis even with zero digestive symptoms present. Real, documented neurological effects include numbness, motor weakness, loss of coordination, and, in real, severe cases, seizures. Osteoporosis and osteopenia, already covered in the bone-density self-advocacy entry, trace directly to malabsorbed calcium and vitamin D. Reproductive effects are real and significant in both sexes: delayed menarche, amenorrhea, and infertility in women, and impotence and infertility in men, with impaired vitamin E absorption specifically implicated as one real, contributing mechanism. Real global prevalence data (1.4% by antibody testing, 0.7% biopsy-confirmed) also shows a genuine sex and age skew worth knowing: roughly 0.6% in women versus 0.4% in men, and higher in children (0.9%) than adults (0.5%).",
    citations: [
  ...
  },
  {
    ...
    teaser: "Italy's own real, national mass-screening program found celiac disease in 1.6% of children, with only 40% of confirmed cases already diagnosed before the screening, real, direct proof of the underdiagnosis the research already names.",
    summary: "This category's own already-covered celiac-iceberg research describes underdiagnosis in general terms; Italy's own real, national policy response gives it real, concrete numbers. In 2023, Italy became the first country in the world to pass a law (National Law 130/2023) mandating that every child between ages 1 and 17 be offered celiac disease screening, tested at ages 2, 6, and 10. The real, direct result confirmed exactly the underdiagnosis problem the iceberg research already describes: a mass school-based screening program found celiac disease present in 1.6% of tested children, and only 40% of those confirmed cases had already been diagnosed before the screening caught them, meaning a real 60% of celiac cases in this specific population had been sitting completely undetected. The US, by contrast, has no equivalent national screening mandate, real estimates finding at least two-thirds of US celiac cases remain undiagnosed, and the US Preventive Services Task Force concluded in 2017 that the evidence was insufficient to even recommend for or against population screening. Worth knowing directly: Italy's own real, national experiment is direct, concrete evidence for what the iceberg research already argues in the abstract, that most celiac disease genuinely hides beneath the surface until someone actually goes looking for it systematically.",
    chart: {
