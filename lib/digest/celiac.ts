...
export const CELIAC_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "This category's own already-covered ZED1227 and TAK-101 research both intervene after gluten has already reached the small intestine. Latiglutenase takes an earlier approach: two enzymes working together to break down gluten proteins directly in the stomach, before they can reach and damage the intestinal lining at all. A Mayo Clinic-led Phase 2b trial, funded by the NIH, tested it directly against a 6-week gluten challenge, and found substantial protection: 88% less damage to the small intestine's own lining, 60% fewer of the specific immune cells (intraepithelial lymphocytes) that signal active gut injury, and urine testing confirmed 95% of the gluten itself was broken down in the stomach before it could act. Symptom relief followed the same pattern, 53 to 99% less symptom severity than placebo during the same gluten exposure. Like ZED1227 and TAK-101 already covered in this category, latiglutenase is being developed as a safety buffer against accidental gluten exposure, meant to work alongside the gluten-free diet, not replace this category's own primary treatment.",
    citations: [
