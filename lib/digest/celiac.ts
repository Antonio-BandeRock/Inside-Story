...
export const CELIAC_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "The Type 1 Diabetes category already covers celiac disease's overlap with T1D. The overlap with Hashimoto's specifically is just as well-documented and, in at least one pediatric comparison, even more pronounced. A large case-control study of 8,489 participants found autoimmune thyroid disorders present in 15.4% of celiac patients compared to 7.5% of controls, roughly double the risk. A separate pediatric study found celiac disease prevalence among children with autoimmune thyroiditis running 1.92 times higher than among children with type 1 diabetes, meaning the celiac-Hashimoto's connection specifically may be even stronger than the celiac-T1D connection already covered elsewhere. The proposed explanation is a shared genetic background predisposing someone to autoimmune attack broadly rather than coincidence. Anyone diagnosed with either condition has a quantified reason to ask about screening for the other, not just watch for symptoms and hope they'd notice.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'An investigational enzyme (latiglutenase) broke down 95% of gluten in the stomach in trial testing, protecting against the accidental cross-contamination this category\'s research already covers.',
    summary:
  ...
  },
  {
    ...
    teaser: "This category's already-covered adult bone-density entry names a screening age, direct pediatric research finds children's bone density can return to completely normal on a gluten-free diet, if caught early enough.",
    summary:
