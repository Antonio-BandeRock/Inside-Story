...
export const CELIAC_ENTRIES: DigestEntry[] = [
  {
    id: 'celiac-overview',
    category: 'celiac',
    title: 'Celiac Disease Is Treated by Diet Alone, With No Medication',
  ...
  },
  {
    ...
    category: 'celiac',
    title: 'What Breaks the 20ppm Gluten-Free Standard in a Kitchen',
  ...
  },
  {
    ...
    summary:
      "Oats are naturally gluten-free, but the oats-and-celiac-disease question is more complicated than that fact alone suggests, and for two separate reasons. The first is ordinary cross-contamination: oats are frequently grown, harvested, or processed alongside wheat, making contamination a common risk unless a product is specifically certified gluten-free. The second is separate from contamination entirely: oats contain avenin, their gluten-like protein, and a minority of celiac patients react to avenin itself, even in laboratory-confirmed, completely uncontaminated pure oats. Research finds pure oats are well-tolerated by most celiac patients at moderate amounts (roughly 20-25 grams a day for children, 50-70 grams for adults), and even in the studies where some patients reacted to purified avenin with symptoms, no actual intestinal damage was found in those reactors, a reassuring, if not fully resolved, detail. Certified gluten-free oats are a reasonable thing to try, but worth introducing carefully and watching for a personal reaction, not assumed universally safe just because they're gluten-free by definition.",
    citations: [
  ...
  },
  {
    ...
    category: 'celiac',
    title: 'How Long Does the Gut Actually Take to Heal? An Age-Dependent Answer',
  ...
  },
  {
    ...
    summary: "The Type 1 Diabetes category covers celiac disease's overlap with T1D. The overlap with Hashimoto's specifically is just as well-documented and, in at least one pediatric comparison, even more pronounced. A large case-control study of 8,489 participants found autoimmune thyroid disorders present in 15.4% of celiac patients compared to 7.5% of controls, roughly double the risk. A separate pediatric study found celiac disease prevalence among children with autoimmune thyroiditis running 1.92 times higher than among children with type 1 diabetes, meaning the celiac-Hashimoto's connection specifically may be even stronger than the celiac-T1D connection. The proposed explanation is a shared genetic background predisposing someone to autoimmune attack broadly rather than coincidence. Anyone diagnosed with either condition has a quantified reason to ask about screening for the other, not just watch for symptoms and hope they'd notice.",
    citations: [
  ...
  // independently verified via WebSearch.
  {
    ...
    summary:
      "Celiac disease's tissue damage is measured with the Marsh (or Marsh-Oberhuber) classification, a biopsy-based staging scale still used today. Marsh 0 is normal, healthy intestinal lining. Marsh 1 shows an increased number of immune cells in the tissue (intraepithelial lymphocytes) with the villi themselves still intact. Marsh 2 adds crypt hyperplasia, the gut's glands enlarging in response to ongoing damage. Marsh 3, split into 3a (mild), 3b (moderate), and 3c (total villous atrophy), is where the absorbing surface of the small intestine actually starts flattening and disappearing, the direct physical mechanism behind celiac's malabsorption and nutrient-deficiency risks. This staging scale is exactly what a biopsy result is reporting when it comes back with a Marsh number, rather than just a \"positive\" or \"negative.\"",
    citations: [
  ...
  },
  {
    ...
    summary: "Celiac disease's non-digestive effects are wide-ranging, a direct consequence of the malabsorption Marsh-stage gut damage causes. Dermatitis herpetiformis, an intensely itchy, blistering rash, is pathognomonic for celiac, meaning its presence alone can point to the diagnosis even with zero digestive symptoms present. Documented neurological effects include numbness, motor weakness, loss of coordination, and, in severe cases, seizures. Osteoporosis and osteopenia, covered in the bone-density self-advocacy entry, trace directly to malabsorbed calcium and vitamin D. Reproductive effects are significant in both sexes: delayed menarche, amenorrhea, and infertility in women, and impotence and infertility in men, with impaired vitamin E absorption specifically implicated as one contributing mechanism. Global prevalence data (1.4% by antibody testing, 0.7% biopsy-confirmed) also shows a sex and age skew: roughly 0.6% in women versus 0.4% in men, and higher in children (0.9%) than adults (0.5%).",
    citations: [
  ...
  },
  {
    ...
    category: 'celiac',
    title: "Celiac's History: A Wartime Bread Shortage Accidentally Solved a Medical Mystery",
  ...
  // verified via WebSearch.
  {
    ...
    category: 'celiac',
    title: 'Dermatitis Herpetiformis, the Itchy Blistering Rash That Is Celiac Disease on the Skin',
  ...
  },
  {
    ...
    summary:
      "Celiac disease carries a documented, if rare, elevated risk of a specific cancer: enteropathy-associated T-cell lymphoma (EATL), a malignant transformation of the same immune cells already driving the disease's intestinal damage. Research finds this and other serious complications, including refractory celiac disease, develop in 2 to 5% of adults diagnosed with celiac disease. Identified risk factors include poor adherence to a gluten-free diet, a specific genetic profile (HLA-DQ2 homozygosity), and a late diagnosis, all pointing toward the same practical conclusion: evidence finds sticking to the diet itself measurably lowers the odds of this complication developing. EATL itself carries a serious prognosis once it does develop, and diagnosing it can be difficult, since the exact same red flags (weight loss, abdominal pain, diarrhea returning despite a strict diet) can also just mean the diet itself has slipped or another condition has been missed. This isn't meant to cause alarm over an already rare event, it's context for why sustained, strict adherence matters for reasons beyond day-to-day symptom control, and why new or returning symptoms after a period of feeling well are always worth raising directly rather than assumed to be a minor slip.",
    citations: [
  ...
  },
  {
    ...
    category: 'celiac',
    title: 'An Emerging Enzyme Pill Aims to Catch Accidental Gluten, Not Replace the Diet',
    teaser: 'An investigational enzyme (latiglutenase) broke down 95% of gluten in the stomach in trial testing, protecting against the accidental cross-contamination this category\'s research covers.',
    summary:
      "This category's research covers how hard real-world cross-contamination is to avoid entirely, even with careful, strict effort. Latiglutenase (formerly ALV003) is an investigational two-enzyme therapy, taken with meals, specifically designed to break down gluten in the stomach before it can reach and damage the small intestine, an adjunct to the gluten-free diet rather than a replacement for it. A controlled trial in adults with celiac disease found latiglutenase significantly protected against gluten-induced intestinal damage during a deliberate gluten challenge, with stable villus height and immune-cell counts compared to a measurable decline in the placebo group, and urine testing found it broke down 95% of ingested gluten in the stomach itself. This remains an investigational therapy, still working through the trial process rather than an approved, available treatment, and its intended real-world role is protecting against accidental, low-level gluten exposure (a shared fryer, an unlabeled sauce), not permitting someone to eat gluten freely. This is most relevant for anyone whose biggest remaining risk is the accidental exposure this category's cross-contamination research already names, rather than a deliberate dietary choice.",
    citations: [
  ...
  },
  {
    ...
    category: 'celiac',
    title: "Italy's Nationwide Celiac Screening Confirms the Iceberg Research",
  ...
  },
  {
    id: 'horizon-celiac',
    category: 'celiac',
    title: 'Two Drug Candidates Are Trying to Do What This Category\'s Enzyme Therapy Entry Says Isn\'t Here Yet',
  ...
  },
  {
    ...
    teaser: "The ZED1227 and TAK-101 research works after gluten has already reached the intestine. Latiglutenase, a two-enzyme combination, degrades gluten in the stomach first, and a trial found striking protection against gut damage.",
    summary:
      "The ZED1227 and TAK-101 research both intervene after gluten has already reached the small intestine. Latiglutenase takes an earlier approach: two enzymes working together to break down gluten proteins directly in the stomach, before they can reach and damage the intestinal lining at all. A Mayo Clinic-led Phase 2b trial, funded by the NIH, tested it directly against a 6-week gluten challenge, and found substantial protection: 88% less damage to the small intestine's lining, 60% fewer of the specific immune cells (intraepithelial lymphocytes) that signal active gut injury, and urine testing confirmed 95% of the gluten itself was broken down in the stomach before it could act. Symptom relief followed the same pattern, 53 to 99% less symptom severity than placebo during the same gluten exposure. Like ZED1227 and TAK-101, latiglutenase is being developed as a safety buffer against accidental gluten exposure, meant to work alongside the gluten-free diet, not replace this category's primary treatment.",
    citations: [
  ...
  },
  {
    ...
    category: 'celiac',
    title: "Refractory Celiac Disease Is Rare, and Its Two Types Carry Different Survival Odds",
  ...
  },
  {
    ...
    teaser: "The villi-healing timeline tracks tissue-level recovery, direct microbiome sequencing finds a strict, sustained gluten-free diet also measurably restoring gut bacterial balance.",
    summary: "The villi-healing research tracks how the intestinal LINING heals over time, and direct microbiome research finds a parallel recovery happening in the gut's bacterial population too. A controlled animal model first demonstrated this directly: gluten-sensitive macaques showed reduced gut microbial diversity while eating gluten, and within just weeks of switching to a gluten-free diet, their microbiome composition began shifting back toward that of a normal, non-sensitive animal, controlled evidence of reversibility. A direct human study, sequencing the gut bacteria of 10 women with celiac disease who had followed a strict gluten-free diet for over a year and comparing them to 10 healthy controls, found that prolonged adherence supported remission of the dysbiosis (bacterial imbalance) associated with untreated celiac disease, and measurably enhanced overall microbiota functionality. A separate, more detailed study combining MRI imaging with microbiome analysis specifically tracked gut function and bacterial composition across a full year of gluten-free eating, directly measuring this same recovery process rather than assuming it from symptom improvement alone. This microbiome-level recovery ties directly into the broader gut-health research: beyond calming symptoms and healing visible tissue, evidence finds a strict gluten-free diet also restoring the gut's bacterial ecosystem over time.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The diagnostic-panel entry names standard antibody testing as the starting point, research finds a documented, if small, share of confirmed celiac cases test completely negative on that same bloodwork.",
    summary:
      "The diagnostic-panel entry names antibody testing (tissue transglutaminase, endomysial antibodies) as the standard first step toward a celiac diagnosis, and research confirms a documented, if small, exception: seronegative celiac disease, biopsy-confirmed celiac disease with completely negative antibody bloodwork. Research found seronegative celiac disease in roughly 1.7 percent of a large cohort of 810 confirmed celiac patients, a minority, but not a vanishingly rare curiosity either. The useful, distinguishing clinical pattern: research found seronegative patients tending to be diagnosed at a significantly older age, with a higher rate of the classical malabsorption presentation, other autoimmune conditions, and more severe villous atrophy on biopsy, a different clinical picture than typical, antibody-positive celiac disease. A direct, related finding explains part of why this happens: antibody positivity itself was found to track with how SEVERE the villous atrophy already is, with endomysial antibody positive in 77 percent of cases with total villous atrophy but only 33 percent with partial atrophy, evidence that milder, earlier tissue damage can fail to trigger a positive antibody result yet. This gap is exactly why a direct biopsy remains important when celiac disease is still strongly suspected despite negative antibody bloodwork, not something to rule out purely from a negative blood test alone.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The pregnancy/fertility research focuses on women, for men specifically, smaller studies found abnormal sperm parameters, but a large, 7,121-man Swedish cohort found no meaningful overall fertility risk at all.",
    summary:
      "The pregnancy and fertility research names direct risks in women (miscarriage risk that reverses on a gluten-free diet), and male fertility deserves direct coverage precisely because the evidence here is mixed rather than settled. Smaller studies do find measurable sperm abnormalities in men with untreated celiac disease, including significantly impaired sperm chromatin maturation (persistent histones and protamine deficiency, both markers of sperm-DNA packaging quality), plausibly linked to nutrient deficiencies this condition can cause, particularly selenium and zinc, both directly involved in sperm development. But the most decisive evidence comes from a much larger, nationwide Swedish population-based cohort of 7,121 men with biopsy-confirmed celiac disease (villous atrophy), which found an overall fertility hazard ratio of 1.02, essentially no meaningful difference from men without celiac disease. Separate research directly titled the underlying question 'fact or fiction' found the broader literature conflicting: some smaller studies report higher infertility rates in celiac patients, others find no such association at all. Rather than picking whichever finding sounds more dramatic, the best, largest, population-level evidence currently available does not support a meaningful male-fertility risk from celiac disease itself, even though measurable sperm-parameter changes can occur, a useful distinction between a detectable biological signal and an actual, population-level fertility outcome.",
    citations: [
  ...
  },
  {
    ...
    category: 'celiac',
    title: "Celiac Disease Carries a 38 Percent Higher Atrial Fibrillation Risk",
    teaser: "The hypertension-paradox entry names a counterintuitive lower blood-pressure finding alongside higher heart-attack risk, a pooled meta-analysis finds atrial fibrillation, a distinct kind of heart problem, also significantly elevated.",
    summary:
      "The hypertension-paradox research already establishes celiac disease's counterintuitive cardiovascular pattern (lower blood pressure, yet higher heart-attack risk), and atrial fibrillation, a distinct kind of heart-rhythm problem rather than a blockage or blood-pressure issue, deserves direct coverage as part of that same broader picture. A pooled meta-analysis of 4 observational studies (64,397 total participants) found celiac disease associated with a significant 38 percent increased risk of atrial fibrillation (pooled odds ratio 1.38). The plausible mechanism the researchers themselves proposed connects directly to this category's core, identity: celiac disease's autoimmune, inflammatory nature, the same systemic inflammatory process already implicated elsewhere in this category's cardiovascular and bone-density research, rather than a mechanism unique to blood pressure or cholesterol. Consistent with how this category's hypertension-paradox entry already treats a similarly counterintuitive finding, this elevated arrhythmia risk occurs even though traditional cardiovascular risk factors (hypertension, high cholesterol, obesity) tend to be LESS common in celiac patients, further evidence this category's cardiovascular risk runs through a different, inflammation-driven pathway rather than the standard risk-factor profile most heart-disease prevention advice is built around. This specific arrhythmia risk is worth mentioning directly to a doctor alongside a celiac diagnosis, particularly for anyone noticing new heart-palpitation symptoms, rather than assuming celiac disease's cardiovascular reach stops at the heart-attack risk.",
    citations: [
