...
export const CELIAC_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'celiac',
    title: "Celiac Disease and Hashimoto's: A Quantified Overlap Worth Screening For Directly",
  ...
  },
  {
    ...
    teaser: 'A condition where the diet itself needs careful nutritional attention, plus an age-dependent healing timeline worth knowing honestly.',
  ...
  },
  {
    ...
    summary:
      "Celiac disease carries a real, if rare, elevated risk of a specific cancer: enteropathy-associated T-cell lymphoma (EATL), a malignant transformation of the same immune cells already driving the disease's own intestinal damage. Research finds this and other serious complications, including refractory celiac disease, develop in a 2 to 5% of adults diagnosed with celiac disease. Identified risk factors include poor adherence to a gluten-free diet, a specific genetic profile (HLA-DQ2 homozygosity), and a late diagnosis, all pointing toward the same practical conclusion: evidence finds sticking to the diet itself measurably lowers the odds of this complication developing. Worth knowing honestly: EATL itself carries a serious prognosis once it does develop, and diagnosing it can be difficult, since the exact same red flags (weight loss, abdominal pain, diarrhea returning despite a strict diet) can also just mean the diet itself has slipped or another condition has been missed. This isn't meant to cause alarm over an already rare event, it's honest context for why sustained, strict adherence matters for reasons beyond day-to-day symptom control, and why new or returning symptoms after a period of feeling well are always worth raising directly rather than assumed to be a minor slip.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A investigational enzyme (latiglutenase) broke down 95% of gluten in the stomach in trial testing, protecting against the accidental cross-contamination this category\'s own research already covers.',
    summary:
      "This category's own research already covers how hard real-world cross-contamination is to avoid entirely, even with careful, strict effort. Latiglutenase (formerly ALV003) is an investigational two-enzyme therapy, taken with meals, specifically designed to break down gluten in the stomach before it can reach and damage the small intestine, an adjunct to the gluten-free diet, not a replacement for it. A controlled trial in adults with celiac disease found latiglutenase significantly protected against gluten-induced intestinal damage during a deliberate gluten challenge, with stable villus height and immune-cell counts compared to a measurable decline in the placebo group, and urine testing found it broke down 95% of ingested gluten in the stomach itself. Worth knowing honestly: this remains an investigational therapy, still working through the trial process rather than an approved, available treatment, and its own intended real-world role is protecting against accidental, low-level gluten exposure (a shared fryer, an unlabeled sauce), not permitting someone to eat gluten freely. Worth watching directly for anyone whose biggest remaining risk is the accidental exposure this category's own cross-contamination research already names, rather than a deliberate dietary choice.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered ZED1227 and TAK-101 research works after gluten has already reached the intestine. Latiglutenase, a two-enzyme combination, degrades gluten in the stomach first, and a trial found striking protection against gut damage.",
    summary:
      "This category's own already-covered ZED1227 and TAK-101 research both intervene after gluten has already reached the small intestine. Latiglutenase takes an earlier approach: two enzymes working together to break down gluten proteins directly in the stomach, before they can reach and damage the intestinal lining at all. A Mayo Clinic-led Phase 2b trial, funded by the NIH, tested it directly against a 6-week gluten challenge, and found substantial protection: 88% less damage to the small intestine's own lining, 60% fewer of the specific immune cells (intraepithelial lymphocytes) that signal active gut injury, and urine testing confirmed 95% of the gluten itself was broken down in the stomach before it could act. Symptom relief followed the same pattern, 53 to 99% less symptom severity than placebo during the same gluten exposure. Worth knowing directly: like ZED1227 and TAK-101 already covered in this category, latiglutenase is being developed as a safety buffer against accidental gluten exposure, meant to work alongside the gluten-free diet, not replace this category's own primary treatment.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Research finds up to 50% of celiac patients still experience ongoing digestive symptoms on a strict gluten-free diet, with an IBS overlap in 22%, a separate problem worth naming, not a sign the diet isn\'t working.',
    summary: "This category's own already-covered villi-healing-timeline research already names the gap between symptom relief and actual gut healing; research on ONGOING symptoms adds a further, honest layer most patients aren't warned about. Studies find at least 20%, and by some estimates up to 50%, of celiac patients continue experiencing chronic digestive symptoms consistent with a functional gastrointestinal disorder despite strict, confirmed gluten-free adherence. A direct study found 36.3% still had persistent symptoms or malabsorption signs even after adequate dietary adherence. A IBS overlap explains a meaningful share of this: research places IBS prevalence in celiac patients at 22%, against a 4-11% background rate in the general population, with over a third of celiac patients showing IBS-LIKE altered gut motility even without a formal IBS diagnosis. The practical answer the already-cited low-FODMAP research already covers: systematic review evidence supports a low-FODMAP approach specifically for celiac patients with these persistent, IBS-like symptoms after their gluten-free diet is already confirmed strict and adequate. Worth knowing directly: lingering symptoms on a strict gluten-free diet are a common, and separately addressable problem, not automatic proof gluten is still sneaking in somewhere.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered diagnostic-panel entry names standard antibody testing as the starting point, research finds a genuine, if small, share of confirmed celiac cases test completely negative on that same bloodwork.",
    summary:
      "This category's own already-covered diagnostic-panel entry names antibody testing (tissue transglutaminase, endomysial antibodies) as the standard first step toward a celiac diagnosis, and research confirms a genuine, if small, exception worth knowing directly: seronegative celiac disease, biopsy-confirmed celiac disease with completely negative antibody bloodwork. Research found seronegative celiac disease in roughly 1.7 percent of a large cohort of 810 confirmed celiac patients, a minority, but not a vanishingly rare curiosity either. The useful, distinguishing clinical pattern: research found seronegative patients tending to be diagnosed at a significantly older age, with a higher rate of the classical malabsorption presentation, other autoimmune conditions, and more severe villous atrophy on biopsy, a different clinical picture than typical, antibody-positive celiac disease. A direct, related finding explains part of why this happens: antibody positivity itself was found to track with how SEVERE the villous atrophy already is, with endomysial antibody positive in 77 percent of cases with total villous atrophy but only 33 percent with partial atrophy, evidence that milder, earlier tissue damage can fail to trigger a positive antibody result yet. Worth stating directly: this honest gap is exactly why a direct biopsy remains important when celiac disease is still strongly suspected despite negative antibody bloodwork, not something to rule out purely from a negative blood test alone.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered hypertension-paradox entry names a counterintuitive lower blood-pressure finding alongside higher heart-attack risk, a pooled meta-analysis finds atrial fibrillation, a distinct kind of heart problem, also significantly elevated.",
    summary:
      "This category's own already-covered hypertension-paradox research already establishes celiac disease's counterintuitive cardiovascular pattern (lower blood pressure, yet higher heart-attack risk), and atrial fibrillation, a distinct kind of heart-rhythm problem rather than a blockage or blood-pressure issue, deserves its own direct coverage as part of that same broader picture. A pooled meta-analysis of 4 observational studies (64,397 total participants) found celiac disease associated with a significant 38 percent increased risk of atrial fibrillation (pooled odds ratio 1.38). The plausible mechanism the researchers themselves proposed connects directly to this category's own core, already-covered identity: celiac disease's own autoimmune, inflammatory nature, the same systemic inflammatory process already implicated elsewhere in this category's own cardiovascular and bone-density research, rather than a mechanism unique to blood pressure or cholesterol. Worth stating directly, the same honest way this category's own hypertension-paradox entry already treats a similarly counterintuitive finding: this elevated arrhythmia risk occurs even though traditional cardiovascular risk factors (hypertension, high cholesterol, obesity) tend to be LESS common in celiac patients, further evidence this category's own cardiovascular risk runs through a different, inflammation-driven pathway rather than the standard risk-factor profile most heart-disease prevention advice is built around. Worth stating directly: this specific arrhythmia risk is worth mentioning directly to a doctor alongside a celiac diagnosis, particularly for anyone noticing new heart-palpitation symptoms, rather than assuming celiac disease's own cardiovascular reach stops at the heart-attack risk already covered elsewhere in this category.",
    citations: [
