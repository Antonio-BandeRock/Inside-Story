...
export const CARDIOVASCULAR_DISEASE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Real, standard cholesterol-testing guidance sets specific intervals by age and risk: a first test between ages 9 and 11, then every 5 years through adulthood for most people, shifting to every 1 to 2 years for men 45 to 65 and women 55 to 65, and annual testing for adults over 65. Worth knowing directly for anyone with a condition already covered that carries its own elevated cardiovascular risk (lupus, rheumatoid arthritis, psoriasis, and PCOS all do, see this category's own cross-links), a real conversation with a prescriber about testing more often than the general schedule above is a reasonable, specific thing to raise, not an overreaction. A real, separate, worth-knowing concept for that same conversation: apolipoprotein B (apoB), a real, specific protein present on every atherogenic (artery-damaging) lipid particle, is a genuinely well-evidenced, more direct measure of cardiovascular risk than LDL cholesterol alone, since it counts particles rather than just their cholesterol content -- see the dedicated Basic Health entry on why that distinction actually matters, backed by a real, large, 52-country study. Worth raising directly by name in a real conversation with a prescriber, especially for anyone whose standard LDL number looks normal but who still carries other real risk factors.",
    citations: [
  ...
  },
  {
    ...
    teaser: '1948, 1987 -- one real, still-running study named the risk factors the research is built on, and a real fungal extract became the drug that transformed treating them.',
    summary: "CVD's own real, modern understanding traces to a single, remarkably influential real project: the Framingham Heart Study, launched in 1948 to follow a large group of initially healthy people over time and identify what actually drove cardiovascular disease, at a moment when real, basic causes were still largely unknown despite CVD deaths having climbed steadily for decades. Real, seminal findings from this same still-running study first established smoking and high cholesterol as real, documented cardiovascular risk factors, the actual scientific foundation the lipid-panel and statin research builds on. The real, transformative treatment breakthrough came decades later: Japanese scientist Akira Endo discovered the first statin compound (compactin) from a real fungal extract in 1976, and on September 1, 1987, lovastatin became the first statin approved by the FDA, a real, genuine revolution in treating high cholesterol that reached over $1 billion in annual sales, with several more statins (simvastatin, pravastatin, atorvastatin, rosuvastatin, all still in use today) following through the 1990s and early 2000s.",
    citations: [
  ...
  },
  {
    ...
    summary: "Cardiac rehabilitation, a real, structured program combining supervised exercise, education, and risk-factor counseling after a heart attack, heart surgery, or a heart failure diagnosis, carries some of the strongest mortality-reduction evidence of any intervention covered in the cardiovascular research, and it's genuinely underused. Real meta-analyses find a 26% reduction in cardiovascular mortality at longest follow-up, with one analysis specifically finding a 27% reduction in all-cause mortality and 31% reduction in cardiac deaths among participants. The benefit is real and dose-dependent too, more sessions attended tracks with lower mortality, with real research suggesting a minimum of around 36 sessions may be needed for the strongest measurable benefit. Despite this real, well-established evidence, global enrollment in cardiac rehabilitation programs remains under 30% of people who would actually qualify for one. Worth knowing directly: anyone who has had a heart attack, stent, bypass surgery, or a heart failure diagnosis has a real, concrete reason to ask specifically about a referral to cardiac rehabilitation, not just general exercise advice, since the structured, supervised program itself is what the real mortality data is actually measuring.",
    citations: [
  ...
  // independently verified via WebSearch.
  {
    ...
    summary: "Triglycerides are a real, distinct blood fat marker from the LDL cholesterol already covered in the lipid-panel research, and real, elevated triglycerides carry their own independent cardiovascular risk. Real research finds omega-3 fatty acids genuinely and substantially lower triglycerides, a real daily intake of 3-4g combined EPA+DHA reducing triglyceride levels by 20-50% in people with elevated baseline levels, with one real trial finding a 27% reduction at the higher dose tested. The real, landmark REDUCE-IT trial tested a purified, high-dose EPA formulation (icosapent ethyl) specifically and found a real, striking 25% reduction in major cardiovascular events, distinguishing it directly from the honest, null omega-3 supplement findings already covered elsewhere in the CVD research (which typically tested lower-dose, mixed EPA/DHA formulations). Genuinely important and honestly complicated: real research finds the size of this cardiovascular benefit disproportionately large compared to the triglyceride reduction alone, suggesting omega-3, at least in this specific purified, high-dose form, may work through additional real mechanisms, reduced blood pressure, an antithrombotic (clot-preventing) effect, improved inflammatory status, and better endothelial (blood vessel lining) function. Worth knowing directly: this is a real, meaningful nuance to the existing omega-3-and-heart-disease conversation, dose and formulation genuinely matter, and someone with elevated triglycerides specifically has a real, different evidence picture to discuss with a doctor than the general omega-3 supplement question already covered elsewhere.",
    citations: [
