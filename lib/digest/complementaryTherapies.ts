...
export const COMPLEMENTARY_THERAPIES_ENTRIES: DigestEntry[] = [
  {
    ...
    summary: "The standing discipline is reporting evidence honestly, whatever it turns out to be. For chiropractic care specifically, the finding is a flat null. A search of the peer-reviewed literature for any study connecting chiropractic care or spinal manipulation to hypothyroidism, Hashimoto's, or autoimmune thyroid disease returned zero results: no clinical trials, no case reports, nothing indexed at all. That's meaningfully different from \"studied and found not to work.\" It simply hasn't been studied in a way that reached the peer-reviewed literature the research relies on throughout. This isn't a dismissal of chiropractic care outright, which is a separate question from whether it helps musculoskeletal pain, something not evaluated here. It's a statement that no evidence-backed connection to Hashimoto's specifically currently exists.",
    citations: [],
    overallTier: 'weak',
  },
  {
    ...
    summary: "Acupuncture is more studied than chiropractic, but the state of the evidence specifically for Hashimoto's is closer to \"a trial exists, results not yet found\" than a clear yes or no. A randomized controlled trial protocol was registered in 2021 specifically to study acupuncture for Hashimoto's thyroiditis, built around a common situation the research keeps returning to: patients with normal thyroid hormone levels who still experience symptoms (neck discomfort, fatigue, mood swings) that meaningfully affect quality of life. A search for that trial's published results came back empty, meaning either it hasn't been completed and published yet, or this research pass simply didn't locate it. Rather than substitute general acupuncture research from a different condition as a stand-in, or guess at what the results might show, the honest answer is pending. A designed study exists asking the right question; the answer isn't in yet.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'The same "borrow evidence honestly, label it clearly" approach already used for other autoimmune diseases, applied here to a technique instead of a disease.',
    summary: "Acupressure, applying pressure rather than needles to the same points acupuncture uses, has randomized trial evidence behind it for one outcome the core purpose cares about directly: fatigue. It just isn't Hashimoto's-specific evidence. Trials found it measurably reduced fatigue in chronic lymphocytic leukemia patients, in chronic fatigue syndrome, and in people undergoing hemodialysis for end-stage renal disease, three different chronic-illness populations converging on a similar benefit for a common symptom. None of these trials studied Hashimoto's or autoimmune thyroid disease specifically, so this is borrowed evidence, not disease-specific proof, the same labeling discipline the Other Autoimmune Diseases category already applies to research from other conditions. It's a low-risk, evidence-backed option for fatigue specifically, while its direct application to Hashimoto's-related fatigue hasn't been tested yet.",
    citations: [
  ...
  },
  {
    ...
    summary: "Heat therapy is the one modality in this category with large-scale, quantified evidence behind it, an outlier compared to chiropractic's flat null or massage's contested claim. A well-known Finnish cohort study found men who used a sauna 4 to 7 times per week had a 63% lower risk of sudden cardiac death compared to men who used one just once a week, with sessions longer than 19 minutes associated with a 52% lower risk compared to sessions under 11 minutes. Striking, dose-dependent numbers, not a vague trend. The same caveat already applied throughout still holds: this is Finnish men in a specific cohort, with a cultural sauna-use pattern most of the world doesn't share, which is a reason to treat the exact magnitude with some caution while still trusting the general direction of the finding. A separate short-term study found sauna sessions actually raised IL-6 acutely, not lowered it, while also raising the anti-inflammatory marker IL-1RA, with CRP unchanged. A more complicated acute picture than \"sauna reduces inflammation\" would suggest, closer to the same adaptive stress-then-recovery pattern the exercise research already describes than a simple, one-direction anti-inflammatory effect.",
    citations: [
  ...
  },
  {
    ...
    teaser: "A published experiment found trained subjects could measurably blunt their inflammatory response to an immune challenge. It wasn't cold exposure alone that did it.",
    summary:
      "Cold water immersion has a striking study behind it, published in one of the most respected general-science journals that exists, PNAS. The correction worth making upfront: it tested a combined technique, not cold exposure in isolation. Subjects trained for 10 days in a specific combination of meditation, a particular breathing technique (cyclic hyperventilation with breath retention), and cold water immersion. They were then given a deliberate endotoxin challenge, a controlled way of triggering an inflammatory immune response under medical supervision, and the trained group showed significantly higher anti-inflammatory IL-10, lower pro-inflammatory TNF-alpha/IL-6/IL-8, and fewer flu-like symptoms than untrained controls facing the identical challenge. A measurable effect on the immune system's inflammatory response, achieved through voluntary practice rather than medication. The caveat matters as much as the finding: this study cannot say which piece of the combined protocol did the work, or whether cold exposure alone would produce anything like this effect on its own. This is legitimate evidence that voluntary techniques can influence inflammatory response, not yet evidence that a cold plunge by itself does the same thing.",
    citations: [
  ...
  },
  {
    ...
    summary: "Read side by side, these six modalities sort into a clear hierarchy, not all six equally worth pursuing. Chiropractic has no evidence at all. Acupuncture has a well-designed trial specifically for Hashimoto's whose results aren't available yet. Massage's most commonly repeated specific claim isn't settled science. Acupressure and cold exposure both have real, if borrowed or combined-protocol, evidence. Sauna and heat therapy has the strongest, most quantified evidence in this category, though from one specific population. Set against all of that, the Mitochondria & Metabolism category already covers something with more, and more directly relevant, evidence than any single entry here: Hashimoto's-adjacent research on exercise's measurable effect on inflammation, visceral fat, and cellular energy metabolism, without needing to borrow evidence from an unrelated condition or lean on one country's cultural habit. That's the direct answer to whether this category should tie into exercise. It already does, by comparison: exercise remains the better-evidenced, more directly applicable choice of everything covered across both categories, and these six modalities are honestly-tiered complements to that, not substitutes for it.",
    citations: [],
    overallTier: 'moderate',
