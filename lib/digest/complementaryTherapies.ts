...
export const COMPLEMENTARY_THERAPIES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "A published experiment found trained subjects could measurably blunt their own inflammatory response to an immune challenge. It wasn't cold exposure alone that did it.",
    summary:
