...
export const COMPLEMENTARY_THERAPIES_ENTRIES: DigestEntry[] = [
  {
    ...
    category: 'hashimotos',
    title: 'Chiropractic Care: A Flat Null',
  ...
  },
  {
    ...
    teaser: 'The same "borrow evidence, label it clearly" approach already used for other autoimmune diseases, applied here to a technique instead of a disease.',
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'Sauna Use Tracked With 63% Lower Sudden Cardiac Death, in Finnish Men Only',
  ...
  },
  {
    ...
    summary: "Read side by side, these six modalities sort into a clear hierarchy, not all six equally worth pursuing. Chiropractic has no evidence at all. Acupuncture has a well-designed trial specifically for Hashimoto's whose results aren't available yet. Massage's most commonly repeated specific claim isn't settled science. Acupressure and cold exposure both have borrowed or combined-protocol evidence. Sauna and heat therapy has the strongest, most quantified evidence in this category, though from one specific population. Set against all of that, the Mitochondria & Metabolism category covers something with more, and more directly relevant, evidence than any single entry here: Hashimoto's-adjacent research on exercise's measurable effect on inflammation, visceral fat, and cellular energy metabolism, without needing to borrow evidence from an unrelated condition or lean on one country's cultural habit. That's the direct answer to whether this category should tie into exercise. It already does, by comparison: exercise remains the better-evidenced, more directly applicable choice of everything covered across both categories, and these six modalities are tiered complements to that, not substitutes for it.",
    citations: [],
    overallTier: 'moderate',
