...
export const PSORIASIS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'The turmeric-forward tonics in this app\'s own fermentation collection fit psoriasis\'s own anti-inflammatory, gut-skin-axis framing well, but several drinks in that same collection carry alcohol content, useful to check before reaching for one.',
