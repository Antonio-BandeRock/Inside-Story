...
export const PSORIASIS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "It's worth reading this alongside the omega-3 finding in the Rheumatoid Arthritis category, because the contrast is real and instructive. For RA, omega-3 supplementation carries strong, repeated trial evidence. For psoriasis, the picture is genuinely weaker. A meta-analysis of randomized controlled trials found fish oil taken alone had no measurable effect on PASI score, lesion area, or itching. Five trials in the same body of research found some benefit; eight found none, and pooled together, fish oil supplementation wasn't associated with reduced disease severity when used by itself. The one place omega-3s showed real promise was in combination with standard psoriasis treatment rather than as a stand-alone approach, several reviews found a real added benefit when fish oil was paired with conventional therapy rather than used on its own. The same nutrient, studied with real rigor in two different autoimmune diseases, landing in two genuinely different places, is exactly the kind of honest, disease-specific distinction worth holding onto rather than assuming one finding transfers automatically to the next condition.",
    citations: [
  ...
  },
  {
    ...
    summary: "Psoriasis's own real, documented history starts with a genuine, and genuinely overdue, correction: in 1808, physician Robert Willan produced the first real clinical description distinguishing psoriasis from leprosy, two conditions that had been confused together for centuries, a real, consequential misclassification given how differently the two conditions were treated and regarded. It took until 1963 for E. J. Van Scott to identify psoriasis as a real autoimmune disorder, and until 1973 for a landmark paper (Moll and Wright) to establish psoriatic arthritis and psoriasis as one connected disease, genuinely distinct from rheumatoid arthritis, the same real distinction the RA and Psoriasis categories reflect by being built as separate conditions. Methotrexate, introduced in 1958, was approved specifically for psoriasis in 1972; the real, more recent turning point came in 2003, when the first biologic agents for psoriasis reached FDA approval, targeting the same specific inflammatory pathways (TNF-alpha, later IL-23/IL-17) the systemic-comorbidity research above traces directly to psoriasis's real, whole-body effects.",
    citations: [
  ...
  },
  {
    ...
    summary: "Pitting, ridging, discoloration, and separation of the nail from the nail bed (onycholysis) can look like a minor, separate nuisance, but real research treats nail psoriasis as a genuine disease marker, not a footnote. Nail involvement appears in up to 80% of people with psoriasis at some point, and can be the ONLY visible sign in about 6% of cases. In one real cohort of 200 Korean psoriasis patients, 85.5% had nail involvement, with pitting (the nail matrix's own signature change) and onycholysis (the nail bed's own signature change) the two most common findings. What makes this worth tracking rather than dismissing: real data from the PsoReal study found nail psoriasis correlates with more severe overall disease, earlier onset, and a real, higher risk of psoriatic arthritis specifically. The already-covered PsA self-advocacy research already recommends watching for joint symptoms; nail changes are a real, visible, easy-to-notice early flag worth mentioning at the same appointment.",
    citations: [
  ...
  },
  {
    ...
    category: 'psoriasis',
    title: "Not All Psoriasis Biologics Are Kept Up With Equally -- Real, Multi-Year 'Drug Survival' Data Shows a Genuine Gap",
    teaser: 'Real-world data tracking how long patients actually stay on a given biologic, not just whether it works in a trial, finds real, substantial differences between drugs, with some genuinely outlasting others by years.',
    summary:
      "This category's own already-covered biologic research (guselkumab's own real VOYAGE 1 trial data) shows strong initial results, and a real, separate, genuinely useful metric, drug survival (how long patients actually keep taking a given biologic before switching or stopping), reveals something a short trial alone can't: real durability over years of actual use. A real meta-analysis of real-world evidence found substantial variation by year 4: etanercept's survival dropped from 66 percent at year one to 41 percent by year four, infliximab from 61 to 42 percent, adalimumab from 69 to 47 percent, while ustekinumab held up markedly better, from 82 to 56 percent. A real, separate pooled analysis found 5-year survival rates of 46.3 percent for adalimumab, 35.9 percent for etanercept, and 34.7 percent for infliximab, broadly confirming the same real pattern. Real, more recent data adds a genuinely useful nuance: among biologic-naive patients, ustekinumab showed superior long-term persistence, but newer drugs (bimekizumab, guselkumab, risankizumab) showed higher 2-year survival specifically in patients who had already tried and moved on from an earlier biologic, real evidence that the right drug can depend on treatment history, not just which one performed best in an initial trial. Worth knowing directly: the real, most common reason for stopping etanercept and infliximab was loss of efficacy over time, and infliximab specifically was most often stopped for adverse effects, real, practical detail worth discussing directly when choosing among this category's own already-covered biologic options.",
    citations: [
