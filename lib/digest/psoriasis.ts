...
export const PSORIASIS_ENTRIES: DigestEntry[] = [
  ...
  // WebSearch.
  {
    ...
    overallTier: 'weak',
    stageNote: 'Adiponectin-severity findings are more consistently replicated; leptin-severity findings conflict directly across studies, included here for that inconsistency.',
