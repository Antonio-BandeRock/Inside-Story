...
export const PSORIASIS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'psoriasis',
    title: 'Alcohol and Psoriasis: A Association That Splits by Sex',
    teaser: 'Heavier drinking tracks with worse psoriasis, most clearly documented in men, with a separate mortality finding worth knowing either way.',
    summary:
  ...
  },
  {
    ...
    summary: "Acitretin, an oral retinoid used for moderate-to-severe plaque psoriasis, carries one of the more serious food-and-substance interactions covered anywhere. Alcohol taken during acitretin treatment converts the drug into etretinate, a related retinoid with a dramatically longer half-life, roughly 120 days compared to acitretin's own 49 hours. That single conversion matters enormously because acitretin, like every retinoid, carries a teratogenic risk, meaning it can cause serious birth defects. A drug that normally clears the body in days instead lingers, in one documented case, still detectable in blood and fat tissue 52 months after the last dose was taken, because of alcohol consumed during treatment. This is exactly why alcohol is specifically prohibited during acitretin treatment and for at least two months after stopping, a different and stricter rule than the general moderation advice attached to most other medications.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'The same drug, methotrexate, gets monitored more loosely under dermatology guidelines than under rheumatology ones, a documented gap worth knowing about.',
    summary: "Methotrexate, cyclosporine, and acitretin all show up in this category's own medication-interaction entries, and each one needs scheduled bloodwork beyond just watching for symptoms. A useful, if uncomfortable, finding worth knowing directly: a comparative study found that dermatology-specific methotrexate monitoring guidelines are looser than rheumatology guidelines for the identical drug, and that the looser dermatology protocol tracked with worse real-world drug-survival outcomes. That's not a reason to distrust a dermatologist. It's a concrete, specific thing worth asking about directly: whether liver enzymes are being checked on the same interval (roughly every 8-12 weeks) the Rheumatoid Arthritis category already covers for the same drug. Cyclosporine adds its own separate monitoring need, regular blood pressure and kidney-function checks, given its own documented risk to both.",
    citations: [
      {
  ...
  // independently verified via WebSearch.
  {
    ...
    teaser: 'PASI, body surface area, and quality-of-life impact all factor into a standardized severity classification, worth knowing by name before a treatment conversation.',
    summary:
  ...
  },
  {
    ...
    teaser: 'A pooled meta-analysis found psoriasis patients had roughly double the odds of suicidal ideation compared with people without the condition, a mental-health burden worth naming directly.',
    summary:
      "This category's own already-covered systemic-comorbidities research names psoriasis's physical reach. Its mental-health burden deserves its own direct, honest accounting too. A pooled meta-analysis found the odds of suicidal ideation among people with psoriasis roughly doubled compared with those without it (an odds ratio of 2.05), with a smaller but still significantly elevated odds of actual suicidal behavior (attempts and completed suicides, an odds ratio of 1.26). A separate large study found depression risk elevated in psoriasis alone (a 43% higher relative risk) and higher still specifically in people who'd also developed psoriatic arthritis (a 55% higher relative risk), a direct link back to this category's own PsA-progression research. Research identifies younger age and more severe skin disease as particular risk factors for suicidality specifically. Worth knowing honestly: existing meta-analyses on this exact question don't all agree, with some finding smaller or less consistent effects depending on study design, a caveat rather than an overstated crisis claim. Worth knowing directly: this elevated mental-health burden is a legitimate reason mental health deserves the same direct, routine attention as skin severity itself in psoriasis care, not an afterthought to physical symptom control.",
    citations: [
  ...
  },
  {
    ...
    teaser: "Norway's own psoriasis prevalence, 3.8-4.6% of the population, sits at the very top of a documented worldwide gradient; East Asia's prevalence sits at roughly 0.14%, near the very bottom.",
    summary: "Psoriasis shows one of the starkest geographic gradients of any condition. Norway carries a national prevalence of 3.8 to 4.6%, with northern Norway specifically rising from 4.8% in 1979-1980 to 11.4% by 2007-2008, and Denmark sits close behind at 2.2 to 2.8%. Global burden data confirms this isn't a Norwegian quirk: Western Europe carries the highest age-standardized prevalence rate worldwide (1,155.9 cases per 100,000), while Eastern Sub-Saharan Africa carries the lowest (150.2 per 100,000), and East Asia's own prevalence, 0.14%, sits at a small fraction of Australasia's 1.99%. Two distinct factors are named directly in the research: higher latitude itself (less year-round UV exposure) and Caucasian ancestry specifically both independently track with higher rates. Worth knowing directly for anyone outside North America or Western Europe: a lower reported psoriasis rate in one's own home region is a documented pattern, not a sign the condition is being missed or under-diagnosed there, even as the SAME environmental and genetic factors behind it (sun exposure, skin-immune biology) remain worth understanding regardless of where someone lives.",
    citations: [
  ...
  },
  {
    ...
    teaser: "A national-registry study in Nuuk, Greenland found psoriasis in just 1.1% of adults, a striking contrast against Norway's own 3.8-4.6% just a few hundred miles away.",
    summary:
      "This category's own already-covered latitude gradient (psoriasis rising with distance from the equator) makes Greenland's own documented prevalence a useful contrast rather than a simple confirmation of that pattern. A national-registry cross-sectional study in Nuuk, Greenland's capital, found only 1.1% of the adult population carrying a diagnosed psoriasis, notably lower than Norway's own 3.8 to 4.6% despite both regions sitting at high, similar latitudes. The honest complication the study's own authors raise directly: they suspect this figure is an UNDERESTIMATE, driven by limited awareness of chronic skin disease and healthcare-access gaps in Greenland specifically, not necessarily true biological rarity, and they call directly for more awareness of chronic skin conditions there. A related finding worth noting: psoriasis patients in this same Nuuk cohort had notably higher rates of diabetes, hypertension, and lung disease (28.6%) than people without psoriasis (20.9%), the same cardiometabolic comorbidity pattern already covered elsewhere in this category. Worth knowing directly: Greenland's own low reported rate is a useful reminder that latitude alone doesn't fully explain psoriasis prevalence, Indigenous genetic background and healthcare-access/awareness gaps can both push a reported rate in either direction.",
    chart: {
  ...
  },
  {
    ...
    summary:
      "This category's own already-covered IL-23 and TYK2 research targets the mechanism behind ordinary plaque psoriasis; generalized pustular psoriasis (GPP), a rare, and dangerous flare pattern involving widespread pus-filled skin lesions, runs through a different inflammatory signal, IL-36, and had no dedicated approved treatment at all until recently. Spesolimab, a first-in-class antibody blocking the IL-36 receptor directly, changed that: its pivotal trial found a single dose clearing visible pustules entirely in a 85.7% of patients within one week, with 73.2% reaching completely clear skin, a dramatic result for a flare pattern that can otherwise require hospitalization. It received FDA approval in September 2022 specifically for GPP flares, since expanded to more countries worldwide. Worth knowing directly: trial data also found spesolimab associated with a higher rate of infections and systemic drug reactions than placebo, an honest tradeoff worth naming alongside the dramatic efficacy, and the drug is specifically indicated for treating an active flare, not for everyday plaque psoriasis already covered by this category's own more established treatment research.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Methotrexate is this category's own already-covered first-line skin treatment, and it's also commonly prescribed once psoriasis reaches the joints (psoriatic arthritis, PsA), but the evidence behind that second use is more mixed than most patients are told. Two randomized trials never found methotrexate outperforming placebo for PsA on its own primary endpoints. Yet clinical and strategy trials, dosed at 15mg/week or higher with active dose escalation, DID find significant improvement across disease activity, dactylitis (a whole swollen \"sausage\" finger or toe, a distinctive PsA sign), enthesitis (tendon-attachment inflammation), and functional status. Real-world biologic-treatment data adds a further, useful data point: dactylitis dropped from 23.6% to 3.5% of patients, and enthesitis from 33.3% to 9.0%, after 6 months of biologic treatment specifically. Worth knowing directly: research has directly questioned whether methotrexate should keep its current status as the default first PsA treatment in international guidelines, given how much better tolerated biologics are in large patient cohorts, an ongoing debate, not a settled question either way.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "This category's own already-covered weight-loss research shows dose-dependent benefit from ordinary weight loss; bariatric surgery data adds a more dramatic, if far more invasive, version of the same pattern. A systematic review pooling 447 patients across 6 studies found 69.5% showed improvement or full remission of psoriasis after metabolic bariatric surgery. Specific numbers vary by surgery type: 80% improvement or remission after gastric bypass, versus only 10% after non-bypass procedures, with research pointing to an additional mechanism beyond weight loss itself, gastric bypass measurably increases secretion of GLP-1, a gut-derived hormone with its own anti-inflammatory signaling separate from body weight. One smaller study found 70% of patients still in remission six months later, with three of four previously medicated patients able to stop systemic psoriasis drugs entirely. Worth knowing directly: this is substantial evidence for an invasive intervention most people would only consider for obesity itself, not for psoriasis alone, but for someone already considering bariatric surgery for other health reasons, an additional psoriasis benefit is honestly worth knowing about in advance.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered weight-loss entry names it as the strongest single lever in psoriasis research, a dedicated Phase IIb trial tested 16:8 intermittent fasting specifically and found significant PASI improvement by 28 weeks.",
    summary:
      "This category's own already-covered weight-loss entry already names it the single best-evidenced lever in psoriasis management, and more recent trials have now tested a specific, structured way to achieve it directly rather than leaving 'lose weight' as an open-ended instruction. A Phase IIb clinical trial tested 16:8 time-restricted intermittent fasting specifically for chronic plaque psoriasis, and found a statistically significant reduction in PASI score (the same severity measure already covered elsewhere in this category) by 28 weeks, alongside measured improvements in quality of life (DLQI) and inflammatory markers (VEGF, hs-CRP), evidence the benefit reaches beyond skin appearance alone into the same systemic inflammation this category's own comorbidity research already covers. A separate trial testing 5:2 modified intermittent fasting (500 calories on two non-consecutive days weekly) found a significant reduction specifically in scaling and skin thickness among patients with mild psoriasis. A additional study of 108 patients found fasting during Ramadan specifically producing a significant PASI reduction too, a different real-world fasting pattern reaching a similar result. Worth stating directly: this is useful, structured guidance beyond the general weight-loss recommendation already covered elsewhere in this category, a specific, testable protocol (16:8 time-restricted eating) worth discussing directly with a doctor as an evidence-backed complement to medical treatment, not a replacement for it.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered guttate/pediatric-strep entry names one childhood trigger, direct prevalence data finds roughly a third of ALL psoriasis cases beginning in childhood generally, with a growing set of biologic options specifically approved for this age group.",
    summary:
      "This category's own already-covered guttate psoriasis entry names one specific pediatric trigger (a preceding strep infection), and broader prevalence data finds childhood-onset psoriasis common well beyond that one subtype: research finds roughly a third of all psoriasis cases beginning during childhood, with prevalence climbing steadily and linearly with age, from a 0.55 percent in UK children ages 0-9 up to 1.37 percent by ages 10-19, and a similar pattern (0.12 percent at age 1 rising to 1.2 percent by age 18) found in German data too, with girls affected somewhat more often than boys. Research finds a meaningful minority, 10 to 20 percent of pediatric psoriasis cases, reaching moderate-to-severe severity requiring systemic treatment, not just topical management. The useful, practical finding: direct pediatric trials now support a growing set of biologic treatments specifically approved for children and adolescents, with etanercept the most studied to date, and adalimumab and ustekinumab also approved options, research finding high efficacy with a favorable safety profile in this specific age group, not simply adult treatments used off-label with unknown pediatric risk. Worth stating directly: this substantial childhood-onset share, and the now-available pediatric-specific biologic options, mean a child's own psoriasis diagnosis deserves the same serious treatment consideration this category's own adult research already covers, not automatically deferred as something to simply outgrow.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered PASI staging measures skin severity, not joint disease, CASPAR is the separate, formally validated criteria for diagnosing psoriatic arthritis itself, with strong accuracy.",
    summary:
      "This category's own already-covered PASI severity staging measures skin disease specifically, and psoriatic arthritis, the joint-involving complication already covered elsewhere in this category, has its own separate, formal diagnostic tool: the ClASsification for Psoriatic ARthritis (CASPAR) criteria. Large, multinational prospective validation found CASPAR carrying a sensitivity of 91.4 percent and specificity of 98.7 percent, strong diagnostic accuracy by any clinical standard. Follow-up studies confirm this holds up well even in early disease specifically, the hardest diagnostic window, with one study finding 87.4 percent sensitivity for early psoriatic arthritis, meaningfully outperforming the older Moll and Wright criteria it replaced (80.2 percent). CASPAR works by scoring a combination of features, including current or past psoriasis, nail changes, a negative rheumatoid factor test, dactylitis (characteristic 'sausage digit' swelling), and evidence of new bone formation near a joint on imaging, rather than relying on any single test alone. Worth stating directly: since this category's own already-covered psoriatic arthritis progression research names a narrow 12-month early-detection window that changes long-term joint outcomes, knowing this accurate, named diagnostic tool exists is worth asking about directly the moment joint symptoms appear alongside psoriasis, rather than waiting for a vaguer clinical impression to form.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered IL-23 inhibitor research reveals why it works for two seemingly unrelated diseases at once: shared genetic risk loci and a common IL-23/Th17 pathway link psoriasis directly to inflammatory bowel disease.",
    summary:
      "This category's own already-covered IL-23 inhibitor research names strong efficacy for psoriasis specifically, and research finds the underlying reason connects directly to a completely different condition already built out elsewhere in this Digest: inflammatory bowel disease. Genome-wide association studies have identified shared genetic susceptibility loci between psoriasis and IBD, including specific genes (IL23R, IL12B, TNFSF15, STAT3) implicated in both diseases independently. The unifying mechanism is the IL-23/Th17 immune pathway, the same pathway already covered elsewhere in this category, driving keratinocyte overgrowth (the root cause of psoriasis's own visible skin plaques) in the skin and direct tissue damage in the gut wall in IBD, two very different-looking diseases sharing one common immune root. This isn't just theoretical: meta-analyses and everyday clinical practice find drugs targeting the IL-17/IL-23 pathway achieving superior skin clearance for psoriasis compared to older TNF-alpha-targeting drugs, practical confirmation that this specific pathway is a central driver, not one of several equally important ones. Worth stating directly: this shared biology is a reason someone with psoriasis experiencing new digestive symptoms, or someone with IBD noticing new skin plaques, is worth mentioning both conditions together to a doctor rather than treating them as two unrelated, coincidental diagnoses.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered pregnancy-family-planning research gets a specific medication answer: certolizumab pegol was found essentially absent from umbilical cord blood in 13 of 14 tested newborns.",
    summary:
      "This category's own already-covered pregnancy and family-planning research names practical challenges managing psoriasis through pregnancy, and pharmacokinetic research identifies one biologic medication with a distinct safety profile: certolizumab pegol. Unlike other biologics already covered elsewhere in this category, certolizumab pegol lacks the Fc portion of a normal antibody, the specific structural piece that actively transports other biologics across the placenta. Dedicated pharmacokinetic studies (the CRIB and CRADLE trials) directly measured this: certolizumab pegol was undetectable in the umbilical cord blood of 13 of 14 tested newborns, and present only in a trace amount in the 14th, direct evidence of minimal to no placental transfer throughout pregnancy. A large pharmacovigilance safety-database analysis backed this up further, finding no increased teratogenic risk and no increased fetal death risk compared to the general population, with miscarriage rates (8.9 to 15.3 percent) and birth-defect rates (3 to 4 percent) for this drug class overall comparable to the general population baseline. Worth stating directly: clinical guidance now names certolizumab pegol as the preferred biologic specifically for psoriasis patients who are pregnant or planning pregnancy, usable safely through all three trimesters, a concrete, answer to a decision this category's own broader pregnancy research names as a common source of anxiety.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'The turmeric-forward tonics in this app\'s own fermentation collection fit psoriasis\'s own anti-inflammatory, gut-skin-axis framing well, but several drinks in that same collection carry alcohol content worth knowing before reaching for one.',
