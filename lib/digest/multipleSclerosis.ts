...
export const MULTIPLE_SCLEROSIS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "This category's already-covered cognitive research establishes real, measurable brain atrophy in MS; a specific, real mechanism in the hippocampus itself adds a further, more precise layer, since it's genuinely distinct from remyelination, MS's better-known repair process (rebuilding the myelin coating on nerve fibers), not the same thing described two different ways. A real animal-model study using a hippocampal demyelination model found new-neuron production nearly abolished in the demyelinated region, driven by neural stem cells shifting from an actively dividing state into a dormant, quiescent one, rather than the stem cells themselves being destroyed. The genuinely hopeful, and mechanistically important, finding: this same study found neurogenesis and the normal connectivity of new neurons both recovered back toward normal levels once remyelination of that same hippocampal region actually occurred, direct evidence the underlying stem-cell reservoir survives the demyelinated period intact and can be reactivated, rather than being permanently lost. With MS's chronic disease course, though, research finds neurogenesis genuinely declines over time as demyelination persists or recurs, tracking with the memory impairment already covered in this category's cognitive research, a real, mechanistic reason ongoing disease control matters directly for this specific, otherwise-recoverable process, not just for preventing further physical disability.",
    citations: [
