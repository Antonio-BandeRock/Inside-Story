...
export const MULTIPLE_SCLEROSIS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Research finds autoimmune thyroiditis or subclinical hypothyroidism present in 20% to 25% of people with MS before they start immunomodulatory treatment, a striking figure, meaning roughly one in four to five untreated MS patients also carries measurable thyroid autoimmunity. Hashimoto's thyroiditis specifically shows up as the single most common comorbid thyroid condition in MS cohort studies. The reassuring finding alongside this: thyroid autoimmunity appears to have a neutral effect on the actual course of MS itself, it doesn't seem to make MS worse, it's simply more likely to co-occur. For two practical reasons, first, MS's own core immune-cell biology (Th17/Treg imbalance, the same mechanism the Gut & Microbiome research already covers) is a shared thread connecting these two diseases, not a coincidence; second, a regular thyroid panel (see the Hashimoto's self-advocacy content for what to ask for) is arguably even more relevant for someone managing MS than for the general population, given how common this overlap actually is.",
    citations: [
