...
export const CHOOSING_QUALITY_PRODUCTS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'A landmark UC Davis study found most tested imported oils failed to meet extra virgin standards, on taste and smell rather than because they were cut with cheaper oils.',
    summary:
  ...
  },
  {
    ...
    summary:
      'Honey\'s value comes from bees processing floral nectar, but cheap sugar syrups (corn, rice, beet, or inverted sugar) can be blended in, or fed directly to bees, at a fraction of the cost, producing something that still tastes and looks like honey to an ordinary shopper. A European Commission investigation across 147 honey samples found 46 percent were suspected of this kind of adulteration, and the underlying detection science has grown accordingly complex (isotope-ratio analysis, chromatography, and spectroscopy methods are all now used specifically because dilution at low percentages is hard to catch by taste or appearance alone). Practically: raw honey typically crystallizes over time in a cool pantry (a sign of unprocessed sugar content) while heavily processed or diluted honey often stays liquid indefinitely; buying from a known local beekeeper, or a brand that discloses its country/region of origin rather than a vague "blend of EU and non-EU honeys" label, meaningfully lowers the risk.',
    citations: [
      {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Saffron\'s Extreme Price Makes It the Most Adulterated Spice in the World',
  ...
  },
  {
    ...
    summary:
      'Maple syrup comes from boiling down tree sap, a slow, labor- and fuel-intensive process, which makes a cheap sweetener blended in (high-fructose corn syrup, beet or cane invert syrup, plain sucrose) a financially attractive substitution the FDA specifically names as a known target for economically motivated adulteration, the same regulatory category honey and olive oil both fall into. A bottle can say "100% pure maple syrup" and still be diluted, since detecting it usually requires lab methods (carbon-isotope ratio testing, nuclear magnetic resonance) rather than anything visible on a shelf. Practically: maple syrup is graded (Golden, Amber, Dark, Very Dark in the current US/Canada grading system, all pure maple, just differing in when in the season the sap was harvested and how dark and strong the flavor is), a bottle that skips grading language entirely, or is priced dramatically below other maple syrup in the same size and region, is worth a second look; buying directly from a known small producer, or a brand that states its state/province of origin, meaningfully lowers this risk.',
    citations: [
      {
