...
export const TYPE_2_DIABETES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'type2Diabetes',
    title: 'Low-Carbohydrate Diets: Strong Short-Term Evidence, With a Caveat About What "Remission" Actually Means',
  ...
  },
  {
    ...
    summary: "Current American Diabetes Association guidelines represent a recent shift in how T2D itself gets treated: GLP-1 receptor agonists and SGLT2 inhibitors are now recommended as first-line pharmacotherapy for many patients, especially those with established heart disease, heart failure, or chronic kidney disease, specifically because of their independent organ-protective benefits, not primarily because of how well they lower blood glucose. Current guidance recommends SGLT2 inhibitors for T2D patients with an eGFR of 20 mL/min/1.73m² or higher specifically because they slow CKD progression and reduce heart-failure risk through a separate mechanism from glucose control, covered directly in the dedicated CKD and MASLD research. The evidence behind this shift is substantial: cardiovascular- and kidney-outcome trials found 12% to 39% risk reductions in major adverse events with these two medication classes over 2 to 5 years. Metformin is no longer automatically the default first medication for everyone with T2D the way it once was, current treatment now depends more on which organs are already at risk than on blood glucose numbers alone.",
    citations: [
  ...
  },
  {
    ...
    category: 'type2Diabetes',
    title: "Why T2D's Complication Screening Starts on Day One, Not Five Years Later",
  ...
  },
  {
    ...
    category: 'type2Diabetes',
    title: "HbA1c Targets: A Correction to \"Lower Is Always Better\"",
  ...
  },
  {
    ...
    teaser: 'Four conditions covered in depth all trace back, at least in part, to the exact same underlying mechanism.',
    summary: "Insulin resistance is a shared thread connecting T2D directly to three other conditions covered in depth. PCOS's central mechanism, already documented in the dedicated research, is the identical insulin-resistance pathway, with a quantified 42.6%-versus-17.1% insulin resistance prevalence difference already cited there. MASLD's mechanism, also already documented, involves the liver storing fat specifically because insulin resistance disrupts normal fat metabolism, the same underlying disruption at work in T2D itself. CKD is directly connected too, diabetes (overwhelmingly T2D specifically) is one of the two most common causes of chronic kidney disease in the first place, which is exactly why SGLT2 inhibitors and other medications covered in the dedicated CKD research do double duty, treating T2D and protecting the kidneys through the same medication at once. Someone managing insulin resistance well, through diet, weight, exercise, or medication, is realistically working on all four of these conditions' shared root cause simultaneously, not four separate, unrelated problems.",
    citations: [
      { source: 'Type 2 Diabetes, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/diabetestype2.html' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'type2Diabetes',
    title: "T2D's Medication History: A Traditional Herbal Remedy, Rediscovered While Searching for a Malaria Drug",
  ...
  },
  {
    ...
    category: 'type2Diabetes',
    title: 'What "Remission" Actually Means Under the ADA Consensus Definition',
  ...
  },
  {
    ...
    category: 'type2Diabetes',
    title: 'Statins Themselves Carry a Modest Diabetes Risk, Even While Preventing Heart Disease',
  ...
  },
  {
    ...
    teaser: 'Individual CPAP trials found glycemic improvement in some cases, but a pooled meta-analysis of 581 patients found no overall HbA1c benefit, an unsettled evidence picture.',
    summary:
  ...
  },
  {
    ...
    summary:
      "The microvascular and nerve-damage complications (eye, kidney, foot) reach the same vascular and neural pathways as another, less commonly discussed one: hearing. Pooled data finds hearing loss prevalence in type 2 diabetes ranging from 40.6 to 71.9 percent across studies, and a direct comparison found clinically significant hearing loss in 53.0 percent of diabetic patients versus 25.2 percent of matched controls, a more than two-fold relative risk. The most common type found is sensorineural hearing loss (46.2 percent of cases), the same category of hearing damage caused by inner-ear or auditory-nerve injury, consistent with a direct link to the neuropathy research: one study found the hearing loss specifically associated with diabetic neuropathy rather than diabetes alone. Identified risk factors mirror the complication-screening research directly: hearing loss prevalence was significantly higher in people with diabetes duration over 10 years, and both disease duration and HbA1c level (covered elsewhere in this category as the central control marker) independently predicted it. Hearing loss isn't part of standard diabetes complication screening the way eye and kidney checks already are, a reason to mention any hearing changes directly to a doctor rather than assume they're simply an unrelated, ordinary part of aging.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The DiRECT trial shows dietary remission evidence, a 10-year surgical follow-up found roughly half of gastric bypass patients still in remission a full decade out, with diabetes duration at the time of surgery the strongest predictor of whether it lasts.",
    summary:
      "The DiRECT trial found substantial diabetes remission through structured dietary weight loss, and long-term surgical data gives a different, more durable comparison point. A Roux-en-Y gastric bypass cohort found remission rates of 74 percent at 1 year, dropping to a 53 percent still in remission at 10 years, roughly half of patients maintaining it for a full decade. The single strongest predictor of lasting remission: how long someone had diabetes before surgery. Patients with a shorter diabetes duration (under 4 years) maintained remission in about 80 percent of cases at 10 years, while a separate cohort study of patients with 10 or more years of diabetes duration found remission rates declining roughly 10 percentage points per year after surgery, from 65.6 percent at year one down to 41.9 percent by year three. Consistent with the window-of-opportunity-style reasoning elsewhere in this Digest, evidence points toward earlier surgical intervention, while glycemic control is still relatively good, producing meaningfully more durable results than waiting until diabetes has been established for a decade or more, concrete reason timing itself is a part of this decision, not just whether to have the surgery at all.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The microvascular-screening research names established complication targets, a pooled meta-analysis of 36 studies (9,220 pancreatic cancer patients) finds a doubled cancer risk too, with an important twist about WHEN that risk shows up.",
    summary:
      "The complication-screening research names established microvascular and cardiovascular targets, and pancreatic cancer deserves direct coverage too. A large meta-analysis of 36 studies (9,220 people with pancreatic cancer) found a summary odds ratio of 1.82, roughly an 82 percent higher risk of pancreatic cancer associated with type 2 diabetes. The important wrinkle: this risk isn't uniform over time. People whose diabetes had only recently been diagnosed (less than 4 years) had a significantly HIGHER risk than people with longer-standing diabetes (5 or more years), a quantified 2.1 versus 1.5 odds ratio. This timing pattern changes how the finding should actually be read: it's strong evidence for REVERSE causation playing a role, an early, undetected pancreatic tumor can itself disrupt blood sugar regulation and cause diabetes to appear, rather than diabetes alone directly causing the cancer in every case. The researchers themselves, after accounting for this, still concluded the data supports a modest causal contribution from diabetes itself, not purely a reverse-causation artifact. This two-part finding is exactly why a NEW diabetes diagnosis, especially later in life with no strong family or lifestyle risk factors, is sometimes worth a closer look rather than assumed to be routine T2D, useful, non-alarmist information rather than something to avoid out of caution.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The cognitive-decline research names hippocampal volume loss and impaired memory, mouse models of T2D found the actual new-neuron-production process itself measurably reduced, with a hopeful twist involving a medication already in wide use.",
    summary:
      "The cognitive research establishes that T2D tracks with smaller hippocampal volume and measurable memory impairment, and a specific mechanism helps explain why: hippocampal neurogenesis itself, the ongoing production of new neurons in that same brain region, is measurably reduced in mouse models of type 2 diabetes, both in obesity-driven and non-obesity-driven versions of the disease, meaning this isn't purely a byproduct of excess weight. A separate study found the mechanism runs at least partly through the adrenal stress hormone corticosterone (the rodent equivalent of human cortisol), diabetes measurably impaired hippocampal memory function, synaptic plasticity, and new-neuron production together, and elevated glucocorticoid levels contributed directly to these effects. The hopeful, practical twist: metformin, already one of the most widely prescribed T2D medications and covered elsewhere in this app's medication research, appears to work in the opposite direction, research found it activates a specific cellular signaling pathway that promotes neural progenitor cell differentiation and measurably enhances spatial memory formation in mice, a concrete example of a medication doing more for the brain than simply lowering blood sugar.",
    citations: [
  ...
  // verified via WebSearch.
  {
    ...
    summary:
      "A randomized clinical trial assigned 99 people with type 2 diabetes to either a low-fat vegan diet or a diet following standard American Diabetes Association guidelines, then measured outcomes at 22 weeks. Both diets worked: A1C (average blood sugar over roughly 3 months) fell in both groups, and body weight dropped further in the vegan group (6.5 kg) than the ADA group (3.1 kg). A1C fell by 0.96 points in the vegan group versus 0.56 in the ADA group, a measurable difference, but one that fell just short of the standard 0.05 significance threshold (p=0.089) when comparing the two groups as originally assigned. A secondary analysis excluding participants who changed their diabetes medications during the trial (which can independently move A1C regardless of diet) found a larger, statistically significant gap, 1.23 points versus 0.38 (p=0.01). Reading both numbers together rather than only the more favorable one, this is trial evidence that a low-fat vegan diet can meaningfully help glycemic control, reported as a result that needed a secondary adjustment to clear significance in its primary comparison, not a clean, uncomplicated win on the first analysis.",
    citations: [
  ...
  // not hold up at the same strength.
  {
    ...
    category: 'type2Diabetes',
    title: 'Acupuncture for Diabetic Nerve Pain',
    teaser:
