...
export const TYPE_2_DIABETES_ENTRIES: DigestEntry[] = [
  ...
  // independently verified via WebSearch.
  {
    ...
    teaser: 'A real, named, official pre-diagnosis category exists, detectable up to 20 real years before symptoms show up, and it\'s the single biggest real window the remission-trial evidence is aimed at.',
    summary: "T2D develops over a genuinely long real timeline (10-20 years), and the ADA formally recognizes a real, distinct pre-diagnosis stage: prediabetes, defined by real lab thresholds (fasting glucose 100-125 mg/dL, a 2-hour post-glucose-challenge reading of 140-199 mg/dL, or an A1C of 5.7-6.4%), none of which yet meets the real threshold for a full T2D diagnosis. This isn't a minor technicality: real research finds prediabetes detectable as early as 20 years before diabetes symptoms actually appear, and up to 60% of people with prediabetes progress to full T2D within 10 years without intervention. This real stage is exactly the window the remission-trial evidence (DiRECT, low-carbohydrate diet research) is most powerfully aimed at, since real, effective interventions genuinely can prevent that progression -- worth knowing directly that \"prediabetes\" isn't a soft, informal label, it's a real, formally screened-for stage with real, documented stakes attached to catching it early.",
    citations: [
