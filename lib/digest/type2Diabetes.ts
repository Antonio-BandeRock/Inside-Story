...
export const TYPE_2_DIABETES_ENTRIES: DigestEntry[] = [
  {
    ...
    summary: "Type 2 diabetes (T2D) typically begins with insulin resistance: cells throughout the body stop responding normally to insulin, so blood glucose stays elevated even while the pancreas is still producing insulin, often producing more of it than usual to compensate. Over extended time, this compensatory overproduction can wear down the pancreas's own insulin-producing cells, and blood sugar control worsens as that capacity declines. Major risk factors include being overweight or obese, physical inactivity, and genetic/family history, and T2D represents the large majority of all diabetes cases. This category sits at the center of a cluster of conditions already covered in depth, insulin resistance is the same core mechanism already documented for PCOS, the same liver-fat-storage driver already documented for MASLD, and T2D itself is one of the two most common causes of CKD, cross-linked throughout rather than re-explained. This category focuses on what's specific to T2D itself: its own remission evidence, its own distinction from Type 1 Diabetes, and a recent shift in how it's actually treated.",
    citations: [
  ...
  },
  {
    ...
    summary: "Type 1 and Type 2 diabetes share a name and a shared end result (elevated blood glucose), but the underlying disease is different, and Type 1 diabetes is already covered in its own dedicated category, worth knowing directly to avoid common confusion between the two. Type 1 is an autoimmune disease, the immune system directly destroys the pancreas's own insulin-producing cells, typically starting in childhood or young adulthood, and requires insulin from diagnosis onward since the body's own insulin production stops. Type 2 is a primarily metabolic disease (see this category's own overview entry), usually developing gradually in adulthood, strongly linked to insulin resistance rather than an autoimmune attack, and often manageable, at least initially, without insulin at all. A practical consequence of this difference: T2D's own onset typically predates its actual diagnosis by years, since insulin resistance develops gradually and symptoms can be mild or absent early on, a reason this category's own screening entry recommends starting complication screening immediately at diagnosis rather than waiting, unlike T1D's own more identifiable onset.",
    citations: [
      { source: 'Type 2 Diabetes, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/diabetestype2.html' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary: "Current American Diabetes Association guidelines represent a recent paradigm shift in how T2D itself gets treated: GLP-1 receptor agonists and SGLT2 inhibitors are now recommended as first-line pharmacotherapy for many patients, especially those with established heart disease, heart failure, or chronic kidney disease, specifically because of their own independent organ-protective benefits, not primarily because of how well they lower blood glucose. Current guidance recommends SGLT2 inhibitors for T2D patients with an eGFR of 20 mL/min/1.73m² or higher specifically because they slow CKD progression and reduce heart-failure risk through a separate mechanism from glucose control, already covered directly in the dedicated CKD and MASLD research. The evidence behind this shift is substantial: cardiovascular- and kidney-outcome trials found 12% to 39% risk reductions in major adverse events with these two medication classes over 2 to 5 years. Worth knowing directly: metformin is no longer automatically the default first medication for everyone with T2D the way it once was, current treatment now depends more on which organs are already at risk than on blood glucose numbers alone.",
    citations: [
  ...
  },
  {
    ...
    teaser: "T1D's own screening waits five years for a reason. T2D can't afford to wait that long, and the reason why is worth understanding directly.",
    summary: "The T1D research already covers standard screening intervals for retinopathy and nephropathy that begin five years after diagnosis. T2D's own current guidance is different, and deliberately so: screening for both retinopathy (an eye exam) and nephropathy (a urine test for microalbuminuria) should begin at the moment of T2D diagnosis itself, not five years later. The reason traces directly back to this category's own T1D-vs-T2D distinction entry: because T2D's own actual biological onset reliably predates its diagnosis by an unknown, often substantial number of years (insulin resistance develops quietly, with symptoms often mild or absent early on), research finds roughly 3% of people newly diagnosed with T2D already have overt nephropathy at the moment of diagnosis itself. Waiting five years the way T1D's own protocol does would mean missing already-present damage in a meaningful share of newly diagnosed patients. Worth knowing directly and asking about explicitly at a first T2D diagnosis visit, since this immediate screening is different from what a friend or family member with T1D may have been told.",
    citations: [
  ...
  // independently verified via WebSearch.
  {
    ...
    summary: "T2D develops over a long timeline (10-20 years), and the ADA formally recognizes a distinct pre-diagnosis stage: prediabetes, defined by lab thresholds (fasting glucose 100-125 mg/dL, a 2-hour post-glucose-challenge reading of 140-199 mg/dL, or an A1C of 5.7-6.4%), none of which yet meets the threshold for a full T2D diagnosis. This isn't a minor technicality: research finds prediabetes detectable as early as 20 years before diabetes symptoms actually appear, and up to 60% of people with prediabetes progress to full T2D within 10 years without intervention. This stage is exactly the window the remission-trial evidence (DiRECT, low-carbohydrate diet research) is most powerfully aimed at, since effective interventions can prevent that progression, worth knowing directly that \"prediabetes\" isn't a soft, informal label, it's a formally screened-for stage with documented stakes attached to catching it early.",
    citations: [
  ...
  // citation independently verified via WebSearch.
  {
    ...
    summary: "Bariatric (weight-loss) surgery carries substantially stronger remission evidence for type 2 diabetes than lifestyle intervention alone, worth knowing alongside the DiRECT lifestyle-trial remission data already covered in the research. A randomized trial comparing Roux-en-Y gastric bypass (RYGB), laparoscopic adjustable gastric banding (LAGB), and intensive lifestyle intervention found any diabetes remission (partial or complete) at 3 years in 40% of RYGB patients and 29% of LAGB patients, compared to literal 0% in the lifestyle-only group. A 5-year follow-up of a separate trial found bariatric surgery patients achieving better long-term blood glucose control than medical management plus lifestyle changes, with benefit documented as far out as 12 years. Striking: research found 65% of RYGB patients went from needing insulin or oral medication at baseline to needing NO diabetes medication at all by year 3, versus none in the lifestyle-only group. Worth knowing honestly: this is quantified evidence favoring surgery for appropriate candidates, not a claim that surgery is risk-free or right for everyone, it carries its own surgical risks and requires lifelong nutritional monitoring (already covered elsewhere in the bariatric-adjacent nutrient research). Worth knowing directly: this is a concrete, evidence-backed option worth discussing directly with an endocrinologist for anyone with obesity and type 2 diabetes who hasn't achieved lasting control through lifestyle measures alone.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Current international consensus defines remission as HbA1c under 6.5% for at least 3 months with zero glucose-lowering medication, a specific, testable definition worth knowing exactly, not a vague sense of "doing better."',
    summary: "Type 2 diabetes remission, already covered through trial data elsewhere in the research (the DiRECT lifestyle trial, bariatric surgery outcomes), has a specific, formal definition worth knowing precisely, since \"remission\" means something exact, not a general feeling of improvement. Current international consensus (a 2021 ADA-convened expert group) defines remission as an HbA1c under 6.5% (48 mmol/mol), measured at least 3 months after stopping all glucose-lowering medication. Alternative criteria exist for when HbA1c itself isn't a reliable marker: fasting plasma glucose under 126 mg/dL, or an estimated HbA1c calculated from continuous glucose monitor data, both valid substitutes. Guidance specifies exact testing timing too, the confirming test should happen no sooner than 3 months after stopping medication, with yearly retesting recommended afterward to confirm the remission is actually holding. Worth knowing directly, and useful historical context: an earlier, 2009 framework used three tiers, \"partial\" remission (sub-diabetic glucose levels for at least 1 year off medication), \"complete\" remission (fully normal glucose for 1 year off medication), and \"prolonged\" remission (complete remission sustained 5 or more years). Worth knowing directly: this specific, testable definition matters because it sets an objective bar, someone who's simply on fewer medications, or whose HbA1c has improved while still on medication, hasn't technically achieved remission by this formal standard, worth understanding clearly before assuming a personal treatment goal has already been met.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Research finds statin use tied to a measurable increased risk of developing type 2 diabetes, roughly one extra case per 100-200 people treated over 5 years, a tradeoff worth understanding honestly, not a reason to avoid them.',
    summary: "Statins, already covered elsewhere in the cardiovascular research for their strong mortality benefit, carry an honest complication worth knowing directly: they modestly raise the risk of developing type 2 diabetes. Research finds moderate-intensity statins increasing diabetes risk by roughly 11%, with a further 12% increase at high-intensity dosing, and one major cohort study found a 46% increased relative risk with statin treatment specifically. Proposed mechanisms include statins pushing someone already close to the diabetes threshold over it slightly earlier than they otherwise would have crossed it, along with direct effects on insulin sensitivity and insulin secretion, and a speculative link to statin-induced mitochondrial dysfunction in skeletal muscle contributing to insulin resistance. Worth knowing honestly and in practical proportion: research translates this into roughly one additional diabetes case per 100 to 200 people treated with statins over 5 years, a small absolute number set against roughly ten times greater benefit on major cardiovascular outcomes (heart attacks, strokes, and deaths prevented) over that same period. Worth knowing directly: this is honest context, not a reason to avoid a beneficial medication, someone already at elevated diabetes risk starting a statin has an evidence-backed reason for slightly closer blood-sugar monitoring going forward, not a reason to skip a medication with much larger cardiovascular benefit.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Obstructive sleep apnea and type 2 diabetes are commonly co-occurring conditions, and research has directly tested whether treating the sleep apnea (with CPAP, continuous positive airway pressure) improves the diabetes itself, with a mixed, honest answer worth knowing plainly rather than assumed settled either way. One controlled trial (50 patients) found CPAP treatment produced a statistically significant improvement in glycemic control and insulin resistance compared with standard care. A later trial (the Diabetes Sleep Treatment Trial) found significant HbA1c improvement at 6 weeks that didn't hold up as a sustained difference by the trial's own primary, intention-to-treat analysis. Worth knowing honestly: a pooled meta-analysis of 6 randomized trials and 581 total participants found no significant overall effect on HbA1c at either 12 or 24 weeks, a more sobering conclusion once the individual, more encouraging trials are combined. One consistent thread across this mixed picture: research found CPAP adherence itself tracked with greater glycemic improvement, suggesting the practical barrier (many people struggle to use CPAP consistently every night) may be diluting an effect that's there for people who use it well. Worth knowing directly: treating sleep apnea remains worthwhile care in its own right (blood pressure, cardiovascular risk, daytime function), just not, based on current pooled evidence, a reliably diabetes-improving intervention on its own.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "This category's own already-covered research (remission, GLP-1/SGLT2 medications, individualized HbA1c targets) draws mostly on adult-onset T2D, the far more common presentation. Long-term data finds youth-onset T2D a different, more aggressive disease, not simply the same condition starting earlier. The landmark TODAY study and its long-term TODAY2 follow-up found insulin-producing beta-cell function declining faster in youth than in adults, and metformin alone, this category's own often-first medication, provided durable glycemic control in only about half of young participants. 15-year follow-up data found 60% of participants had developed at least one diabetes-related complication, and nearly a third had two or more, at an average age of just 26, high blood pressure in 67%, kidney disease in nearly 55%, eye disease in 51%, and nerve disease in 32%. Research found the rate of heart, vascular, and stroke-related events three times higher than in a comparison study of older adults with a longer disease duration, a striking reversal of the usual assumption that more years with diabetes means more complications. Worth knowing directly: a young person diagnosed with T2D deserves more assertive, more closely-monitored treatment from the start, not a wait-and-see approach based on how the disease usually behaves in adults, since evidence finds it usually doesn't behave the same way at all.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered Nauru research shows the highest per-capita rate; China and India instead show the largest absolute number of people affected, over 140 million and nearly 90 million respectively.",
    summary:
      "This category's own already-covered Nauru entry tells a per-capita story, roughly half of one small island's population affected. China and India tell a different kind of story: sheer scale. IDF Diabetes Atlas data finds China carrying the world's largest absolute number of people with diabetes, over 140 million in 2021, projected to exceed 174 million by 2045, with India close behind at nearly 90 million adults, accounting for roughly 1 in every 7 adults with diabetes worldwide. A further complication: over half of everyone with UNDIAGNOSED diabetes globally lives in just three countries, China, India, and Indonesia, meaning the true scale in these countries is likely even larger than the already-enormous confirmed numbers. Projections show India's own diabetes population rising a further 75% by 2050. Worth knowing directly: this is a different, complementary statistic to Nauru's own per-capita story, rather than one country having the 'worst' diabetes problem, global diabetes burden concentrates differently depending on whether the question is which population is proportionally hit hardest (Nauru, the Pacific Islands) or where the largest absolute number of affected people actually live (China, India), both true, and worth knowing for a global picture of this disease.",
    chart: {
  ...
  },
  {
    ...
    teaser: "This category's own already-covered GLP-1/SGLT2 paradigm shift is already moving toward a third hormone target, a single drug now activating GIP, GLP-1, AND glucagon receptors together, with a 22,000-plus-participant trial program underway.",
    summary:
      "This category's own already-covered paradigm shift toward GLP-1 and SGLT2 medications is already advancing toward a further step. Retatrutide is an investigational drug activating three separate hormone receptors at once (GIP, GLP-1, and glucagon), rather than the one or two most current medications target. Its first Phase 3 trial (TRANSCEND-T2D-1) met both its primary and key secondary endpoints, delivering superior blood-sugar reduction and weight loss compared with placebo at 40 weeks, part of a large program spanning 14 trials and more than 22,000 participants. Separately, and still much earlier-stage, research continues investigating whether the body's own insulin-producing beta cells can be coaxed into regeneration, through cell proliferation, converting other pancreatic cell types into functional beta cells, or reprogramming precursor cells directly, active laboratory research rather than anything close to patient use yet. Worth knowing directly: the field's own current direction is less about finding one single new drug and more about combining an increasing number of distinct hormone-signaling pathways into single medications, extending the same core strategy already proven with existing GLP-1 and SGLT2 treatments.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "This category's own already-covered microvascular and nerve-damage complications (eye, kidney, foot) reach the same vascular and neural pathways as another, less commonly discussed one: hearing. Pooled data finds hearing loss prevalence in type 2 diabetes ranging from 40.6 to 71.9 percent across studies, and a direct comparison found clinically significant hearing loss in 53.0 percent of diabetic patients versus 25.2 percent of matched controls, a more than two-fold relative risk. The most common type found is sensorineural hearing loss (46.2 percent of cases), the same category of hearing damage caused by inner-ear or auditory-nerve injury, consistent with a direct link to this category's own already-covered neuropathy research: one study found the hearing loss specifically associated with diabetic neuropathy rather than diabetes alone. Identified risk factors mirror this category's own already-covered complication-screening research directly: hearing loss prevalence was significantly higher in people with diabetes duration over 10 years, and both disease duration and HbA1c level (already covered elsewhere in this category as the central control marker) independently predicted it. Worth stating directly: hearing loss isn't part of standard diabetes complication screening the way eye and kidney checks already are, reason to mention any hearing changes directly to a doctor rather than assume they're simply an unrelated, ordinary part of aging.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered DiRECT trial shows dietary remission evidence, a 10-year surgical follow-up found roughly half of gastric bypass patients still in remission a full decade out, with diabetes duration at the time of surgery the strongest predictor of whether it lasts.",
    summary:
      "This category's own already-covered DiRECT trial found substantial diabetes remission through structured dietary weight loss, and long-term surgical data gives a different, more durable comparison point. A Roux-en-Y gastric bypass cohort found remission rates of 74 percent at 1 year, dropping to a 53 percent still in remission at 10 years, roughly half of patients maintaining it for a full decade. The single strongest predictor of lasting remission: how long someone had diabetes before surgery. Patients with a shorter diabetes duration (under 4 years) maintained remission in about 80 percent of cases at 10 years, while a separate cohort study of patients with 10 or more years of diabetes duration found remission rates declining roughly 10 percentage points per year after surgery, from 65.6 percent at year one down to 41.9 percent by year three. Worth stating directly, and consistent with this category's own already-covered window-of-opportunity-style reasoning elsewhere in this Digest: evidence points toward earlier surgical intervention, while glycemic control is still relatively good, producing meaningfully more durable results than waiting until diabetes has been established for a decade or more, concrete reason timing itself is a part of this decision, not just whether to have the surgery at all.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered sleep-apnea/CPAP entry names an honestly mixed treatment picture, direct data finds sleep duration and quality THEMSELVES, apart from apnea specifically, carrying a striking, independent effect on glycemic control.",
    summary: "This category's own already-covered sleep-apnea research finds treating apnea itself producing a mixed benefit for blood sugar control, and separate research finds sleep duration and quality carry their own, independent, effect worth covering directly. Direct clinical data found people with T2D sleeping fewer than 6 hours a night had 8.3 times higher odds of poor glycemic control compared with those getting adequate sleep, and poor sleep quality itself (regardless of duration) carried a 3.3 times higher odds of poor control. Research names a plausible, direct mechanism: sleep disturbance is associated with measurable increases in circulating cortisol, sympathetic nervous system activity, and epinephrine, each already directly implicated elsewhere in the inflammation and glucose-metabolism research, not a vague, general wellness claim. A separate meta-analysis of sleep characteristics and diabetes risk more broadly confirms both short and long sleep duration, not just short sleep, tracking with elevated risk, a U-shaped relationship. Worth stating directly: this is actionable information independent of whether sleep apnea is present at all, someone with T2D and consistently poor sleep, for any reason, has an evidence-backed reason to address sleep directly as part of glucose management, not treat it as separate from or secondary to diet and medication.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered microvascular-screening research names established complication targets, a pooled meta-analysis of 36 studies (9,220 pancreatic cancer patients) finds a doubled cancer risk too, with an important twist about WHEN that risk shows up.",
    summary:
      "This category's own already-covered complication-screening research names established microvascular and cardiovascular targets, and pancreatic cancer deserves its own direct, honestly nuanced coverage. A large meta-analysis of 36 studies (9,220 people with pancreatic cancer) found a summary odds ratio of 1.82, roughly an 82 percent higher risk of pancreatic cancer associated with type 2 diabetes. The important, honest wrinkle: this risk isn't uniform over time. People whose diabetes had only recently been diagnosed (less than 4 years) had a significantly HIGHER risk than people with longer-standing diabetes (5 or more years), a quantified 2.1 versus 1.5 odds ratio. Worth stating directly, since this changes how the finding should actually be read: this timing pattern is strong evidence for REVERSE causation playing a role, an early, undetected pancreatic tumor can itself disrupt blood sugar regulation and cause diabetes to appear, rather than diabetes alone directly causing the cancer in every case. The researchers themselves, after accounting for this, still concluded the data supports a real, if modest, causal contribution from diabetes itself, not purely a reverse-causation artifact. Worth stating directly: this honest, two-part finding is exactly why a NEW diabetes diagnosis, especially later in life with no strong family or lifestyle risk factors, is sometimes worth a closer look rather than assumed to be routine T2D, a useful, non-alarmist piece of information worth knowing rather than avoiding out of caution.",
    citations: [
