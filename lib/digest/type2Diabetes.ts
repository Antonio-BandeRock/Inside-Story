...
export const TYPE_2_DIABETES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'This category\'s already-covered GLP-1/SGLT2 shift gets real-world confirmation: large cohort studies find GLP-1 agonists tracking with fewer heart attacks, strokes, and deaths compared to older diabetes drugs, not just controlled-trial results.',
    summary:
  ...
  },
  {
    ...
    teaser: "This category's already-covered sleep-apnea/CPAP entry names a mixed treatment picture, direct data finds sleep duration and quality THEMSELVES, apart from apnea specifically, carrying a striking, independent effect on glycemic control.",
  ...
  },
  {
    ...
    teaser: "This category's already-covered cognitive-decline research names hippocampal volume loss and impaired memory, mouse models of T2D found the actual new-neuron-production process itself measurably reduced, with a hopeful twist involving a medication already in wide use.",
    summary:
      "This category's already-covered cognitive research establishes that T2D tracks with smaller hippocampal volume and measurable memory impairment, and a specific mechanism helps explain why: hippocampal neurogenesis itself, the ongoing production of new neurons in that same brain region, is measurably reduced in mouse models of type 2 diabetes, both in obesity-driven and non-obesity-driven versions of the disease, meaning this isn't purely a byproduct of excess weight. A separate study found the mechanism runs at least partly through the adrenal stress hormone corticosterone (the rodent equivalent of human cortisol), diabetes measurably impaired hippocampal memory function, synaptic plasticity, and new-neuron production together, and elevated glucocorticoid levels contributed directly to these effects. The hopeful, practical twist: metformin, already one of the most widely prescribed T2D medications and already covered elsewhere in this app's medication research, appears to work in the opposite direction, research found it activates a specific cellular signaling pathway that promotes neural progenitor cell differentiation and measurably enhances spatial memory formation in mice, a concrete example of a medication doing more for the brain than simply lowering blood sugar.",
    citations: [
  ...
  // verified via WebSearch.
  {
    ...
    overallTier: 'moderate',
    stageNote: 'A randomized trial with a statistical wrinkle: the primary between-group comparison did not reach standard significance, only a secondary analysis excluding those who changed medications did.',
