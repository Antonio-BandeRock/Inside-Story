...
export const NEUROGENESIS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Line up everything in this topic and a useful, honestly-scoped picture emerges. Adult neurogenesis is a real, directly demonstrated phenomenon, concentrated specifically in the hippocampus's dentate gyrus, not a myth, but the exact scale of how much persists into old age remains an unresolved scientific disagreement, not settled either way. BDNF is the real molecular thread connecting nearly everything else in this topic together: exercise raises it and supports new-neuron survival with the strongest, most repeated human evidence of any single lever covered here; chronic stress and elevated cortisol work directly against it, with real, human-cell-level evidence that omega-3 fatty acids specifically protect against that damage; sleep's effect depends on duration, chronic sleep loss suppresses it through a pathway separate from stress hormones entirely, while brief sleep loss shows a more mixed picture. The neurogenic hypothesis of depression ties this whole topic directly into everyday mental health, real, causal-style evidence suggests neurogenesis itself may be required for at least some antidepressant medications to work, though this remains a contested, active research question rather than settled fact. Where this topic connects to a specific, real, well-documented health condition rather than universal physiology, that connection lives in its dedicated entry in that condition's category instead, Hashimoto's, Type 2 Diabetes, Cardiovascular Disease, Multiple Sclerosis, and Inflammatory Bowel Disease each earned one on the evidence; most of the other tracked conditions did not, and this topic deliberately doesn't force a connection where the real evidence doesn't support one.",
    citations: [],
    overallTier: 'strong',
    relatedIds: [
