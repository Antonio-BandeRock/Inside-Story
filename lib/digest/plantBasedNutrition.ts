...
export const PLANT_BASED_NUTRITION_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Caldwell Esselstyn's long-running case series enrolled 18 patients with severe, angiographically-confirmed coronary artery disease, most of whom had been told by their doctors that little more could be done. In the 8 years before joining the study, this same group of patients had collectively experienced 49 cardiovascular events between them. Esselstyn placed them on a strict, fat-restricted, whole-food, plant-based diet and tracked them for over a decade, publishing updates at 5, 12, and beyond 20 years. Average cholesterol fell by roughly half, disease progression halted in every participant who stayed on the diet, and repeat angiography documented actual measured reversal of blockages in several of them. This is long-term data, and it's also a fundamentally different kind of evidence than the Ornish trial above: there was no control group, no randomization, and the 18 participants were a small, self-selected group of people motivated enough to sustain a very strict diet for years, meaning it's not possible to fully separate the diet's effect from the characteristics of the people willing and able to follow it that strictly. Worth holding both things at once: this is a striking, long-term result in a group nothing else had worked for, and it's a design that can't, on its own, prove the diet caused the outcome the way a randomized trial can.",
    citations: [
