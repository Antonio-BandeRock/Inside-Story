...
export const HORMONES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Leptin's reach goes past hunger: it also signals to the hypothalamic-pituitary-gonadal axis, the hormonal chain that governs puberty, ovulation, and menstrual cycling. Hypothalamic amenorrhea, when periods stop from very low body fat or energy availability (seen in some athletes and in low-calorie dieting), tracks closely with low leptin levels. A small trial (8 women) tested giving these women recombinant leptin directly and found measurable improvement in reproductive hormone levels and ovarian function within weeks. This is the same hormone covered above, and it means body fat isn't only a metabolic-health question, it's directly tied to fertility signaling too, relevant for anyone whose periods have become irregular alongside a significant, sustained drop in body fat or calorie intake.",
    citations: [
