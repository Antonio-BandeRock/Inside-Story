...
export const HISTORY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "The already-covered gut-microbiome research finds real, specific bacterial differences in Hashimoto's patients, including a real, documented enrichment of Bacteroides fragilis. The genuinely new, current step: an active real clinical trial (part of a real, broader research effort including a study named IMITHOT) is directly testing fecal microbiota transplantation, transferring a healthy donor's own gut bacteria into a Hashimoto's patient, to see whether reshaping the gut microbiome itself can measurably improve immune function and metabolic control. One real, currently active trial is studying this specifically in adults who have both Type 2 diabetes and Hashimoto's thyroiditis together, testing FMT's effect on both conditions at once. The real, proposed mechanism runs through pathways the research has already covered elsewhere: improving microbial diversity, shifting microbial metabolite production, and calming the same real intestinal-barrier dysfunction and low-grade inflammation already tied to autoimmune thyroid disease. Worth knowing directly and honestly: real research in this specific area is still described by the field itself as preclinical or early-clinical, this is a genuinely active, real research direction testing a real hypothesis, not yet a validated treatment.",
    citations: [
