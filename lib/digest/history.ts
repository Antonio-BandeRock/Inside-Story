...
// History & Milestones -- 9 entries, added 2026-08-07 direct response to "a
...
// narrative by nature (real, dated events); the rewrite adds real
// scene-setting and stakes to each entry rather than restructuring the
// underlying facts, which are unchanged from the original pass.
export const HISTORY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      'In the early 1920s, a visible band of American states around the Great Lakes -- Michigan, Minnesota, and Wisconsin among them -- had earned a real, grim nickname: the "goiter belt." Real public-health surveys found goiter, a visibly enlarged thyroid driven by iodine deficiency, in 70 to 100 percent of schoolchildren in parts of the region. Physician David Cowie, having studied European iodization practices already underway elsewhere, proposed a simple fix: add iodine to table salt. On May 1, 1924, Michigan salt manufacturers voluntarily began doing exactly that, with no law requiring it at all. A 1935 follow-up survey found enlarged-thyroid rates had dropped by as much as 90 percent in the years since. Real, direct historical proof that a simple, food-based intervention could measurably prevent a real thyroid disease at population scale -- and, in a real twist this app\'s own research keeps returning to, foundational to, but genuinely distinct from, the very different iodine-excess concerns Hashimoto\'s research raises today.',
    citations: [
  ...
  },
  {
    ...
    teaser: 'Before this era, there was no real blood test that could reliably tell anyone their own thyroid status.',
    summary:
      "It's easy to take a routine thyroid blood test for granted. For most of medical history, no such test existed at all. The first TSH radioimmunoassay -- a technique using radioactive tracers to measure a hormone's concentration -- originated in 1965, and for roughly two decades that was the single most important tool available for diagnosing and managing hypothyroidism. But this first generation could only reliably detect TSH at fairly high concentrations, missing the more subtle elevations seen in real early or subclinical disease. The real leap came with monoclonal antibody technology in the mid-1970s, enabling a \"sandwich\" assay design by the late 1980s that was dramatically more sensitive and specific -- the direct ancestor of the ordinary TSH blood test used today. This is the actual reason a diagnosis of subclinical hypothyroidism -- elevated TSH with still-normal T4 -- is even possible to make at all; the diagnostic category itself couldn't exist until a test sensitive enough to detect it did.",
    citations: [
  ...
  },
  {
    ...
    summary:
      'For years after the 1956 autoimmune-mechanism discovery, researchers knew Hashimoto\'s patients carried real antibodies against something inside the thyroid\'s own "microsomal" cell fraction -- but nobody yet knew exactly what that target actually was. In 1985, researchers demonstrated that this "microsomal antigen" was in fact thyroid peroxidase, TPO -- the very enzyme responsible for making thyroid hormone in the first place. That meant the immune system was attacking the thyroid\'s own hormone-production machinery directly, not some incidental bystander protein sitting nearby. This is the direct scientific origin of the modern TPO antibody blood test -- the same lab value this app\'s own Healing Stages research uses as its real, primary tracking signal, resting on a foundation laid nearly forty years before this app ever existed.',
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "It's a strange thing to picture now, but for most of the 20th century, treating an underactive thyroid meant taking a pill made from an actual, dried animal gland. Real thyroid organ therapy dates back to 1891, using desiccated (dried, ground) thyroid extract from pig or cow glands -- and this remained the dominant treatment for over 70 years, with roughly 80 percent of US thyroid prescriptions still being natural desiccated thyroid as late as 1965. The real problem driving the eventual shift to synthetic levothyroxine: batch-to-batch potency in natural extract genuinely varied enormously, with some real batches measured at anywhere from double to zero detectable hormone activity -- a serious, documented dosing-consistency problem, not a theoretical one. Levothyroxine's synthetic, precisely-measurable dosing and simpler once-daily use made it the standard of care by the 1970s, and it remains the single most-prescribed medication in the US today. Natural desiccated thyroid is still prescribed for a real minority of patients who report better symptom control on it despite normalized lab values -- a real, still-open thread in thyroid treatment, not fully settled even now.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'The first real genome-wide search for Hashimoto\'s-specific genes only happened in 2018 -- more recently than most people would guess.',
    summary:
      "Long before genome-wide studies were technically possible, researchers already suspected Hashimoto's ran in families, and linked it to specific immune-regulation genes, particularly CTLA-4 -- a gene that normally helps put the brakes on immune-cell activation. The first real genome-wide association study (GWAS) dedicated specifically to Hashimoto's thyroiditis wasn't published until 2018, identifying real new candidate genetic regions beyond what earlier candidate-gene studies alone had found. A real, honest limitation worth naming directly: even combining every genetic association discovered so far, known genetic variants explain only a modest share of who actually develops Hashimoto's. Real, continuing evidence that environmental and dietary factors -- this app's own core focus -- matter alongside genetic susceptibility, not instead of it; genetics may load the gun, in the old phrase, but they clearly aren't pulling the trigger alone.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The potency problem that helped push doctors toward synthetic thyroxine had a real fix -- it just arrived too late to matter.",
    summary:
      "The desiccated-thyroid story above has a real postscript that rarely makes it into the shorter version of this history. The same real potency-variability problem that helped drive levothyroxine's rise actually had a genuine partial fix: after 1985, natural desiccated thyroid manufacturing standardization measurably improved. But by that point, levothyroxine's own real practical advantages -- once-daily dosing, precise, easily-adjustable milligram-level dosing, and a growing base of real clinical-trial evidence -- had already made it the entrenched standard of care. Worth knowing as real historical context rather than a settled verdict either way: today's desiccated-thyroid products are genuinely more consistent than their pre-1985 predecessors, even though that real improvement came after the field had already largely moved on.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Read start to finish, this isn't just a list of dates -- it's a real record of how much of what this whole app relies on had to be discovered, piece by piece, before it could exist at all. The disease had to be described (1912) before it could be studied. Autoimmunity itself had to be proven real (1956) before Hashimoto's could be understood as more than a medical mystery. A genuinely sensitive lab test had to be invented across two real technological leaps (the 1960s radioimmunoassay, the 1970s-80s monoclonal-antibody sandwich assay) before \"subclinical\" disease could even be diagnosed at all. And the actual antigen had to be identified (1985) before a TPO antibody test -- the same lab value this app's own Healing Stages tracking leans on today -- could exist in the first place. Even treatment itself took nearly a century to settle: 70-plus years of inconsistent desiccated animal thyroid before synthetic levothyroxine's own precision finally won out in the 1970s. The honest closing note: genetics research remains real but limited -- known variants explain only a modest share of who develops Hashimoto's -- which is itself part of why environmental and dietary factors, this app's own core focus, matter as much as they do.",
    citations: [
      { source: 'Autoimmune thyroid disease -- a review discussing the 1956 discovery and its significance', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC7266799/' },
    ],
    overallTier: 'strong',
