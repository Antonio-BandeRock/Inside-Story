...
export const HISTORY_ENTRIES: DigestEntry[] = [
  {
    ...
    category: 'hashimotos',
    title: '1912, Hakaru Hashimoto Described the Disease From Four Surgical Specimens',
    teaser: 'A disease now affecting millions was first noticed by one surgeon, looking closely at tissue from just four people.',
    summary: "Somewhere in a Japanese hospital in the early 1910s, a surgeon named Hakaru Hashimoto sat down with thyroid tissue removed from four separate patients during surgery, unremarkable, routine surgical specimens by any reasonable expectation. What he found in that tissue wasn't routine at all: diffuse infiltration of lymphoid cells forming lymphoid follicles with germinal centers, alongside fibrosis and tissue atrophy, a pattern nobody had described before. He published these findings in 1912, in a German surgical journal (German being the dominant language of medical publishing at the time), under the Latin name struma lymphomatosa. His work sat largely unrecognized for decades afterward. The condition wasn't even renamed in his honor until much later, once the broader medical community finally recognized what he'd actually found: not a rare surgical curiosity, but the first clearly described case of a disease that would go on to affect millions of people worldwide. A reminder that everything else in the research traces back to one person, looking closely at four specimens, and refusing to assume what he was seeing was nothing.",
    citations: [
      {
  ...
  },
  {
    ...
    summary: 'In the early 1920s, a visible band of American states around the Great Lakes, Michigan, Minnesota, and Wisconsin among them, had earned a grim nickname: the "goiter belt." Public-health surveys found goiter, a visibly enlarged thyroid driven by iodine deficiency, in 70 to 100 percent of schoolchildren in parts of the region. Physician David Cowie, having studied European iodization practices already underway elsewhere, proposed a simple fix: add iodine to table salt. On May 1, 1924, Michigan salt manufacturers voluntarily began doing exactly that, with no law requiring it at all. A 1935 follow-up survey found enlarged-thyroid rates had dropped by as much as 90 percent in the years since. Direct historical proof that a simple, food-based intervention could measurably prevent a thyroid disease at population scale, and foundational to, but distinct from, the very different iodine-excess concerns Hashimoto\'s research raises today, a thread the research keeps returning to.',
    citations: [
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'The 1960s Brought the First Reliable Blood Test for Thyroid Status',
    teaser: 'Before this era, there was no reliable blood test that could tell anyone their thyroid status.',
    summary:
      "It's easy to take a routine thyroid blood test for granted. For most of medical history, no such test existed at all. The first TSH radioimmunoassay, a technique using radioactive tracers to measure a hormone's concentration, originated in 1965, and for roughly two decades that was the single most important tool available for diagnosing and managing hypothyroidism. But this first generation could only reliably detect TSH at fairly high concentrations, missing the more subtle elevations seen in early or subclinical disease. The leap came with monoclonal antibody technology in the mid-1970s, enabling a \"sandwich\" assay design by the late 1980s that was dramatically more sensitive and specific, the direct ancestor of the ordinary TSH blood test used today. This is the actual reason a diagnosis of subclinical hypothyroidism (elevated TSH with still-normal T4) is even possible to make at all. The diagnostic category itself couldn't exist until a test sensitive enough to detect it did.",
    citations: [
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: '1985, the Microsomal Antibody Was Identified as Thyroid Peroxidase',
    teaser: 'The antibody behind the standard Hashimoto\'s blood test wasn\'t even known by that name until 1985.',
    summary: 'For years after the 1956 autoimmune-mechanism discovery, researchers knew Hashimoto\'s patients carried antibodies against something inside the thyroid\'s own "microsomal" cell fraction, but nobody yet knew exactly what that target actually was. In 1985, researchers demonstrated that this "microsomal antigen" was in fact thyroid peroxidase, TPO, the very enzyme responsible for making thyroid hormone in the first place. That meant the immune system was attacking the thyroid\'s hormone-production machinery directly, not some incidental bystander protein sitting nearby. This is the direct scientific origin of the modern TPO antibody blood test, the same lab value the Healing Stages research uses as its primary tracking signal, resting on a foundation laid nearly forty years earlier.',
    citations: [
      {
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'Thyroid Treatment Went From Dried Animal Gland to a Precisely Dosed Pill',
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'The Genetic Era: Susceptibility Genes, Limits to What They Explain',
  ...
  },
  {
    ...
    summary:
      "The desiccated-thyroid story above has a postscript that rarely makes it into the shorter version of this history. The same potency-variability problem that helped drive levothyroxine's rise actually had a partial fix: after 1985, natural desiccated thyroid manufacturing standardization measurably improved. But by that point, levothyroxine's practical advantages (once-daily dosing, precise, easily-adjustable milligram-level dosing, and a growing base of clinical-trial evidence) had already made it the entrenched standard of care. As historical context, not a settled verdict either way: today's desiccated-thyroid products are more consistent than their pre-1985 predecessors, even though that improvement came after the field had already largely moved on.",
    citations: [
  ...
  },
  {
    ...
    summary: "\"My antibodies are positive but my TSH is still normal, how worried should I actually be?\" is a common question the antibody-tracking research keeps circling without ever giving a hard number. The answer traces back to one of epidemiology's landmark studies: the Whickham Survey, a cohort of 2,779 adults first surveyed in the 1970s and followed up 20 years later. The baseline rate of new spontaneous hypothyroidism in women overall was modest, roughly 3.5 to 4.1 cases per 1,000 women per year. The striking finding sits in the risk-stratified numbers: women with both an elevated TSH and positive thyroid antibodies at the start had 38 times higher odds of developing overt hypothyroidism than women with neither, a quantified answer to exactly the anxious question above, not a vague \"it depends.\" That's a different situation from either risk factor alone (each independently carried about an 8-fold higher odds on its own). The combined risk is substantially more than either one by itself. A positive antibody result alongside even a mildly elevated TSH is meaningful information about future risk, which is exactly why the Self Advocacy category recommends periodic, not one-time, monitoring of both together.",
    citations: [
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'What This History Actually Teaches',
    teaser: 'From "the body cannot attack itself" to a genome-wide search for the genes that let it, an arc, not just a list of dates.',
    summary: "Read start to finish, this isn't just a list of dates. It's a record of how much of today's Hashimoto's diagnosis and treatment had to be discovered, piece by piece, before any of it could exist at all. The disease had to be described (1912) before it could be studied. Autoimmunity itself had to be proven (1956) before Hashimoto's could be understood as more than a medical mystery. A sensitive lab test had to be invented across two technological leaps (the 1960s radioimmunoassay, the 1970s-80s monoclonal-antibody sandwich assay) before \"subclinical\" disease could even be diagnosed at all. And the actual antigen had to be identified (1985) before a TPO antibody test, the same lab value the Healing Stages tracking leans on today, could exist in the first place. Even treatment itself took nearly a century to settle: 70-plus years of inconsistent desiccated animal thyroid before synthetic levothyroxine's precision finally won out in the 1970s. The closing note: genetics research remains limited. Known variants explain only a modest share of who develops Hashimoto's, which is itself part of why environmental and dietary factors, the core focus, matter as much as they do.",
    citations: [
      { source: 'Autoimmune thyroid disease: a review discussing the 1956 discovery and its significance', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC7266799/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: "What's Next for Hashimoto's: Early Research Into Actually Calming the Immune Attack, Not Just Replacing Hormone",
    teaser: 'Every current Hashimoto\'s treatment replaces lost thyroid hormone rather than addressing the immune attack itself. Early-phase research into stem-cell therapy is trying to change that, though it remains experimental.',
    summary:
      "Every current Hashimoto's treatment, levothyroxine included, replaces the hormone the damaged thyroid can no longer make; none of them address the underlying autoimmune attack itself. Where the field is actively looking for something more: mesenchymal stem cell (MSC) therapy, an early-stage research direction using cells with documented anti-inflammatory and immune-modulating properties. Preclinical studies (animal models and human cells in the lab, not yet patients) have found MSCs reducing thyroid inflammation and, in mechanistic work, calming a specific inflammatory signaling pathway (STING) already tied to oxidative stress in Hashimoto's thyroid tissue. Early-phase human clinical trials are underway, but this remains early-stage research, not an available treatment, and the field itself names unresolved challenges directly: immune rejection risk, regulatory hurdles, and cost. Where medicine currently stands, no approved therapy yet targets the autoimmune process in Hashimoto's directly, current care manages the consequence (low thyroid hormone) rather than the cause, and stem-cell research is one of the more active, if still distant, attempts to change that.",
    citations: [
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: "Active Trials Are Now Directly Testing Whether Transplanting Gut Bacteria Can Treat Hashimoto's Itself",
    teaser: 'Fecal microbiota transplantation (FMT) has moved from an observed correlation in this Digest\'s gut-microbiome research into an actual, clinical trial testing the transplant itself as treatment.',
    summary: "The gut-microbiome research finds specific bacterial differences in Hashimoto's patients, including a documented enrichment of Bacteroides fragilis. The new, current step: an active clinical trial (part of a broader research effort including a study named IMITHOT) is directly testing fecal microbiota transplantation, transferring a healthy donor's gut bacteria into a Hashimoto's patient, to see whether reshaping the gut microbiome itself can measurably improve immune function and metabolic control. One currently active trial is studying this specifically in adults who have both Type 2 diabetes and Hashimoto's thyroiditis together, testing FMT's effect on both conditions at once. The proposed mechanism runs through pathways the research has: improving microbial diversity, shifting microbial metabolite production, and calming the same intestinal-barrier dysfunction and low-grade inflammation already tied to autoimmune thyroid disease. Research in this specific area is still described by the field itself as preclinical or early-clinical, this is an active, research direction testing a hypothesis, not yet a validated treatment.",
    citations: [
