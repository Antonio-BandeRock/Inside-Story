...
export const HISTORY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: 'For years after the 1956 autoimmune-mechanism discovery, researchers knew Hashimoto\'s patients carried antibodies against something inside the thyroid\'s own "microsomal" cell fraction, but nobody yet knew exactly what that target actually was. In 1985, researchers demonstrated that this "microsomal antigen" was in fact thyroid peroxidase, TPO, the very enzyme responsible for making thyroid hormone in the first place. That meant the immune system was attacking the thyroid\'s own hormone-production machinery directly, not some incidental bystander protein sitting nearby. This is the direct scientific origin of the modern TPO antibody blood test, the same lab value the Healing Stages research uses as its primary tracking signal, resting on a foundation laid nearly forty years earlier.',
    citations: [
      {
