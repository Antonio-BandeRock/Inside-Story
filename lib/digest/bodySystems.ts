...
export const BODY_SYSTEMS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    overallTier: 'moderate',
    stageNote: 'The vitamin A/blindness link is strong and settled (see the dedicated Vitamin A entry). The AREDS2 lutein/zeaxanthin finding is reported here at its more modest confidence level.',
  ...
  },
  {
    ...
    overallTier: 'moderate',
    stageNote: 'A direct clinical study with a null result for biotin specifically, included precisely because it corrects a widely repeated claim rather than confirms it.',
  ...
  },
  {
    ...
    teaser: "Roughly 300 million tiny air sacs, unfolded, would cover close to 80 square meters, and the entire point of that enormous surface is getting oxygen onto the same iron molecule already covered in this app's Iron research.",
    summary:
      "The lung's functional surface, the alveoli where oxygen actually crosses into the bloodstream and carbon dioxide crosses back out, is enormous for how compactly it's packed: an adult human has roughly 300 million individual alveoli, together providing around 80 square meters of gas-exchange surface, with the wall between air and blood only about one cell thick on each side, a gap roughly 1/1000th of a millimeter. That entire structure exists for one singular purpose: loading oxygen onto hemoglobin, the same iron-built protein already covered in full in this app's Iron deep-dive, and unloading the carbon dioxide cellular metabolism produces everywhere else in the body. A second, separate nutrient story plays out in this same organ, and it's more specific than \"vitamin D is generally good for immunity.\" A large, individual-participant-data meta-analysis (25 randomized trials) found vitamin D supplementation reduced the odds of at least one acute respiratory infection overall, but only modestly (adjusted odds ratio 0.88, number needed to treat 33). What the same analysis found underneath that modest headline number is the more useful part: among participants who were vitamin D deficient at the start of the trial, the effect was far stronger (odds ratio 0.58, NNT 8), and stronger again among deficient participants given daily or weekly dosing specifically (odds ratio 0.30, NNT just 4). The lesson isn't \"take vitamin D to avoid catching a cold\" as a blanket rule, it's the same, already-established theme this app's Vitamin D research covers elsewhere: a deficient body benefits far more from correcting that deficiency than an already-sufficient one gains from adding more on top.",
    citations: [
      {
    ...
    overallTier: 'strong',
    stageNote: 'The alveolar surface-area figure is settled anatomy. The vitamin D finding is a large individual-participant-data meta-analysis, reported here at its modest overall size, with the much stronger deficient-subgroup effect broken out separately rather than blended into one flattering headline number.',
    chart: {
  ...
  },
  {
    ...
    teaser: "This app's Zinc research already covers immune function, skin, and wound healing. Add sperm production to that list, along with a complication: does supplementing it actually help?",
    summary:
    ...
    overallTier: 'moderate',
    stageNote: "The deficiency mechanism itself is well documented; the supplementation-trial evidence is weaker and mixed, reported alongside the mechanism rather than only the more flattering half.",
