...
export const BODY_SYSTEMS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "This app's Zinc research already covers immune function, skin, and wound healing. Add sperm production to that list, along with an honest complication: does supplementing it actually help?",
    summary:
