...
export const BODY_SYSTEMS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "This app's own Hormones deep-dive already covers insulin, cortisol, thyroid hormones, leptin and ghrelin, and estrogen and testosterone individually, each with its own mechanism and citations. What that individual coverage doesn't fully capture on its own is how directly these systems lean on each other in time. Chronic stress and elevated cortisol, already covered in this app's own Lifestyle & Environment research, directly suppresses the enzymes that convert inactive thyroid hormone (T4) into its active form (T3), meaning a stressed HPA axis can produce thyroid-level symptoms even when the thyroid gland itself is working normally. Insulin resistance runs its own crosstalk into the sex hormones: elevated insulin directly stimulates the ovaries to overproduce androgens, a central mechanism behind PCOS already covered in full in that condition's own Digest content. And bone's own hormone, osteocalcin, covered above, closes the loop the other direction, a skeletal tissue most people never think of as hormonal directly influences how sensitive the rest of the body is to insulin. None of these systems has a truly separate, walled-off lane. A disruption in one (chronic stress, insulin resistance, or a nutrient deficiency undermining any of them) has a documented tendency to show up as a symptom in a completely different system, which is exactly why this app tracks and cross-references so many of them together rather than treating any single hormone as the whole story.",
    citations: [],
    overallTier: 'moderate',
    stageNote: "A synthesis connecting citations already given individually in this app's own Hormones, Lifestyle & Environment, and PCOS research, not a new external claim of its own.",
  ...
  },
  {
    ...
    citations: [],
    overallTier: 'moderate',
    stageNote: "A synthesis connecting several already-cited nutrient-toxicity entries elsewhere in this app around one shared organ-level mechanism, not a new external research claim of its own.",
  ...
  },
  {
    ...
    overallTier: 'moderate',
    stageNote: "Tagged at the honesty of its weakest support, per this app's own standing rule: the calcium-antagonist mechanism is settled pharmacology, but the actual clinical-outcome evidence across independent systematic reviews is mixed, not just under-studied.",
  ...
  },
  {
    ...
    summary:
      "The two halves of the human reproductive system don't just look physically different, they run on two different production models. Oogenesis, egg development, is a finite, front-loaded process: the number of oocytes actually peaks before birth, reaching roughly 6-7 million by mid-gestation, then falls sharply through a natural process called atresia to approximately 2 million by the time of birth itself, and continues declining from there through childhood, puberty, and the entire reproductive lifespan, already covered in full for what that decline means hormonally in this app's own Estrogen & Progesterone and Perimenopause research. There is no mechanism to make more eggs later, the entire lifetime supply is set before a person is even born. Spermatogenesis runs on the opposite model entirely: a continuous, ongoing manufacturing process, with a fresh cycle from stem cell to mature sperm taking roughly 65 days in humans, restarting indefinitely rather than drawing down a fixed reserve. That roughly two-month production cycle has a practical consequence worth naming directly: a semen sample taken today largely reflects diet, health, and lifestyle from the past two to three months, not yesterday's choices, the reason fertility-focused nutrition changes (already covered in this app's own Zinc research below) take time to show up in results. One more direct consequence of just how early and fast the female side of this system moves: the neural tube, the structure that becomes the brain and spinal cord, closes within the first 21 to 28 days after conception, a window that's often over before a pregnancy is even recognized. That single, narrow timing fact is the actual, physical reason this app's own Folate research treats adequate intake as something to already have in place before conception, not something to start once a pregnancy test comes back positive.",
    citations: [
      {
    ...
    overallTier: 'strong',
    stageNote: 'Settled, well-established developmental biology across all three claims, the value here is connecting facts this app already had scattered (perimenopause, folate timing) back to the underlying reproductive-biology mechanism driving both.',
  ...
  },
  {
    ...
    overallTier: 'moderate',
    stageNote: "The deficiency mechanism itself is well documented. Tagged at the honesty of the weaker, mixed supplementation-trial evidence, per this app's own standing rule for reporting a null finding alongside a mechanism rather than only the more flattering half.",
  ...
  },
  {
    ...
    overallTier: 'strong',
    stageNote: 'Settled anatomy and physiology throughout, the value here is the missing structural layer underneath this app\'s own already-cited cortisol, aldosterone/electrolyte, and adrenal-autoimmunity research, not a new or contested claim of its own.',
    relatedIds: [
      'organ-adrenal-aps2',
