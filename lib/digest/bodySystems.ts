...
export const BODY_SYSTEMS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'A mineral this app covers for the heart, muscle, and bone has an emergency-medicine use for severe asthma, but systematic reviews disagree on how much it actually changes hospital admissions.',
    summary:
