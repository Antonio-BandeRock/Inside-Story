...
export const OTHER_AUTOIMMUNE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Psoriasis shows up on the skin, red, scaly patches, sometimes accompanied by joint pain in its arthritic form, about as visually different from a digestive or thyroid condition as an autoimmune disease can look. Two findings connect it back to the rest of this category anyway. The first is a well-documented, bidirectional relationship with obesity and visceral fat inflammation, echoing the Mitochondria & Metabolism research on visceral fat as active, hormone-producing tissue rather than passive padding. The second, more specific finding: an identifiable subgroup of psoriasis patients test positive for gluten antibodies, and that exact subgroup sees measurable skin improvement on a gluten-free diet. Not a claim that gluten causes psoriasis broadly, but evidence of a genuine responder subgroup worth knowing about if the condition runs in a family. A useful closing example for this whole category's own approach: the finding isn't \"gluten causes psoriasis\" for everyone. It's a testable, minority pattern, exactly the kind of precise, non-sweeping claim this Digest tries to make throughout.",
    citations: [
