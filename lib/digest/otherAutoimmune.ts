...
export const OTHER_AUTOIMMUNE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Psoriasis shows up on the skin, red, scaly patches, sometimes accompanied by joint pain in its arthritic form, about as visually different from a digestive or thyroid condition as an autoimmune disease can look. Two findings connect it back to the rest of this category anyway. The first is a well-documented, bidirectional relationship with obesity and visceral fat inflammation, echoing the Mitochondria & Metabolism research on visceral fat as active, hormone-producing tissue rather than passive padding. The second, more specific finding: an identifiable subgroup of psoriasis patients test positive for gluten antibodies, and that exact subgroup sees measurable skin improvement on a gluten-free diet. Not a claim that gluten causes psoriasis broadly, but evidence of a responder subgroup, relevant if the condition runs in a family. The finding isn't \"gluten causes psoriasis\" for everyone. It's a testable, minority pattern, exactly the kind of precise, non-sweeping claim this app tries to make throughout.",
    citations: [
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'The Same Few Mechanisms, Seven Different Diseases',
    ...
    summary: "Read one at a time, the seven diseases in this category don't have much in common on the surface: joints, skin, nerves, the pancreas, glands, the gut itself. It would be easy to read through them as seven unrelated case studies and move on. Step back and read them together instead, and the same three mechanisms keep resurfacing, entry after entry: a shifted balance between Th17 and Treg immune cells (rheumatoid arthritis, IBD, MS, and lupus all show it independently), the exact same \"consistent correlation, unreliable intervention trial\" vitamin D pattern (confirmed, separately, in three completely different diseases), and gut-barrier/zonulin involvement (lupus's named bacterial strain, IBD's directly-visualized inflammation). None of these seven research groups were trying to confirm each other's work. They were each simply studying their disease. That's exactly what makes the repetition worth paying attention to. When independent researchers, working on different diseases with no reason to agree, keep landing on the same underlying biology, that's corroborating weight, not proof of anything Hashimoto's-specific, but a strong signal that the mechanisms the Gut & Microbiome research is built around are general biology, not a theory invented to fit one disease.",
    citations: [
      {
