...
export const GRAVES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "This category's already-covered teprotumumab entry names its structural eye-disease reversal. Trial and follow-up data finds roughly 10% of patients also reported hearing-related symptoms, a consideration before starting treatment.",
    summary:
  ...
  },
  {
    ...
    teaser: "This category's already-covered thyroid eye disease research gets a surgical option: decompression surgery reduced eye protrusion by a measured 3-4mm on average, with complication data included.",
    summary:
