...
export const GRAVES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'Two serious risks, agranulocytosis and liver injury, each with its own specific warning signs before starting either drug.',
    summary:
  ...
  },
  {
    ...
    teaser: "This category's own already-covered teprotumumab entry names its structural eye-disease reversal, trial and follow-up data finds roughly 10% of patients also reported hearing-related symptoms, a real consideration before starting treatment.",
    summary:
  ...
  },
  {
    ...
    summary:
      "This category's own already-covered landmark selenium trial found measured improvement in mild Graves' orbitopathy sustained through its own 12-month follow-up window (6 months of treatment plus 6 months after stopping), and a separate, much longer 5-year prospective controlled cohort study (74 patients) adds an important nuance, the original trial's own shorter-term finding doesn't extend indefinitely. The 5-year study found that six months of selenium supplementation did measurably change the EARLY course of mild-to-moderate orbitopathy, direct confirmation of the same short-term benefit already covered elsewhere in this category, but found the same regimen made no measurable difference in long-term outcomes at the full 5-year mark. This isn't a contradiction of the original landmark trial, both are accurate for the specific timeframe each actually measured, it's an extension showing that an early benefit doesn't automatically mean a lasting one. Matching this category's own already-established caution about moderate-to-severe orbitopathy specifically: selenium's own best-supported role remains a short-term aid during the active early phase of mild orbitopathy, not a proven long-term disease-modifying treatment, worth discussing directly with an endocrinologist about what a course of selenium can and can't realistically be expected to achieve.",
    citations: [
