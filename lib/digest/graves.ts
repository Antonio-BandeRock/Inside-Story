...
export const GRAVES_ENTRIES: DigestEntry[] = [
  {
    ...
    teaser: 'The most common cause of an overactive thyroid, and a distinct disease with its own food and lifestyle evidence base.',
  ...
  },
  {
    ...
    teaser: 'A double-blind, placebo-controlled trial in 159 patients found a measured improvement, with one honest limit worth knowing.',
    summary:
      "A landmark randomized, double-blind, placebo-controlled trial gave 159 patients with mild Graves' orbitopathy (the eye disease that can accompany Graves') either sodium selenite (100 micrograms twice daily) or a placebo for six months, then followed everyone for another six months after stopping. The selenium group showed measured improvement in both eye-disease severity and disease-specific quality of life, and those gains held up even after supplementation ended. That's a strong result for a specific population: mild orbitopathy. The honest limit is worth stating directly: later trials across different selenium-status populations and disease severities have found inconsistent results, and what selenium actually does for moderate-to-severe orbitopathy specifically remains an open question the evidence hasn't settled yet.",
    citations: [
  ...
  },
  {
    ...
    summary: "Graves' disease has three distinct first-line treatment paths, already covered individually across the research (antithyroid drugs, radioactive iodine, and thyroidectomy), and direct, long-term comparative research finds differences in outcomes between them worth knowing about together. A large comparative study found patients treated with surgery as their initial treatment had a lower long-term risk of all-cause mortality, cardiovascular disease, atrial fibrillation, psychological disease, diabetes, and hypertension compared to those treated first with antithyroid drugs or radioactive iodine. Separate cost-effectiveness research found total thyroidectomy more cost-effective than radioactive iodine specifically for patients who can't tolerate or don't respond to antithyroid drugs, quality-adjusted-life-year data favoring surgery (23.6 vs. 20.9 QALYs). Worth knowing honestly: research finds radioactive iodine's own overall success rate variable, 60.7% in one study of young adults, with larger thyroid size and longer disease duration both identified risk factors for treatment failure requiring a second round. Research also finds long-term, continuous antithyroid drug treatment (rather than the standard fixed-course approach) achieving substantially higher sustained remission, a worth-knowing alternative to the usual time-limited course. Worth knowing directly: this is comparative evidence worth bringing directly into a treatment-choice conversation with an endocrinologist, no single option is universally best, and the tradeoffs (surgical risk and recovery vs. Radioactive iodine's own variable success rate vs. Antithyroid drugs' own relapse risk) deserve an individualized weighing rather than defaulting to whichever option is most commonly offered first.",
    citations: [
  ...
  },
  {
    ...
    summary: "Vitamin D deficiency shows up repeatedly across the autoimmune-disease research, and Graves' disease is no exception, but the evidence here is honestly more mixed than a simple 'take vitamin D' recommendation would suggest. A meta-analysis found people with Graves' disease significantly more likely to be vitamin D deficient than healthy controls (odds ratio 2.24), with one individual study finding a striking gap (64% deficient in Graves' patients versus 30% in controls). Worth knowing honestly, and directly relevant to what this actually means for treatment: a separate prospective study found vitamin D deficiency was NOT associated with actually developing Graves' disease or its eye complications, and a supplementation trial found giving vitamin D didn't prevent Graves' disease from recurring after treatment. Put together, this is an association between having Graves' disease and running low on vitamin D, without solid, evidence yet that the deficiency causes the disease or that correcting it changes the disease's own course, the same honest 'correlation, unproven intervention' pattern the research has already found repeating across several other autoimmune conditions. Worth knowing directly: checking vitamin D status remains reasonable, general health practice, just not, based on current evidence, a specific lever for preventing or reversing Graves' disease itself.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "This category's own already-covered antithyroid-drug-monitoring and block-and-replace-versus-titration research is written largely around adult dosing and safety. Pooled evidence finds one important difference specific to children and adolescents worth knowing directly: remission takes longer to reach. A pooled meta-analysis found remission rates of 15.5% for treatment courses under 2 years, rising to 24.1% for 2 to 5 years, and 33.0% for courses longer than 5 years, with each additional year of treatment adding a measurable 3.8% increase in the relative likelihood of remission. This is a meaningfully different pattern from adult Graves' treatment, where this category's own general remission research already treats a much shorter initial course as standard. Worth knowing directly: a well-documented practical implication follows directly from this data, extending antithyroid drug treatment well past the point an adult might stop is an evidence-backed strategy specifically in pediatric Graves', not simply a slower version of the same adult protocol. This is useful context for a parent or a pediatric endocrinology team weighing how long to continue medication before considering radioactive iodine or surgery, both already covered in this category's own treatment-comparison research.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Graves' disease is usually discussed for its effects on the thyroid gland and, in this category's own already-covered content, the eyes. A third, distinct site is worth knowing directly: the skin. Pretibial myxedema (also called Graves' dermopathy), a thickened, non-pitting swelling most often on the front of the shins, affects a 0.5 to 4.3% of Graves' patients overall, historically documented as high as 5% before modern early antithyroid treatment likely reduced how often it progresses to this stage. The meaningful pattern worth knowing: this prevalence climbs substantially, to 15%, specifically in Graves' patients who also have eye involvement (ophthalmopathy), and a case series found the pretibial area involved in 99% of cases with 96% of patients also having coexisting eye disease, evidence that skin and eye involvement share much of the same underlying immune mechanism rather than occurring independently. Worth knowing directly: a new, unexplained thickened or waxy patch of skin on the shins, especially alongside already-diagnosed Graves' eye disease, is a recognizable, named finding worth mentioning to a doctor directly by name, not a separate, unrelated skin condition.",
    chart: {
  ...
  },
  {
    ...
    teaser: "This category's own already-covered rituximab research tries to stop the antibody from being made. A newer drug, K1-70, works the opposite way: it physically occupies the TSH receptor first, so the antibody has nothing left to attack.",
    summary:
      "This category's own already-covered TRAb/TSI research names the specific antibody driving Graves' disease, one that mimics TSH and overstimulates the thyroid. K1-70, a human monoclonal antibody now in early clinical testing, represents a different strategy from this category's own already-covered rituximab research: rather than stopping the body from making that antibody, K1-70 binds the TSH receptor itself first, physically blocking both TSH and the harmful autoantibody from reaching it at all. A Phase 1 trial tested ascending doses in 18 Graves' patients already stable on antithyroid drugs, and found it well tolerated at every dose with no serious side effects and no significant immune reaction to the drug itself. At the higher doses tested, patients showed measurable symptom improvement, reduced tremor, better sleep, improved mental focus, and for patients with Graves' eye disease specifically, measured reductions in eye bulging and light sensitivity. Worth knowing directly and honestly: this remains early Phase 1 safety data in a small number of patients, the drug's effect pushed thyroid hormone levels toward hypothyroid ranges at higher doses, meaning careful dosing will matter directly if this advances toward patient use.",
    citations: [
  ...
  },
  {
    ...
    summary: "This category's own already-covered remission-rate research names the overall numbers; more specific predictor research answers the practical follow-up question, who is actually most likely to relapse. Studies place relapse within the first year after stopping antithyroid drugs at roughly 30-40% overall, with some cohorts finding it as high as 43-50%. Independently identified predictors include smoking (the already-covered Graves'-specific smoking research, now with a second reason to matter), a large goiter, elevated thyroid hormone (FT4) at the START of treatment, stopping the drug before completing a full 12 months, and a low TSH measured just 4 weeks after stopping, a practical early-warning signal a doctor can check for directly rather than waiting to see if symptoms return. Research has also found a genetic component (variation in immune costimulatory genes and TRAb levels) contributing to relapse risk, tied directly to the already-covered genetic/family-risk research. Worth knowing directly: relapse after stopping treatment is common enough that it should be treated as an expected possibility to actively watch for, not a sign that something went wrong with an otherwise successful first round of treatment.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered teprotumumab entry names its structural eye-disease reversal, trial and follow-up data finds roughly 10% of patients also reported hearing-related symptoms, worth discussing directly before starting treatment.",
    summary:
      "This category's own already-covered teprotumumab research names a structural reversal of thyroid eye disease, and dedicated follow-up research into a specific side effect deserves its own direct coverage. Clinical-trial data found hearing abnormalities reported by about 10 percent of patients receiving teprotumumab, with the pivotal trial documenting specific cases: hypoacusis (reduced hearing), one case of temporary deafness, autophony (hearing an echo of one's own voice), and eustachian tube dysfunction, most of which resolved. More recent, dedicated research finds these symptoms often gradual in onset, affecting both ears, persistent, and impactful on quality of life while they last, with research finding the underlying mechanism involves both inner-ear and eustachian-tube dysfunction. A important, honest complication worth stating directly: a more recent formal comparison found a similar prevalence of hearing-related complaints in Graves'/thyroid-eye-disease patients who never received teprotumumab at all, evidence that baseline hearing issues in this population make it hard to know how much of any given case is caused by the drug itself versus the underlying disease. Worth stating plainly: this is worth discussing directly with a doctor before starting treatment, alongside this category's own already-covered benefit, not a reason to avoid an effective treatment outright.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered agranulocytosis/liver-risk entry names general antithyroid-drug risks, pregnancy adds a third, trimester-specific consideration: methimazole and PTU carry different risks to the developing fetus at different points.",
    summary:
      "This category's own already-covered antithyroid-drug safety research names agranulocytosis and liver injury as risks shared by both methimazole and propylthiouracil (PTU), and pregnancy adds a third, different consideration specific to the developing fetus. Current guidance recommends PTU specifically during the first trimester, the most sensitive window for fetal organ development, because methimazole (and its close relative carbimazole) carries a documented risk of causing specific birth defects (embryopathy) when taken during this exact window, a risk PTU doesn't share to the same degree. The honest tradeoff: PTU itself carries its own already-covered liver-injury risk, described elsewhere in this category as capable of coming on rapidly and unpredictably, meaning the first-trimester drug choice is a deliberate tradeoff between two different risks, not a simple 'safer drug' pick. Current practice guidance reflects this directly: switching from methimazole to PTU specifically upon confirming pregnancy, then often switching back to methimazole after the first trimester once the embryopathy-risk window has passed, since PTU's own liver risk makes it less ideal for longer-term use. Worth stating directly: this trimester-specific switching strategy is worth confirming directly with an endocrinologist as soon as pregnancy is confirmed or being planned, since the right drug changes depending on exactly where in pregnancy someone is, not a single answer that holds throughout.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered landmark selenium trial found gains held up through the original 12-month follow-up, a separate, much longer 5-year cohort study found the same early benefit didn't translate into a lasting long-term difference.",
    summary:
      "This category's own already-covered landmark selenium trial found measured improvement in mild Graves' orbitopathy sustained through its own 12-month follow-up window (6 months of treatment plus 6 months after stopping), and a separate, much longer 5-year prospective controlled cohort study (74 patients) adds an important, honest nuance worth stating directly rather than assuming the original trial's own shorter-term finding extends indefinitely. The 5-year study found that six months of selenium supplementation did measurably change the EARLY course of mild-to-moderate orbitopathy, direct confirmation of the same short-term benefit already covered elsewhere in this category, but found the same regimen made no measurable difference in long-term outcomes at the full 5-year mark. This isn't a contradiction of the original landmark trial, both are real, and both are accurate for the specific timeframe each actually measured, it's an honest extension showing that an early benefit doesn't automatically mean a lasting one. Worth stating directly, matching this category's own already-established caution about moderate-to-severe orbitopathy specifically: selenium's own best-supported role remains a short-term aid during the active early phase of mild orbitopathy, not a proven long-term disease-modifying treatment, worth discussing directly with an endocrinologist about what a course of selenium can and can't realistically be expected to achieve.",
    citations: [
