...
export const GRAVES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Propranolol and similar beta-blockers don't treat Graves' disease itself, and don't lower thyroid hormone levels at all. They block many of the immediate, uncomfortable symptoms of excess thyroid hormone, rapid heart rate, tremor, anxiety, heat intolerance, while antithyroid drugs or another definitive treatment work on the actual underlying cause, which typically takes weeks to bring hormone levels down meaningfully. The two drugs do different jobs: one (methimazole or PTU) treats the disease, the other (a beta-blocker) manages how it feels while that first drug takes effect. Beta-blockers are typically tapered off once thyroid hormone levels have normalized, not continued indefinitely once they're no longer doing work.",
    citations: [
      { source: "Graves' Disease, National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK)", url: 'https://www.niddk.nih.gov/health-information/endocrine-diseases/graves-disease' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'graves',
    title: "Graves' Disease's History: Named After a Man Who Wasn't Actually First to Describe It",
  ...
  },
  {
    ...
    category: 'graves',
    title: "A Counterintuitive Pregnancy Risk: A Mother's TRAb Antibodies Can Cause Fetal Thyrotoxicosis Even After SHE Has Become Hypothyroid",
    teaser: "TRAb antibodies cross the placenta independent of the mother's current thyroid hormone level, meaning a mother made hypothyroid by past radioactive-iodine treatment can still, rarely, cause her baby's thyroid to run too fast.",
    summary: "This is a surprising finding, relevant if pregnancy is being planned after any past Graves' treatment: TRAb (TSH-receptor antibody), the same antibody covered in the self-advocacy research, crosses the placenta and can stimulate the FETUS's thyroid independent of what the mother's current thyroid hormone level actually is. That means even a mother made hypothyroid by earlier radioactive-iodine treatment or surgery can, in documented if rare cases, still carry high enough TRAb levels to cause fetal or neonatal thyrotoxicosis. Research finds this happens in up to 5% of pregnancies in mothers with a Graves' history, with a serious 12-20% mortality rate when it occurs, mainly from fetal heart failure. TRAb crossing becomes most consequential in the second half of pregnancy, when placental passage increases and the fetal thyroid has matured enough to actually respond to it. TRAb levels, not just the mother's TSH/T4, need monitoring throughout a pregnancy with any Graves' history, and continued fetal surveillance (heart rate, ultrasound) is recommended regardless of how low a mother's antibody titer currently reads.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Research finds biotin supplements can interfere with the exact TRAb/TSI antibody tests covered in the Graves\' self-advocacy research, producing a misleading lab pattern identical to Graves\' disease itself.',
    summary: "High-dose biotin supplements carry a well-documented, and important risk of distorting the TRAb/TSI antibody testing covered in the Graves' self-advocacy research, since it can lead to a misdiagnosed case of Graves' disease that isn't actually there. Research finds biotin specifically interferes with the detection of anti-thyrotropin (TSH-receptor) antibodies, and case reports document this producing a laboratory pattern that looks identical to Graves' disease. The underlying mechanism ties to how most commercial thyroid assays work: they rely on a biotin-streptavidin binding system, and excess biotin in the blood can either falsely lower or falsely raise a given test's result depending on the specific assay design, competitive assays (like T3/T4) tend to read falsely HIGH with excess biotin, while sandwich assays (like TSH itself) tend to read falsely LOW. Current American Thyroid Association guidance recommends stopping biotin supplementation for at least 2 days before any thyroid lab test, the Labs & Medication Timing category covers this same interference for Hashimoto's; it applies with equal, direct relevance here for anyone on biotin considering testing for Graves' antibodies specifically. A surprising or unexpected positive TRAb/TSI result in someone taking high-dose biotin (common in hair/skin/nail supplements) is a reason to retest after stopping the supplement before accepting the result as a Graves' diagnosis.",
    citations: [
  ...
  },
  {
    ...
    summary: "Graves' disease has three distinct first-line treatment paths, covered individually across the research (antithyroid drugs, radioactive iodine, and thyroidectomy), and direct, long-term comparative research finds measurable differences in outcomes between them. A large comparative study found patients treated with surgery as their initial treatment had a lower long-term risk of all-cause mortality, cardiovascular disease, atrial fibrillation, psychological disease, diabetes, and hypertension compared to those treated first with antithyroid drugs or radioactive iodine. Separate cost-effectiveness research found total thyroidectomy more cost-effective than radioactive iodine specifically for patients who can't tolerate or don't respond to antithyroid drugs, quality-adjusted-life-year data favoring surgery (23.6 vs. 20.9 QALYs). Research finds radioactive iodine's overall success rate variable, 60.7% in one study of young adults, with larger thyroid size and longer disease duration both identified risk factors for treatment failure requiring a second round. Research also finds long-term, continuous antithyroid drug treatment (rather than the standard fixed-course approach) achieving substantially higher sustained remission, an alternative to the usual time-limited course. This is comparative evidence worth bringing directly into a treatment-choice conversation with an endocrinologist, no single option is universally best, and the tradeoffs (surgical risk and recovery vs. Radioactive iodine's variable success rate vs. Antithyroid drugs' relapse risk) deserve an individualized weighing rather than defaulting to whichever option is most commonly offered first.",
    citations: [
  ...
  },
  {
    ...
    summary: "Vitamin D deficiency shows up repeatedly across the autoimmune-disease research, and Graves' disease is no exception, but the evidence here is more mixed than a simple 'take vitamin D' recommendation would suggest. A meta-analysis found people with Graves' disease significantly more likely to be vitamin D deficient than healthy controls (odds ratio 2.24), with one individual study finding a striking gap (64% deficient in Graves' patients versus 30% in controls). A separate prospective study found vitamin D deficiency was NOT associated with actually developing Graves' disease or its eye complications, and a supplementation trial found giving vitamin D didn't prevent Graves' disease from recurring after treatment. Put together, this is an association between having Graves' disease and running low on vitamin D, without solid evidence yet that the deficiency causes the disease or that correcting it changes the disease's course, the same 'correlation, unproven intervention' pattern the research has already found repeating across several other autoimmune conditions. Checking vitamin D status remains reasonable, general health practice, just not, based on current evidence, a specific lever for preventing or reversing Graves' disease itself.",
    citations: [
  ...
  },
  {
    ...
    summary: "The remission-rate research names the overall numbers; more specific predictor research answers the practical follow-up question, who is actually most likely to relapse. Studies place relapse within the first year after stopping antithyroid drugs at roughly 30-40% overall, with some cohorts finding it as high as 43-50%. Independently identified predictors include smoking (the Graves'-specific smoking research, now with a second reason to matter), a large goiter, elevated thyroid hormone (FT4) at the START of treatment, stopping the drug before completing a full 12 months, and a low TSH measured just 4 weeks after stopping, a practical early-warning signal a doctor can check for directly rather than waiting to see if symptoms return. Research has also found a genetic component (variation in immune costimulatory genes and TRAb levels) contributing to relapse risk, tied directly to the genetic/family-risk research. Relapse after stopping treatment is common enough that it should be treated as an expected possibility to actively watch for, not a sign that something went wrong with an otherwise successful first round of treatment.",
    citations: [
  ...
  },
  {
    ...
    summary: "The treatment landscape names radioactive iodine as a common first-line option for Graves' disease, and follow-up data shows exactly what it actually does to the thyroid over time. A retrospective study of 312 Graves' patients found 69.87 percent already evaluated as hypothyroid at just 6 months post-treatment, and longer-term data across multiple studies finds cumulative hypothyroidism rates ranging widely, from roughly 38.5 percent at a median 7.5 years in one cohort up to figures approaching 90 percent in others, depending on the radioactive dose used and how aggressively physicians target the thyroid. Research finds this variation isn't random: predictive factors identified across several studies include male sex, a shorter disease duration before treatment, a smaller thyroid gland, and lower iodine uptake on pre-treatment scanning, each independently associated with becoming hypothyroid sooner. The worth-understanding reframe: radioactive iodine isn't designed to preserve normal thyroid function while curing the overactivity, evidence finds most patients trade Graves' hyperthyroidism for a permanent need for levothyroxine replacement, covered extensively elsewhere in the Hashimoto's research. This is a known, largely intentional tradeoff of the treatment, worth discussing directly and in advance with an endocrinologist rather than treated as a surprise complication after the fact.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The teprotumumab entry names its structural eye-disease reversal. Trial and follow-up data finds roughly 10% of patients also reported hearing-related symptoms, a consideration before starting treatment.",
    summary:
      "The teprotumumab research names a structural reversal of thyroid eye disease, and dedicated follow-up research into a specific side effect deserves separate coverage. Clinical-trial data found hearing abnormalities reported by about 10 percent of patients receiving teprotumumab, with the main trial documenting specific cases: hypoacusis (reduced hearing), one case of temporary deafness, autophony (hearing an echo of one's voice), and eustachian tube dysfunction, most of which resolved. More recent, dedicated research finds these symptoms often gradual in onset, affecting both ears, persistent, and impactful on quality of life while they last, with research finding the underlying mechanism involves both inner-ear and eustachian-tube dysfunction. An important complication: a more recent formal comparison found a similar prevalence of hearing-related complaints in Graves'/thyroid-eye-disease patients who never received teprotumumab at all, evidence that baseline hearing issues in this population make it hard to know how much of any given case is caused by the drug itself versus the underlying disease. This is worth discussing directly with a doctor before starting treatment, alongside the benefit, not a reason to avoid an effective treatment outright.",
    citations: [
  ...
  },
  {
    ...
    category: 'graves',
    title: "A 5-Year Follow-Up Adds a Time Limit to Selenium's Landmark Orbitopathy Trial",
    teaser: "The landmark selenium trial found gains held up through the original 12-month follow-up, a separate, much longer 5-year cohort study found the same early benefit didn't translate into a lasting long-term difference.",
    summary:
      "The landmark selenium trial found measured improvement in mild Graves' orbitopathy sustained through its 12-month follow-up window (6 months of treatment plus 6 months after stopping), and a separate, much longer 5-year prospective controlled cohort study (74 patients) adds an important limit, the original trial's shorter-term finding doesn't extend indefinitely. The 5-year study found that six months of selenium supplementation did measurably change the EARLY course of mild-to-moderate orbitopathy, direct confirmation of the same short-term benefit, but found the same regimen made no measurable difference in long-term outcomes at the full 5-year mark. Both findings are accurate for the specific timeframe each actually measured. The 5-year study extends the original rather than contradicting it, showing that an early benefit doesn't automatically mean a lasting one. Matching this category's already-established caution about moderate-to-severe orbitopathy specifically: selenium's best-supported role remains a short-term aid during the active early phase of mild orbitopathy, not a proven long-term disease-modifying treatment, worth discussing directly with an endocrinologist about what a course of selenium can and can't realistically be expected to achieve.",
    citations: [
  ...
  },
  {
    ...
    category: 'graves',
    title: "Graves' Disease Carries 2.2 Times the Atrial Fibrillation Risk, With Surgery the Exception",
