...
export const NUTRIENTS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Read one at a time, all of these nutrients can start to sound equally important. Each entry makes its own case, and none of them says \"skip this one.\" Read side by side instead, and they sort into a clear hierarchy. Selenium, paired with myo-inositol, carries the strongest trial-level evidence of anything in the entire research base, with iodine's own two-edged deficiency/excess risk close behind as similarly well-established, a risk that applies whether the source is food, kelp, or a supplement pill, not three separate concerns. Vitamin D, zinc/iron/B12, Nigella sativa, and ashwagandha sit in a middle tier: mechanisms and trial data, but each still resting on fewer, smaller trials than selenium's own much deeper evidence base. Folate and the antioxidant vitamins sit at the bottom: findings worth knowing, but thin and mostly observational. None of this is a reason to ignore the weaker entries. It's a reason to prioritize selenium and iodine status first if choosing where to actually start, and to treat everything below that as worth a conversation with a doctor rather than aggressive self-supplementing based on a correlation alone.",
    citations: [
      {
        source: 'Selenium supplementation in patients with Hashimoto thyroiditis: a systematic review and meta-analysis of 21 studies (1,610 subjects)',
        url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC12401265/',
  ...
  },
  {
    ...
    summary: 'This app\'s own Wild-Fermented Tart Cherry, Ginger & Turmeric Tonic (in Recipes) combines tart cherry\'s melatonin and anthocyanins with fermented ginger and turmeric, black pepper included for turmeric\'s own documented curcumin-absorption boost, dairy-free and gluten-free by design. Coconut Kefir and Beet Kvass are gentler starting points if gut repair is still in an early, "go slow" phase: both are dairy-free, low-sugar once fully fermented, and easy to dose in small amounts first. Every wild-fermented tonic in this app\'s own Recipes category was built dairy-free and gluten-free specifically because those are the two most common Hashimoto\'s triggers, so none of them need modification to fit. Two things worth knowing plainly: dairy-based ferments (Milk Kefir, Ayran, Lassi, Tarag-Style) carry casein, whose link to thyroid autoimmunity is a practitioner hypothesis repeated widely online, not settled peer-reviewed consensus, tiered honestly weak here; and any dairy ferment\'s own calcium content can block levothyroxine absorption if drunk within about 4 hours of your morning dose, a well-established interaction worth spacing around regardless of the casein question.',
    citations: [
    ...
    overallTier: 'moderate',
    stageNote: 'Most relevant once gut-repair work is already underway (Wentz Stage 3), introduced slowly per this app\'s own phased fermented-drink guidance.',
    relatedIds: [
