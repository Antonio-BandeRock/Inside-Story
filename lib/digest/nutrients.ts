...
export const NUTRIENTS_ENTRIES: DigestEntry[] = [
  {
    ...
    teaser: 'Out of every supplement researched here, one stands clearly above the rest in trial-level evidence, with one honest caveat.',
  ...
  },
  {
    ...
    teaser: 'Nine nutrient entries, ranked honestly, not by how often each one gets talked about, but by how strong its actual evidence really is.',
