...
export const PREVENTION_LIFESTYLE_ENTRIES: DigestEntry[] = [
  {
    ...
    summary: "Hashimoto's is autoimmune, genetic and environmental triggers set it in motion before any lifestyle choice comes into play, so this isn't about prevention in the way it might be for a purely diet-driven condition. What everyday choices DO shape is how well the condition is managed day to day. The research supports a few concrete changes: keep iodine intake balanced rather than chasing either extreme (both deficiency and excess can worsen thyroid autoimmunity, dose-dependent research covers this directly); keep selenium intake adequate, since even mild deficiency tracks with worse autoimmune activity; take levothyroxine on an empty stomach, separated from calcium, iron, coffee, and high-fiber meals by the intervals the labs research already establishes; favor a whole-food, fiber-rich, moderately fermented diet that supports the gut barrier the microbiome research ties directly to autoimmune activity; and keep exercise moderate, rather than either sedentary or extreme, since both under-eating and overtraining can suppress T3 through the same cortisol/HPA-axis pathway covered in the mitochondria research. The World Health Organization's general activity target, 150 to 300 minutes of moderate exercise weekly plus muscle-strengthening work twice a week, is a reasonable, unremarkable-feeling starting point, not an extreme one.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Psoriasis has a genetic starting point (HLA-Cw6 and related markers), but the research finds several everyday factors that move how severe it runs. Weight loss carries RCT-backed benefit, even a modest reduction measurably lowers PASI severity scores, and a Mediterranean-pattern diet shows the same effect independently. Alcohol and smoking both carry dose-dependent worsening effects, quitting or cutting back on either is a direct lever, not just general health advice. A less obvious factor: physical trauma to the skin itself, a scratch, a sunburn, a tattoo, can trigger a brand-new psoriasis patch at that exact site (the Koebner phenomenon), so protecting skin from unnecessary injury is a practical habit. Regular, moderate exercise supports the same weight and cardiometabolic benefits already tied to lower severity, and stress management matters directly too, psoriasis research under Conditions ties stress to flare timing. Vitamin D's evidence is mixed for oral supplementation (a finding), so it isn't a guaranteed lever the way weight and alcohol are.",
    citations: [
  ...
  },
  {
    ...
    teaser: "Graves' levers: smoking cessation carries the single strongest evidence of any modifiable factor, iodine intake needs to stay balanced rather than excessive, and stress management has newer supporting evidence.",
    summary:
      "Graves' disease is autoimmune and can't be prevented by lifestyle once the underlying genetic and immune process is set in motion, but the research names one dominant modifiable factor above the rest: smoking. Meta-analysis-level evidence ties smoking directly to both a higher risk of developing Graves' disease and, more strongly, to worse thyroid eye disease specifically, making smoking cessation the single most consequential lifestyle change available. Iodine needs careful balance in the opposite direction from Hashimoto's: excess iodine can trigger or worsen Graves' disease in a genetically susceptible person, so avoiding high-dose iodine supplements and excessive seaweed/kelp intake matters directly, covered in Graves' iodine research under Conditions. A newer body of evidence ties chronic stress to Graves' onset in genetically susceptible people, making stress management a legitimate, evidence-grounded lever, not just general advice. During an active, uncontrolled hyperthyroid phase, exercise needs caution, the cardiac research notes strain risk until heart rate and thyroid hormone levels are brought under control with treatment; once stabilized, the WHO's general activity guideline applies normally.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Type 1 diabetes results from an autoimmune destruction of insulin-producing cells that begins well before diagnosis, the staging research confirms it can be detected years earlier via antibody testing, but no known diet or lifestyle change stops or prevents that underlying process. What everyday choices DO shape is how well the condition is managed once it's here. Carbohydrate counting accuracy matters directly, the research finds an average 21% error rate in typical carb estimates, and closing that gap measurably improves glucose stability. Exercise carries complexity, aerobic exercise can drop glucose while resistance exercise can sometimes raise it, so timing and type both matter, not just volume, and the alcohol research adds a delayed-hypoglycemia risk to plan around specifically. Bone health deserves direct attention given the sevenfold hip-fracture-risk finding, weight-bearing and resistance exercise are a protective lever here specifically. Consistent meal timing, sick-day protocols, and awareness of the celiac comorbidity (screening for gluten sensitivity, not avoiding gluten preemptively) round out the practical picture.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Celiac Disease's One Prevention Strategy Has to Be Complete, Not Partial",
    ...
    summary:
      "Celiac disease is unusual in this app: it has exactly one effective prevention strategy, and it's binary rather than a spectrum of moderation. Once diagnosed, strict, lifelong avoidance of gluten, including attention to cross-contamination (shared cooking water, shared toasters, mislabeled products), is the only treatment that stops ongoing intestinal damage. What needs active management alongside that: the research finds commercial gluten-free products often run lower in protein and fiber and higher in sugar and cost than their gluten-containing equivalents, so a whole-food gluten-free pattern (naturally gluten-free grains, vegetables, lean protein) matters more than simply swapping in packaged gluten-free substitutes. Deliberate attention to iron, folate, B12, vitamin D, calcium, and zinc is worth building into a regular diet, since the research finds these can run short on a gluten-free diet if not actively managed. Bone-protective, weight-bearing exercise matters directly given the bone-density findings at diagnosis, and regular dental checkups are worth keeping given the documented enamel-defect risk.",
    citations: [
  ...
  },
  {
    id: 'prevention-ibd',
    category: 'basicHealth',
    title: "IBD's Levers Include a Direct Correction to the Common 'Avoid Fiber' Advice",
    ...
    summary: "Inflammatory bowel disease has genetic and environmental triggers, and while lifestyle can't prevent the underlying disease from developing, it shapes flare frequency and severity. Smoking needs careful, disease-specific framing: it's a documented risk factor for developing and worsening Crohn's disease, but carries a paradoxical protective effect specifically against ulcerative colitis, meaning the right smoking-related guidance depends on which specific IBD diagnosis someone has. A direct correction: the common advice to restrict fiber during a flare has surprisingly thin evidence behind it, the research found no support for the restriction and, more strikingly, found higher fiber intake tracking with LOWER flare risk within six months. Vitamin D deficiency tracks directly with disease severity, adequate levels are a worthwhile target. Regular, moderate exercise, adequate hydration, and stress management all support the same gut-barrier and inflammation pathways covered throughout the gut-microbiome research, and NSAIDs are worth avoiding given their documented flare-triggering potential.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "The latitude-gradient and EBV research shows MS risk is substantially set by factors (childhood sun exposure, viral history) that are largely out of anyone's later control, but meaningful levers still exist for both risk and day-to-day life with the condition. Smoking cessation carries direct evidence for reducing both onset risk and disease progression. Vitamin D deserves careful framing: it's strongly linked to MS risk in observational research, but the trial evidence for SUPPLEMENTATION specifically is mixed, adequate levels are still a reasonable, low-risk target. Diet carries quantified benefit: the WAVES trial, found both the Swank (very low saturated fat) and Wahls (nutrient-dense, plant-forward) diets produced clinically meaningful fatigue and quality-of-life improvement, sharing a common thread of whole-food, limited-processed-food eating. Exercise needs one MS-specific caution, Uhthoff's phenomenon, temporary symptom worsening from overheating during exertion, meaning cooling strategies matter as much as exercise volume itself. Fasting-mimicking approaches show preliminary promise but remain experimental rather than established guidance.",
    citations: [
  ...
  },
  {
    id: 'prevention-lupus',
    category: 'basicHealth',
    title: "Lupus's Levers Center on One Very Specific Environmental Trigger and Sun Protection",
    ...
    summary:
      "Lupus has genetic and, per the research, ethnic risk factors that can't be changed through lifestyle, but several concrete, everyday levers matter for flare prevention. Sun protection is close to non-negotiable, the photosensitivity research finds sun exposure can trigger a full-body flare, making consistent sunscreen and sun avoidance a primary lever rather than a general skin-health suggestion. One specific, avoidable food deserves direct naming: alfalfa sprouts, contain a compound (L-canavanine) documented to induce a lupus-like immune response. Omega-3 shows modest, low-certainty benefit per the meta-analysis. Smoking cessation matters directly, and anyone in mining, construction, sandblasting, or similar industrial work should know about the documented silica-dust exposure risk, a modifiable occupational factor. Vitamin D needs careful framing given the catch-22 (sun protection reduces flare risk but also reduces the body's vitamin D production), making dietary or supplemental vitamin D a more reliable lever than sun exposure for meeting needs. Exercise should stay moderate, especially during active flares.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Sjögren's Levers Center Directly on Hydration and Two Everyday Dehydrating Habits",
    ...
    summary:
      "Sjögren's syndrome centers on immune-driven damage to moisture-producing glands, and while lifestyle can't reverse that underlying process, the research names everyday habits that measurably worsen or ease the core dryness symptoms. Alcohol and caffeine both carry a documented dehydrating effect that worsens dryness within hours, making moderation a same-day lever rather than a long-term one. Omega-3 shows strong, randomized trial evidence here, more consistently positive than in several other conditions covered in this app, improving both dry eye symptoms and measured saliva flow in the same trial. Xylitol offers a two-way dental benefit, it stimulates saliva production while not feeding the cavity-causing bacteria sugar would, directly protecting against the rapid tooth decay risk this condition carries. Adequate, consistent hydration throughout the day matters more here than in most conditions in this app, given how directly and quickly it affects core symptoms. Regular dental and eye care, moderate exercise, and avoiding unnecessarily dry indoor environments round out the practical picture.",
    citations: [
  ...
  },
  {
    id: 'prevention-pcos',
    category: 'basicHealth',
    title: "PCOS's Central Mechanism Makes Diet and Exercise the Primary Treatment",
    ...
    summary: "PCOS is different from most autoimmune conditions: its central mechanism, insulin resistance, is directly, powerfully responsive to diet and exercise, making lifestyle change closer to a primary treatment here than in almost any other condition. The BAMBINI trial found each single percentage point of body weight lost tracking with a 5.6% higher chance of ovulation returning, a direct, quantified benefit. A lower-glycemic-load diet pattern (favoring whole grains, legumes, and vegetables over refined carbohydrates) directly targets the same insulin-resistance mechanism. Exercise matters in both forms covered in the general research, aerobic activity for cardiometabolic benefit and resistance training for insulin sensitivity specifically, making the WHO's combined aerobic-plus-strength guideline especially well-suited here. Specific supplements carry trial support: myo-inositol and D-chiro-inositol at the 40:1 ratio, and spearmint tea's anti-androgen effect. Sleep deserves direct attention too, given the sleep-apnea comorbidity, and stress management matters through the same cortisol-insulin interaction covered elsewhere in the hormone research.",
    citations: [
  ...
  },
  {
    id: 'prevention-ckd',
    category: 'basicHealth',
    title: "CKD's Levers Include a Direct Correction to the Standard 'Avoid Potassium' Advice",
    ...
    summary:
      "Chronic kidney disease progression responds to everyday choices, and the research includes a direct correction: blanket potassium restriction, the 'avoid bananas and oranges' advice given to nearly every CKD patient, has surprisingly little trial evidence behind it, and emerging research points toward a liberalized, plant-based, high-fiber pattern as potentially more helpful than restriction. Protein source matters more than protein avoidance: the research finds a plant-forward low-protein pattern (0.6 to 0.8g/kg/day) superior to animal-based protein on several measured outcomes. Sodium moderation following a DASH-aligned pattern remains well-supported. NSAIDs deserve direct avoidance given the quantified injury risk (73% general population, 63% in existing CKD). 'Hidden phosphorus,' the highly-absorbed additive form, is worth watching for on ingredient labels specifically, more than naturally-occurring phosphorus in whole foods. Adequate hydration, blood pressure control through the same DASH-style diet and regular moderate exercise, and avoiding documented nephrotoxic herbal supplements (aristolochic acid) round out the practical picture.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Type 2 diabetes carries some of the most striking evidence of lifestyle producing remission, not just management, of any condition in this app. The DiRECT trial found 46% of participants achieved complete diabetes remission at 12 months through a structured weight-management program alone, with some sustaining it 5 years out. Diet pattern matters directly: low-carbohydrate approaches showed strong short-term remission rates in the meta-analysis, and time-restricted eating independently improved fasting glucose and HbA1c in pooled trial data, a different, complementary lever from calorie or carbohydrate content alone. Exercise needs both forms already established in this app, aerobic activity and resistance training together, matching the WHO's combined guideline directly. Sleep deserves direct attention given the sleep-apnea research. An important complication: intensive glycemic control below the standard target doesn't improve outcomes and raises hypoglycemia risk, meaning the goal is an individualized target, not the tightest number achievable. Regular screening for retinopathy and neuropathy from the moment of diagnosis matters directly, given the finding that complications are often already present by then.",
    citations: [
  ...
  },
  {
    id: 'prevention-ibs',
    category: 'basicHealth',
    title: "IBS's Levers Blend Structured Diet Change With the Brain-Gut Connection Directly",
    ...
    summary:
      "IBS responds to a dual set of levers, the visceral-hypersensitivity research explains why both diet AND the brain-gut connection itself matter directly, not just one or the other. A structured, TEMPORARY low-FODMAP elimination, followed by systematic reintroduction (not permanent restriction), remains the best-evidenced dietary approach. An easy-to-miss finding: coffee, alcohol, and artificial sweeteners can all trigger symptoms on a DELAYED timeline (1 to 72 hours later per the research), meaning a same-day symptom diary can miss the trigger entirely. Soluble fiber tends to help more consistently than insoluble fiber. Regular meal timing and adequate hydration support gut motility directly. Brain-gut-axis therapies deserve equal weight to dietary change here, cognitive behavioral therapy and gut-directed hypnotherapy both carry trial evidence, since IBS's mechanism runs through the nervous system's processing of gut signals, not diet content alone. Regular, moderate exercise and stress management both work through this same pathway. Peppermint oil carries imperfect but supportive evidence as a targeted symptom-relief option.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Migraine's Levers Are Mostly About Consistency, Not Any One Specific Food",
    ...
    summary:
      "Migraine management centers on everyday consistency more than eliminating any one specific food, and the research includes a correction to some of the most common migraine advice: tyramine, the compound long blamed for aged-cheese and red-wine triggers, has documented problems as an explanation, and chocolate's evidence is mixed rather than a clear culprit. What evidence DOES support: a consistent sleep schedule and consistent meal timing (never skipping meals) both matter directly, since irregularity itself is a documented trigger. A specific combination, magnesium, riboflavin, and CoQ10 together, showed randomized trial benefit, reducing migraine days measurably more than either component alone might suggest. Caffeine carries complexity: it can be both a trigger for some people and a withdrawal-headache cause for others, sometimes through the very same medication, making CONSISTENCY (not necessarily elimination) the more reliable lever. Adequate hydration and regular, moderate (not suddenly intense) exercise both help, and stress-management techniques carry modest supporting evidence.",
    citations: [
  ...
  },
  {
    ...
    teaser: "CVD's levers: a Mediterranean or DASH-style whole-food pattern, quantified exercise volume, smoking cessation, and sodium moderation all trace back to the same foundational Seven Countries Study.",
    summary:
      "Cardiovascular disease responds directly and substantially to everyday choices, the Seven Countries Study first established the connection at international scale, finding southern European, Mediterranean-diet-following populations carrying roughly half the cardiovascular disease rate of northern European populations. The practical version of that same finding: a whole-food pattern built around olive oil, legumes, vegetables, and fish, low in saturated fat and processed food, is the single best-evidenced dietary lever in this whole category. Exercise carries quantified benefit at the WHO's general 150 to 300 minute weekly target, and the cardiac-rehabilitation research finds a 26 to 31% mortality reduction from structured post-event exercise programs specifically. Smoking cessation and sodium moderation (the same DASH-aligned target) both carry strong, direct evidence. Alcohol needs careful framing given the research, cardiovascular risk exists, but the evidence doesn't support a single simple rule the way smoking cessation does. Regular blood pressure and lipid-panel monitoring (see Self Advocacy) matters directly, since much of the risk-reduction value of diet and exercise only becomes visible through tracking these numbers over time.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Prostate Health's Levers Are Backed by Some of Oncology's Strongest Migrant-Study Evidence",
    teaser: "Prostate health's levers: lycopene, cruciferous vegetables, and regular exercise all carry quantified benefit, and migrant studies prove diet change measurably shifts risk within one lifetime, not just across generations.",
    summary: "Prostate health responds to everyday choices backed by some of the strongest evidence that diet changes individual risk. The migrant studies found men who moved from a low-incidence country to a high-incidence one saw their prostate cancer risk rise 4 to 12-fold within one generation, direct proof that environment and diet, not just genetics, drive most of the worldwide 30-fold incidence gap. Lycopene (concentrated in cooked tomatoes) and cruciferous vegetables (broccoli, cauliflower, the same sulforaphane compound) both carry dose-response trial support. Regular exercise carries a direct mortality benefit. Everyday choices: limiting processed and charred meat, moderating choline intake given the gut-bacteria-to-TMAO pathway, and keeping zinc intake adequate given the prostate's distinctive tissue concentration of it. Weight management and moderate alcohol both matter, and regular PSA and symptom monitoring (see Self Advocacy) is worth pursuing alongside diet and exercise, not instead of them.",
    citations: [
