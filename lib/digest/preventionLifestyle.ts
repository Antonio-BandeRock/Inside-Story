...
export const PREVENTION_LIFESTYLE_ENTRIES: DigestEntry[] = [
  {
    ...
    teaser: "Hashimoto's own levers: balanced (not excess, not deficient) iodine and selenium, medication timing, gut-supportive fiber, and avoiding the overtraining/under-eating patterns that suppress thyroid hormone.",
  ...
  },
  {
    ...
    teaser: "RA's own levers: a Mediterranean eating pattern, omega-3 dosing above 2.7g/day, moderate (not extreme) exercise, and smoking cessation, the single most consequential modifiable risk factor the RA research names.",
    summary:
      "Rheumatoid arthritis can't be prevented by diet alone once the underlying autoimmune process and genetic risk are in place, but this category's own already-covered research gives concrete levers for reducing flares and slowing joint damage. Diet: a RCT-backed Mediterranean pattern (olive oil, legumes, vegetables, fish) measurably reduces disease activity, and omega-3 dosing above 2.7 grams daily for at least 3 months reduces NSAID reliance. Smoking cessation is the single most consequential change available, research ties smoking directly to the citrullination process that drives RA's own antibody response, and quitting is one of the few RA risk factors a person can fully control. Exercise should be regular and moderate, not avoided out of fear of joint pain (research finds appropriate exercise reduces inflammation, not just maintains function) and not pushed to exhaustion. Bone protection matters directly: adequate calcium and vitamin D offset the fracture risk from glucocorticoid treatment already covered in this category. Worth knowing directly: this category's own 'window of opportunity' research means acting on all of this EARLY, within the first few months of diagnosis, produces measurably better long-term outcomes than the same changes made later.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Graves' disease is autoimmune and can't be prevented by lifestyle once the underlying genetic and immune process is set in motion, but this category's own already-covered research names one dominant modifiable factor above the rest: smoking. Meta-analysis-level evidence ties smoking directly to both a higher risk of developing Graves' disease and, more strongly, to worse thyroid eye disease specifically, making smoking cessation the single most consequential lifestyle change available. Iodine needs careful balance in the opposite direction from Hashimoto's: excess iodine can trigger or worsen Graves' disease in a genetically susceptible person, so avoiding high-dose iodine supplements and excessive seaweed/kelp intake matters directly, covered already in this category's own iodine research. A newer body of evidence ties chronic stress to Graves' onset in genetically susceptible people, making stress management a legitimate, evidence-grounded lever, not just general advice. During an active, uncontrolled hyperthyroid phase, exercise needs caution, this category's own already-covered cardiac research notes strain risk until heart rate and thyroid hormone levels are brought under control with treatment; once stabilized, the WHO's own general activity guideline applies normally.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Type 1 diabetes results from an autoimmune destruction of insulin-producing cells that begins well before diagnosis, this category's own already-covered staging research confirms it can be detected years earlier via antibody testing, but no known diet or lifestyle change stops or prevents that underlying process. What everyday choices DO shape is how well the condition is managed once it's here. Carbohydrate counting accuracy matters directly, this category's own already-covered research finds an average 21% error rate in typical carb estimates, and closing that gap measurably improves glucose stability. Exercise carries complexity worth knowing plainly, aerobic exercise can drop glucose while resistance exercise can sometimes raise it, so timing and type both matter, not just volume, and this category's own already-covered alcohol research adds a delayed-hypoglycemia risk worth planning around specifically. Bone health deserves direct attention given this category's own already-covered sevenfold hip-fracture-risk finding, weight-bearing and resistance exercise are a protective lever here specifically. Consistent meal timing, sick-day protocols, and awareness of this category's own already-covered celiac comorbidity (screening for gluten sensitivity, not avoiding gluten preemptively) round out the practical picture.",
    citations: [
  ...
  },
  {
    ...
    teaser: "IBD's own levers: smoking cessation matters, but works in OPPOSITE directions for Crohn's and ulcerative colitis, and evidence finds higher fiber intake tracking with LOWER flare risk, not the restriction many people are told.",
    summary: "Inflammatory bowel disease has genetic and environmental triggers already covered in this category, and while lifestyle can't prevent the underlying disease from developing, it shapes flare frequency and severity. Smoking needs careful, disease-specific framing: it's a documented risk factor for developing and worsening Crohn's disease, but carries a paradoxical protective effect specifically against ulcerative colitis, already covered in this category, meaning the right smoking-related guidance depends on which specific IBD diagnosis someone has. A direct correction worth stating plainly: the common advice to restrict fiber during a flare has surprisingly thin evidence behind it, this category's own already-covered research found no support for the restriction and, more strikingly, found higher fiber intake tracking with LOWER flare risk within six months. Vitamin D deficiency tracks directly with disease severity, adequate levels are a worthwhile target. Regular, moderate exercise, adequate hydration, and stress management all support the same gut-barrier and inflammation pathways already covered throughout the gut-microbiome research, and NSAIDs are worth avoiding given their own documented flare-triggering potential.",
    citations: [
  ...
  },
  {
    ...
    teaser: "PCOS's own levers: even modest weight loss (each 1% lost tracks with a 5.6% higher chance of ovulation returning), a lower-glycemic-load diet, and combined aerobic-plus-resistance exercise all work through the same central insulin-resistance mechanism.",
    summary: "PCOS is different from most autoimmune conditions: its own central mechanism, insulin resistance, is directly, powerfully responsive to diet and exercise, making lifestyle change closer to a primary treatment here than in almost any other condition covered. This category's own already-covered BAMBINI trial found each single percentage point of body weight lost tracking with a 5.6% higher chance of ovulation returning, a direct, quantified, real-world benefit. A lower-glycemic-load diet pattern (favoring whole grains, legumes, and vegetables over refined carbohydrates) directly targets the same insulin-resistance mechanism. Exercise matters in both forms already covered in the general research, aerobic activity for cardiometabolic benefit and resistance training for insulin sensitivity specifically, making the WHO's own combined aerobic-plus-strength guideline especially well-suited here. Specific supplements carry trial support in this category: myo-inositol and D-chiro-inositol at the 40:1 ratio already covered, and spearmint tea's own anti-androgen effect. Sleep deserves direct attention too, given this category's own already-covered sleep-apnea comorbidity, and stress management matters through the same cortisol-insulin interaction already covered elsewhere in the hormone research.",
    citations: [
  ...
  },
  {
    ...
    teaser: "CKD's own levers: the standard blanket potassium-restriction advice has surprisingly thin evidence, a plant-forward protein pattern shows advantages over animal protein, and NSAIDs carry a quantified, largely avoidable injury risk.",
    summary:
      "Chronic kidney disease progression responds to everyday choices, and this category's own already-covered research includes a direct correction worth stating plainly: blanket potassium restriction, the 'avoid bananas and oranges' advice given to nearly every CKD patient, has surprisingly little trial evidence behind it, and emerging research points toward a liberalized, plant-based, high-fiber pattern as potentially more helpful than restriction. Protein source matters more than protein avoidance: this category's own already-covered research finds a plant-forward low-protein pattern (0.6 to 0.8g/kg/day) superior to animal-based protein on several measured outcomes. Sodium moderation following a DASH-aligned pattern remains well-supported. NSAIDs deserve direct avoidance given this category's own already-covered, quantified injury risk (73% general population, 63% in existing CKD). 'Hidden phosphorus,' the highly-absorbed additive form already covered in this category, is worth watching for on ingredient labels specifically, more than naturally-occurring phosphorus in whole foods. Adequate hydration, blood pressure control through the same DASH-style diet and regular moderate exercise, and avoiding documented nephrotoxic herbal supplements (aristolochic acid, already covered here) round out the practical picture.",
    citations: [
  ...
  },
  {
    ...
    teaser: "Type 2 diabetes's own levers: the DiRECT trial found 46% of participants reached complete remission through structured weight management alone, and time-restricted eating shows an independent glucose benefit.",
    summary:
      "Type 2 diabetes carries some of the most striking evidence of lifestyle producing remission, not just management, of any condition in this Digest. This category's own already-covered DiRECT trial found 46% of participants achieved complete diabetes remission at 12 months through a structured weight-management program alone, with some sustaining it 5 years out. Diet pattern matters directly: low-carbohydrate approaches showed strong short-term remission rates in this category's own already-covered meta-analysis, and time-restricted eating independently improved fasting glucose and HbA1c in pooled trial data, a different, complementary lever from calorie or carbohydrate content alone. Exercise needs both forms already established in this Digest, aerobic activity and resistance training together, matching the WHO's own combined guideline directly. Sleep deserves direct attention given this category's own already-covered sleep-apnea research. A important complication worth knowing plainly: intensive glycemic control below the standard target doesn't improve outcomes and raises hypoglycemia risk, meaning the goal is an individualized target, not the tightest number achievable. Regular screening for retinopathy and neuropathy from the moment of diagnosis matters directly, given this category's own already-covered finding that complications are often already present by then.",
    citations: [
  ...
  },
  {
    ...
    teaser: "IBS's own levers: a structured, temporary low-FODMAP elimination, delayed-effect triggers (coffee, alcohol, artificial sweeteners) most people never connect to their own symptoms, and brain-gut-axis therapies like CBT and gut-directed hypnotherapy.",
    summary:
      "IBS responds to a dual set of levers, this category's own already-covered visceral-hypersensitivity research explains why both diet AND the brain-gut connection itself matter directly, not just one or the other. A structured, TEMPORARY low-FODMAP elimination, followed by systematic reintroduction (not permanent restriction), remains the best-evidenced dietary approach already covered in this category. A easy-to-miss finding worth stating plainly: coffee, alcohol, and artificial sweeteners can all trigger symptoms on a DELAYED timeline (1 to 72 hours later per this category's own already-covered research), meaning a same-day symptom diary can miss the trigger entirely. Soluble fiber tends to help more consistently than insoluble fiber. Regular meal timing and adequate hydration support gut motility directly. Brain-gut-axis therapies deserve equal weight to dietary change here, cognitive behavioral therapy and gut-directed hypnotherapy both carry trial evidence already covered in this category, since IBS's own mechanism runs through the nervous system's processing of gut signals, not diet content alone. Regular, moderate exercise and stress management both work through this same pathway. Peppermint oil carries real, if imperfect, evidence as a targeted symptom-relief option.",
    citations: [
  ...
  },
  {
    ...
    teaser: "Migraine's own levers: consistent sleep and meal timing matter more than any specific 'trigger food' avoidance list, a specific magnesium/riboflavin/CoQ10 combination shows trial-backed prevention benefit, and caffeine needs consistency more than avoidance.",
    summary:
      "Migraine management centers on everyday consistency more than eliminating any one specific food, and this category's own already-covered research includes an honest correction to some of the most common migraine advice: tyramine, the compound long blamed for aged-cheese and red-wine triggers, has documented problems as an explanation, and chocolate's own evidence is mixed rather than a clear culprit. What evidence DOES support: a consistent sleep schedule and consistent meal timing (never skipping meals) both matter directly, since irregularity itself is a documented trigger. A specific combination, magnesium, riboflavin, and CoQ10 together, showed randomized trial benefit already covered in this category, reducing migraine days measurably more than either component alone might suggest. Caffeine carries complexity worth knowing plainly: it can be both a trigger for some people and a withdrawal-headache cause for others, sometimes through the very same medication, making CONSISTENCY (not necessarily elimination) the more reliable lever. Adequate hydration and regular, moderate (not suddenly intense) exercise both help, and stress-management techniques carry genuine, if modest, supporting evidence.",
    citations: [
  ...
  },
  {
    ...
    teaser: "CVD's own levers: a Mediterranean or DASH-style whole-food pattern, quantified exercise volume, smoking cessation, and sodium moderation all trace back to the same foundational Seven Countries Study already covered in this category.",
    summary:
      "Cardiovascular disease responds directly and substantially to everyday choices, this category's own already-covered Seven Countries Study first established the connection at international scale, finding southern European, Mediterranean-diet-following populations carrying roughly half the cardiovascular disease rate of northern European populations. The practical version of that same finding: a whole-food pattern built around olive oil, legumes, vegetables, and fish, low in saturated fat and processed food, is the single best-evidenced dietary lever in this whole category. Exercise carries quantified benefit at the WHO's own general 150 to 300 minute weekly target, and this category's own already-covered cardiac-rehabilitation research finds a 26 to 31% mortality reduction from structured post-event exercise programs specifically. Smoking cessation and sodium moderation (the same DASH-aligned target already covered in this category) both carry strong, direct evidence. Alcohol needs honest framing given this category's own already-covered research, cardiovascular risk exists, but the evidence doesn't support a single simple rule the way smoking cessation does. Regular blood pressure and lipid-panel monitoring (already covered in this category's own self-advocacy research) matters directly, since much of the risk-reduction value of diet and exercise only becomes visible through actually tracking these numbers over time.",
    citations: [
