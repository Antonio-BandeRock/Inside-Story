...
export const PREVENTION_LIFESTYLE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "Prostate health's levers: lycopene, cruciferous vegetables, and regular exercise all carry quantified benefit, and migrant studies covered in this category prove diet change measurably shifts risk within one lifetime, not just across generations.",
    summary: "Prostate health responds to everyday choices backed by some of the strongest evidence that diet changes individual risk, not just population-level statistics. The migrant studies found men who moved from a low-incidence country to a high-incidence one saw their prostate cancer risk rise 4 to 12-fold within one generation, direct proof that environment and diet, not just genetics, drive most of the worldwide 30-fold incidence gap. Lycopene (concentrated in cooked tomatoes) and cruciferous vegetables (broccoli, cauliflower, the same sulforaphane compound) both carry dose-response trial support. Regular exercise carries a direct mortality benefit, not just a general fitness recommendation. Everyday choices: limiting processed and charred meat, moderating choline intake given the gut-bacteria-to-TMAO pathway, and keeping zinc intake adequate given the prostate's distinctive tissue concentration of it. Weight management and moderate alcohol both matter, and regular PSA and symptom monitoring (covered in this category's self-advocacy research) is worth pursuing alongside diet and exercise, not instead of them.",
    citations: [
