...
export const PREVENTION_LIFESTYLE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Migraine management centers on everyday consistency more than eliminating any one specific food, and this category's own already-covered research includes an honest correction to some of the most common migraine advice: tyramine, the compound long blamed for aged-cheese and red-wine triggers, has documented problems as an explanation, and chocolate's own evidence is mixed rather than a clear culprit. What evidence DOES support: a consistent sleep schedule and consistent meal timing (never skipping meals) both matter directly, since irregularity itself is a documented trigger. A specific combination, magnesium, riboflavin, and CoQ10 together, showed randomized trial benefit already covered in this category, reducing migraine days measurably more than either component alone might suggest. Caffeine carries complexity : it can be both a trigger for some people and a withdrawal-headache cause for others, sometimes through the very same medication, making CONSISTENCY (not necessarily elimination) the more reliable lever. Adequate hydration and regular, moderate (not suddenly intense) exercise both help, and stress-management techniques carry genuine, if modest, supporting evidence.",
    citations: [
