...
export const PREVENTION_LIFESTYLE_ENTRIES: DigestEntry[] = [
  {
    ...
    summary:
      "Hashimoto's is autoimmune, real genetic and environmental triggers set it in motion before any lifestyle choice comes into play, so this isn't about prevention in the way it might be for a purely diet-driven condition. What real, everyday choices DO shape is how well the condition is managed day to day. This app's own already-covered research supports a few real, concrete changes: keep iodine intake balanced rather than chasing either extreme (both deficiency and excess can worsen thyroid autoimmunity, real, dose-dependent research already covers this directly); keep selenium intake adequate, since even mild deficiency tracks with worse autoimmune activity; take levothyroxine on an empty stomach, separated from calcium, iron, coffee, and high-fiber meals by the real intervals this app's own labs research already establishes; favor a whole-food, fiber-rich, moderately fermented diet that supports the gut barrier this app's own microbiome research ties directly to autoimmune activity; and keep exercise real and moderate, rather than either sedentary or extreme, since both under-eating and overtraining can suppress T3 through the same cortisol/HPA-axis pathway already covered in this app's own mitochondria research. The World Health Organization's own general activity target, 150 to 300 minutes of moderate exercise weekly plus muscle-strengthening work twice a week, is a real, reasonable, unremarkable-feeling starting point, not an extreme one.",
    citations: [
  ...
  },
  {
    ...
    teaser: "RA's own real levers: a Mediterranean eating pattern, real omega-3 dosing above 2.7g/day, moderate (not extreme) exercise, and smoking cessation, the single most consequential modifiable risk factor this app's own RA research names.",
    summary:
  ...
  },
  {
    ...
    summary:
      "PCOS is genuinely different from most autoimmune conditions in this Digest: its own central mechanism, insulin resistance, is directly, powerfully responsive to diet and exercise, making lifestyle change closer to a real primary treatment here than in almost any other condition covered in this app. This category's own already-covered BAMBINI trial found each single percentage point of body weight lost tracking with a real 5.6% higher chance of ovulation returning, a genuinely direct, quantified, real-world benefit. A lower-glycemic-load diet pattern (favoring whole grains, legumes, and vegetables over refined carbohydrates) directly targets the same insulin-resistance mechanism. Exercise matters in both real forms already covered in this app's own general research, aerobic activity for cardiometabolic benefit and resistance training for insulin sensitivity specifically, making the WHO's own combined aerobic-plus-strength guideline especially well-suited here. Real, specific supplements carry genuine trial support in this category: myo-inositol and D-chiro-inositol at the real 40:1 ratio already covered, and spearmint tea's own real anti-androgen effect. Sleep deserves real, direct attention too, given this category's own already-covered sleep-apnea comorbidity, and stress management matters through the same cortisol-insulin interaction already covered elsewhere in this app's own hormone research.",
    citations: [
