...
export const MITOCHONDRIA_METABOLISM_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Most findings in this research base are correlational: two things measured together, a plausible mechanism proposed to connect them. This entry is a rarer thing, direct experimental proof of cause and effect. Hashimoto's thyroid follicular cells show elevated IL-23 actively suppressing autophagy, the cell's internal cleanup process, and driving reactive oxygen species (ROS) accumulation, via the AKT/mTOR/NF-κB pathway. Researchers didn't just observe this. They tested it directly. Blocking IL-23, blocking mTOR, and blocking NF-κB were each tried independently, and each one independently reversed both the suppressed autophagy and the ROS buildup. A rare case in the whole research base of a mechanism confirmed through direct experimental intervention rather than only measured association.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: "The same Treg cells the Gut & Microbiome research keeps returning to, specifically depleted in one tissue.",
    summary: "Regulatory T cells, or Tregs, show up throughout the Gut & Microbiome research as the immune cells that keep the body from attacking itself. This entry finds them specifically missing somewhere unexpected. Hashimoto's patients show measurably depleted regulatory T cells specifically within visceral adipose tissue, the same immune cell type SCFAs from dietary fiber were shown to induce elsewhere in the Gut & Microbiome research, here found specifically reduced in visceral fat rather than uniformly reduced everywhere in the body. A specific finding, not a general \"inflammation is bad\" statement. One particular tissue, one particular missing cell type, directly connecting this category back to the gut-immune mechanisms covered elsewhere.",
    citations: [
      {
