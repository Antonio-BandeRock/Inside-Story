...
export const MITOCHONDRIA_METABOLISM_ENTRIES: DigestEntry[] = [
  {
    ...
    teaser: "A tiny peptide made by mitochondria themselves, measured lower in real Hashimoto's patients -- not borrowed from another disease.",
    summary:
      "Most of this category has to borrow evidence from other diseases or general metabolic research. This one didn't need to. A real study measured circulating MOTS-c -- a peptide produced by mitochondria that regulates insulin sensitivity and inflammation -- in 90 Hashimoto's patients against 90 matched controls, finding it significantly lower in the patient group. It was also inversely correlated with autoantibody levels, meaning lower MOTS-c tracked with a more active autoimmune process, not just a passive side effect sitting alongside it. A genuinely Hashimoto's-specific mitochondrial finding, not extrapolated from a different condition -- real evidence the disease reaches down to the cellular power-generation level, not just the thyroid gland itself.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "Most findings in this research base are correlational -- two things measured together, a plausible mechanism proposed to connect them. This entry is a rarer thing: real, direct experimental proof of cause and effect. Hashimoto's thyroid follicular cells show elevated IL-23 actively suppressing autophagy -- the cell's own internal cleanup process -- and driving reactive oxygen species (ROS) accumulation, via the AKT/mTOR/NF-κB pathway. Researchers didn't just observe this; they tested it directly. Blocking IL-23, blocking mTOR, and blocking NF-κB were each tried independently, and each one independently reversed both the suppressed autophagy and the ROS buildup. A rare case in this app's whole research base of a mechanism confirmed through direct experimental intervention rather than only measured association -- real proof, not just a plausible story.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: 'The identical pathway shows up reprogramming the immune cells driving the attack itself -- a real mechanistic bridge, not two separate topics.',
    summary:
      "The mTOR pathway just implicated in suppressing thyroid-cell autophagy doesn't stop there. It shows up again, in a completely different part of the same disease. The same mTOR pathway reprograms the CD4+ T cells that drive the autoimmune attack itself onto an altered fatty-acid-oxidation fuel source -- meaning the immune cells doing the attacking and the thyroid tissue being attacked are both, independently, being shaped by the same one metabolic pathway. A real mechanistic bridge connecting two parts of the disease that would otherwise look completely unrelated -- thyroid tissue damage on one side, the immune cells attacking it on the other -- both converging on one shared pathway.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "Fasting shows up in wellness conversations as an almost universally positive intervention. The real research on it, specifically for someone with Hashimoto's, is genuinely more complicated than that. Fasting and caloric restriction are genuinely the most potent known triggers of autophagy -- the exact cellular cleanup process IL-23 was shown above to suppress in Hashimoto's specifically. But fasting also reliably suppresses T3 and raises reverse-T3 via hypothalamic TRH downregulation -- a real, well-documented thyroid-specific cost, not a minor footnote. Both facts are presented here together deliberately, rather than picking the flattering one; the most plausible reading is that short, moderate fasting windows -- not multi-day extended fasts -- are where the two effects most reasonably balance out.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Most fasting-and-autophagy research happens in animal models or short-term lab settings. Real, sustained human fasting data in people who already have a thyroid condition is much harder to come by -- except for one real, recurring natural experiment. Studies of Ramadan fasting in existing hypothyroid patients found independent TSH suppression during the fasting period, plus a real, practical complication: fasting disrupts the empty-stomach medication-absorption timing levothyroxine dosing depends on. A genuine, human -- not animal-model -- data point on how fasting interacts with existing thyroid treatment specifically, distinct from the general autophagy-benefit research above, and worth a real conversation with a doctor before combining any extended fast with existing thyroid medication.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "Visceral fat gets discussed throughout this category as a real problem -- inflamed, hormonally active tissue linked to worse metabolic outcomes. One more recent reappraisal complicates that picture in a genuinely interesting way. A 2024 reappraisal argues visceral fat inflammation partly functions as an adaptive barrier, filtering gut-derived endotoxin before it reaches general circulation -- meaning some of the inflammation associated with visceral fat may be a downstream consequence of gut permeability, rather than an independent problem in its own right. A real reason gut repair, covered under Gut & Microbiome, and visceral fat reduction likely need pursuing together, not as substitutes for each other -- the fat may be as much a symptom of the gut problem as a problem of its own.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'The real reason to prefer gentle exercise for an autoimmune condition -- reached by a completely different route than the previous entry.',
    summary:
      "If exercise intensity doesn't meaningfully change the inflammation-marker story, why does this app's own research still lean toward recommending low intensity specifically? The real answer runs through a different mechanism entirely. High-intensity exercise drives cortisol toward levels comparable to Cushing's syndrome and can shift immune balance toward a Th2-dominant profile -- the identical HPA-axis/cortisol-suppressing-deiodinase pathway already covered under Lifestyle & Environment for alcohol, juice, and chronic stress, reached here by an entirely different route. One more real appearance of the same recurring hormone pathway this app's own research keeps circling back to -- worth understanding once, as one real mechanism, rather than as another separate warning.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "After fasting's own real tension (a powerful autophagy trigger with a real thyroid-hormone cost) and exercise's own cortisol caveat, this category could easily end on a note of \"everything has a downside.\" One real finding pushes back against that. Exercise itself, independent of fasting, triggers autophagy and mitophagy -- the mitochondria-specific version of the same cellular cleanup process -- in skeletal muscle through the PGC-1α pathway. A real, positive mechanism that doesn't carry fasting's own T3-suppression tradeoff, making moderate, consistent, low-intensity exercise a genuinely dual-benefit intervention across both the autophagy and the cortisol/inflammation mechanisms this category covers.",
    citations: [
