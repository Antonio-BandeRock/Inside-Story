...
export const MITOCHONDRIA_METABOLISM_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "If exercise intensity doesn't meaningfully change the inflammation-marker story, why does the research still lean toward recommending low intensity specifically? The answer runs through a different mechanism entirely. High-intensity exercise drives cortisol toward levels comparable to Cushing's syndrome and can shift immune balance toward a Th2-dominant profile, the identical HPA-axis/cortisol-suppressing-deiodinase pathway already covered under Lifestyle & Environment for alcohol, juice, and chronic stress, reached here by an entirely different route. One more appearance of the same recurring hormone pathway the research keeps circling back to, worth understanding once, as one mechanism, rather than as another separate warning.",
    citations: [
      {
