...
export const BODY_FAT_BIOLOGY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "A direct study of the Hadza measured blood pressure across nearly 200 people and cardiovascular biomarkers (C-reactive protein, cholesterol, triglycerides) in a smaller sample, alongside continuous heart-rate monitoring to quantify actual daily activity. The Hadza spend over two hours a day in moderate-to-vigorous physical activity on average, more than 14 times the amount typically measured in large United States epidemiological studies, and researchers found low blood pressure across every age group studied and consistently favorable levels on every cardiovascular biomarker measured. The limit here matters: this is an observational study of one population, not a controlled experiment, so it cannot cleanly separate how much of this protection comes from activity level specifically versus diet, body composition, or other lifestyle factors that all differ from industrialized populations at the same time. Still, it is a directly measured data point supporting a documented relationship between sustained physical activity and cardiovascular health, worth reading alongside the dedicated cardiovascular disease research rather than as an isolated documentary anecdote.",
    citations: [
  ...
  },
  {
    ...
    summary: "Not all body fat behaves the same way metabolically. Visceral fat, stored deep in the abdominal cavity around the organs, is consistently linked to glucose intolerance, unfavorable cholesterol levels, and high blood pressure. This research traces back to a specific classification, visceral fat obesity as a distinct risk category, developed through direct CT-scan measurement. Subcutaneous fat, stored just under the skin, does not carry the same risk profile at a comparable amount. This distinction is the documented reason two people with a similar body-fat percentage, or even a similar total weight, can have meaningfully different metabolic health, and it's part of why NOVA's The Truth About Fat (PBS, 2020) highlighted sumo wrestlers specifically: despite very high total body fat, active wrestlers were reported to carry disproportionately more of it subcutaneously rather than viscerally, alongside favorable glucose and cholesterol levels while actively training. That specific sumo-wrestler comparison traces to the documentary and secondary science journalism rather than a dedicated peer-reviewed study, so it is an illustrative example rather than a citation, clearly separate from the well-established general visceral-fat science above. Waist circumference (a rough proxy for visceral fat) is a more informative single number for metabolic risk than weight or body-fat percentage alone.",
    citations: [
