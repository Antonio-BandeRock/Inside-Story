...
export const PROSTATE_HEALTH_ENTRIES: DigestEntry[] = [
  {
    ...
    summary: "Two real, separate conditions live under this category. Benign prostatic hyperplasia (BPH) is a non-cancerous enlargement of the prostate gland that squeezes the urethra, causing urinary symptoms (frequency, urgency, a weak stream, nighttime waking to urinate); it's genuinely age-dependent, real data showing 29% prevalence in men in their 50s, climbing to 44.7% in their 60s, 58.1% in their 70s, and 69.2% at 80 and older. Prostate cancer is a real, separate disease, the most commonly diagnosed cancer among American men, accounting for roughly 27% of new male cancer diagnoses in a recent year. Both conditions share real, overlapping risk factors and, notably, both have genuine, independently documented connections to diet and the gut microbiome: specific gut bacteria convert dietary compounds into androgens that directly affect prostate tissue, gut dysbiosis is linked to BPH through reduced anti-inflammatory short-chain fatty acid production, and specific whole foods (tomatoes, cruciferous vegetables) carry real, quantified risk-reduction evidence. Diet won't cure either condition, and nothing here replaces a urologist's own evaluation and treatment plan. What follows is what the actual research supports, kept honest about how strong each finding really is.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The same real dietary pattern that supports a healthy gut microbiome elsewhere shows up again here, with its own direct prostate evidence.",
    summary: "Diets rich in plant foods, fiber, and prebiotics are real, documented to promote gut microbial profiles linked to anti-inflammatory and anti-carcinogenic activity, while a Western dietary pattern, high in saturated fat and processed food, is real, documented to promote the dysbiosis linked to both BPH and worse prostate cancer outcomes. This isn't a single supplement or a single food; it's the same broad, whole-food pattern the research already finds carrying real evidence across several other conditions, showing up here through its own real, prostate-specific mechanism. Short-term dietary changes are real, documented to measurably shift gut microbiota composition, and microbiota composition genuinely differs between prostate cancer patients and healthy individuals, a real, if not yet fully causal, connection worth taking seriously as a genuine lever rather than dismissed as unrelated to a gland-specific disease.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A real, large prospective cohort found metabolic syndrome tracked with a faster prostate growth rate and worse urinary symptoms, the same real insulin-resistance mechanism already covered elsewhere.',
    summary: "Metabolic syndrome (the real cluster of insulin resistance, obesity, high blood pressure, and abnormal cholesterol already covered across several other conditions, including PCOS and Type 2 Diabetes) has real, direct, documented reach into prostate health specifically. A real, large prospective cohort study found metabolic syndrome a significant, independent risk factor for developing BPH in the first place, and a separate real study of men with moderate-to-severe urinary symptoms found metabolic syndrome tracked with a real, faster annual prostate growth rate, larger prostate volume, lower peak urine flow, and more residual urine left in the bladder after voiding, real, measured markers of the disease's own actual clinical progression, not just its presence. The real, proposed mechanisms run through several already-familiar pathways: insulin resistance and inflammation both directly promoting prostate tissue growth, plus a real, documented shift in sex-hormone balance (including lower sex-hormone-binding protein) that metabolic syndrome itself tends to cause. Worth knowing directly: this gives someone managing both BPH and metabolic syndrome a real, concrete, twofold reason to address the metabolic side specifically, not just for the separately well-documented cardiovascular and diabetes benefits already covered elsewhere, but as a real, direct lever on BPH's own actual day-to-day urinary symptoms and its own future progression.",
    citations: [
  ...
  },
  {
    ...
    category: 'prostateHealth',
    title: 'The Two Main 5-Alpha-Reductase Drugs Aren’t Interchangeable -- Real, Head-to-Head Data Finds One Works Harder',
    teaser: "This category's own already-covered 5-ARI cancer-risk controversy and combination-therapy research treat finasteride and dutasteride as one drug class -- a real, head-to-head comparison finds a genuine effectiveness difference between the two.",
    summary:
      "This category's own already-covered research on 5-alpha-reductase inhibitors (5-ARIs) -- the drug class that shrinks an enlarged prostate by blocking the hormone conversion driving its growth -- has mostly treated finasteride and dutasteride as one interchangeable group. A real, direct, head-to-head comparison finds a genuine difference worth knowing before choosing between them. A real-world retrospective study of 401 BPH patients (162 on finasteride, 239 on dutasteride, evaluated after at least six months of continuous treatment) found dutasteride achieved a significantly greater reduction in prostate volume (26.3 percent versus 18.1 percent), a significantly greater PSA reduction (43.7 percent versus 32.5 percent), and a real, if smaller, edge in symptom-score improvement. The real, practical reason: dutasteride blocks both real forms of the enzyme (type 1 and type 2) that converts testosterone into the more potent hormone driving prostate growth, while finasteride blocks only the type 2 form, a genuine mechanistic difference behind the measured gap. Real, direct safety comparison found the two drugs equally gentle on sexual function (no statistically meaningful difference in erectile-function scores) and on kidney function, meaning the real tradeoff isn't about safety, it's about how much shrinkage a given case of BPH actually needs. Worth stating directly: this doesn't override this category's own already-covered 5-ARI cancer-risk-controversy or MTOPS/CombAT combination-therapy research, which both still apply to either drug -- it's real, useful evidence that the choice between the two isn't arbitrary, and worth a real, direct conversation about which one better fits a specific case.",
    citations: [
