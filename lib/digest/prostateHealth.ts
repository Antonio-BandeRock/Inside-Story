...
export const PROSTATE_HEALTH_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Diets rich in plant foods, fiber, and prebiotics are documented to promote gut microbial profiles linked to anti-inflammatory and anti-carcinogenic activity, while a Western dietary pattern, high in saturated fat and processed food, is documented to promote the dysbiosis linked to both BPH and worse prostate cancer outcomes. This isn't a single supplement or a single food; it's the same broad, whole-food pattern the research already finds carrying evidence across several other conditions, showing up here through its prostate-specific mechanism. Short-term dietary changes are documented to measurably shift gut microbiota composition, and microbiota composition differs between prostate cancer patients and healthy individuals, a real, if not yet fully causal, connection worth taking seriously as a lever rather than dismissed as unrelated to a gland-specific disease.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "The tissue hypoxia named in the ischemia hypothesis above doesn't just sit there passively. Low-oxygen prostate tissue activates hypoxia-inducible factor-1alpha (HIF-1alpha), which switches on genes for vascular endothelial growth factor (VEGF) and drives angiogenesis, the growth of new blood vessels a hyperplastic or malignant mass needs to keep expanding. This same HIF-1alpha/VEGF pathway is documented as active in BPH tissue, and is separately, and far more prominently, tied to prostate cancer's progression, where HIF-1alpha upregulation is considered an early event in a real, formally named process called the angiogenic switch, the point where a small, dormant tumor begins actively recruiting its blood supply. A direct comparative study measuring microvessel density found angiogenesis significantly more prominent in prostate cancer than in BPH tissue from the same patient population. This is a shared molecular pathway triggered by the same low-oxygen conditions, not evidence that BPH is somehow becoming cancer, and BPH and prostate cancer remain two separate diseases (see the overview). It has already opened a real, if early, research direction of its own: at least one BPH-specific herbal compound has been studied specifically for inhibiting this pathway, a different therapeutic angle from the hormone-blocking medications already covered elsewhere in this category.",
    citations: [
