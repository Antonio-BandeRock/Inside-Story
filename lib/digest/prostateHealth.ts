...
export const PROSTATE_HEALTH_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'prostateHealth',
    title: 'Nearly Half of Men With Chronic Pelvic Pain Report Specific Foods Making It Worse, and the List Is Consistent',
    teaser:
  ...
  },
  {
    ...
    teaser: "This category's already-covered family-history research already names BRCA mutations as a risk factor. Approved PARP inhibitors now let a positive genetic test actively guide treatment, not just risk awareness.",
    summary:
      "This category's already-covered family-history and genetic-risk research already names BRCA1/BRCA2 mutations as an elevated prostate cancer risk factor. PARP inhibitors turn that same genetic information into an actual treatment decision: cancer cells with a BRCA mutation already have a damaged DNA-repair system, and PARP inhibitors block a second, backup repair pathway those same cells still rely on, a precision approach that works specifically because of the mutation, not despite it. A Phase 3 trial (PROfound) tested olaparib specifically in men with metastatic, treatment-resistant prostate cancer carrying BRCA1, BRCA2, or a related gene mutation, and found meaningful clinical benefit, with a separate trial finding over 1 in 5 evaluable patients showing a greater-than-50% drop in PSA, most of them specifically the ones with a confirmed DNA-repair-gene mutation. This treatment only works for men who actually carry one of these specific mutations, confirmed genetic testing is required first, and known side effects include fatigue, gastrointestinal symptoms, and in some cases meaningful drops in blood cell counts, a tradeoff worth weighing directly with an oncologist.",
    citations: [
