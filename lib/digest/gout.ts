...
export const GOUT_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "One of the few individual foods in any condition covered with its own dedicated case-crossover study measuring a real, specific attack-risk reduction.",
    summary:
  ...
  },
  {
    ...
    category: 'gout',
    title: "Gout Rarely Travels Alone: A Real, Direct Overlap With Several Other Conditions",
    teaser: "Gout's own most common real risk factors are, largely, the same conditions already built out in their own right.",
    summary: "Real, standard medical guidance names heart failure, high blood pressure, and chronic kidney disease directly among gout's own most common real risk factors, and the real, underlying relationship runs in both directions for at least one of these. Elevated uric acid can itself contribute to real kidney damage over time, while reduced kidney function separately impairs the body's own ability to clear uric acid in the first place, a genuine, bidirectional relationship rather than a one-way cause, already covered in real depth in the dedicated chronic kidney disease research. Gout also shows up alongside insulin resistance and metabolic syndrome more often than chance would predict, the same real, shared thread already documented connecting the Type 2 Diabetes, PCOS, MASLD, and CKD research together. Worth knowing directly and practically: someone managing weight, blood pressure, or insulin resistance well is very likely also working on real, shared risk factors for gout at the same time, not a separate, unrelated project.",
    citations: [
      { source: 'Gout, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/gout.html' },
    ],
  ...
  },
  {
    ...
    summary: "Line up everything in this category and gout reads as a condition where the real, individual dietary evidence is genuinely more specific and better studied than most other conditions: meat and seafood measurably raise risk while dairy measurably lowers it, sugar-sweetened drinks and beer carry real, dose-dependent risk while diet soda and wine don't, and cherries, vitamin C, and coffee all carry real, individually-tested, protective associations. Medication choice carries a real, serious, quantified safety distinction (allopurinol's real cardiovascular safety advantage over febuxostat), and this category's own two self-advocacy entries matter at two genuinely different moments: HLA-B*58:01 testing before a first allopurinol prescription in specific, named higher-risk populations, and recognizing when a flare might actually be a real joint infection needing urgent, different treatment. And gout's own real, common overlap with heart, kidney, and metabolic conditions already built out elsewhere means managing those well is very likely helping gout too, not a separate, unrelated effort.",
    citations: [
      { source: 'Gout, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/gout.html' },
    ],
    overallTier: 'strong',
