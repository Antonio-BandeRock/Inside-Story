...
export const GOUT_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Allopurinol and febuxostat both work by blocking xanthine oxidase, the enzyme that produces uric acid, and both are standard first-line options for long-term gout management. A large, dedicated safety trial (6,190 patients, median follow-up 32 months) was run specifically because febuxostat's FDA approval required this direct comparison, and it found a serious, quantified difference: febuxostat carried a 34% higher risk of cardiovascular death and a 22% higher risk of death from any cause compared to allopurinol, even though the two performed similarly on the trial's broader combined safety measure. This is worth knowing directly and by name in a conversation with a prescriber, especially for anyone with existing cardiovascular risk (see the dedicated cardiovascular disease research), allopurinol remains the standard first choice for most people specifically because of this trial's findings, with febuxostat generally reserved for people who can't tolerate or don't respond to allopurinol.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's already-covered DASH-pattern research names a 26-year cohort's long-term risk reduction, a direct, randomized feeding trial tested DASH against actual uric acid levels, and found a surprising, honest twist involving sodium.",
    summary: "This category's already-covered DASH-diet research names a long-term, observational cohort finding risk reduction over 26 years, and a direct, controlled, randomized ancillary study of the original DASH-Sodium trial gives this category's already-established pattern a mechanistic, interventional confirmation. In this randomized crossover feeding study (103 participants, Johns Hopkins), the DASH diet produced a statistically significant reduction in serum uric acid of 0.35 mg/dL compared with a control diet, with the effect substantially larger in people who started with already-elevated uric acid (7 mg/dL or higher), a 1.3 mg/dL drop in that specific group. The SAME trial found a counterintuitive result for sodium: increasing sodium intake from a low level actually LOWERED serum uric acid (by 0.3 to 0.4 mg/dL at medium and high sodium levels), the opposite direction someone might expect given sodium's already-covered link to hypertension elsewhere in the research. Research doesn't fully resolve why this happens, but it's honest, controlled trial data, not something to quietly leave out because it complicates a simpler story. Neither finding overturns this category's already-established DASH-pattern benefit (the diet's OVERALL uric-acid-lowering effect held regardless of the sodium result), but the honest sodium twist is a useful reminder that a single nutrient's effect on one lab value doesn't always match its effect on a whole, different condition, worth discussing directly with a doctor rather than assuming every dietary rule generalizes cleanly across conditions.",
    citations: [
