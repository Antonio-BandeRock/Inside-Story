...
export const GOUT_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered colchicine entry names its own narrow therapeutic index, direct comparative trials find naproxen and steroids often work just as well for an acute flare, useful alternatives to know about.",
    summary:
