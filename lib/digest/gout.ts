...
export const GOUT_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Standard medical guidance names heart failure, high blood pressure, and chronic kidney disease directly among gout's own most common risk factors, and the underlying relationship runs in both directions for at least one of these. Elevated uric acid can itself contribute to kidney damage over time, while reduced kidney function separately impairs the body's own ability to clear uric acid in the first place, a bidirectional relationship rather than a one-way cause, already covered in depth in the dedicated chronic kidney disease research. Gout also shows up alongside insulin resistance and metabolic syndrome more often than chance would predict, the same shared thread already documented connecting the Type 2 Diabetes, PCOS, MASLD, and CKD research together. Worth knowing directly and practically: someone managing weight, blood pressure, or insulin resistance well is very likely also working on shared risk factors for gout at the same time, not a separate, unrelated project.",
    citations: [
      { source: 'Gout, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/gout.html' },
    ],
  ...
  },
  {
    ...
    summary:
      "Gout is usually framed as a disease of aging, but when it shows up early, in the teens, twenties, or thirties, research points toward a different, more concentrated set of causes than the diet and lifestyle factors this category otherwise emphasizes. Adolescents and young adults with gout tend to have measurably higher uric acid levels, faster development of tophi (visible urate deposits), and a higher rate of family history compared with people who develop gout later in life, evidence that genetics plays an even larger role in early-onset cases than in the more common, later-life form. Two specific genetic causes account for a meaningful share of these early cases: mutations in the UMOD gene cause a distinct inherited kidney condition (ADTKD-UMOD) that produces early hyperuricemia, gout, and progressive kidney scarring, often reaching kidney failure by around age 40, and dysfunction in the ABCG2 urate transporter gene is strongly associated with pediatric- and early-onset hyperuricemia and gout independent of any kidney disease. Worth knowing directly: gout appearing well before the typical age, especially alongside a family history of gout or unexplained kidney problems, is a reasonable trigger for asking a doctor about genetic testing or a kidney-function workup, rather than assuming diet alone explains it.",
    citations: [
