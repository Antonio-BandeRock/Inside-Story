...
export const GOUT_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "This category's already-covered DASH-pattern research names a 26-year cohort's long-term risk reduction, a direct, randomized feeding trial tested DASH against actual uric acid levels, and found a surprising twist involving sodium.",
    summary: "This category's already-covered DASH-diet research names a long-term, observational cohort finding risk reduction over 26 years, and a direct, controlled, randomized ancillary study of the original DASH-Sodium trial gives this category's already-established pattern a mechanistic, interventional confirmation. In this randomized crossover feeding study (103 participants, Johns Hopkins), the DASH diet produced a statistically significant reduction in serum uric acid of 0.35 mg/dL compared with a control diet, with the effect substantially larger in people who started with already-elevated uric acid (7 mg/dL or higher), a 1.3 mg/dL drop in that specific group. The SAME trial found a counterintuitive result for sodium: increasing sodium intake from a low level actually LOWERED serum uric acid (by 0.3 to 0.4 mg/dL at medium and high sodium levels), the opposite direction someone might expect given sodium's already-covered link to hypertension elsewhere in the research. Research doesn't fully resolve why this happens, but it's controlled trial data, not something to quietly leave out because it complicates a simpler story. Neither finding overturns this category's already-established DASH-pattern benefit (the diet's OVERALL uric-acid-lowering effect held regardless of the sodium result), but the sodium twist is a useful reminder that a single nutrient's effect on one lab value doesn't always match its effect on a whole, different condition, worth discussing directly with a doctor rather than assuming every dietary rule generalizes cleanly across conditions.",
    citations: [
  ...
  // the kind this app's own evidence-tiering discipline exists for.
  {
    ...
    overallTier: 'moderate',
    stageNote: 'The causal (Mendelian randomization) evidence is the stronger of the two citations here; the observational correlation citation is included for the contrast, not as independent proof.',
  ...
  // verified via WebSearch.
  {
    ...
    overallTier: 'moderate',
    stageNote: 'A randomized pilot trial, but a small one (33 people); a good candidate for a larger confirmatory trial, not yet strong enough to treat as a settled, first-line recommendation on its own.',
