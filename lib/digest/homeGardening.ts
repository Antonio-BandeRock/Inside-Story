...
export const HOME_GARDENING_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: 'Zones 9 and 10: A Inverted Growing Calendar',
    ...
    overallTier: 'strong',
    stageNote: 'A specific, regionally documented finding, not a general rule of thumb, the 92-degree fruit-set threshold and the three-region planting-window structure both come directly from University of Florida\'s own extension guide.',
    relatedIds: ['garden-understanding-your-zone', 'garden-tropical-subtropical-crops'],
  },
  {
    id: 'garden-tropical-subtropical-crops',
    category: 'homeGardening',
    title: 'Zones 10 Through 13: True Year-Round, With Its Own Rules',
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: 'The Easiest Crops for a First Garden',
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: 'Ways to Stretch a Growing Season by Six to Eight Weeks',
    teaser: 'A floating row cover, a cold frame, or a simple hoop house can each add weeks onto both ends of a growing season, in any zone.',
    summary:
      "Season-extension tools work by creating a small, unheated microclimate around a plant, and Clemson Cooperative Extension's Home & Garden Information Center describes several low-cost options that apply in any zone. A floating row cover is a lightweight, permeable fabric laid directly over plants, raising the humidity and temperature around them enough to protect against light frost without any support structure. A hooped row cover, or low tunnel, suspends that same fabric over a series of wire or PVC hoops, giving better protection against cold, wind, and hail than a floating cover alone. A cold frame is a small, bottomless box with a clear lid that relies entirely on the sun for heat during the day and a closed lid to slow heat loss at night, useful both for hardening off seedlings and for growing cold-tolerant crops through the shoulder seasons. A hoop house, also called a high tunnel, is a larger, walk-in version of the same basic idea, essentially an unheated greenhouse. Used well, these tools extend a growing season by a six to eight weeks combined, spring and fall, letting a gardener in almost any zone start earlier and harvest later than the raw frost dates alone would allow.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: 'A Measured Freshness Benefit Shipped Produce Structurally Can\'t Match',
    ...
    overallTier: 'strong',
    stageNote: 'A controlled, published measurement, not an estimate. The exact retention percentage varies by nutrient and crop, but the direction (faster loss at higher temperature, meaningful loss within days) is well established.',
    ...
    chart: {
      ...
      sourceNote: 'Pandrangi & LaBorde 2004, Journal of Food Science, measured spinach nutrient retention',
    },
  },
  {
    ...
    chart: {
      ...
      sourceNote: 'University of Maryland Extension, soil-lead thresholds for vegetable gardening',
    },
  },
  {
    id: 'garden-composting-at-home',
    category: 'homeGardening',
    title: 'Turning Kitchen and Yard Scraps Into Free Soil Amendment',
    ...
    summary: "Backyard composting is a direct way to feed a garden without buying fertilizer, and the EPA's own guidance lays out exactly how it works. A pile built from roughly two to three parts \"browns\" (dry leaves, shredded cardboard, straw) to one part \"greens\" (fruit and vegetable scraps, grass clippings, coffee grounds), kept moist and turned occasionally, produces finished compost in about three to five months. A worm bin, or vermicomposting system, uses red wiggler worms instead and works on a similar three-to-six-month timeline, an option for anyone without outdoor space for a pile. What to leave out matters as much as what to include: meat, fish, bones, dairy, fats and oils, pet waste, and diseased plant material should stay out of a home compost system, since they attract pests or fail to break down safely at typical backyard pile temperatures. Beyond the free soil amendment itself, the EPA notes finished compost improves water retention and soil structure, and applying it to land keeps carbon stored in the soil rather than released to the atmosphere, a small, individual-level version of the same soil-carbon principle covered at a much larger scale in the Earth Matters research.",
    citations: [
      {
    ...
    overallTier: 'strong',
    stageNote: 'A EPA-sourced practical guide, not a general "compost is good" gesture. The three-to-five-month timeline and the browns-to-greens ratio are both directly stated by the source, not estimated.',
  ...
  },
  {
    ...
    teaser: 'A single seed packet can produce far more plants than the equivalent number of store-bought transplants, at a fraction of the cost.',
    summary:
      "Mississippi State University Extension states the cost gap directly: vegetable and flower transplants are convenient, but they can easily cost 20 times more than growing the same plants from seed. Starting from seed also opens up variety choice a garden-center transplant rack rarely offers, since mail-order and online seed companies carry far more cultivars than what's grown out and sold locally as transplants, including varieties bred for a specific climate or a specific trait (disease resistance, a shorter days-to-maturity count) that a generic transplant selection won't include. The tradeoff, per West Virginia University Extension: transplants accelerate an early harvest, produce a more uniform stand, and sidestep the germination losses seed starting can carry, and most vegetable and annual flower seedlings need 6 to 8 weeks of indoor growth before they're ready to harden off and move outside, lead time that has to be planned around a location's own last frost date. A practical middle ground many gardeners actually use: start the crops with a long lead time and variety selection at stake from seed indoors (tomatoes, peppers), and simply buy transplants for the rest.",
    citations: [
      {
    ...
    overallTier: 'strong',
    stageNote: 'The "20 times more" figure is stated directly by a university extension source, not an unverified marketing claim, though the exact multiplier will vary by crop and region.',
  ...
  },
  {
    ...
    teaser: 'Layering cardboard, "browns," and "greens" directly on top of grass or poor soil builds a workable garden bed without digging or tilling at all.',
    summary:
      "Cornell Cooperative Extension describes a well-documented no-dig method, sometimes called lasagna gardening or sheet mulching, that builds a garden bed by layering materials on top of existing ground rather than digging it out. The steps: start with a base layer of cardboard or newspaper, watered thoroughly, to smother grass and weeds underneath. Add a 2-inch layer of carbon-rich \"brown\" material (leaves, straw, sawdust), then a 2-inch layer of nitrogen-rich \"green\" material (grass clippings, vegetable scraps, aged manure), and keep alternating until the pile reaches roughly 3 feet, watering each layer as it's added. No turning is required, unlike an active compost pile, and Cornell describes the process as saving labor while enriching the soil underneath. This is a home-scale version of the same soil-biology principle Earth Matters' own regenerative-farming research documents at commercial scale: undisturbed soil keeps its own microbial life intact rather than having it disrupted by tilling, the identical mechanism behind Brazil's own large-scale no-till movement. A no-dig bed also has a practical advantage for anyone gardening on poor or contaminated urban soil, since it builds a new growing layer on top of the ground rather than working directly in it.",
    citations: [
      {
  ...
  },
  {
    ...
    summary: "Iowa State University Extension states directly that drip irrigation systems use 30 to 50 percent less water than sprinklers or other overhead watering methods, since water moves through tubing straight to the soil at the base of each plant rather than being sprayed over a wider area where much of it evaporates or runs off before reaching a root zone. Beyond the water savings, keeping a plant's own leaves dry has a disease benefit: many common vegetable diseases spread through water splashing onto foliage and fruit, and a drip system that never wets the leaves at all measurably reduces that risk. Hand watering, by contrast, is harder to get right consistently, with a tendency toward over- or under-watering depending on how much attention a gardener actually has to give it day to day. A basic drip system can be built cheaply from tubing and simple emitters and run on an inexpensive timer, turning what would otherwise be daily hands-on watering into a mostly automated task. This is a small, individual-level version of the same water-use-efficiency question the Earth Matters research covers at a much larger scale in its Ogallala Aquifer entry.",
    citations: [
      {
    ...
    overallTier: 'strong',
    stageNote: 'A quantified water-savings figure directly from a university extension source, not a manufacturer\'s own marketing claim.',
    relatedIds: ['foodhistory-regen-ogallala-water-depletion', 'garden-understanding-your-zone'],
  },
  {
    id: 'garden-natural-pest-management',
    category: 'homeGardening',
    title: 'Managing Garden Pests Without Reaching for a Pesticide',
    teaser: 'In one study, only 7% of pest insects laid eggs on plants surrounded by companion plants, versus 36% on the identical plant grown alone in bare soil.',
    summary: "University of Florida IFAS Extension documents specific companion-planting strategies that measurably reduce pest damage without pesticide use, built around what researchers call the landings theory: a pest insect typically needs several successful landings on the correct host plant before it lays eggs, and a plant surrounded by other species disrupts that pattern. In one cited study, 36% of pest insects laid eggs on a host plant grown alone in bare soil, versus only 7% on the same plant surrounded by companion plants, a substantial difference from mixed planting alone. Specific, documented pairings: blue Hubbard squash planted around a garden's perimeter as a trap crop draws squash vine borers and squash bugs away from the main squash crop; radishes interplanted among eggplant trap flea beetles that would otherwise target the eggplant directly; and flowering plants like dill, fennel, milkweed, and cosmos attract ladybugs and other beneficial insects that prey on garden pests. This approach has a direct benefit beyond pest control: avoiding pesticide use in a home garden entirely is one of the most concrete, individual-level things a gardener can do for the same pollinators the Earth Matters research documents as being harmed by pesticide exposure at a much larger, industrial scale.",
    citations: [
      {
  ...
  },
  {
    ...
    overallTier: 'strong',
    stageNote: 'Specific extension-sourced timelines, not a general "fruit takes years" statement, worth planning around directly since perennial fruit is a longer commitment than any annual vegetable in this category.',
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: 'Saving Seed From This Year\'s Harvest for Next Year\'s Garden',
    teaser: 'Beans, peas, tomatoes, and lettuce are the easiest crops to save seed from, since they self-pollinate and rarely cross with anything else nearby.',
    summary: "Seed saving only works reliably with open-pollinated or heirloom varieties, not hybrids: a hybrid's own seed produces one of its original parent plants rather than a repeat of the plant it came from, so seed saved from a hybrid tomato or pepper won't grow true the following year. Penn State Extension recommends starting with self-pollinating crops specifically, beans, peas, tomatoes, and lettuce, since they're far less likely to cross-pollinate with a neighboring variety than a crop that depends on insects moving pollen between different plants. A worth-knowing exception: several common vegetables share the same botanical species and can cross with each other even though they look nothing alike, most notably broccoli, Brussels sprouts, collards, kale, and mustard greens, all of which belong to Brassica oleracea, meaning only one variety of that species should flower in the same garden in a given year if the seed is meant to stay true. Once seed is harvested, it needs to dry fully before storage, a simple test being whether a seed can be snapped by hand or shattered rather than dented by a fingernail, then kept in a labeled, sealed container somewhere cool, dry, and dark, since most seed stays viable for only a few years. Saving seed at home is an individual-level counterpart to the seed-diversity loss the Earth Matters research documents happening at a much larger, commercial scale.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: 'Herbs Are the Starting Point for Anyone With Only a Windowsill',
    ...
    summary:
      "The Chicago Botanic Garden's own guidance on growing herbs indoors names thyme, lemon thyme, sage, oregano, basil, parsley, and chives as excellent candidates for a windowsill herb garden, with chamomile, lavender, lemon balm, and mint as worthwhile additions once the basics are working. Most herbs need four to six hours of direct sun, or roughly 14 hours of supplemental grow-light exposure, with a south- or southwest-facing window generally working best. Basil, parsley, and cilantro do best started from seed indoors, while sage, oregano, lemon balm, mint, and thyme can instead be started from cuttings or divisions of an outdoor plant, a practical option for bringing a favorite outdoor herb inside before the first fall frost rather than losing it for the winter. A useful distinction most people never think about: thyme, chives, oregano, and rosemary tolerate being on the dry side and actually prefer it, while basil is the exception among common herbs, wanting warmer, more humid conditions than the rest of a typical windowsill herb collection. Regular pinching keeps plants compact and productive rather than leggy, and pots need working drainage, since herbs kept too wet indoors are prone to root rot.",
    citations: [
      {
  ...
  },
  {
    ...
    citations: [
      ...
      {
        source: 'Wikipedia: Sprouting (documented foodborne-illness outbreak history and FDA/Health Canada safety guidance)',
        url: 'https://en.wikipedia.org/wiki/Sprouting',
      },
    ],
    overallTier: 'strong',
    stageNote: 'The nutrient-density finding comes from a direct laboratory measurement against the USDA\'s own reference database, and the sprout-safety caution cites a large, documented outbreak rather than a general warning.',
  ...
  },
  {
    ...
    teaser: 'Colorado State University Extension states directly that mulch reduces irrigation need by around 50%, alongside weed suppression and soil-temperature benefits.',
    summary:
      "Mulch, any material spread over bare soil around plants, does measurable work beyond just looking tidy. Colorado State University Extension states directly that mulching minimizes evaporation from the soil surface, reducing irrigation need by around 50%, while also stabilizing soil moisture, reducing compaction, and suppressing weeds. Recommended organic options include grass clippings (applied thin, no more than about a quarter inch at a time, to avoid matting), certified weed-free straw, and compost or leaf mold at 1 to 2 inches deep directly around growing plants. A worth-knowing exception: wood or bark chips should stay in the walkways between garden beds, not the growing beds themselves, since they take years to break down and interfere with future soil preparation once they're worked in. Black plastic mulch is a different tool specifically for warm-season fruiting crops like tomatoes, peppers, and melons, warming the soil enough to produce a two to three weeks earlier harvest, though it has to go down early enough that plant growth shades the plastic before summer heat arrives, or the trapped heat can damage the crop instead of helping it.",
    citations: [
      {
    ...
    overallTier: 'strong',
    stageNote: 'The 50% irrigation-reduction figure and the 2-to-3-week earlier-harvest figure for black plastic mulch are both stated directly by a university extension source, not estimated.',
  ...
  },
  {
    ...
    summary:
      "Growing the same crop, or a close relative, in the same spot year after year builds up two separate problems: soil-borne disease organisms that can persist in soil for several years once established, and lopsided nutrient depletion, since different plant families draw down different specific nutrients at different rates. Iowa State University Extension recommends not planting vegetables from the same plant family in the same location for 3 to 4 years, 5 or more if space allows, and names the five practical groupings worth tracking: nightshades (tomato, pepper, potato), gourds (cucumber, squash, melon), the pea and bean family, mustards (broccoli, cabbage, kale), and the onion/garlic family. One useful asymmetry worth planning around directly: gourds are heavy nitrogen feeders, while beans and peas are nitrogen fixers that add it back to the soil rather than depleting it, meaning a bean or pea planting is a good choice for the spot a heavy feeder just vacated. Even an imperfect rotation in a small garden with limited space still helps, per the same extension guidance, keeping a simple written or photographed record of what grew where each year is the practical tool that makes rotation possible at all once a garden has more than a season or two of history behind it.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: 'Earth Matters documents cover cropping as still rare even on commercial farms. A home gardener faces essentially none of the barriers keeping that number low.',
    summary: "The Earth Matters research already documents an honest finding: cover cropping, planting a non-food crop specifically to protect and feed the soil between growing seasons, is one of the cheapest, best-understood regenerative practices there is, yet official USDA data still found it on under 5% of total US cropland as of 2022. A home gardener faces essentially none of the economic and logistical barriers (specialized equipment, a crop-insurance system that doesn't reward it, a farm's own tight seasonal labor calendar) that help explain that low commercial adoption rate, making a home garden bed an easy place to actually do this. Penn State Extension's own specific guidance: legume cover crops like clover add nitrogen to the soil directly, fast-growing brassicas like tillage radish outcompete winter weeds, and winter rye can be sown as late as November and still germinate at soil temperatures as low as 35 degrees Fahrenheit, useful for a late-season planting window most vegetables have already missed. The practical mechanics: broadcast seed over smoothed soil, rake it in lightly, water gently, then turn the cover crop under 2 to 3 weeks before spring planting, terminating it before it flowers so it doesn't reseed itself into next year's vegetable bed.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: 'A 2024 umbrella review found a positive effect of gardening on well-being, while directly stating that most of the underlying studies were rated critically low quality.',
    summary:
      "A 2024 umbrella review and meta-analysis, published in a peer-reviewed systematic-reviews journal, pooled the available evidence on gardening and well-being and found a statistically significant positive effect (an effect size of 0.55) across measures of well-being, depression, and anxiety. The honest complication, stated directly by the review's own authors rather than glossed over: of the underlying reviews synthesized, 71% were rated critically low quality using a standard quality-assessment tool, heterogeneity across the included studies was severe, and the authors explicitly conclude the evidence does not currently support strong recommendations, calling for methodologically robust randomized controlled trials to actually establish whether gardening causes the improvement or simply correlates with it, since people already inclined toward better well-being or fitness may simply be more likely to garden in the first place. Separately, and with less rigorous backing, Virginia Tech Extension cites research finding short gardening sessions, as little as 10 to 30 minutes, linked to feeling calmer, and points to being around plants as a plausible way to lower cortisol, the body's own stress hormone. Presented honestly rather than oversold: gardening plausibly helps mental well-being, and a current review found a positive signal, but the underlying evidence base is not yet strong enough to call this a settled, well-established finding.",
    citations: [
      {
    ...
    overallTier: 'moderate',
    stageNote: 'A current meta-analysis found a positive effect, but its own authors rate most of the underlying evidence critically low quality and explicitly withhold a strong recommendation, reported here exactly as honestly as the review itself states it.',
    relatedIds: ['mentalhealth-overview', 'garden-community-gardens'],
  },
  {
    id: 'garden-community-gardens',
    category: 'homeGardening',
    title: 'No Private Space at All? A Randomized Trial Found Community Gardens Still Move the Needle',
    teaser: 'In a randomized controlled trial, people given a community garden plot increased their vegetable intake by 0.63 servings a day by harvest time, a statistically significant result.',
    summary: "Every entry in this category so far has assumed at least some private space, a yard, a balcony, a windowsill. A community garden is the answer for anyone without even that, a shared plot of land, usually organized by a city, nonprofit, or neighborhood group, divided into individual growing spaces. The strongest evidence for whether this actually changes what people eat comes from a randomized controlled trial: 243 Denver, Colorado residents were randomized to either a community-garden intervention (a plot, plants, seeds, and a gardening class) or a waitlist control group, and by harvest time, gardeners had significantly increased their total vegetable intake by 0.63 servings a day and their intake of vegetables they'd actually grown themselves by 0.67 servings a day, both statistically significant results. A honest limitation worth keeping rather than hiding: a winter follow-up measurement found the gap between the two groups had closed, meaning the benefit tracked with the active growing season rather than persisting as a lasting habit change on its own. This is a direct, individual-level answer to the food-access gap the Earth Matters research already documents, growing food doesn't require owning land, just access to a plot somewhere.",
    citations: [
      {
    ...
    overallTier: 'strong',
    stageNote: 'A randomized controlled trial, not an observational study, strong evidence, with its own honest, stated limitation (the effect faded once the growing season ended) included rather than left out.',
  ...
  },
  {
    ...
    chart: {
      ...
      sourceNote: 'PMC8796024, controlled dwarf-tomato LED lighting trial',
    },
  },
  {
    id: 'garden-water-quality-filtration',
    category: 'homeGardening',
    title: 'Does Tap Water Need Filtering for Plants? A Honest Answer',
    teaser: "For ordinary garden and container growing, Extension guidance says typical tap-water chlorine/chloramine levels aren't toxic to plants, but hydroponic systems and seedlings are the exception.",
    summary: "Whether tap water needs filtering before it reaches plants depends on the growing method, not a single universal answer. For ordinary soil-based garden and container growing, an answer from Ask Extension (citing both the EPA and University of Nebraska Extension) is reassuring: typical municipal chlorine and chloramine levels are not toxic to garden plants, and most common vegetables, trees, and turf tolerate normal tap water without any problem. Chlorine specifically dissipates from water left standing uncovered for about 24 hours, though chloramine (increasingly used in place of plain chlorine by many municipal systems specifically because it's more stable and doesn't dissipate the same way) does not go away just by letting water sit, a practical distinction worth knowing before assuming the old \"let it sit overnight\" advice covers every water supply. The exception is hydroponic and aeroponic growing, where the water itself becomes the entire root environment with no soil to buffer anything: one study found chloramine-treated water caused root browning in hydroponically grown lettuce specifically. For a hydroponic or aeroponic system, growing guidance recommends starting from filtered water, either a simple activated-carbon filter (removes chlorine and organic compounds, the same mechanism a household water-filter pitcher already uses) or, for full mineral control, reverse osmosis (rejects roughly 94-99% of dissolved solids, producing near-zero-mineral water so a nutrient solution's own measured ratios aren't thrown off by whatever minerals happen to already be in the local tap water), with a carbon pre-filter specifically required ahead of an RO membrane, since chlorine itself can damage the membrane over time. Seedlings and young transplants are also more sensitive than mature plants across every growing method, so dechlorinated or aged water is worth the extra step specifically during that early, vulnerable stage even in an ordinary soil garden.",
    citations: [
      {
    ...
    overallTier: 'moderate',
    stageNote: 'The core "typically fine for soil growing" claim traces to an Extension answer citing the EPA and University of Nebraska Extension; the hydroponic lettuce root-browning finding is from a single cited study, not independently re-verified against its own original paper in this pass.',
    relatedIds: ['garden-indoor-growing-methods-overview'],
  },
  {
    ...
    teaser: "Not a metaphor, a randomized trial. Add forest floor, sod, and diverse plants to where kids spend their days, and their own blood immune markers measurably shift within a month.",
    summary:
      "A direct, causal test of whether contact with a biodiverse natural environment changes a person's own immune system, not just an association study. Researchers in Finland (Roslund et al. 2020) ran an intervention trial across 10 daycare centers and 75 children aged 3-5: the play yards at intervention daycares were enriched with forest floor material, sod, and diverse planters, while standard urban daycares and already-nature-oriented daycares served as comparison groups, over a 28-day period. The result wasn't a survey or a self-report, researchers drew blood and skin samples and measured actual immune markers before and after. Skin microbial diversity increased measurably in the intervention group, and that increase tracked directly with two statistically significant immune shifts: a rise in the percentage of regulatory T cells (the same Treg population this app's own gut-microbiome research already covers as the actual cellular mechanism behind dietary fiber's own anti-inflammatory effect) and a rise in the ratio of the anti-inflammatory signal IL-10 to the pro-inflammatory signal IL-17A. Plasma TGF-beta1, a cytokine directly involved in growing and maintaining Treg cells, also rose across the intervention group. None of this happened in the standard urban daycare group over the same 28 days. This is the single most direct piece of human evidence in this app's own research that the same immune-tolerance machinery already covered for gut bacteria and fermented food can also be reached through a completely different, external route: getting hands, skin, and lungs into contact with a biodiverse outdoor environment, exactly what a garden provides.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: "The Soil Bacterium Behind \"Getting Your Hands Dirty Feels Good,\" Honestly Caveated",
    teaser: 'A well-known finding, and an important limit on it: proven in mice, not yet proven the same way in people.',
    summary:
      "A specific, soil bacterium, Mycobacterium vaccae, is the actual organism behind the popular claim that dirt has a natural antidepressant-like effect. A 2007 study (Lowry et al., Neuroscience) found that exposing mice to M. Vaccae activated a specific group of serotonin-producing neurons in a particular part of the brain (the dorsal raphe nucleus) and increased serotonin activity in the prefrontal cortex, producing measurable, antidepressant-like changes in the mice's own behavior. A independent follow-up out of the same research group later found similar stress-resilience effects using a \"two hit\" stress model. Told honestly rather than as a settled human fact: both of these are peer-reviewed animal studies, and there is no equivalent controlled human trial proving the same causal chain in people. What makes it worth including here anyway is the plausible, mechanism it points to alongside everything else in this category and Earth Matters' own Gut Connection research: M. Vaccae is a soil organism, the kind of environmental \"old friend\" this whole line of research keeps returning to, and gardening is one of the most ordinary, repeated ways an actual person comes into direct physical contact with it. Whether or not the mood effect itself holds up exactly the same way in humans, the underlying story is consistent either way, soil isn't an inert growing medium, it's a live, biologically active environment that measurably interacts with the body that touches it.",
    citations: [
      {
    ...
    overallTier: 'weak',
    stageNote: 'A well-documented animal-model finding, deliberately not oversold as proven in humans, included for the honest mechanism it illustrates, not as a settled clinical claim.',
    relatedIds: ['garden-hands-in-soil-immune-training', 'foodhistory-regen-old-friends-hypothesis', 'garden-symbiosis-mission'],
  },
  {
    id: 'garden-symbiosis-mission',
    category: 'homeGardening',
    title: 'Growing Your Own Food Is a Physical Act of Symbiosis, Not Just a Way to Save on Groceries',
    teaser: "Every finding in this shelf, and in Earth Matters' own Gut Connection research, points the same direction: a person's own body and the natural world it grew out of were never really two separate systems.",
    summary:
      "Read alongside Earth Matters' own research on the same subject, the point of this whole shelf isn't really about gardening technique, it's about what gardening actually does to the person doing it. The 28-day daycare trial above shows a measured immune shift from contact with a more biodiverse environment. The Old Friends hypothesis, covered fully in Earth Matters, explains why that contact matters: specific environmental organisms are a needed input for how the immune system's own regulatory circuits finish developing, not an incidental exposure to be avoided. And the Mycobacterium vaccae research, honestly caveated as animal-only, points at a specific mechanism for why physical contact with soil itself, not just eating what grows in it, may matter on its own. None of this is really about gardening being a nice hobby. It's a direct, personal, repeatable way to restore a biological relationship modern life has made unusually easy to lose entirely, hands in soil, growing biodiverse food, rather than encountering nature only through a screen or a sealed package. This is also, directly, why this app puts a whole Garden tab next to its food-tracking tools rather than treating growing food as a separate hobby: a harvest becomes a selectable ingredient in every one of the eleven Food builders, so growing something yourself and eating it are one continuous act, not two separate ones. It sits alongside this app's own Fermented Foods research and builder for the same underlying reason, deliberately cultivating live microbial diversity, whether in soil outside or in a jar on a counter, is a practical way to work with the same biology this whole research base keeps describing, not around it. The teaching point worth carrying past any one fact here: humans are not separate from the natural systems they evolved inside of, and a body that stays in ongoing contact with a healthy, biodiverse natural world, through the soil it gardens in and the food that soil produces, is doing something measurably different from a body that doesn't. Treating the land well and treating your own gut and immune system well were never two different projects.",
    citations: [],
    overallTier: 'moderate',
    stageNote: "A synthesis of the citations already given individually above and in Earth Matters' own Gut Connection shelf, plus a direct statement of why this app's own features are built the way they are, not a new external research claim of its own.",
    relatedIds: [
