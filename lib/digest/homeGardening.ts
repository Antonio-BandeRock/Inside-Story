...
export const HOME_GARDENING_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    overallTier: 'moderate',
    stageNote: 'A current meta-analysis found a positive effect, but its authors rate most of the underlying evidence critically low quality and explicitly withhold a strong recommendation, reported here exactly as honestly as the review itself states it.',
  ...
  },
  {
    ...
    overallTier: 'strong',
    stageNote: 'A randomized controlled trial, not an observational study, strong evidence, with its honest, stated limitation (the effect faded once the growing season ended) included rather than left out.',
