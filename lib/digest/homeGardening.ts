...
export const HOME_GARDENING_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    overallTier: 'strong',
    stageNote: 'Directly relevant to anyone without land access, including renters and apartment dwellers, and a real, practical individual-level counterpart to the Earth Matters research on food access.',
  ...
  },
  {
    ...
    summary: "Backyard composting is a real, direct way to feed a garden without buying fertilizer, and the EPA's own guidance lays out exactly how it works. A pile built from roughly two to three parts \"browns\" (dry leaves, shredded cardboard, straw) to one part \"greens\" (fruit and vegetable scraps, grass clippings, coffee grounds), kept moist and turned occasionally, produces finished compost in about three to five months. A worm bin, or vermicomposting system, uses red wiggler worms instead and works on a similar three-to-six-month timeline, a real option for anyone without outdoor space for a pile. What to leave out matters as much as what to include: meat, fish, bones, dairy, fats and oils, pet waste, and diseased plant material should stay out of a home compost system, since they attract pests or fail to break down safely at typical backyard pile temperatures. Beyond the free soil amendment itself, the EPA notes finished compost improves water retention and soil structure, and applying it to land keeps carbon stored in the soil rather than released to the atmosphere, a small, real, individual-level version of the same soil-carbon principle covered at a much larger scale in the Earth Matters research.",
    citations: [
      {
  ...
  },
  {
    ...
    overallTier: 'strong',
    stageNote: 'A real, practical, extension-sourced how-to, directly tied to the seed-diversity concern already documented at commercial scale in the Earth Matters research.',
  ...
  },
  {
    ...
    overallTier: 'strong',
    stageNote: 'A real, direct individual-level counterpart to a finding already documented at commercial scale in the Earth Matters research, not a loosely related idea.',
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: 'A Real, Direct Answer to The Pollinator Research',
    teaser: 'A home garden is one of the few real levers an individual actually controls over the pollinator crisis the Earth Matters research documents.',
    ...
    overallTier: 'strong',
    stageNote: 'A real, direct bridge between the Earth Matters research and something an individual gardener can actually do, not a separate initiative.',
    relatedIds: [
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: "A Real, 28-Day Trial: What Actually Happens to a Child's Immune System When Their Play Environment Gets More Biodiverse",
    teaser: "Not a metaphor -- a real, randomized trial. Add forest floor, sod, and diverse plants to where kids spend their days, and their own blood immune markers measurably shift within a month.",
    summary:
      "A real, direct, causal test of whether contact with a biodiverse natural environment changes a person's own immune system, not just an association study. Researchers in Finland (Roslund et al. 2020) ran a genuine intervention trial across 10 daycare centers and 75 children aged 3-5: the play yards at intervention daycares were enriched with real forest floor material, sod, and diverse planters, while standard urban daycares and already-nature-oriented daycares served as real comparison groups, over a 28-day period. The result wasn't a survey or a self-report -- researchers drew real blood and skin samples and measured actual immune markers before and after. Skin microbial diversity increased measurably in the intervention group, and that increase tracked directly with two real, statistically significant immune shifts: a rise in the percentage of regulatory T cells (the same real Treg population this app's own gut-microbiome research already covers as the actual cellular mechanism behind dietary fiber's own anti-inflammatory effect) and a rise in the ratio of the anti-inflammatory signal IL-10 to the pro-inflammatory signal IL-17A. Plasma TGF-beta1, a real cytokine directly involved in growing and maintaining Treg cells, also rose across the intervention group. None of this happened in the standard urban daycare group over the same 28 days. This is the single most direct piece of human evidence in this app's own research that the same real immune-tolerance machinery already covered for gut bacteria and fermented food can also be reached through a completely different, external route: getting hands, skin, and lungs into contact with a genuinely biodiverse outdoor environment, exactly what a real garden provides.",
    citations: [
      {
    ...
    overallTier: 'strong',
    stageNote: 'A real, randomized, blood-and-skin-sample intervention trial, not an association study -- one of the more directly causal pieces of evidence in this whole research base.',
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: "The Real Soil Bacterium Behind \"Getting Your Hands Dirty Feels Good,\" Honestly Caveated",
    teaser: 'A real, well-known finding, and a real, important limit on it: proven in mice, not yet proven the same way in people.',
    summary:
      "A specific, real soil bacterium, Mycobacterium vaccae, is the actual organism behind the popular claim that dirt has a natural antidepressant-like effect. A real 2007 study (Lowry et al., Neuroscience) found that exposing mice to M. vaccae activated a specific group of serotonin-producing neurons in a particular part of the brain (the dorsal raphe nucleus) and increased serotonin activity in the prefrontal cortex, producing measurable, antidepressant-like changes in the mice's own behavior. A real, independent follow-up out of the same research group later found similar stress-resilience effects using a \"two hit\" stress model. Told honestly rather than as a settled human fact: both of these are real, peer-reviewed animal studies, and there is no equivalent controlled human trial proving the same causal chain in people. What makes it worth including here anyway is the plausible, real mechanism it points to alongside everything else in this category and Earth Matters' own Gut Connection research: M. vaccae is a genuine soil organism, the kind of environmental \"old friend\" this whole line of research keeps returning to, and gardening is one of the most ordinary, repeated ways an actual person comes into direct physical contact with it. Whether or not the mood effect itself holds up exactly the same way in humans, the underlying story is consistent either way -- soil isn't an inert growing medium, it's a live, biologically active environment that measurably interacts with the body that touches it.",
    citations: [
      {
    ...
    overallTier: 'weak',
    stageNote: 'A real, well-documented animal-model finding, deliberately not oversold as proven in humans -- included for the real, honest mechanism it illustrates, not as a settled clinical claim.',
  ...
  },
  {
    ...
    category: 'homeGardening',
    title: 'Growing Your Own Food Is a Real, Physical Act of Symbiosis, Not Just a Way to Save on Groceries',
    teaser: "Every real finding in this shelf, and in Earth Matters' own Gut Connection research, points the same direction: a person's own body and the natural world it grew out of were never really two separate systems.",
    summary:
      "Read alongside Earth Matters' own research on the same subject, the point of this whole shelf isn't really about gardening technique -- it's about what gardening actually does to the person doing it. The 28-day daycare trial above shows a real, measured immune shift from contact with a more biodiverse environment. The Old Friends hypothesis, covered fully in Earth Matters, explains why that contact matters: specific environmental organisms are a real, needed input for how the immune system's own regulatory circuits finish developing, not an incidental exposure to be avoided. And the Mycobacterium vaccae research, honestly caveated as animal-only, points at a real, specific mechanism for why physical contact with soil itself, not just eating what grows in it, may matter on its own. None of this is really about gardening being a nice hobby. It's a direct, personal, repeatable way to restore a real biological relationship modern life has made unusually easy to lose entirely -- hands in real soil, growing real, biodiverse food, rather than encountering nature only through a screen or a sealed package. This is also, directly, why this app puts a whole Garden tab next to its food-tracking tools rather than treating growing food as a separate hobby: a real harvest becomes a genuine, selectable ingredient in every one of the eleven Food builders, so growing something yourself and eating it are one continuous act, not two separate ones. It sits alongside this app's own Fermented Foods research and builder for the same underlying reason -- deliberately cultivating live microbial diversity, whether in soil outside or in a jar on a counter, is a real, practical way to work with the same biology this whole research base keeps describing, not around it. The teaching point worth carrying past any one fact here: humans are not separate from the natural systems they evolved inside of, and a body that stays in real, ongoing contact with a healthy, biodiverse natural world, through the soil it gardens in and the food that soil produces, is doing something measurably different from a body that doesn't. Treating the land well and treating your own gut and immune system well were never two different projects.",
    citations: [],
    overallTier: 'moderate',
    stageNote: "A real synthesis of the citations already given individually above and in Earth Matters' own Gut Connection shelf, plus a direct statement of why this app's own features are built the way they are -- not a new external research claim of its own.",
    relatedIds: [
