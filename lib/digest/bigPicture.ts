...
export const BIG_PICTURE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "Cooked spinach, eggs, a squeeze of lemon -- small choices, each already backed by a real, checkable reason.",
    summary:
      "The spinach is cooked, not raw -- myrosinase, the enzyme that unlocks a goitrogenic compound in cruciferous and leafy greens, is mostly deactivated by heat (see Problem Foods & Swaps). The eggs come with a squeeze of lemon, and the vitamin C in it genuinely helps absorb the iron sitting on the same plate (see Nutrient Interactions). The bread is a real, home-baked loaf rather than a bagged one -- not out of purism, but because it skips the dough conditioners and preservatives a shelf-stable loaf usually needs (see Food Additives). None of this needed to be worked out at the table. The reasoning already happened, once, and got folded into a habit -- exactly the promise this app is built around: the complexity lives in the research, not in the person eating breakfast.",
    citations: [],
  ...
  },
  {
    ...
    teaser: 'A spoonful of homemade yogurt at lunch is doing real, specific, named biological work.',
    summary:
      "The yogurt at lunch isn't \"probiotic\" in some vague, marketing sense -- it carries real, named bacterial strains (see Fermented Foods) working through genuinely distinct mechanisms: some rebuilding specific tight-junction proteins in the gut lining, others feeding the short-chain-fatty-acid production that trains the immune system toward tolerance rather than attack (see Gut & Microbiome). It's also a deliberate choice about timing, not just content -- this same gut-repair work waited until she was solidly into her own healing journey's second stage, once histamine tolerance was no longer an unknown variable (see Healing Stages). The gut barrier this yogurt is helping to maintain shows up again in a completely different corner of this app's research: as visceral fat's own possible line of defense (see Mitochondria & Metabolism), and as the one shared thread running through seven other autoimmune diseases that aren't Hashimoto's at all (see Other Autoimmune Diseases). One real structure, showing up everywhere this Digest looks.",
    citations: [],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    summary:
      "An afternoon energy crash could be the thyroid itself -- or it could be zinc, iron, or B12, each independently common in Hashimoto's and each capable of producing the exact same fatigue on its own (see Nutrients & Micronutrients). It could be the liver, which does the largest single share of the body's own T4-to-T3 conversion and is directly, measurably affected by hypothyroidism itself (see Organs & Body Systems). It could even be a second, less-discussed autoimmune process quietly targeting the adrenal glands alongside the thyroid, a real, named clinical combination with its own history. None of these possibilities cancel each other out -- they're exactly why this app tracks real, individual data over time instead of assuming every symptom traces back to the same single cause.",
    citations: [],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    category: 'bigPicture',
    title: 'Evening: A Glass of Wine, a Genuinely Two-Sided Question',
    teaser: "The research doesn't always land where intuition expects it to -- and this app says so, even when the honest answer is complicated.",
    summary:
      "A glass of wine with dinner turns out to be a genuinely two-sided case, not the simple warning most people expect: two real population studies found moderate drinking isn't linked to new thyroid-antibody development, and actually tracks with LOWER risk of progressing to overt disease (see Lifestyle & Environment). The real concern shows up later, at heavier and more frequent drinking, through the liver's own competing workload -- the same liver already doing the lion's share of T4-to-T3 conversion, mentioned back at the afternoon crash. This is the app's own standing discipline in miniature, playing out in one ordinary evening decision: report what the evidence actually shows, including the times it complicates a tidier, more expected story.",
    citations: [],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    category: 'bigPicture',
    title: 'The Longer Arc: A Person, a Century, and a Real Choice',
    teaser: "Zoom out far enough, and one day's worth of small decisions connects to 150 years of food history.",
    summary:
      "None of today's small decisions happened in a vacuum. The wheat in that bread went through a real 150-year transformation -- from stone-milled, fiber-and-nutrient-intact flour to the industrially stripped, nutrient-thin version that became standard by the 1880s (see Food Industry & History) -- across roughly the same historical window autoimmune and digestive disease first started climbing, and have kept climbing since. The soil that grew today's vegetables likely holds somewhat less real mineral content than it did seventy years ago, for reasons that are genuinely more complicated than \"depleted soil\" alone. None of this is fatalism. It's the actual argument for building a day, and a plate, out of real, whole ingredients on purpose -- the same practical bet this whole app is built around: since nobody can wait for every hard causal question to be fully settled before acting, eating closer to that pre-1870s baseline -- real food, real fermentation, minimal industrial processing -- is a reasonable, evidence-consistent choice regardless of how those bigger questions eventually resolve.",
    citations: [],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    teaser: 'Not one more thing to worry about -- the opposite. The worrying already happened, so eating does not have to be a research project.',
    summary:
      "Fourteen other categories, well over a hundred entries, hundreds of real citations -- and the actual point of all of it is to remove work from someone's day, not add to it. The person eating breakfast in this same story doesn't need to know why the spinach is cooked or why the coffee waits an hour; she just needs the habit to already be right. That's the whole design: let the complexity -- matching foods to body chemistry, catching real interactions, tracking personal patterns over time -- live inside this app's own research, so what's actually left for a person to do each day is simple: eat, follow clear rules that already did the thinking, and become the healthiest version of themselves without first having to become their own nutritionist.",
    citations: [],
    overallTier: 'moderate',
