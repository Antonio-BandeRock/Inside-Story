...
export const BIG_PICTURE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "An afternoon energy crash could be the thyroid itself, or it could be zinc, iron, or B12, each independently common in Hashimoto's and each capable of producing the exact same fatigue on its own (see Nutrients & Micronutrients). It could be the liver, which does the largest single share of the body's own T4-to-T3 conversion and is directly, measurably affected by hypothyroidism itself (see Organs & Body Systems). It could even be a second, less-discussed autoimmune process quietly targeting the adrenal glands alongside the thyroid, a named clinical combination with its history. None of these possibilities cancel each other out. That's why individual data gets tracked over time instead of assuming every symptom traces back to the same single cause.",
    citations: [],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    teaser: "The research doesn't always land where intuition expects it to, even when the answer is complicated.",
    summary:
      "A glass of wine with dinner turns out to be a two-sided case, not the simple warning most people expect. Two population studies found moderate drinking isn't linked to new thyroid-antibody development, and actually tracks with lower risk of progressing to overt disease (see Lifestyle & Environment). The concern shows up later, at heavier and more frequent drinking, through the liver's competing workload, the same liver already doing the lion's share of T4-to-T3 conversion mentioned back at the afternoon crash. This is the same standing discipline in miniature, playing out in one ordinary evening decision: report what the evidence actually shows, including the times it complicates a tidier, more expected story.",
    citations: [],
    overallTier: 'moderate',
