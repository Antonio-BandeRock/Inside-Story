...
export const PORTIONS_AND_RDAS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: 'Every food logged through the builders carries a specific quantity, not a generic "one serving" assumption, and Insights converts that amount against the exact NASEM/NIH ODS reference tables cited throughout this topic to show a percentage of daily need rather than a guess. The value of this topic isn\'t new math this app doesn\'t already do, it\'s reading the resulting percentage correctly: knowing that most nutrients here are floors (aim to reach or exceed), that sodium is a ceiling (aim to stay under), that a single day under an RDA isn\'t automatically a deficiency, and that the RDA itself already carries a safety margin above the bare physiological minimum. A person who understands what these numbers actually represent gets meaningfully more out of the same percentage this app was already showing them.',
    citations: [
      {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'How Many Calories a Body Actually Needs Has a Published Formula Behind It',
    ...
    overallTier: 'strong',
    stageNote: 'Set sex, birth date, height, weight, and Activity Level in Profile to see your numbers in Insights\' Energy & Portions lens.',
