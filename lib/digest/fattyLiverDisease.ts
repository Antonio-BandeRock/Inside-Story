...
export const FATTY_LIVER_DISEASE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'A real, graded weight-loss staircase, coffee as one of the most consistently positive findings anywhere, and a genuinely elegant thyroid-hormone connection tying the whole category back to the core focus.',
    summary: "Line up everything in this category and MASLD reads as a condition where real, specific numbers replace vague advice at nearly every turn. Weight loss isn't just \"recommended,\" it's a real, graded staircase (3% for real histological benefit to begin, 10% for the strongest fibrosis regression). The Mediterranean diet works, and so, honestly, does a plainer low-fat diet, real evidence pointing toward overall dietary quality and weight loss as the actual driving mechanism rather than one specific pattern. Coffee stands out as one of the more consistently positive, low-effort findings in the whole research base, while fructose-heavy sweeteners deserve real, elevated caution specifically because of MASLD's own already-strained liver. Two real medication stories, resmetirom and semaglutide, both reached patients only very recently and both carry real, substantial trial evidence behind them, resmetirom's own thyroid-hormone-receptor mechanism forming a genuinely elegant, direct link back to the core focus. And FIB-4 offers a real, low-cost way to know where someone actually stands, often without a single new test.",
    citations: [
      { source: 'Steatotic Liver Disease, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/steatoticliverdisease.html' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary: "MASLD's own real systemic reach is genuinely substantial: real research finds it a global condition affecting over 31% of people worldwide, and a real, independent risk factor for cardiovascular disease, chronic kidney disease, several cancers, and sleep apnea, not merely a downstream effect of the shared metabolic risk factors (obesity, insulin resistance) already covered elsewhere. The real, specific finding worth knowing directly: fibrosis STAGE, not the raw amount of liver fat, is the strongest disease-specific predictor of cardiovascular risk, a real, direct reason the F0-F4 staging above matters beyond the liver itself. Real, documented mechanisms driving this wide reach include systemic inflammation, gut dysbiosis with metabolic endotoxemia (a real, direct link to the Gut & Microbiome research), and atherogenic dyslipidemia, already covered in the cholesterol research. A real, specific connection worth naming: epicardial fat thickness (fat surrounding the heart itself) correlates directly with both sleep-apnea severity and liver damage in MASLD patients, a real, physical link between three seemingly separate systems.",
    citations: [
  ...
  },
  {
    ...
    teaser: '1980, 1986, 2023 -- a genuinely fast real naming history compared to most conditions, reflecting how recently the metabolic mechanism itself was actually understood.',
    summary: "MASLD's own real history is genuinely short and fast-moving compared to most conditions. In 1980, pathologist Jurgen Ludwig and colleagues first described \"non-alcoholic steatohepatitis,\" real liver damage that looked identical to alcohol-related liver disease under a microscope, in patients who denied heavy alcohol use. In 1986, Shaffer and Thaler formally coined \"non-alcoholic fatty liver disease\" (NAFLD) as the real, broader umbrella term. Real understanding of WHY it happens came later: insulin resistance and hyperinsulinemia were first linked to fatty liver in 1998, and metabolic syndrome specifically in 1999, the real scientific foundation the already-established metabolic-syndrome-cluster research builds on. The real, most recent turning point came in June 2023: a supermajority vote among over 200 physicians, public health experts, and patient advocates renamed the condition MASLD (metabolic dysfunction-associated steatotic liver disease), a real, deliberate move away from \"non-alcoholic,\" a name defined by what the condition ISN'T, and toward naming its actual real, metabolic cause directly, while also reducing real stigma tied to the words \"alcohol\" and \"fatty.\"",
    citations: [
  ...
  },
  {
    ...
    summary: "Fatty liver disease shows a real, wide, well-documented spread across regions of the world. Global MASLD prevalence sits at roughly 30%, but that hides real regional extremes: Latin America carries the highest real prevalence (44.4%), Western Europe the lowest among major regions studied (25.1%), and South Asian populations show a pooled real prevalence of 34.7%, climbing to 60.0% specifically among people who also have Type 2 diabetes, with a real, striking urban-vs-rural gap (47.1% urban vs. 18.5% rural) pointing directly at diet and lifestyle. A real, specific genetic variant helps explain some of this: the PNPLA3 gene variant (I148M) is unevenly distributed by ancestry, and real US data finds Hispanic populations carrying both a higher frequency of this variant AND the highest real MASLD/MASH rates in the country, while African American populations carry a lower variant frequency and correspondingly lower rates despite similar obesity levels. South Asian populations also show a real, distinct pattern already familiar from the PCOS and Type 2 Diabetes research: metabolic problems, including fatty liver, showing up at a genuinely lower body weight than in other populations. Worth knowing directly: a real combination of inherited genetic variation and regional diet/urbanization patterns, not body weight alone, explains much of why fatty liver disease looks so different by region, a real reason the weight-loss and Mediterranean-diet research applies everywhere, even as the real, underlying risk baseline genuinely differs by where someone's own ancestry and current diet sit.",
    citations: [
