...
export const FATTY_LIVER_DISEASE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'A elegant, direct echo of the thyroid-hormone-and-liver research: the first MASH medication works by mimicking thyroid hormone\'s effect on the liver.',
  ...
  },
  {
    ...
    teaser: 'Research finds MASLD in a 7.4% of the general pediatric population, rising to over half (52.5%) of children with obesity specifically, a rapidly growing problem this category\'s research hasn\'t named directly yet.',
    summary:
