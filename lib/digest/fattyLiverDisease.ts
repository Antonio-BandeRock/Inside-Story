...
export const FATTY_LIVER_DISEASE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'fattyLiverDisease',
    title: 'Fructose and MASLD: The General HFCS Research Applies Here With Extra Force',
  ...
  },
  {
    ...
    summary:
      "This category's already-covered resmetirom and semaglutide research represents already-approved MASLD treatment; efruxifermin is the next major candidate working through a different mechanism. It's a lab-made, longer-lasting version of FGF21, a hormone the liver itself naturally produces to help regulate fat metabolism. A 96-week Phase 2b trial (HARMONY) found efruxifermin produced improvements in both liver fibrosis and MASH severity measured directly from biopsy, with near-complete disease reversal in 30% of the patients on the highest dose tested, a striking result for a disease this category's already-covered fibrosis-staging research treats as usually only slowly reversible. It's now being tested in three separate Phase 3 trials covering earlier-stage fibrosis, more advanced cirrhosis, and real-world use, and a separate trial is testing it in combination with a GLP-1 drug (the same drug class as this category's already-covered semaglutide research), exploring whether combining two different mechanisms works better than either alone. Efruxifermin is one of several FGF21-based drugs (alongside pegozafermin and others) in active development, representing a new hormone-based direction for liver-disease treatment, not yet approved but advancing quickly through late-stage trials.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's already-covered fibrosis-staging research names the small share of MASLD that progresses to serious disease, at the national population scale, that small share still adds up to a projected, near-quadrupled transplant burden by mid-century.",
    summary:
      "This category's already-covered fibrosis-staging research already establishes that only a small minority of MASLD progresses to cirrhosis, and a direct national-projection study shows exactly why even that small share matters enormously at population scale. A formal modeling study projects MASLD-attributed liver transplants in the US rising from a current baseline of 1,717 per year (2020-2025) to a projected 6,720 per year by 2046-2050, a 291 percent increase, nearly quadrupling, with a cumulative total of 132,600 MASLD-related liver transplants projected across the full 2020-2050 period. This directly supports what separate research already states plainly: MASLD is projected to soon become the leading indication for liver transplant in the United States overall, and more specific data already finds it has become the TOP transplant indication specifically for women and for patients with hepatocellular carcinoma (HCC, liver cancer), a current milestone, not just a future projection. This striking national trajectory is exactly why this category's already-covered weight-loss thresholds, exercise research, and medication options (resmetirom, semaglutide) matter at a public-health scale, not just an individual one, direct evidence that a disease often framed as manageable lifestyle risk is on track to reshape the single scarcest resource in all of transplant medicine, donor livers, within most current adults' own lifetimes.",
    citations: [
  ...
  // rather than left out for being less flattering to the headline claim.
  {
    ...
    overallTier: 'moderate',
    stageNote: 'Both are randomized trials. Included together deliberately: the second trial\'s finding (weight loss and food processing, not diet label, as the likely mechanism) is a complication of the first trial\'s headline result, not a reason to hide it.',
