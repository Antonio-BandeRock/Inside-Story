...
export const FATTY_LIVER_DISEASE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'fattyLiverDisease',
    title: 'The Mediterranean Diet: Randomized Trial Evidence, With a Caveat About What It\'s Competing Against',
    teaser: 'A head-to-head trial found the Mediterranean diet worked. It also found a plainer low-fat diet worked just as well.',
    summary:
      "A randomized controlled trial (250 adults with MASLD, 12 weeks) directly compared a moderately calorie-reduced Mediterranean diet against a low-fat diet and found both approaches similarly effective at reducing liver fat (steatosis) and fibrosis, with no difference based on a person's PNPLA3 genotype (a gene variant linked to MASLD risk). A separate, systematic review and meta-analysis reached the same conclusion: no significant difference between the Mediterranean diet and a low-fat diet in improving liver enzymes, liver fat, or related markers in MASLD, both working roughly equally well in the short term. Weight loss and overall dietary quality both diets share (food, reduced calories, less ultra-processed intake) appear to be the actual driving mechanism behind the measured improvement, not something unique to the Mediterranean pattern specifically. A person doesn't need to follow the Mediterranean diet exactly to get a comparable benefit, a calorie-appropriate, whole-food, low-fat approach works about as well.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "MASLD is defined specifically by fat accumulation NOT explained by heavy alcohol use, but a contested question remains open within that same population: does moderate drinking still matter? A newly created diagnostic category, MetALD, now exists specifically to capture people with metabolic risk factors for MASLD who also drink moderately, defined by specific gram-per-day or drinks-per-week thresholds that differ depending on which clinical source is consulted, a sign the boundary itself is still being worked out rather than firmly settled. Research specifically looking at low-to-moderate drinking within MASLD populations has found it associated with increased fibrosis, a direct challenge to the older, more casual assumption that only heavy drinking matters once someone already has MASLD. The current picture: international guidelines increasingly recommend alcohol restriction or abstinence for anyone with steatotic liver disease and metabolic risk factors, regardless of amount, even though the exact threshold at which risk begins remains an unresolved, actively studied question rather than a single agreed-upon number.",
    citations: [
  ...
  },
  {
    ...
    summary: "Line up everything in this category and MASLD reads as a condition where specific numbers replace vague advice at nearly every turn. Weight loss isn't just \"recommended,\" it's a graded staircase (3% for histological benefit to begin, 10% for the strongest fibrosis regression). The Mediterranean diet works, and so does a plainer low-fat diet, evidence pointing toward overall dietary quality and weight loss as the actual driving mechanism rather than one specific pattern. Coffee stands out as one of the more consistently positive, low-effort findings in the whole research base, while fructose-heavy sweeteners deserve elevated caution specifically because of MASLD's already-strained liver. Two medication stories, resmetirom and semaglutide, both reached patients only very recently and both carry substantial trial evidence behind them, resmetirom's thyroid-hormone-receptor mechanism forming an elegant, direct link back to the core focus. And FIB-4 offers a low-cost way to know where someone actually stands, often without a single new test.",
    citations: [
      { source: 'Steatotic Liver Disease, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/steatoticliverdisease.html' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary: "MASLD's systemic reach is substantial: research finds it a global condition affecting over 31% of people worldwide, and an independent risk factor for cardiovascular disease, chronic kidney disease, several cancers, and sleep apnea, not merely a downstream effect of the shared metabolic risk factors (obesity, insulin resistance). The specific finding: fibrosis STAGE, not the raw amount of liver fat, is the strongest disease-specific predictor of cardiovascular risk, a direct reason the F0-F4 staging above matters beyond the liver itself. Documented mechanisms driving this wide reach include systemic inflammation, gut dysbiosis with metabolic endotoxemia (a direct link to the Gut & Microbiome research), and atherogenic dyslipidemia, covered in the cholesterol research. A specific connection: epicardial fat thickness (fat surrounding the heart itself) correlates directly with both sleep-apnea severity and liver damage in MASLD patients, a physical link between three seemingly separate systems.",
    citations: [
  ...
  },
  {
    ...
    category: 'fattyLiverDisease',
    title: "MASLD's Recent History: Named Three Times in Under 45 Years",
  ...
  },
  {
    ...
    teaser: 'The PIVENS trial found vitamin E at 800 IU/day resolved active liver inflammation in 42% of patients versus 18% on placebo, meaningful evidence for a specific, non-diabetic subgroup covered elsewhere in the medication research.',
    summary: "The PIVENS trial is a landmark, randomized, placebo-controlled study (247 adults with confirmed NASH, no diabetes) directly testing whether vitamin E supplementation could improve actual liver tissue damage, not just lab values. Results found vitamin E at 800 IU daily meeting the trial's pre-defined histological improvement endpoint in 43% of patients, compared to 19% on placebo, with resolution of NASH itself (active inflammation) achieved in 42% of the vitamin E group versus just 18% on placebo. This connects directly to the vitamin_e_nash medication already tracked elsewhere in the research, giving it a specific, quantified trial behind the recommendation rather than just a name on a list. The PIVENS trial specifically excluded people with diabetes, so this evidence applies most directly to non-diabetic NASH, and a separate trial did find benefit in diabetic NASH patients too, but the strength of evidence in that specific subgroup is generally considered weaker than in the original PIVENS population. High-dose vitamin E supplementation also carries its separate safety considerations worth discussing with a doctor rather than starting on one's own, since sustained high-dose antioxidant supplementation isn't automatically risk-free. This is a meaningful, trial-backed option for anyone managing biopsy-confirmed NASH, not just a general \"antioxidants might help\" suggestion.",
    citations: [
  ...
  },
  {
    ...
    category: 'fattyLiverDisease',
    title: 'MASLD Carries an Independently Elevated Colorectal Cancer Risk',
    ...
    summary: "MASLD's health reach extends beyond the liver and the cardiovascular/kidney risk, a growing body of research finds it independently associated with colorectal cancer and its precursor lesions, colorectal adenomas (polyps). An updated meta-analysis pooling 15 cohort studies and nearly 10 million participants found MASLD tracked with a 25% higher colorectal cancer risk and a 38% higher colorectal adenoma risk, and a separate, even larger analysis of over 56 million people found broadly consistent, elevated risk across colorectal polyps, adenomas, and cancer alike. The proposed mechanism runs through the same shared metabolic dysfunction, insulin resistance, chronic low-grade inflammation, and altered gut-bacteria metabolites, all of which have their separately documented links to colorectal cancer risk too. This elevated risk is a concrete reason someone with MASLD has individual standing to ask specifically whether their colorectal cancer screening should start earlier or run more frequently than standard age-based guidelines alone would suggest, the same kind of direct self-advocacy conversation the research already encourages for other condition-specific risk elevations.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Research finds MASLD in 7.4% of the general pediatric population, rising to over half (52.5%) of children with obesity specifically, a rapidly growing problem this category\'s research hasn\'t named directly yet.',
    summary:
      "The research (weight loss, diet, medications) is written the way most MASLD research still is, centered on adults. Current data finds this is no longer just an adult condition: MASLD is now the most common chronic liver disease in children and adolescents, tracking directly alongside rising childhood obesity rates. Pooled meta-analysis data finds MASLD present in 7.4% of the general pediatric population, rising sharply to 52.5% specifically among children with obesity, over half. Research finds this same condition underscreened and underdiagnosed in the pediatric obesity population, meaning a substantial share of affected children likely go unrecognized. The underlying biology (insulin resistance, visceral fat, the same genetic risk variants like PNPLA3 covered in this category's research) works the same way in children as in adults, but pediatric-specific management differs in practical ways, most weight-loss medications and the one FDA-approved MASH drug (resmetirom) covered elsewhere in this category aren't approved for children, making the lifestyle and dietary levers (weight loss thresholds, the Mediterranean-pattern research) even more central for this age group specifically. A child or adolescent with obesity has legitimate standing for a liver-health conversation, not just a weight conversation, given how common this condition turns out to actually be at that age.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "The resmetirom and semaglutide research represents already-approved MASLD treatment; efruxifermin is the next major candidate working through a different mechanism. It's a lab-made, longer-lasting version of FGF21, a hormone the liver itself naturally produces to help regulate fat metabolism. A 96-week Phase 2b trial (HARMONY) found efruxifermin produced improvements in both liver fibrosis and MASH severity measured directly from biopsy, with near-complete disease reversal in 30% of the patients on the highest dose tested, a striking result for a disease the fibrosis-staging research treats as usually only slowly reversible. It's now being tested in three separate Phase 3 trials covering earlier-stage fibrosis, more advanced cirrhosis, and real-world use, and a separate trial is testing it in combination with a GLP-1 drug (the same drug class as the semaglutide research), exploring whether combining two different mechanisms works better than either alone. Efruxifermin is one of several FGF21-based drugs (alongside pegozafermin and others) in active development, representing a new hormone-based direction for liver-disease treatment, not yet approved but advancing quickly through late-stage trials.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The semaglutide research works through one hormone pathway. Survodutide adds a second, and a Phase 3 trial found it completely clearing liver fat in the majority of patients treated, more than ten times the placebo rate.",
    summary: "The semaglutide research activates one hormone pathway (GLP-1); survodutide is a dual-acting drug activating both GLP-1 AND glucagon receptors together, the same glucagon pathway already tied elsewhere in the research to directly boosting the liver's fat-burning activity. A Phase 3 trial (SYNCHRONIZE-MASLD) found liver fat content completely normalized in 61% of patients on survodutide, compared with just 5.7% on placebo, and liver fat was reduced by up to 63.1%, versus 24.5% with placebo, both striking results. A separate, earlier Phase 2 trial focused specifically on people with existing liver fibrosis found 83.0% showing measured improvement in MASH severity after 48 weeks, versus 18.2% on placebo, described by the drug's developers as the strongest fibrosis benefit ever shown by this specific drug class at that trial stage. Survodutide is still in active late-stage development rather than approved, but it represents a different mechanism from every other MASLD treatment, adding a second hormone target rather than refining the first one.",
    citations: [
  ...
  },
  {
    ...
    category: 'fattyLiverDisease',
    title: 'MASLD Carries 26.3% Depression and 37.2% Anxiety Prevalence, Each Raising the Risk of the Other',
  ...
  },
  {
    ...
    summary: "The insulin-resistance mechanism means MASLD and type 2 diabetes share overlapping biology, and large-scale data confirms they drive one another, not just co-occur by coincidence. A national Korean cohort study following 636,520 people with pre-existing type 2 diabetes for a median of over 6 years found that persistent MASLD independently tracked with significantly higher risk of heart failure, heart attack, stroke, and all-cause mortality, even after accounting for diabetes itself. A separate, retrospective cohort study directly confirmed the relationship runs both directions: type 2 diabetes measurably worsens MASLD's progression, and MASLD in turn measurably worsens glycemic control and diabetes complications, a feedback loop rather than one condition simply causing the other. This directly reinforces the finding, elsewhere, that the two conditions cluster together with PCOS and CKD around one shared insulin-resistance mechanism. Someone managing type 2 diabetes who also has MASLD is managing a measurably higher combined cardiovascular and liver risk than either condition carries alone, not simply two separate diagnoses to track in parallel.",
    citations: [
  ...
  },
  {
    ...
    summary: "The exercise research already establishes that activity helps independent of weight loss, and research finds resistance training specifically deserves its own, distinct attention, not just as a variant of general exercise advice. Prevalence data finds sarcopenia, meaningful loss of skeletal muscle mass, affecting 20 to 40 percent of MASLD patients, and mechanistic research finds this isn't incidental: reduced muscle mass directly worsens insulin resistance and liver fat accumulation, creating a two-way feedback loop that can accelerate progression toward fibrosis and cirrhosis, the same staging. A recent systematic review and meta-analysis of 11 randomized controlled trials (395 participants) found resistance exercise produced a significant decrease in ALT (a liver-enzyme marker covered in the labs research), with 7 of 8 imaging studies finding substantial reductions in liver fat content directly. Specific, actionable guidance from this same body of trials: whole-body, multi-muscle resistance training, 8 to 10 exercises at 60 to 80 percent of one-rep-max intensity, at least 3 times weekly for a minimum of 12 weeks, is the minimum effective protocol found across these trials. This is a separate, complementary lever from aerobic exercise and dietary weight loss, not a replacement for either, and combining it with adequate protein intake is directly relevant to preventing the sarcopenia this category's research already flags as an independent MASLD risk.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The FIB-4 entry names it as a screening tool, current guidelines now build it into a formal, two-tier pathway that's directly cut unnecessary specialist referrals.",
    summary:
      "The FIB-4 fibrosis-screening entry gives the basic tool, and current clinical guidance builds it into a practical, two-step pathway most people will actually encounter through primary care, not a liver specialist. Current guidelines (AASLD, ACG, and AGA jointly informing this pathway) recommend FIB-4, a simple score calculated from age, AST, ALT, and platelet count, already routinely drawn bloodwork, as the first screening step for anyone with type 2 diabetes or metabolic syndrome (both covered elsewhere in this app as MASLD risk factors). Specific thresholds trigger the second step: an elevated FIB-4 (above 1.3 for ages 36-65, above 2.0 for over 65) leads to a non-invasive secondary test, transient elastography (an ultrasound-based liver-stiffness measurement) or a similar blood-based fibrosis score, before ever involving a specialist. This two-tier approach has measurably reduced unnecessary specialist referrals, letting gastroenterology and hepatology clinics focus on people who need them. This structured pathway means an already-common lab panel can start the process of ruling MASLD-related fibrosis in or out, worth asking about directly if type 2 diabetes or metabolic syndrome is already part of someone's health picture.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The Mediterranean-diet head-to-head trial names a caveat about what it competes against, a separate 2-year trial found sustained dietary adherence directly, measurably lowering a specific marker of liver cell death and inflammation.",
    summary:
      "The Mediterranean-diet entry names evidence that a plainer low-fat diet works comparably well over the shorter term, and a separate, longer trial adds useful depth about SUSTAINED adherence specifically. A 2-year clinical trial of 62 MASLD patients (ages 40-60) randomly assigned to a Mediterranean-diet-and-physical-activity intervention found a significant reduction in CK-18 (cytokeratin-18), a specific, measurable blood marker of liver cell death and inflammation, already directly relevant to this category's fibrosis-staging research. The worth-knowing detail: this benefit was found specifically in participants with HIGH adherence to the diet, and the reduction became more pronounced the longer they stayed with it, measured at both 6 and 24 months, direct evidence that consistency over time, not just short-term dietary compliance, is what drives the measurable benefit. This directly reinforces this category's already-established graded weight-loss-and-lifestyle research (5 percent reduces steatosis, 7 percent improves inflammation, 10 percent stabilizes or reverses fibrosis), with additional confirmation the Mediterranean pattern specifically, sustained over years, produces measurable improvement in liver-specific biomarkers, not just general metabolic health.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The PIVENS trial covers vitamin E's quantified NASH benefit, vitamin D tells a different, more sobering story, observational association without a matching treatment benefit.",
    summary:
      "The vitamin E research (the PIVENS trial) is a success story for one fat-soluble vitamin directly treating MASH, vitamin D's story is more mixed, and worth reporting exactly that rather than assuming the same pattern repeats. Observational data consistently finds low vitamin D levels tracking with both MASLD's presence and its severity: one large population study found each 1 ng/mL increase in vitamin D levels associated with a 2 percent lower MASLD risk, and people with the highest vitamin D levels had a sizable reduction in likelihood of fatty liver disease compared to those with the lowest levels. The plausible mechanism connects directly to processes, vitamin D has documented roles in insulin sensitivity and inflammatory signaling, both central to MASLD's progression. But a randomized, double-blind, placebo-controlled trial specifically testing whether SUPPLEMENTING vitamin D actually helps found a disappointing answer: in 65 patients with type 2 diabetes and NAFLD, high-dose oral vitamin D for 24 weeks significantly raised blood vitamin D levels as expected, but produced no difference in hepatic fat content, liver enzymes, or fibrosis markers compared to placebo. This is a textbook example of why an observational association, however consistent, doesn't automatically mean the deficiency itself is a fixable CAUSE of the disease rather than a marker of something else going on (reduced sun exposure from lower physical activity, say), unlike vitamin E's trial-confirmed benefit, correcting vitamin D levels specifically for liver benefit isn't currently supported by the best available trial evidence.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The fibrosis-staging research names the small share of MASLD that progresses to serious disease, at the national population scale, that small share still adds up to a projected, near-quadrupled transplant burden by mid-century.",
    summary:
      "The fibrosis-staging research already establishes that only a small minority of MASLD progresses to cirrhosis, and a direct national-projection study shows exactly why even that small share matters enormously at population scale. A formal modeling study projects MASLD-attributed liver transplants in the US rising from a current baseline of 1,717 per year (2020-2025) to a projected 6,720 per year by 2046-2050, a 291 percent increase, nearly quadrupling, with a cumulative total of 132,600 MASLD-related liver transplants projected across the full 2020-2050 period. This directly supports what separate research already states plainly: MASLD is projected to soon become the leading indication for liver transplant in the United States overall, and more specific data already finds it has become the TOP transplant indication specifically for women and for patients with hepatocellular carcinoma (HCC, liver cancer), a current milestone, not just a future projection. This striking national trajectory is exactly why the weight-loss thresholds, exercise research, and medication options (resmetirom, semaglutide) matter at a public-health scale, not just an individual one, direct evidence that a disease often framed as manageable lifestyle risk is on track to reshape the single scarcest resource in all of transplant medicine, donor livers, within most current adults' own lifetimes.",
    citations: [
  ...
  // rather than left out for being less flattering to the headline claim.
  {
    ...
    category: 'fattyLiverDisease',
    title: 'A Vegetarian Diet Improved Fatty Liver in a Randomized Trial, and a Separate Trial Found Weight Loss Was Likely the Actual Driver',
    ...
    summary:
      "A randomized controlled trial in China assigned 220 adults with MASLD to either a lacto-ovo-vegetarian diet or a standard omnivore diet for 6 months, both groups following dietitian-supervised meal plans. The vegetarian group achieved significantly more weight loss (1.40 kg more, on average) and a significantly higher rate of the trial's combined success measure, at least 5% weight loss plus measurable improvement in liver fat, by two different measurement methods (33.3% vs. 16.1% by ultrasound, 37.6% vs. 21.5% by a specialized liver-fat measurement called CAP). Cholesterol and blood pressure improved significantly only in the vegetarian group. Read alongside a separate complication, rather than as the whole story: a different, more recent randomized trial specifically tested whether diet type or weight loss and reduced ultra-processed food intake was the driver of liver-fat improvement in MASLD, and found the latter, reductions in BMI and in ultra-processed food consumption independently predicted improvement, while the specific dietary pattern itself did not. Read together, these say that a vegetarian or plant-based pattern is an effective real-world path to the weight loss and processed-food reduction that actually drive liver-fat improvement, not that plant-based eating carries some separate, additional liver-specific effect beyond that.",
    citations: [
