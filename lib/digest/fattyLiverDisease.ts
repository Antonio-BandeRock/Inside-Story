...
export const FATTY_LIVER_DISEASE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "This category's own already-covered fibrosis-staging research already establishes that only a small minority of MASLD progresses to cirrhosis, and a direct national-projection study shows exactly why even that small share matters enormously at population scale. A formal modeling study projects MASLD-attributed liver transplants in the US rising from a current baseline of 1,717 per year (2020-2025) to a projected 6,720 per year by 2046-2050, a 291 percent increase, nearly quadrupling, with a cumulative total of 132,600 MASLD-related liver transplants projected across the full 2020-2050 period. This directly supports what separate research already states plainly: MASLD is projected to soon become the leading indication for liver transplant in the United States overall, and more specific data already finds it has become the TOP transplant indication specifically for women and for patients with hepatocellular carcinoma (HCC, liver cancer), a current milestone, not just a future projection. Worth stating directly: this striking national trajectory is exactly why this category's own already-covered weight-loss thresholds, exercise research, and medication options (resmetirom, semaglutide) matter at a public-health scale, not just an individual one, direct evidence that a disease often framed as manageable lifestyle risk is on track to reshape the single scarcest resource in all of transplant medicine, donor livers, within most current adults' own lifetimes.",
    citations: [
