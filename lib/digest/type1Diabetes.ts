...
export const TYPE_1_DIABETES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "This category's already-covered honeymoon-phase research names a temporary window where some natural insulin production remains. A repurposed, decades-old drug, verapamil, is measurably extending that window in randomized trials.",
    summary:
      "This category's already-covered honeymoon-phase entry names a temporary window right after diagnosis where some natural insulin production often remains. Verapamil, an already-approved blood-pressure medication used for decades for a completely different purpose, is showing repeated trial evidence of extending that same window. A randomized trial in 88 children and teenagers with newly diagnosed T1D found those taking verapamil had a 30% higher C-peptide level (a direct, measured marker of the body's remaining insulin production) after 52 weeks compared with placebo, and 95% of the verapamil group maintained a meaningful insulin-production threshold versus 71% on placebo. A separate, adult trial found the same pattern, verapamil measurably preserving natural insulin production and lowering how much injected insulin patients needed. The proposed mechanism ties to this category's already-covered biology: verapamil appears to protect a signaling pathway (IGF-1) that supports beta-cell survival. Research still needs to confirm how long this benefit actually lasts and how long treatment should continue, this is repeated, positive trial evidence for an already-available, low-cost drug, not yet a formally approved T1D indication.",
    citations: [
