...
export const TYPE_1_DIABETES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'Aerobic exercise and resistance training pull blood glucose in different directions, worth planning around specifically.',
    summary:
  ...
  },
  {
    ...
    category: 'type1Diabetes',
    title: 'Celiac Disease and T1D: A Overlap Worth Actual Screening, Not Just Symptom-Watching',
  ...
  },
  {
    ...
    summary: "Islet cell transplantation is a working, if still limited and specialized, treatment that can restore the body's own natural insulin production in type 1 diabetes, worth knowing about directly as an option beyond the closed-loop insulin-delivery technology already covered in the research. The procedure involves transplanting insulin-producing islet cells, harvested from a donor pancreas, into the recipient, a less invasive and more affordable alternative to a full, whole-organ pancreas transplant. Registry-based data (the Collaborative Islet Transplant Registry) finds 50% of adults achieved complete insulin independence one year after transplantation, a striking outcome for a condition otherwise requiring lifelong insulin. Research finds benefits beyond glucose numbers alone: stabilization or improvement in most microvascular complications, preservation of long-term kidney function, and improvements in vascular health markers with possible reductions in cardiovascular risk, though that specific data remains more limited. Quality-of-life research finds benefits sustained up to 36 months, including a meaningful reduction in fear of hypoglycemia. Worth knowing honestly: this isn't risk-free or universally available, downsides include short-term procedural pain, the need for lifelong immunosuppressant medication with its own side effects, and emotional impact if the transplanted graft eventually loses function. Worth knowing directly: this is a specialized option worth discussing with an endocrinologist specifically for people with type 1 diabetes experiencing severe, hard-to-manage hypoglycemia or hypoglycemia unawareness (already covered elsewhere in the research), not a mainstream first-line treatment for most people with the condition.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Type 1 diabetes is often pictured as a childhood diagnosis, but a distinct autoimmune form, latent autoimmune diabetes in adults (LADA), shows up later in life and is easy to mistake for type 2 diabetes. Estimates put LADA at 4 to 14% of everyone currently carrying a type 2 diabetes diagnosis, with some studies suggesting closer to 10%, meaning a meaningful share of people labeled as type 2 may actually have a slower-moving autoimmune process instead. The distinguishing features: LADA patients tend to be younger at diagnosis (under 50), leaner, and less likely to show the insulin resistance or metabolic syndrome features typical of type 2 diabetes, while still testing positive for the same autoantibodies used to diagnose classic type 1 diabetes and following the same gradual but inevitable path toward needing insulin. Worth knowing directly: misdiagnosis carries concrete stakes here, since LADA's underlying autoimmune process usually calls for a different treatment approach than standard type 2 management, and inappropriate treatment has been linked to an increased complication risk. Anyone diagnosed with type 2 diabetes as a lean adult, or with no clear metabolic-syndrome features, has reasonable standing to ask whether an autoantibody panel, the same one already covered in this category, should be checked before assuming the diagnosis is settled.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "This category's own already-covered Finland research isn't the only T1D hotspot worth knowing about. Sardinia, a Mediterranean island belonging to Italy, carries the world's second-highest Type 1 diabetes incidence (45 per 100,000), directly behind Finland's 64.2 per 100,000, and unlike Finland's own plateauing incidence (already covered as tied to rising vitamin D levels), Sardinia's own incidence has nearly doubled over the last 20 years and, by some more recent measures, may now be the world's actual highest. The distinct explanation: Sardinia's own genetic background is different from Finland's, carrying a high frequency of a specific predisposing genetic marker (HLA-DR3-B18) that isn't the same one driving Finland's own elevated risk, direct evidence that more than one distinct genetic pathway can independently produce very high T1D risk in different, genetically isolated populations. Sardinia's own distinct Mediterranean climate and diet also rule out the most obvious environmental explanations already covered for Finland (rapid modernization, high-latitude vitamin D scarcity), making it a separate research puzzle, not just a smaller copy of Finland's own story. Worth knowing directly: T1D's own highest-risk populations worldwide aren't one single story, they're at least two independently-arising genetic and environmental combinations landing on a similarly extreme result.",
    chart: {
  ...
  },
  {
    ...
    teaser: 'Research finds hypertension in roughly 30% of people with Type 1 Diabetes, rising to nearly 90% once kidney disease reaches its most advanced stage, and the two often develop in a specific order worth knowing.',
  ...
  },
  {
    ...
    category: 'type1Diabetes',
    title: "T1D Reaches the Skin Too: Two Distinct Conditions Worth Recognizing by Name",
