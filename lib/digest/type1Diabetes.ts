...
export const TYPE_1_DIABETES_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Line up everything in this category and T1D reads differently in shape from every condition already built. Food's own real daily relevance here isn't about triggering or avoiding, it's about matching, carb counting accurately enough that insulin dosing actually works, with a real, measured average error (21%) directly tied to worse blood glucose control. Exercise and alcohol both carry real, specific, sometimes delayed risks (post-exercise lows, a next-morning crash from an evening drink) worth planning around rather than discovering the hard way. DKA is the one true emergency in this category, with a real, checkable ketone threshold that tells you when it's no longer a wait-and-see situation. The celiac-comorbidity finding gives the existing cross-disease observation real, actionable numbers and a real screening schedule. And the three self-advocacy entries carry the same kind of precise, quantified numbers the other conditions have already established matter: the real antibody panel behind diagnosis, Time in Range as a genuine complement to HbA1c, and the real screening intervals that exist specifically because the earliest, most treatable stage of eye and kidney damage has no symptoms at all.",
    citations: [
      { source: 'Type 1 Diabetes, National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK)', url: 'https://www.niddk.nih.gov/health-information/diabetes/overview/what-is-diabetes/type-1-diabetes' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'type1Diabetes',
    title: "T1D's Real, Long-Term Complication Burden -- and a Real, Direct Reason The Screening Guidance Matters",
  ...
  },
  {
    ...
    summary: "Islet cell transplantation is a real, genuinely working, if still limited and specialized, treatment that can restore the body's own natural insulin production in type 1 diabetes, worth knowing about directly as a real option beyond the closed-loop insulin-delivery technology already covered in the research. The real procedure involves transplanting insulin-producing islet cells, harvested from a donor pancreas, into the recipient, a real, less invasive and more affordable alternative to a full, whole-organ pancreas transplant. Real, registry-based data (the Collaborative Islet Transplant Registry) finds 50% of adults achieved complete insulin independence one year after transplantation, a real, striking outcome for a condition otherwise requiring lifelong insulin. Real research finds benefits beyond glucose numbers alone: stabilization or improvement in most microvascular complications, real preservation of long-term kidney function, and improvements in vascular health markers with possible reductions in cardiovascular risk, though that specific data remains more limited. Real, quality-of-life research finds benefits sustained up to 36 months, including a genuinely meaningful reduction in fear of hypoglycemia. Worth knowing honestly: this isn't risk-free or universally available, real downsides include short-term procedural pain, the need for lifelong immunosuppressant medication with its own real side effects, and real emotional impact if the transplanted graft eventually loses function. Worth knowing directly: this is a real, specialized option worth discussing with an endocrinologist specifically for people with type 1 diabetes experiencing severe, hard-to-manage hypoglycemia or hypoglycemia unawareness (already covered elsewhere in the research), not a mainstream first-line treatment for most people with the condition.",
    citations: [
