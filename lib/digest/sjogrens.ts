...
export const SJOGRENS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Sugar-free chewing gum and lozenges containing xylitol are a specifically recommended tool in official Sjögren's clinical practice guidelines, and they work through two distinct mechanisms at once. First, the physical act of chewing itself stimulates mechanical saliva flow, and xylitol has a direct additional effect on the salivary glands beyond that. Second, and just as: xylitol doesn't feed the bacteria responsible for tooth decay the way ordinary sugar does, directly addressing the elevated cavity risk this category's own dental-caries entry covers. Practical guidance suggests using a xylitol product four to five times a day, for about five minutes after meals and snacks, to stimulate saliva production when it's needed most. One honest caveat : excessive gum chewing can cause jaw or TMJ fatigue in some people, worth watching for rather than assuming more is automatically better.",
    citations: [
