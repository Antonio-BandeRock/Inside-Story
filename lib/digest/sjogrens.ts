...
export const SJOGRENS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'sjogrens',
    title: "Sjögren's Reach Beyond Dryness: The Lungs, Blood Vessels, and Peripheral Nerves",
  ...
  // rather than assumed.
  {
    ...
    overallTier: 'weak',
    stageNote: 'Conflicting small studies, not a consistent finding; included to show what is and isn\'t yet established, not as a confirmed mechanism.',
