...
export const SJOGRENS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Saliva isn't just a comfort function, it does active protective work in the mouth: lubrication, buffering acid, clearing food particles and bacterial plaque, and fighting bacteria directly. Sjögren's own damage to the salivary glands reduces both the amount and the composition of saliva, compromising all of these protective functions at once, not just causing dryness as a standalone symptom. The clinical result is a documented pattern of rapid, multifocal tooth decay, often starting at the roots and gumline (areas usually well protected in someone with normal saliva flow), along with an elevated risk of dental restoration failure and complications around dental implants. This is a well-documented mechanism, not just \"dry mouth is uncomfortable\", dental guidance for Sjögren's specifically recommends a combined approach: dietary counseling, saliva stimulation (see this category's own separate entries on xylitol and medication options), and topical remineralization products like high-fluoride toothpaste, treating the structural loss of saliva's own protective role directly rather than only treating the dryness itself.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The same sweetener that doesn't feed cavity-causing bacteria also stimulates the saliva Sjögren's own dryness has taken away.",
    summary:
      "Sugar-free chewing gum and lozenges containing xylitol are a specifically recommended tool in official Sjögren's clinical practice guidelines, and they work through two distinct mechanisms at once. First, the physical act of chewing itself stimulates mechanical saliva flow, and xylitol has a direct additional effect on the salivary glands beyond that. Second, and just as: xylitol doesn't feed the bacteria responsible for tooth decay the way ordinary sugar does, directly addressing the elevated cavity risk this category's own dental-caries entry covers. Practical guidance suggests using a xylitol product four to five times a day, for about five minutes after meals and snacks, to stimulate saliva production when it's needed most. One honest caveat worth knowing: excessive gum chewing can cause jaw or TMJ fatigue in some people, worth watching for rather than assuming more is automatically better.",
    citations: [
  ...
  },
  {
    ...
    teaser: "A fairly large, recent trial found the same supplement helping both of Sjögren's own hallmark symptoms together.",
  ...
  // independently verified via WebSearch.
  {
    ...
    summary:
      "Sjögren's has a formal split worth understanding beyond the already-covered RA/lupus overlap: primary Sjögren's occurs on its own, while secondary Sjögren's occurs alongside another established connective-tissue disease, most often lupus or rheumatoid arthritis, and less often systemic sclerosis, MS, or autoimmune thyroiditis. A formal diagnostic distinction exists too: in someone who already has a confirmed connective-tissue disease, one symptom plus two of three objective test criteria is enough to classify secondary Sjögren's, a lower bar than the ACR/EULAR criteria (a score of 4 or higher across several weighted criteria, including salivary gland biopsy findings) used for a primary diagnosis. A counterintuitive finding worth knowing: primary Sjögren's patients show MORE severe glandular dysfunction (worse dryness) than secondary Sjögren's patients, not less, despite secondary cases involving a second autoimmune disease on top.",
    citations: [
  ...
  // citation independently verified via WebSearch.
  {
    ...
    summary: "The labial minor salivary gland biopsy, a minor procedure taking a small tissue sample from inside the lower lip, is an important, if under-discussed, diagnostic tool for confirming Sjögren's syndrome, worth knowing about directly alongside the antibody testing already covered in the Sjögren's research. Diagnostic criteria score this biopsy using a \"focus score,\" a focus being defined as a dense cluster of 50 or more lymphocytes (immune cells) found per 4 square millimeters of gland tissue, with a focus score of 1 or higher a critical, formal step in Sjögren's classification. Research finds the biopsy's own diagnostic performance strong, sensitivity ranging from 63.5% to 93.7% and specificity from 61.2% up to 100% in some studies. Worth knowing honestly: research also finds this test imperfect and inconsistent in practice, focus score isn't reported at all in a 17% of cases, inter-observer variability exists between different pathologists reading the same sample, and a 18-40% of confirmed primary Sjögren's patients still have a focus score below the diagnostic threshold on their own lip biopsy, meaning a negative result doesn't fully rule the disease out. Emerging AI-assisted scoring tools are being developed specifically to reduce this variability. Worth knowing directly: this is a worth-understanding piece of the diagnostic puzzle for anyone being evaluated for Sjögren's, useful alongside, not instead of, the antibody panel and clinical symptom picture already covered elsewhere in the research.",
    citations: [
  ...
  },
  {
    ...
    summary: "Fatigue, not the dry eyes and dry mouth Sjögren's is best known for, is worth knowing directly as the disease's own most prevalent and most disabling symptom for many patients. Research finds disabling fatigue reported in up to 70% of Sjögren's patients, with fatigue explicitly named in clinical research as the most commonly reported and debilitating extraglandular (beyond the glands) symptom of the disease, more burdensome to many patients than the dryness itself. Research finds fatigue's own predictors are more strongly tied to pain, helplessness, and depression, along with sleep disturbances and comorbid fibromyalgia (already covered in the Sjögren's-secondary-overlap research), than to standard bloodwork or inflammatory lab markers, meaning a person's own subjective fatigue burden often doesn't show up as any single abnormal test result. A direct comparison found fatigue significantly more severe in Sjögren's specifically than in other systemic autoimmune rheumatic diseases without Sjögren's involved, evidence this isn't just generic chronic-illness tiredness but something characteristic of the disease itself. Worth knowing directly: this is validating information for anyone with Sjögren's whose fatigue feels disproportionate to what their labs or a doctor's visual assessment of dryness alone would suggest, it's a well-documented, central part of the disease, worth naming and tracking directly rather than dismissed as unrelated or purely psychological.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A French, 120-patient randomized trial (TEARS) found rituximab didn\'t significantly beat placebo on its own primary measure, an honest example of a plausible treatment not panning out as hoped.',
    summary: "Rituximab, a well-established biologic that depletes a specific type of immune cell (B cells), has biological plausibility for Sjögren's, since B-cell overactivity is a documented part of the disease. A randomized, placebo-controlled French trial (TEARS), following 120 patients after a single course of rituximab, tested this directly against a specific bar: at least a meaningful improvement in two of four core symptom measures (dryness, pain, fatigue, and overall disease-activity assessment) at 24 weeks. Rituximab didn't reach that bar. An early improvement in fatigue at 6 weeks didn't hold up by 24 weeks, and the trial's own authors noted the chosen outcome measure was demanding and subjective, which may have made a smaller benefit harder to detect. A second, separate UK trial (TRACTISS) reached a similarly negative primary result. Worth knowing honestly: this doesn't mean rituximab has zero effect, secondary measures in these same trials did show some improvement in objective salivary flow and lab markers, but it's an honest example of promising biological reasoning not translating cleanly into the specific, real-world symptom improvement a randomized trial is built to detect. This is named directly rather than only covering medications with a clean positive result, since knowing what DIDN'T clearly work, and why, is useful context too.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Hydroxychloroquine has strong evidence in lupus, but the JOQUER trial found it no better than placebo for Sjögren\'s own core symptoms of dryness, pain, and fatigue.',
    summary: "Hydroxychloroquine is a well-established, effective medication in lupus (see the lupus research), and it's commonly prescribed for Sjögren's syndrome too, on the reasonable, assumption that a medication working for one antibody-driven autoimmune disease should plausibly help a related one. The landmark JOQUER trial tested this directly: 120 patients with primary Sjögren's syndrome, randomized to hydroxychloroquine (400mg daily) or placebo for 24 weeks, measuring the condition's own three core symptoms, dryness, pain, and fatigue. The honest result: hydroxychloroquine was NOT more effective than placebo at improving any of these three core symptoms, a negative finding for the trial's own primary purpose. Worth knowing honestly, since this isn't a simple 'it doesn't work' story either: later analysis of the same trial's own biological samples found hydroxychloroquine DID measurably reduce a specific immune signal (interferon activation) tied to Sjögren's own disease process, biological activity that just didn't translate into the specific, symptom relief patients were hoping for at 24 weeks. Worth knowing directly: this is a useful example of why the research draws a hard line between a medication working for one autoimmune condition and it necessarily working for a related but distinct one, worth a direct conversation about whether hydroxychloroquine is helping if already prescribed for Sjögren's specifically.",
    citations: [
  ...
  },
  {
    ...
    teaser: "Data finds Sjögren's runs higher in Mediterranean than Northern European countries, and its own male-to-female ratio, symptom pattern, and typical age at diagnosis all shift measurably by ethnicity too.",
  ...
  },
  {
    ...
    teaser: "A German claims-data study found only 11% of people with a confirmed Sjögren's diagnosis were actually receiving rheumatologic care, evidence this category's own already-covered diagnostic-delay research understates how often people simply fall through entirely.",
    summary: "This category's own already-covered diagnostic-delay research (dryness dismissed as normal aging, seronegative cases missed by antibody testing) has a further, structural layer worth naming directly: even a confirmed diagnosis often doesn't lead to ongoing specialist care. A German claims-data study of 54,273 people with a documented Sjögren's diagnosis found only 5,961 of them, just 11%, were actually receiving care from a rheumatologist, meaning a large majority were managing an autoimmune disease without the specialist oversight the already-covered care generally assumes. US-based estimates independently arrive at a similarly stark picture from the diagnosis side itself: experts estimate roughly 50% of Sjögren's cases, an estimated 2 million Americans, remain completely undiagnosed, driven by limited healthcare-provider awareness of the disease and the absence of one single gold-standard diagnostic test. Worth knowing directly: the already-covered international research (geographic and ethnic variation in Sjögren's presentation) is worth reading alongside this structural finding, someone's own experience with Sjögren's, wherever they live, may look less like 'the disease is uncommon here' and more like 'this disease is under-recognized nearly everywhere,' an important distinction when comparing one's own regional prevalence data against another country's.",
    chart: {
  ...
  },
  {
    ...
    teaser: 'Iscalimab, blocking the CD40 receptor itself rather than its ligand, became the first drug ever to produce a meaningful reduction in a formal, systemic Sjögren\'s disease-activity score, a distinct finding alongside this category\'s own already-covered dazodalibep research.',
    summary:
      "This category's own already-covered dazodalibep research blocks CD40 ligand; iscalimab, a separate antibody, blocks the CD40 receptor itself, essentially the two sides of the same immune-signaling handshake, both now independently showing promise. A placebo-controlled proof-of-concept trial in 44 Sjögren's patients found intravenous iscalimab producing a statistically significant reduction in ESSDAI (the field's own formal, systemic disease-activity score) after just 12 weeks, direct evidence described by the field itself as the first drug to achieve a clinically meaningful change in Sjögren's own systemic complications specifically, not just symptom relief. A follow-up Phase 2 trial (TWINSS) further confirmed both safety and efficacy for a subcutaneous version of the same drug. Worth knowing directly: two independent drugs targeting essentially the same CD40 signaling pathway from opposite sides both showing benefit is a meaningful confirmation that this specific immune mechanism matters in Sjögren's, not just a single trial's own result, strengthening the case for this whole approach even before either drug reaches a final, larger Phase 3 confirmation.",
    citations: [
  ...
  },
  {
    ...
    summary: 'Cross-sectional research finds a substantial mental-health burden in primary Sjögren\'s syndrome: depression prevalence estimates as high as 32 to 46 percent, and one study finding 36.9 percent depression and 33.8 percent anxiety, both significantly higher than matched controls. Research finds the two symptoms carry partly distinct risk factors: anxiety tracks most closely with younger age, pain, and fatigue (the already-covered, most disabling Sjögren\'s symptom), while depression tracks most closely with xeroderma (dry skin), pain, and fatigue. A specific-to-this-disease finding worth knowing directly: research identifies oral health and swallowing disorders as the single most important predictor of anxiety specifically in Sjögren\'s patients, a direct, mechanistic link to the disease\'s own already-covered dental-caries and dry-mouth research, not a generic chronic-illness anxiety finding. Worth reading alongside the existing fatigue entry, which already names depression as one of fatigue\'s own predictors, the two are intertwined, not separate concerns competing for attention.',
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered dental-caries entry names Sjögren's cavity risk, a rigorous, placebo-controlled trial found quarterly fluoride varnish didn't produce a statistically clear reduction in new cavities, though it did meaningfully cut oral yeast overgrowth.",
    summary: "This category's own already-covered dental-caries risk entry names Sjögren's mechanical route to rapid tooth decay, and a rigorous, 24-month randomized, double-blind, placebo-controlled trial tested one of the most commonly recommended preventive tools directly: quarterly fluoride varnish applications in 78 Sjögren's patients. The honest result: at 24 months, new coronal enamel cavities were identical between groups (1.6 surfaces each), and while new cavities beneath the enamel (dentin caries) were numerically lower in the fluoride group (1.4 versus 2.7 surfaces), the statistical difference didn't reach significance. Worth stating plainly, matching the standing discipline: this is an honest null result on the primary question, not evidence fluoride varnish definitely doesn't help, but direct evidence this specific trial couldn't confirm the clear preventive benefit many dental guidelines assume. A positive, secondary finding did emerge from the same trial: oral Candida (yeast) counts dropped 30 percent in the fluoride group while rising 61 percent in the placebo group, evidence fluoride varnish may still carry meaningful benefit for oral yeast overgrowth even if the cavity-prevention picture stayed unclear. Worth knowing directly: this doesn't mean skip fluoride treatment, dental guidance still recommends it as part of a broader prevention plan (already covered elsewhere in this category alongside xylitol), just that the specific cavity-prevention claim deserves more confirmatory trial evidence than currently exists.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered lymphoma-risk entry names the elevated risk overall, research finds one specific, physically noticeable symptom, persistent swelling of the parotid gland, a major direct predictor worth tracking.",
    summary:
      "This category's own already-covered lymphoma-risk entry names Sjögren's elevated risk of a specific blood cancer, and research identifies one specific, physically noticeable symptom as a major direct predictor: persistent parotid gland swelling (swelling of the salivary gland located near the jaw and ear). Research finds lymphoma in Sjögren's most often localizes specifically in the parotid gland, with MALT lymphoma (a usually slow-growing type, consistent with this category's own already-covered reassurance about the typical disease course) the most frequent histological type. A direct study found that precise, systematic clinical recording of parotid swelling (rather than a vague general impression) measurably improved lymphoma prediction in primary Sjögren's syndrome, evidence this is a worth-tracking, quantifiable clinical sign, not just a subjective symptom. Research also identifies additional, lab-based risk markers worth knowing alongside it: mixed cryoglobulinemia with vasculitis (already covered elsewhere in this category), rheumatoid factor positivity, and low complement C4 levels, together forming a composite risk picture rather than any single marker alone. A growing role for salivary-gland ultrasound in monitoring adds a non-invasive tool to this picture too. Worth stating directly: persistent, new, or worsening parotid swelling in Sjögren's is worth reporting to a rheumatologist directly and promptly, not assumed to be an ordinary, harmless fluctuation of an already-affected gland.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered fatigue entry names it as the disease's most disabling symptom, two distinct randomized trials, one on walking, one on resistance training, found structured exercise directly, measurably reduced it.",
    summary:
      "This category's own already-covered fatigue entry names it as Sjögren's own single most disabling symptom, more disruptive than the dryness the disease is named for, and direct trial evidence finds structured exercise an actionable response rather than something to avoid out of caution. Fatigue affects up to 70 percent of primary Sjögren's patients, with more than half experiencing it as intense and incapacitating, documented reasons many patients understandably slide toward a more sedentary lifestyle, which research finds can make fatigue worse over time, not better. A randomized controlled trial had women with primary Sjögren's follow a supervised walking program three times a week for 16 weeks and found significant improvement in cardiorespiratory fitness, exercise tolerance, AND fatigue itself, with the intervention confirmed safe throughout. A separate randomized trial testing resistance training specifically found it effectively improved fatigue, pain, functional capacity, emotional wellbeing, and vitality, with participants' own subjective sense of disease activity also improving, broad benefit from a different exercise type. A third trial specifically measuring cardiovascular effects of physical exercise in primary Sjögren's confirmed measurable benefit there too. Worth stating directly: this is replicated, randomized-trial evidence across two different exercise types (aerobic and resistance), not a single small study, worth taking seriously as a low-risk, directly actionable response to what patients themselves consistently name as their hardest symptom to live with.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Sjögren\'s own reduced saliva already raises dental caries risk on its own, and dental guidance for this condition specifically names acidic fermentation drinks as something to actively watch.',
