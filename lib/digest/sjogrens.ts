...
export const SJOGRENS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'sjogrens',
    title: "Secondary Sjögren's: A Real, Substantial Overlap With Two Conditions Already covered",
  ...
  },
  {
    ...
    teaser: 'A disease defined by dryness that reaches the kidneys and a real cancer risk, and a real, direct, same-day relationship with food and drink most other conditions don\'t share.',
    summary: "Line up everything in this category and Sjögren's reads as a disease whose real reach genuinely exceeds its own reputation as \"just dryness.\" The dental-caries mechanism shows exactly how directly saliva loss translates into real, measurable physical damage, and the real fixes, xylitol and the medications pilocarpine and cevimeline, work by restoring the body's own real function rather than just masking the symptom. Alcohol and caffeine carry a genuinely immediate, same-day relationship to dryness, a more direct food-symptom link than most other conditions show. The real lymphoma risk and the real renal tubular acidosis finding, which can strike before the disease's own hallmark dryness is even recognized, both argue for taking Sjögren's seriously as a systemic disease, not a cosmetic inconvenience. And the real, substantial overlap with rheumatoid arthritis and lupus, both already covered elsewhere, is a direct, practical reason anyone managing either of those conditions should know this category exists at all.",
    citations: [
      { source: "Sjögren's Syndrome, MedlinePlus, U.S. National Library of Medicine", url: 'https://medlineplus.gov/sjogrenssyndrome.html' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'sjogrens',
    title: "The Same Real Anti-Ro/Anti-La Antibody Risk The Lupus Research Covers, With Sjögren's Own Real, Specific Numbers",
  ...
  // citation independently verified via WebSearch.
  {
    ...
    summary: "The labial minor salivary gland biopsy, a real, minor procedure taking a small tissue sample from inside the lower lip, is a genuinely important, if under-discussed, diagnostic tool for confirming Sjögren's syndrome, worth knowing about directly alongside the antibody testing already covered in the Sjögren's research. Real diagnostic criteria score this biopsy using a \"focus score,\" a focus being defined as a real, dense cluster of 50 or more lymphocytes (immune cells) found per 4 square millimeters of gland tissue, with a focus score of 1 or higher a real, critical, formal step in Sjögren's classification. Real research finds the biopsy's own diagnostic performance genuinely strong, sensitivity ranging from 63.5% to 93.7% and specificity from 61.2% up to 100% in some studies. Worth knowing honestly: real research also finds this test genuinely imperfect and inconsistent in practice, focus score isn't reported at all in a real 17% of cases, real inter-observer variability exists between different pathologists reading the same sample, and a real 18-40% of confirmed primary Sjögren's patients still have a focus score below the diagnostic threshold on their own lip biopsy, meaning a negative result doesn't fully rule the disease out. Real, emerging AI-assisted scoring tools are being developed specifically to reduce this variability. Worth knowing directly: this is a real, worth-understanding piece of the diagnostic puzzle for anyone being evaluated for Sjögren's, useful alongside, not instead of, the real antibody panel and clinical symptom picture already covered elsewhere in the research.",
    citations: [
  ...
  },
  {
    ...
    summary: 'Real, cross-sectional research finds a genuinely substantial mental-health burden in primary Sjögren\'s syndrome: depression prevalence estimates as high as 32 to 46 percent, and one real study finding 36.9 percent depression and 33.8 percent anxiety, both significantly higher than matched controls. Real research finds the two symptoms carry real, partly distinct risk factors: anxiety tracks most closely with younger age, pain, and fatigue (the already-covered, most disabling Sjögren\'s symptom), while depression tracks most closely with xeroderma (dry skin), pain, and fatigue. A real, genuinely specific-to-this-disease finding worth knowing directly: real research identifies oral health and swallowing disorders as the single most important predictor of anxiety specifically in Sjögren\'s patients -- a real, direct, mechanistic link to the disease\'s own already-covered dental-caries and dry-mouth research, not a generic chronic-illness anxiety finding. Worth reading alongside the existing fatigue entry, which already names depression as one of fatigue\'s own real predictors -- the two are genuinely intertwined, not separate concerns competing for attention.',
    citations: [
