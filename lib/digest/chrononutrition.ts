...
export const CHRONONUTRITION_ENTRIES: DigestEntry[] = [
  {
    ...
    summary: "Sleep & Health covers the brain's master clock, the suprachiasmatic nucleus, and how light resets it daily. That master clock isn't the only one running: the liver, pancreas, gut, adipose tissue, and skeletal muscle all carry independent \"peripheral\" clocks, built from the same core clock genes, that govern organ-specific jobs, like when the liver ramps up glucose production, or when the pancreas is primed to release insulin most efficiently. The key distinction that makes chrononutrition a field in its own right, not just a restatement of general circadian science: these peripheral clocks can't sense light directly. Food is their main synchronizing cue instead. Eating at consistent, biologically appropriate times keeps the liver, gut, and pancreas clocks running in step with the brain's master clock, while eating at irregular or very late hours can pull them out of alignment with each other, a state called circadian misalignment, distinct from (though related to) the light-driven misalignment sleep research already documents.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Time-Restricted Eating Doesn\'t Always Improve Insulin Sensitivity',
  ...
  },
  {
    ...
    overallTier: 'weak',
    relatedIds: ['chrono-late-eating-cardiovascular-risk', 'chrono-early-time-restricted-eating', 'diet-intermittent-fasting'],
  },
  {
    id: 'chrono-gut-microbiome-diurnal-rhythm',
    category: 'basicHealth',
    title: 'Your Gut Bacteria Have a Daily Schedule, Too',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Cortisol Follows a Daily Rhythm, But the \"Awakening Response\" Itself Has a New Complication",
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Shift Workers Show Measurably Higher Rates of Metabolic and Cardiovascular Disease',
    ...
    summary: "Night and rotating shift work forces a sustained mismatch between a person's internal circadian clock and when they eat, sleep, and are active, making shift workers a natural population for studying what happens when circadian rhythms are chronically disrupted, not just a theoretical concern. A large meta-analysis found night shift workers had significantly higher cardiovascular event risk, with a clear dose-response relationship: each additional five years of night shift work further raised risk. A separate meta-analysis specifically in healthcare workers found shift work carried roughly 11 to 14% higher odds of metabolic syndrome compared to day work. The proposed mechanisms are the same ones the other chrononutrition entries describe: circadian misalignment disrupting glucose tolerance, lipid metabolism, and the gut microbiome's daily rhythm, not a separate, unexplained shift-work-specific effect.",
    citations: [
