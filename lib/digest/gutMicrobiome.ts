...
//
// 2026-08-07, same day, rewritten in a real narrative shape, the second
...
// and his own central thesis that the gut is the body's real first line
// of defense -- protecting it is where reversing Hashimoto's symptoms
...
export const GUT_MICROBIOME_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'gutMicrobiome',
    title: "L-Glutamine: Almost Certainly the Most Recommended \"Leaky Gut\" Supplement -- and a Real, Humbling Correction",
    ...
    summary:
      "Walk into almost any conversation about healing a \"leaky gut\" and L-glutamine will come up within the first few sentences -- it's probably the single most commonly recommended supplement in this entire space, repeated confidently enough that it rarely gets questioned. It's not a baseless recommendation to begin with. Glutamine has a real, specific mechanism: it regulates the tight-junction proteins occludin and claudin-1, and it's the preferred fuel source enterocytes -- the cells lining the small intestine -- burn directly. It also has genuine positive trial results in specific, narrower contexts: HIV, burn injuries, exercise-induced heat stress. But when a systematic review pooled 10 real clinical trials, 352 participants total, specifically testing whether glutamine improves intestinal permeability, the honest answer came back no -- no significant overall improvement. This is exactly the kind of correction this Digest exists to make plainly rather than quietly bury: a real mechanism and genuine trial support in narrow contexts doesn't automatically mean the popular, broader claim holds up once it's actually pooled and tested at scale.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: "Vitamin D's own effect on Hashimoto's antibodies is a genuinely mixed picture. Its effect on the gut barrier is a different, cleaner story, discovered by researchers who weren't even looking for it.",
    summary:
      "Vitamin D's own track record against Hashimoto's antibodies directly, covered elsewhere in this Digest under Nutrients & Micronutrients, is honestly mixed -- a real correlation, inconsistent intervention trials. That mixed picture doesn't mean vitamin D has nothing real to do with Hashimoto's; it may simply mean the research has been looking in the wrong place. A gene called CLDN2 codes for claudin-2, one of the actual structural proteins making up a tight junction between gut cells. Real ChIP-assay research -- a direct, molecular method for confirming a gene is genuinely under another molecule's control, not just associated with it -- found CLDN2 is a direct, confirmed target of the vitamin D receptor. That means vitamin D receptor signaling has a real, specific, non-speculative role protecting gut-barrier integrity through the MLCK signaling pathway, entirely separate from whatever it's doing (or not clearly doing) to TPO antibodies directly. If vitamin D turns out to matter for Hashimoto's, this gut-barrier pathway is a genuinely plausible reason why -- a second, independent route to the same disease, found by researchers who weren't even asking about Hashimoto's when they found it.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Zinc on its own already has a real, if fairly general, role in immune function, covered elsewhere in this Digest. Zinc carnosine -- a specific bonded compound of zinc and the amino acid carnosine, not interchangeable with plain zinc -- has something more specific and more directly useful to say about the gut barrier itself. A real randomized controlled trial found zinc carnosine completely blocked the intestinal-permeability increase caused by NSAIDs, the same everyday over-the-counter pain relievers (ibuprofen, naproxen, aspirin) covered under Lifestyle & Environment for their own documented gut-barrier effect. Separate trial evidence supports zinc carnosine for tight-junction integrity in two more specific populations: athletes and people with gastric ulcers. A more consistently positive picture than glutamine's own honest null result above -- worth knowing by its specific compound name, not lumped in with \"zinc\" generally the way it usually gets marketed.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'gutMicrobiome',
    title: 'How Long Does Gut Repair Actually Take? A Real, Checkable Answer',
    teaser: "Not an indefinite \"it takes time\" -- real trials measured zonulin directly and put an actual number of weeks on it.",
    summary:
      '"Healing the gut takes time" is true, and almost useless on its own -- it gives no real sense of whether that means two weeks or two years. Real dietary-intervention studies that measured zonulin directly, not just symptoms, put an actual number on it. A randomized crossover trial in older adults eating a polyphenol-rich diet (the MaPLE trial) found significant zonulin reductions within just 8 weeks. A second, independent trial following real weight loss in patients with MASH/liver fibrosis confirmed genuine reductions holding at both the 12-week and the 24-week mark. A genuine, checkable timeline instead of an open-ended promise -- worth pairing with the honest caveat that these are group averages from specific interventions in specific populations, not a guarantee of any one person\'s own exact pace.',
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "Reading through this category, most of the strongest individual mechanisms -- the named bacterial strain found in lupus, the endoscopically-confirmed AIP trial run in IBD patients -- come from other autoimmune diseases, included as real corroborating evidence rather than direct proof. This entry is the exception. A real dietary-fiber-intervention study measured gut microbiota changes directly in Hashimoto's thyroiditis patients -- not extrapolated, not borrowed, a genuinely disease-specific population. It directly supports the SCFA/fiber mechanism at the top of this category, but with data drawn from the actual disease this whole app is built around, not a related one standing in for it. Small in scope, but real, and rare enough in this category to be worth flagging specifically -- one of the few entries here where \"Hashimoto's\" isn't a word researchers were reasoning toward from somewhere else, but the actual population sitting in front of them.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "The Autoimmune Protocol diet shows up throughout this app's research as a real, if imperfectly evidenced, elimination-and-reintroduction strategy. Its single strongest piece of trial evidence doesn't come from Hashimoto's research at all. A real randomized controlled trial of the AIP diet in inflammatory bowel disease -- Crohn's and ulcerative colitis -- found improvement in BOTH quality of life AND endoscopic (directly visualized) inflammation. That's a larger, more rigorous trial than the single small Hashimoto's-specific AIP pilot study this app otherwise leans on, run in a disease where \"did the gut actually get better\" can be checked directly on camera rather than inferred from how someone says they feel. Real corroborating weight for AIP as a strategy worth considering -- not proof it works for Hashimoto's specifically, but a meaningfully stronger foundation than the thin Hashimoto's-only evidence would provide on its own.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Not a mouse study, not an observation -- a real randomized human trial of ordinary probiotic yogurt, in a genuinely different autoimmune disease.',
    summary:
      "Most of the food-level interventions covered in this app's own Fermented Foods research rest on mechanism and observational data. This entry is a rarer thing: a real, randomized, controlled human trial of an actual, everyday food. Lupus patients given a real probiotic yogurt containing L. rhamnosus and B. bifidum showed measurable improvement in both disease activity and disability measures compared to controls -- genuine clinical-trial evidence, not observational correlation, in a disease with real, documented biological overlap to Hashimoto's through the same gut-autoimmunity mechanisms this category covers throughout. A real, human, food-based intervention that worked, in a real trial -- exactly the kind of evidence this whole Digest is built to surface, while still being honest about its actual limit: a different disease, not Hashimoto's itself.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: 'The real immunology explaining the single strangest-sounding claim in this whole app: that gut bacteria could be connected to an attack on the thyroid.',
    summary:
      '"Gut bacteria might be connected to your thyroid" is probably the claim in this entire Digest that sounds the most far-fetched on first hearing it. Molecular mimicry is the real, well-established immunology that makes it genuinely plausible. When a microbial protein happens to structurally resemble a human protein closely enough, the antibodies the immune system trained to recognize and attack that microbe can mistakenly cross-react with the body\'s own tissue instead -- a genuine case of biological mistaken identity, not a metaphor. This is one of the leading proposed mechanisms connecting gut bacterial composition to thyroid autoimmunity specifically, standing alongside, not replacing, the zonulin/permeability pathway and the SCFA/Treg pathway covered elsewhere in this same category. Three genuinely different mechanisms, each with its own real evidence, all pointing the same direction -- not one vague "gut-thyroid connection" repeated three times over, but three separate, specific reasons the connection is real.',
    citations: [
