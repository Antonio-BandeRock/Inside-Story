...
export const GUT_MICROBIOME_ENTRIES: DigestEntry[] = [
  {
    ...
    overallTier: 'strong',
    relatedIds: ['gut-fiber-hashimotos-microbiota', 'foodhistory-butter-short-chain-fat', 'prostate-gut-microbiome-bph', 'ckd-fiber-intake-inflammation', 'foodhistory-regen-antibiotic-resistance-livestock', 'foodhistory-regen-soil-gut-microbiome-axis', 'foodhistory-regen-old-friends-hypothesis', 'garden-hands-in-soil-immune-training', 'garden-symbiosis-mission'],
  },
  {
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: "A Real Human Trial of One of The Everyday Foods, Just Not in Hashimoto's Patients",
