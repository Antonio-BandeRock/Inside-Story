...
export const GUT_MICROBIOME_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Zinc on its already has a fairly general role in immune function, covered elsewhere in this Digest. Zinc carnosine, a specific bonded compound of zinc and the amino acid carnosine, not interchangeable with plain zinc, has something more specific and more directly useful to say about the gut barrier itself. A randomized controlled trial found zinc carnosine completely blocked the intestinal-permeability increase caused by NSAIDs, the same everyday over-the-counter pain relievers (ibuprofen, naproxen, aspirin) covered under Lifestyle & Environment for their documented gut-barrier effect. Separate trial evidence supports zinc carnosine for tight-junction integrity in two more specific populations: athletes and people with gastric ulcers. A more consistently positive picture than glutamine's honest null result above, best tracked by its specific compound name, not lumped in with \"zinc\" generally the way it usually gets marketed.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: 'The mechanism is measurable. The label is still debated. Here is an honest look at exactly where that line actually sits.',
    summary: '"Leaky gut" is simultaneously one of the most mocked phrases in mainstream medicine and one of the most measurable phenomena described throughout this entire category. Both things are true at once, and conflating them does a disservice to the actual science either way. Intestinal permeability itself (zonulin levels, lactulose-mannitol testing) is a directly measurable phenomenon with documented mechanistic links to several autoimmune conditions, exactly what this whole category has been laying out entry by entry. "Leaky gut syndrome" as a standalone clinical diagnosis is a different claim, and it remains debated within mainstream gastroenterology and endocrinology, not because the underlying biology is fake, but because a clear, agreed clinical definition and diagnostic threshold simply don\'t exist yet the way they do for, say, celiac disease. Held to the same evidence-tiering standard as everything else: mechanism, measurement, contested label, a distinction worth keeping straight rather than either dismissing the whole idea or overselling it as settled fact.',
    citations: [
