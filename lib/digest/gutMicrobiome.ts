...
export const GUT_MICROBIOME_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "\"Leaky gut\" gets used so loosely in casual health conversation that it's easy to assume there's no biology behind it, just a catchy phrase standing in for \"something's wrong down there.\" That assumption doesn't survive contact with the actual research. Gliadin, a specific fragment of the gluten protein, binds directly to a receptor called CXCR3 on the surface of intestinal cells. That binding event triggers those cells to release zonulin, a named protein whose entire job is regulating how tightly the junctions between gut lining cells stay sealed. Zonulin doesn't destroy the barrier. It reversibly opens it, the molecular equivalent of a security checkpoint temporarily waving more traffic through than it should. This pathway was first fully characterized in celiac disease, but it doesn't stay confined there. The same gliadin-CXCR3-zonulin sequence is now documented as relevant across several other autoimmune conditions this app covers under Other Autoimmune Diseases, not just celiac. This is exactly the kind of specific, named mechanism worth insisting on instead of vague gut-health language: a receptor, a protein, a reversible effect, not a mystery standing in for one.",
    citations: [
  ...
  },
  {
    ...
    teaser: "If there's one supplement everyone assumes fixes a leaky gut, it's this one. The actual trial data, pooled, says otherwise.",
    summary:
      "Walk into almost any conversation about healing a \"leaky gut\" and L-glutamine will come up within the first few sentences. It's probably the single most commonly recommended supplement in this entire space, repeated confidently enough that it rarely gets questioned. It's not a baseless recommendation to begin with. Glutamine has a specific mechanism: it regulates the tight-junction proteins occludin and claudin-1, and it's the preferred fuel source enterocytes (the cells lining the small intestine) burn directly. It also has positive trial results in specific, narrower contexts: HIV, burn injuries, exercise-induced heat stress. But when a systematic review pooled 10 clinical trials, 352 participants total, specifically testing whether glutamine improves intestinal permeability, the answer came back no, no significant overall improvement. This is exactly the kind of correction this app exists to make plainly rather than quietly bury: a mechanism and trial support in narrow contexts doesn't automatically mean the popular, broader claim holds up once it's actually pooled and tested at scale.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: "Vitamin D's effect on Hashimoto's antibodies is a mixed picture. Its effect on the gut barrier is a different, cleaner story, discovered by researchers who weren't even looking for it.",
    summary:
      "Vitamin D's track record against Hashimoto's antibodies directly, covered elsewhere in this app under Nutrients & Micronutrients, is mixed: a correlation, inconsistent intervention trials. That mixed picture doesn't mean vitamin D has nothing to do with Hashimoto's. It may simply mean the research has been looking in the wrong place. A gene called CLDN2 codes for claudin-2, one of the actual structural proteins making up a tight junction between gut cells. ChIP-assay research, a direct, molecular method for confirming a gene is under another molecule's control, not just associated with it, found CLDN2 is a direct, confirmed target of the vitamin D receptor. That means vitamin D receptor signaling has a specific, non-speculative role protecting gut-barrier integrity through the MLCK signaling pathway, entirely separate from whatever it's doing (or not clearly doing) to TPO antibodies directly. If vitamin D turns out to matter for Hashimoto's, this gut-barrier pathway is a plausible reason why, a second, independent route to the same disease, found by researchers who weren't even asking about Hashimoto's when they found it.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Not just "zinc": a specific paired compound with a trial showing it fully blocked a documented, everyday cause of gut damage.',
    summary:
      "Zinc on its own already has a fairly general role in immune function, covered elsewhere in this app. Zinc carnosine, a specific bonded compound of zinc and the amino acid carnosine, not interchangeable with plain zinc, has something more specific and more directly useful to say about the gut barrier itself. A randomized controlled trial found zinc carnosine completely blocked the intestinal-permeability increase caused by NSAIDs, the same everyday over-the-counter pain relievers (ibuprofen, naproxen, aspirin) covered under Lifestyle & Environment for their documented gut-barrier effect. Separate trial evidence supports zinc carnosine for tight-junction integrity in two more specific populations: athletes and people with gastric ulcers. A more consistently positive picture than glutamine's null result above, best tracked by its specific compound name, not lumped in with \"zinc\" generally the way it usually gets marketed.",
    citations: [
      {
  ...
  },
  {
    id: 'gut-4r-protocol',
    category: 'hashimotos',
    title: 'The 4R Protocol: Evidence in Every Piece, No Trial of the Whole Package',
    ...
    summary:
      "The 4R Protocol (Remove triggers, Replace digestive support, Reinoculate with probiotics, Repair the gut lining) is one of the most widely used frameworks in functional medicine, repeated across countless practitioner sites and patient guides as an established, proven protocol. Piece by piece, it holds up. Elimination, probiotics, glutamine, zinc carnosine (with glutamine's limits, noted above), every individual component covered elsewhere in this category has its separately-tested evidence base. What doesn't hold up under a direct search is the packaged, 4-step protocol itself. A search for clinical validation of the 4R Protocol as a whole turned up almost entirely practitioner and wellness-industry sources, not a peer-reviewed trial of the combined program as its intervention. That's a meaningfully different thing to know than either \"this protocol works\" or \"this protocol is fake.\" It's a useful organizing framework built from separately-evidenced parts, tiered here as exactly that: a practitioner framework, not a validated package.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: 'Not an indefinite "it takes time." trials measured zonulin directly and put an actual number of weeks on it.',
    summary:
      '"Healing the gut takes time" is true, and almost useless on its own. It gives no sense of whether that means two weeks or two years. Dietary-intervention studies that measured zonulin directly, not just symptoms, put an actual number on it. A randomized crossover trial in older adults eating a polyphenol-rich diet (the MaPLE trial) found significant zonulin reductions within just 8 weeks. A second, independent trial following weight loss in patients with MASH/liver fibrosis confirmed reductions holding at both the 12-week and the 24-week mark. A checkable timeline instead of an open-ended promise, worth pairing with the caveat that these are group averages from specific interventions in specific populations, not a guarantee of any one person\'s exact pace.',
    citations: [
      {
  ...
  },
  {
    ...
    teaser: 'A drug, built specifically to block zonulin, has reached Phase III trials, with one humbling result attached to it.',
    summary:
      "It would be easy to assume gut-permeability biology is a wellness-industry concept mainstream pharmaceutical research doesn't take seriously. Larazotide acetate is direct evidence otherwise. This is a drug candidate, purpose-built specifically to block zonulin, and it has reached Phase III clinical trials for celiac disease, the kind of sustained investment a pharmaceutical company doesn't make in a mechanism it considers fringe. The complication: despite showing measurable symptom benefit in its trial, larazotide did not significantly improve the actual measured intestinal-permeability outcome researchers were tracking. A humbling reminder for this whole category: symptom relief and a measured biological marker don't always move together, even inside a well-funded pharmaceutical trial, one more reason this app tries to report what was actually measured, not just what people reported feeling.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "Reading through this category, most of the strongest individual mechanisms, the named bacterial strain found in lupus, the endoscopically-confirmed AIP trial run in IBD patients, come from other autoimmune diseases, included as corroborating evidence rather than direct proof. This entry is the exception. A dietary-fiber-intervention study measured gut microbiota changes directly in Hashimoto's thyroiditis patients, not extrapolated, not borrowed, a disease-specific population. It directly supports the SCFA/fiber mechanism at the top of this category, but with data drawn from Hashimoto's itself, not a related disease standing in for it. Small in scope, and rare enough in this category to be worth flagging specifically, one of the few entries here where \"Hashimoto's\" isn't a word researchers were reasoning toward from somewhere else, but the actual population sitting in front of them.",
    citations: [
      {
  ...
  },
  {
    id: 'gut-aip-ibd-rct',
    category: 'hashimotos',
    title: "The Strongest AIP Evidence in The Research Base Comes From a Different Disease Entirely",
    teaser: "A larger, more rigorous trial than anything ever run on Hashimoto's directly, and it happened somewhere else.",
    summary: "The Autoimmune Protocol diet shows up throughout the research as an elimination-and-reintroduction strategy, if an imperfectly evidenced one. Its single strongest piece of trial evidence doesn't come from Hashimoto's research at all. A randomized controlled trial of the AIP diet in inflammatory bowel disease (Crohn's and ulcerative colitis) found improvement in both quality of life and endoscopic (directly visualized) inflammation. That's a larger, more rigorous trial than the single small Hashimoto's-specific AIP pilot study otherwise relied on, run in a disease where \"did the gut actually get better\" can be checked directly on camera rather than inferred from how someone says they feel. Corroborating weight for AIP as a strategy, not proof it works for Hashimoto's specifically, but a meaningfully stronger foundation than the thin Hashimoto's-only evidence would provide on its own.",
    citations: [
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: "A Human Trial of One of The Everyday Foods, Just Not in Hashimoto's Patients",
    teaser: 'Not a mouse study, not an observation: a randomized human trial of ordinary probiotic yogurt, in a different autoimmune disease.',
    summary: "Most of the food-level interventions covered in the Fermented Foods research rest on mechanism and observational data. This entry is a rarer thing: a randomized, controlled human trial of an actual, everyday food. Lupus patients given a probiotic yogurt containing L. Rhamnosus and B. Bifidum showed measurable improvement in both disease activity and disability measures compared to controls, clinical-trial evidence, not observational correlation, in a disease with documented biological overlap to Hashimoto's through the same gut-autoimmunity mechanisms this category covers throughout. A human, food-based intervention that worked, in a trial, exactly the kind of evidence worth surfacing, while still naming its actual limit: a different disease, not Hashimoto's itself.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: '"Leaky Gut": Biology, a Contested Diagnosis',
    teaser: 'The mechanism is measurable. The label is still debated.',
    summary: '"Leaky gut" is simultaneously one of the most mocked phrases in mainstream medicine and one of the most measurable phenomena described throughout this entire category. Both things are true at once, and conflating them does a disservice to the actual science either way. Intestinal permeability itself (zonulin levels, lactulose-mannitol testing) is a directly measurable phenomenon with documented mechanistic links to several autoimmune conditions, exactly what this whole category has been laying out entry by entry. "Leaky gut syndrome" as a standalone clinical diagnosis is a different claim, and it remains debated within mainstream gastroenterology and endocrinology, because a clear, agreed clinical definition and diagnostic threshold simply don\'t exist yet the way they do for, say, celiac disease. The underlying biology is not what is in question. Held to the same evidence-tiering standard as everything else: mechanism, measurement, contested label, a distinction worth keeping straight rather than either dismissing the whole idea or overselling it as settled fact.',
    citations: [
