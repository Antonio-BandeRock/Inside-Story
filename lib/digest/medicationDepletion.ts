...
export const MEDICATION_DEPLETION_ENTRIES: DigestEntry[] = [
  {
    ...
    summary:
      'A small set of extremely commonly prescribed medications, acid-reducing drugs, statins, diuretics, oral contraceptives, and metformin among them, carry documented, measurable effects on specific nutrient levels with sustained use, through mechanisms ranging from reduced absorption to increased excretion. None of this is a reason to stop or fear a prescribed medication on your own, every one of these drug classes exists because it treats something that needs treating, and the depletion effect is usually a tradeoff worth monitoring, not avoiding. The practical value of knowing this: several of the symptoms a depleted nutrient can cause (fatigue, muscle cramps, mood changes, numbness) can be mistaken for the original condition getting worse, or for an unrelated new problem, when the fixable cause is a nutrient level that\'s quietly drifted down over months or years of otherwise appropriate treatment.',
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      'Proton pump inhibitors (omeprazole, esomeprazole, and similar drugs) work by deliberate, substantial acid suppression, and stomach acid is what\'s needed to release vitamin B12 from the protein it\'s bound to in food, so less acid means less B12 absorbed over time. Documented data: one study found serum B12 dropped 12 to 18 percent over 12 months of use, and people using a PPI for over a year showed 11.6 times higher odds of measurable B12 deficiency than shorter-term or non-users. The evidence on magnesium is more mixed, some studies find no measurable change even after a year, while others find significantly lower magnesium levels and up to 12.8 times higher odds of deficiency at the one-year mark; the current read is an established B12 effect and a less consistent magnesium one. Neither is a reason to stop a needed PPI without a doctor\'s guidance, it\'s a documented reason long-term use is worth periodic monitoring.',
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      'Both major diuretic classes cause documented potassium loss (hypokalemia) as blood pressure medications work by increasing how much sodium, and along with it potassium, the kidneys excrete, a well-established, dose-dependent effect for both thiazide and loop diuretics alike, most severe pill-for-pill with higher doses. Magnesium is where the two classes diverge: thiazide diuretics are specifically, consistently associated with lower serum magnesium and measurable higher hypomagnesemia risk, while loop diuretics are not, one large population study even found loop-diuretic users trending toward slightly higher magnesium, a counterintuitive finding pointing to a different underlying kidney mechanism between the two drug classes rather than one shared "diuretics deplete magnesium" rule. The practical takeaway: which specific diuretic someone takes matters for which mineral is worth watching, not just that a diuretic is being taken at all.',
    citations: [
      {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Oral Contraceptives Carry a Documented B12 and B6 Effect, but Folate Is an Exception',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'The Practical Pattern Across Every Medication That Depletes a Nutrient',
    ...
    summary: 'Every medication named across these entries (PPIs, statins, diuretics, oral contraceptives, and the metformin/B12 research) treats something that needs treating, and every one of these depletion effects is a documented tradeoff of long-term use, not a reason to avoid a needed medication. The practical pattern that applies across all of them: a symptom that could plausibly be the depletion effect (persistent fatigue, muscle cramps, numbness or tingling, unusual mood changes) is worth naming directly to whoever prescribes the medication, ideally alongside a lab check for the specific nutrient in question, rather than either ignoring it or self-treating with an over-the-counter supplement that might itself interact with something else already being taken. The My Meds & Interactions lens surfaces several of these same interactions against a person\'s tracked medications; these entries are the "why" behind what that feature checks for.',
    citations: [
      {
        source: 'FDA, drug-nutrient interaction general guidance',
        url: 'https://www.fda.gov/drugs',
