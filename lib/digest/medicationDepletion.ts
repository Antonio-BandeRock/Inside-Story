...
export const MEDICATION_DEPLETION_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'The blood-level drop is well established; whether it actually explains statin-related muscle aches is a still-open scientific question, not a settled fact either way.',
    summary:
