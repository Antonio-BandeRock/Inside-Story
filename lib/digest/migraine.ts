...
export const MIGRAINE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'migraine',
    title: 'Chiropractic Care for Headache: The Placebo Group Improved Too',
    teaser:
