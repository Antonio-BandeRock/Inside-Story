...
export const MIGRAINE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'migraine',
    title: 'Food Triggers: A Complicated Picture, Not a Clean List',
  ...
  },
  {
    ...
    summary:
      "A randomized, double-blind, placebo-controlled multicenter trial tested a specific combination supplement (magnesium 600mg, riboflavin 400mg, and coenzyme Q10 150mg, plus a low-dose multivitamin) in 130 adult migraine patients experiencing three or more attacks a month, over a 3-month treatment period following a 4-week baseline. The results: migraine days per month dropped from 6.2 to 4.4 in the treatment group, versus 6.2 to 5.2 in the placebo group, and migraine pain intensity was significantly reduced in the treatment group compared to placebo. The trial tested this specific combination and dose (Migravent/Dolovent, a proprietary formula), so a generic multivitamin containing these three ingredients cannot be assumed to produce the same result. Each of the three ingredients also carries its separate, research history in migraine prevention individually, this combined-formula trial represents structured evidence for using them together specifically, at these specific doses.",
    citations: [
  ...
  },
  {
    ...
    category: 'migraine',
    title: 'Menstrual Migraine: A Common Hormonal Pattern, With a Caveat About the Evidence Behind It',
  ...
  },
  {
    ...
    category: 'migraine',
    title: "Migraine's History: Described Nearly 2,000 Years Ago, Understood Only in the Last 40",
    teaser: 'A.D. 81, 1938, 1991, an ancient description sat behind one dominant but ultimately incomplete theory for 50 years before the actual breakthrough treatment arrived.',
  ...
  },
  {
    ...
    category: 'migraine',
    title: 'Anxiety Appears in Over Half of Migraine Patients, Each Condition Doubling the Other',
  ...
  // independently verified via WebSearch.
  {
    ...
    summary: "OnabotulinumtoxinA, the same botulinum toxin known by the brand name Botox, is an FDA-approved, specifically studied preventive treatment for chronic migraine, distinct from the CGRP inhibitors covered in the migraine research. The landmark PREEMPT clinical trial program tested this specific treatment in two large, randomized, placebo-controlled trials. PREEMPT 2 found onabotulinumtoxinA statistically significantly superior to placebo for its primary outcome, reduction in headache days per 28-day period (a 9.0-day reduction versus 6.7 days for placebo), with significant improvement on every secondary measure tested too. PREEMPT 1, the companion trial, did NOT find a significant difference on its primary endpoint (headache episodes specifically, a different way of counting than headache days), an inconsistency between the two trials. The pooled analysis combining both trials' full data did confirm onabotulinumtoxinA as an effective preventive treatment overall, and research found repeated treatment cycles (administered every 12 weeks) safe and well tolerated over time. This is an FDA-approved, evidence-backed option specifically for CHRONIC migraine (15 or more headache days a month, covered in the episodic-vs-chronic research), not typically used for less frequent episodic migraine, worth discussing directly with a neurologist for anyone whose chronic migraine hasn't responded well to oral preventive medications.",
    citations: [
  ...
  },
  {
    ...
    category: 'migraine',
    title: 'The Trigeminovascular System Releases CGRP During a Migraine Attack',
  ...
  },
  {
    ...
    category: 'migraine',
    title: 'IV Magnesium in the ER Is a Separate Question From Oral Magnesium for Prevention',
  ...
  },
  {
    ...
    summary: "Weather, and barometric pressure specifically, is one of the most commonly self-reported migraine triggers, and research does find supporting evidence behind that common belief, though it is inconsistent. A recent systematic review pooling 14 studies and 2,696 participants found several individual studies reporting a significant association between pressure drops or rapid fluctuations and increased migraine FREQUENCY specifically, fewer studies found any link to attack SEVERITY, and none found a link to attack DURATION. The review's overall conclusion was that findings were inconsistent study to study, not a settled, uniform effect, research estimates weather's overall measurable influence at only around 20% across studied populations, meaning most migraine days in most people likely have little to do with weather at all. This is an example of a widely believed trigger with documented but inconsistent supporting evidence and meaningful individual variation, some people are weather-sensitive, most aren't strongly so, and the personal-pattern-tracking approach (rather than assuming a commonly cited trigger applies universally) is the practical way to find out which category a given person actually falls into.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Hormonal transition reshapes migraine, in both directions, and data shows the picture is more mixed than a simple 'menopause makes it better' story. In a study of over 3,600 women, those in perimenopause and menopause were 50 to 60% more likely to report frequent headaches (10 or more days a month), and a separate, 2025 population study of nearly 5,000 women found 46% still had migraine attacks after menopause, with one in five still having attacks past age 60. Once past menopause, when estrogen settles into a new, stable, low baseline, many people do improve, clinic-based data finding 24.4% improved with menopause while 35.7% actually worsened, a roughly even split rather than a guaranteed relief. The separate and more urgent point: a headache that starts brand-new after age 50, one that was never a pattern before, always warrants medical evaluation to rule out a vascular, structural, or other systemic cause, rather than being assumed to be ordinary menopause-related migraine. This is especially true for aura symptoms (visual disturbances, numbness, or speech changes) appearing for the very first time in an older woman, since these can closely mimic a transient ischemic attack or seizure. A lifelong migraine pattern shifting around menopause is expected and usually not a red flag on its own, but a new headache pattern starting after 50 is a separate situation that deserves its workup.",
    citations: [
  ...
  },
  {
    ...
    category: 'migraine',
    title: 'Belgium Ranks First of 204 Countries for Migraine, Which Also Carries a Wide Gender Gap',
    ...
    summary:
      "The treatment-access research explains part of why migraine's burden falls unevenly by region; current prevalence data adds a second, surprising layer. Among 204 countries analyzed in the most recent global burden data, Belgium recorded the highest age-standardized migraine prevalence in the world, alongside Western Europe and tropical Latin America both ranking among the highest-prevalence regions overall, a notable finding given migraine's burden research shows the highest DISABILITY specifically concentrated in sub-Saharan Africa instead, direct evidence that where migraine occurs MOST and where it causes the most lasting harm are two different maps. Layered on top of regional variation, migraine carries one of the widest gender gaps of any disorder studied worldwide, the third-largest female-to-male prevalence ratio among all conditions in the same global analysis, trailing only long-COVID neurological complications and multiple sclerosis. Data also finds male migraine cases rising 4 to 5 times faster than female cases in recent years, even though overall prevalence remains substantially higher in women. Migraine's global picture is two-dimensional, prevalence concentrates differently than disability, and a historically wide gender gap appears to be narrowing from the male side specifically, not from women's migraine burden decreasing.",
    citations: [
  ...
  },
  {
    ...
    category: 'migraine',
    title: 'Migraine Reaches Roughly 20% by the Teenage Years, With Thin Preventive Trial Evidence',
    ...
    summary:
      "The research is overwhelmingly built on adult data, but epidemiological research finds migraine is common in childhood too, with prevalence climbing from roughly 3 percent in younger children to around 20 percent in adolescents, and a separate meta-analysis pooling primary-headache studies finding an overall pediatric migraine prevalence near 11 percent. A subset (0.6 to 1.8 percent of children and adolescents) develops chronic migraine, covered elsewhere in this category as 15 or more headache days a month. The complication: controlled trials in pediatric migraine prevention are limited, and research finds the placebo response in children and adolescents is consistently larger than in adults, meaning a reduction in headache frequency often shows up even without active medication, which makes distinguishing an effective preventive drug from a placebo effect harder in this age group specifically. Controlled trial data does exist for propranolol specifically, covered elsewhere in this Digest as a migraine-prevention medication, with children on it more likely to reach at least a 50 percent reduction in headache frequency than those on placebo, modest evidence in a population where solid trial data is harder to come by.",
    citations: [
  ...
  },
  {
    ...
    category: 'migraine',
    title: "Migraine Has a Distinct Gut-Microbiome Signature",
  ...
  },
  {
    ...
    category: 'migraine',
    title: 'Migraine With Aura Carries Heart Attack and Cardiovascular Risk Beyond Stroke',
    teaser: "The aura-stroke research names a specific risk, a 115,000-woman, 20-year study found migraine with aura also carries significantly elevated risk of heart attack, angina, and cardiovascular death, a broader risk than stroke alone.",
    summary: "The migraine-with-aura research already names a specific stroke risk, and a large, long-term study finds the underlying cardiovascular risk actually extends well beyond stroke alone. A 20-year prospective cohort study of over 115,000 women (the Nurses' Health Study II) found active migraine associated with a significantly elevated risk of major cardiovascular disease overall, including a quantified 39 percent higher risk of heart attack specifically (hazard ratio 1.39), plus significantly elevated stroke risk and angina/coronary-revascularization procedures. The important distinction: this elevated risk was found specifically in migraine WITH aura, active migraine WITHOUT aura was not associated with increased risk of any cardiovascular event in the same study, direct evidence that the aura component itself, not migraine broadly, is what carries this particular risk. Research names plausible, direct shared mechanisms behind this connection: endothelial dysfunction (blood-vessel-lining impairment), neurovascular dysregulation, platelet hyperactivity, and systemic inflammation, several of which are covered elsewhere in the broader cardiovascular research as general disease-driving processes. This broader cardiovascular signal, not just the stroke risk, is exactly why migraine with aura is now considered by research as an overall cardiovascular risk factor, worth a direct conversation about cardiovascular risk-factor management (blood pressure, cholesterol, smoking) for anyone with this specific migraine subtype, not treated as a purely neurological concern.",
    citations: [
      { source: 'Migraine, vascular risk, and cardiovascular events in women: prospective cohort study, PMC2505092', url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2505092/' },
  ...
  },
  {
    ...
    teaser: "The anxiety/depression research names bidirectional mental-health links, a large UK workplace survey finds 6 in 10 people with migraine actively hide their condition from employers, and a published finding ranks migraine's stigma above dementia, Parkinson's, and stroke.",
    summary:
      "The anxiety and depression research already names bidirectional mental-health effects of living with migraine, and a distinct, social dimension, stigma, deserves direct coverage. A large 2025 UK workplace survey by the Migraine Trust (2,141 people with migraine, plus a separate 2,000-person comparison group without migraine) found roughly 6 in 10 migraine sufferers hide their condition from employers specifically because of documented workplace stigma. Published research directly names something striking: migraine is considered MORE stigmatizing than conditions like dementia, Parkinson's disease, or stroke, largely because it's often perceived, wrongly, as 'just a headache' rather than the disabling neurological condition the chronification and disability research establishes it to be. Survey data finds this stigma triggering direct, measured emotional consequences, feelings of anger, loneliness, and sadness, particularly among people with severe, frequent attacks in a workplace that doesn't recognize the condition's severity. This is large-scale organizational survey data rather than a formal peer-reviewed clinical trial, but the underlying pattern (stigma, disclosure avoidance, emotional cost) is consistently reported across multiple independent surveys, not a one-off finding. This social burden compounds the disability and mental-health research directly: it's a documented barrier, not just an individual, private struggle, since accurate awareness of migraine's severity is itself part of what research finds reduces this stigma's impact.",
    citations: [
  ...
  },
  {
    ...
    category: 'migraine',
    title: 'AIP and Elimination Diets for Migraine: A Documented Mechanism, Not Yet a Direct Trial',
  ...
  // Complementary & Manual Therapies, added 2026-09-04 as part of the
  // hands-on therapies batch. Migraine is one of the few conditions this
  // app tracks where both acupuncture and spinal manipulation have been
  // tested against a placebo control, so both get an entry and both are
  // reported at whatever the trials actually found.
  {
    id: 'complementary-migraine-acupuncture',
    category: 'migraine',
    title: 'Acupuncture for Migraine Prevention: A Small Effect, Comparable to the Drugs',
    teaser:
      'A Cochrane review found headache frequency at least halved in 50% of people receiving acupuncture against 41% receiving sham.',
    summary:
      "Migraine prevention is where acupuncture has been tested most carefully against a sham control, which matters because needling produces a strong placebo response and a trial comparing it against no treatment cannot separate the two. A Cochrane review of acupuncture for preventing episodic migraine pooled fourteen trials covering 1,825 participants for the comparison that counts. After treatment, headache frequency had at least halved in 50% of people receiving acupuncture against 41% receiving sham acupuncture, and at follow-up in 53% against 42%. Put in the terms clinicians use, roughly eleven people need to be treated for one additional person to reach that halving who would not have reached it with sham. Evidence quality was rated moderate. Read carefully, this says three things at once. Acupuncture does more than sham, which earlier versions of this same review could not conclude. The margin is small. And a placebo needling procedure got 41% of people to a halved headache frequency, which is a large effect in its own right and says something about how much of migraine burden responds to attention and expectation. Compared against the drugs used for the same purpose, acupuncture came out at least as good, with fewer people dropping out over side effects. That makes it a reasonable option to raise with a neurologist, particularly for someone who has not tolerated preventive medication.",
    citations: [
      {
        source:
    ...
    overallTier: 'moderate',
    relatedIds: [
      'complementary-migraine-spinal-manipulation',
      'handson-acupuncture-chronic-pain',
      'handson-acupuncture-where-it-does-nothing',
      'migraine-trigeminovascular-cgrp-mechanism',
    ],
  },
  {
    id: 'complementary-migraine-spinal-manipulation',
    category: 'migraine',
    title: 'A Sham-Controlled Headache Trial Saw the Placebo Group Improve Just as Much',
    teaser:
      'A three-armed trial gave one group actual manipulation and one group a sham procedure. Both improved. That result is why the comparison group exists.',
    summary:
      "Headache is the one place outside back pain where spinal manipulation has been tested against a sham procedure, and the results are instructive about why such a comparison is necessary. A three-armed single-blinded randomized controlled trial compared chiropractic spinal manipulative therapy against a sham manipulation and against usual pharmacological care in migraine, published in the European Journal of Neurology in 2017. Headache frequency improved in the manipulation group. It also improved in the sham group, at all measured time points, while the usual-care control group did not change. When the treatment and its placebo move together and the untreated arm does not, the improvement is being produced by something other than the specific technique: the handling, the ritual, the regular appointments, the expectation. A companion trial in cervicogenic headache, meaning headache generated by structures in the neck rather than by migraine biology, found the same pattern for frequency, with the headache index favoring the manipulation group. Adverse events across these trials were few, mild, and short-lived. The reasonable reading is that people with headache often feel better under a course of chiropractic care, that the improvement is not clearly coming from the adjustment itself, and that this sits well below acupuncture in the evidence available for migraine specifically. Manipulation of the neck also carries a small risk profile, covered in the Basic Health safety entry.",
    citations: [
      {
        source:
          'Chaibi A, Benth JS, Tuchin PJ, Russell MB 2017: Chiropractic spinal manipulative therapy for migraine: a three-armed, single-blinded, placebo, randomized controlled trial (Eur J Neurol 24(1):143-153)',
        url: 'https://pubmed.ncbi.nlm.nih.gov/27696633/',
      },
      {
        source:
          'Fernandez M, Moore C, Tan J, et al. 2020: Spinal manipulation for the management of cervicogenic headache: A systematic review and meta-analysis (Eur J Pain 24(9):1687-1702)',
        url: 'https://pubmed.ncbi.nlm.nih.gov/32621321/',
      },
    ],
    overallTier: 'moderate',
    relatedIds: [
