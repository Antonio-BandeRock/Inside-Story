...
export const MIGRAINE_ENTRIES: DigestEntry[] = [
  ...
  // reported at whatever the trials actually found.
  {
    ...
    category: 'migraine',
    title: 'Acupuncture for Migraine Prevention: Small, Real, and Comparable to the Drugs',
    teaser:
