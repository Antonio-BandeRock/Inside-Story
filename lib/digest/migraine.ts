...
export const MIGRAINE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'Three separate supplements, each with their own migraine-prevention history, tested together in one randomized trial with a specific dosing formula.',
    summary:
      "A randomized, double-blind, placebo-controlled multicenter trial tested a specific combination supplement (magnesium 600mg, riboflavin 400mg, and coenzyme Q10 150mg, plus a low-dose multivitamin) in 130 adult migraine patients experiencing three or more attacks a month, over a 3-month treatment period following a 4-week baseline. The results: migraine days per month dropped from 6.2 to 4.4 in the treatment group, versus 6.2 to 5.2 in the placebo group, and migraine pain intensity was significantly reduced in the treatment group compared to placebo. This specific combination and dosing (Migravent/Dolovent, a proprietary formula) is worth knowing directly rather than assuming any generic multivitamin containing these three ingredients would produce the same result, since the actual trial tested this specific combination and dose, not a loosely similar one. Each of the three ingredients also carries its own separate, research history in migraine prevention individually, this combined-formula trial represents structured evidence for using them together specifically, at these specific doses.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Caffeine occupies a two-sided, role in migraine that's worth understanding directly rather than treating as simply good or bad. On one side, standard medical guidance specifically advises people with migraine or other chronic headaches to discuss limiting caffeine intake with their own healthcare provider, since it's a documented trigger for some people. On the other, well-documented caffeine withdrawal symptoms specifically include headache, alongside drowsiness, irritability, and trouble concentrating, typically resolving within a couple of days once intake stabilizes again, meaning an inconsistent caffeine habit (a lot some days, none on others) can cause headaches through withdrawal even in someone who isn't otherwise caffeine-sensitive at all. Caffeine is also a common ingredient in combination over-the-counter headache treatments, adding a practical complication: someone using a caffeine-containing headache medication frequently could be managing both a trigger and a withdrawal risk from the same substance, in the same treatment, at the same time. Worth knowing directly: consistent caffeine intake, whatever the actual daily amount, is often more important for migraine management than the specific total consumed.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A neurological disease with its own dedicated medication class, supplement evidence with a specific formula, and an honest correction to oversimplified trigger lists.',
    summary:
      "Line up everything in this category and migraine reads as a neurological disease deserving more precision than the \"bad headache\" framing it's often given. Food triggers are for many people but more individualized and less clean-cut than popular trigger lists suggest, tyramine's own reputation as the culprit behind cheese and red wine doesn't fully hold up under closer, more refined measurement. The magnesium/riboflavin/CoQ10 combination and CGRP inhibitors both represent structured, trial-backed approaches at opposite ends of the intervention spectrum, one an accessible, supplement formula, the other a major, migraine-specific medication class built around the same CGRP mechanism medication-overuse headache also involves. Menstrual migraine's own leading explanation (estrogen withdrawal) is real and widely accepted, honestly reported alongside the gaps still remaining in its own evidence base. And caffeine's double role, and the specific red flags that separate an ordinary migraine from something requiring urgency, both matter for the same reason everything else in this category does: managing migraine well depends on specific knowledge, not general assumptions.",
    citations: [
      { source: 'Cutaneous Allodynia, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK537129/' },
    ],
    overallTier: 'strong',
  ...
  // independently verified via WebSearch.
  {
    ...
    summary: "Migraine's own formal classification (ICHD-3) draws a specific line: chronic migraine means 15 or more headache days a month for over 3 months, with at least 8 of those days showing migraine-specific features; anything below that threshold is classified as episodic. This precise-sounding line has an active controversy behind it worth knowing directly: research comparing disability levels found people with 8-14 headache days a month, technically still \"episodic\" by the formal definition, showing disability levels statistically indistinguishable from those meeting the full chronic threshold. This has led researchers to propose revised criteria recognizing \"high-frequency episodic migraine\" as its own meaningfully burdened category, since the current 15-day line may not actually reflect who needs more aggressive treatment. Worth knowing directly if headache frequency sits in that disputed 8-14-day range: the formal \"episodic\" label may understate lived burden the CGRP-inhibitor and medication-overuse research already covers.",
    citations: [
  ...
  },
  {
    ...
    summary: "Migraine's own reach extends beyond head pain into a documented, independent cardiovascular risk, most pronounced specifically for migraine WITH aura (the visual or sensory disturbance some people experience before an attack). Research in women found active migraine with aura carrying a hazard ratio of 1.93 for major cardiovascular disease, 1.80 for ischemic stroke, and 1.94 for heart attack compared to women without migraine. The striking part: this elevated stroke risk persists even after adjusting for other vascular risk factors, meaning migraine with aura itself, not just the other risk factors that happen to co-occur with it, appears to be an independent marker of systemic vascular vulnerability. Proposed mechanisms include endothelial dysfunction, platelet aggregation, and systemic inflammation, worth knowing directly since migraine affects an enormous global population (roughly 1.16 billion people as of 2021), meaning even a modest per-person risk increase represents a large public-health consideration, and a direct reason cardiovascular risk factors (already covered in the dedicated CVD research) deserve extra attention specifically in anyone who experiences migraine with aura.",
    citations: [
  ...
  // verified via WebSearch.
  {
    ...
    summary: "Vestibular migraine is an underrecognized migraine subtype worth knowing about directly, since its own defining symptom, dizziness or a spinning sensation, doesn't require head pain to be present at the same time, meaning it can easily go unrecognized as migraine at all. Prevalence estimates vary by population studied: roughly 1% of the general population and 10% of people with migraine overall, but research finds it far more concentrated in specific groups, up to 60% of people with chronic migraine and a striking 73% of those with migraine with aura (already covered in the stroke-risk research) meet diagnostic criteria for it. The specific underrecognition problem: during ordinary headache-clinic interviews, only about 20% of patients spontaneously mention vestibular symptoms on their own, but that number roughly doubles when a specific questionnaire is used, and climbs as high as 75% when a clinician asks about it directly. Research in women aged 20-50 presenting specifically with dizziness found vestibular migraine in 42.86% of cases, a common, disabling condition. Worth knowing directly: unexplained dizziness or balance problems, even without a classic headache alongside them, are worth raising directly as a possible migraine variant, not assumed to be an unrelated inner-ear or balance problem by default.",
    citations: [
  ...
  // independently verified via WebSearch.
  {
    ...
    summary: "OnabotulinumtoxinA, the same botulinum toxin known by the brand name Botox, is a FDA-approved, specifically studied preventive treatment for chronic migraine, worth knowing about directly alongside the CGRP inhibitors already covered in the migraine research. The landmark PREEMPT clinical trial program tested this specific treatment in two large, randomized, placebo-controlled trials. PREEMPT 2 found onabotulinumtoxinA statistically significantly superior to placebo for its primary outcome, reduction in headache days per 28-day period (a 9.0-day reduction versus 6.7 days for placebo), with significant improvement on every secondary measure tested too. Worth knowing honestly: PREEMPT 1, the companion trial, did NOT find a significant difference on its own primary endpoint (headache episodes specifically, a different way of counting than headache days), an honest inconsistency between the two trials worth naming directly rather than only citing the positive result. The pooled analysis combining both trials' full data did confirm onabotulinumtoxinA as an effective preventive treatment overall, and research found repeated treatment cycles (administered every 12 weeks) safe and well tolerated over time. Worth knowing directly: this is a FDA-approved, evidence-backed option specifically for CHRONIC migraine (15 or more headache days a month, already covered in the episodic-vs-chronic research), not typically used for less frequent episodic migraine, worth discussing directly with a neurologist for anyone whose chronic migraine hasn't responded well to oral preventive medications.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A trial of ubrogepant found 21.8% of patients pain-free at 2 hours versus 14.3% on placebo, a different medication working through the same CGRP pathway this category\'s own preventive treatments target.',
    summary:
      "This category's own research already covers CGRP inhibitors as monthly PREVENTIVE treatment. Gepants are a related but distinct medication class, oral pills taken to treat an attack that's already started, working through the same CGRP signaling pathway rather than a separate mechanism. Ubrogepant and rimegepant were both FDA-approved starting in 2019 and 2020, and a large randomized trial of ubrogepant (ACHIEVE II, 1,465 patients) found 21.8% of patients on the higher tested dose were completely pain-free at 2 hours, compared with 14.3% on placebo, a meaningful difference for a single-attack, as-needed medication. Rimegepant's own trial data showed a broadly similar effect, with benefit that held up through 24 hours in some measures. A important, practical distinction from older acute migraine medications (triptans, and even overused simple painkillers): research and current guidance treat gepants as carrying a much lower risk of causing medication-overuse headache with frequent use, a direct answer to a problem this category's own medication-overuse-headache research already covers in depth. Worth knowing directly: gepants are a newer option specifically worth raising for anyone whose current acute treatment either doesn't work well enough or triggers rebound headaches with regular use.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "This category's own already-covered treatment-access research explains part of why migraine's burden falls unevenly by region; current prevalence data adds a second, surprising layer. Among 204 countries analyzed in the most recent global burden data, Belgium recorded the highest age-standardized migraine prevalence in the world, alongside Western Europe and tropical Latin America both ranking among the highest-prevalence regions overall, a notable finding given migraine's own already-covered burden research shows the highest DISABILITY specifically concentrated in sub-Saharan Africa instead, direct evidence that where migraine occurs MOST and where it causes the most lasting harm are two different maps. Layered on top of regional variation, migraine carries one of the widest gender gaps of any disorder studied worldwide, the third-largest female-to-male prevalence ratio among all conditions in the same global analysis, trailing only long-COVID neurological complications and multiple sclerosis. Data also finds male migraine cases rising 4 to 5 times faster than female cases in recent years, even though overall prevalence remains substantially higher in women. Worth knowing directly: migraine's own global picture is two-dimensional, prevalence concentrates differently than disability, and a historically wide gender gap appears to be narrowing from the male side specifically, not from women's own migraine burden decreasing.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered PREEMPT trial entry names Botox's formal clinical-trial evidence, real-world data following actual patients (not trial participants) for up to 11 years finds the benefit sustained, not a short-lived trial effect.",
    summary:
      "This category's own already-covered PREEMPT trial research establishes Botox's formal, clinical-trial-level evidence, and real-world data (actual patients treated in ordinary practice, not a controlled trial population) adds a meaningfully longer-term confirmation. A longitudinal real-world study followed patients for a median of 15 months, with some followed up to a 11 years, finding sustained benefit that didn't fade with continued use, direct evidence against the common concern that a preventive treatment's own effect might wear off over years of repeated injections. A separate retrospective observational study of 579 chronic migraine patients, treated with injections every 12 weeks per the same PREEMPT protocol dosing (155-195 units), tracked outcomes out to 60 months and found continued improvement in monthly headache days, frequency, and MIDAS disability scores. A separate Phase IV trial (COMPEL) extended the original PREEMPT evidence out to 2 years specifically, formal confirmation bridging the gap between the shorter original trials and this longer-term real-world data. Worth stating directly: this sustained, multi-year evidence (both formal trial extensions and real-world practice data) is exactly the kind of long-term confirmation worth knowing about before starting a treatment involving repeated injections indefinitely, direct reassurance the benefit doesn't simply run out after the first year or two.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's own already-covered anxiety/depression research names bidirectional mental-health links, a large UK workplace survey finds 6 in 10 people with migraine actively hide their condition from employers, and a published finding ranks migraine's own stigma above dementia, Parkinson's, and stroke.",
    summary:
      "This category's own already-covered anxiety and depression research already names bidirectional mental-health effects of living with migraine, and a distinct, social dimension, stigma, deserves its own direct coverage. A large 2025 UK workplace survey by the Migraine Trust (2,141 people with migraine, plus a separate 2,000-person comparison group without migraine) found roughly 6 in 10 migraine sufferers hide their condition from employers specifically because of documented workplace stigma. Published research directly names something striking: migraine is considered MORE stigmatizing than conditions like dementia, Parkinson's disease, or stroke, largely because it's often perceived, wrongly, as 'just a headache' rather than the disabling neurological condition this category's own already-covered chronification and disability research establishes it to be. Survey data finds this stigma triggering direct, measured emotional consequences, feelings of anger, loneliness, and sadness, particularly among people with severe, frequent attacks navigating a workplace that doesn't recognize the condition's own severity. Worth stating directly, honestly, since this is large-scale organizational survey data rather than a formal peer-reviewed clinical trial: the underlying pattern (stigma, disclosure avoidance, emotional cost) is consistently reported across multiple independent surveys, not a one-off finding. Worth stating directly: this social burden compounds this category's own already-covered disability and mental-health research directly, worth naming plainly as a documented barrier, not just an individual, private struggle, since accurate awareness of migraine's own severity is itself part of what research finds reduces this stigma's own impact.",
    citations: [
