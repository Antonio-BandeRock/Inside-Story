...
export const ESSENTIAL_NUTRIENTS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Muscle Cramps: A Correction to Magnesium's Most Popular Use",
    ...
    summary: "Muscle cramps are very likely the single most common reason people take a magnesium supplement in the first place, popular, and widely repeated advice. The evidence behind it, though, doesn't hold up under close review. A 2020 Cochrane review, the same rigorous, high-bar evidence standard already applied elsewhere in the research (and the update to an earlier 2012 review reaching a similar conclusion), found it unlikely that magnesium supplementation provides benefit for skeletal muscle cramps. A correction to one of magnesium's most common real-world uses, not a reason to think magnesium is unimportant generally, its well-documented roles in blood pressure, glucose metabolism, and hundreds of other enzyme reactions are covered directly elsewhere in this category. Muscle cramps specifically just isn't where the strongest evidence for magnesium actually sits.",
    citations: [
  ...
  },
  {
    ...
    summary: "The VITAL trial, a large (25,871 participants), rigorously designed randomized controlled trial, tested a standard 2,000 IU daily dose of vitamin D3 specifically to answer whether supplementation reduces cancer or cardiovascular disease risk in people without a prior diagnosis of either. The result: it didn't, at least not to a statistically or clinically meaningful degree for either primary outcome, a well-powered null finding rather than a small or ambiguous trial easy to dismiss. That is a direct, evidence-based reason behind this category's dedicated entry on the 2024 Endocrine Society guideline's conservative stance on supplementing healthy adults broadly. Vitamin D's well-established roles are in bone health and the specific, named groups covered elsewhere in this category, not a broad, general-purpose disease-prevention supplement for cancer or cardiovascular disease in an otherwise healthy adult.",
    citations: [
  ...
  // belongs in that disease's own category.
  {
    ...
    summary:
      "Iron's best-known job is building hemoglobin, the protein inside red blood cells that actually carries oxygen from the lungs to every other tissue, and myoglobin, the same job inside muscle itself. Beyond oxygen transport, iron is a required cofactor for enzymes involved in DNA synthesis, energy production in the mitochondria, and immune cell function, which is why both deficiency and overload show up as such a wide, seemingly unrelated list of symptoms. The single fact that shapes most of the rest of this category: the human body has no active mechanism to excrete excess iron. Iron balance is controlled almost entirely by regulating absorption in the small intestine, not by getting rid of what's already been taken in. That one-way design is efficient for a nutrient the body cannot do without, and it's also exactly why chronic overload (see the hemochromatosis entry below) is a distinct medical problem rather than something the body simply corrects on its over time.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Zinc Deficiency's Tell: Taste and Smell Loss, Before Almost Anything Else",
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Zinc Toxicity: An Acute GI Illness at High Single Doses, and a Chronic Risk From Long-Term Over-Supplementation',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'B12 Toxicity: An Exception to Almost Every Other Nutrient in This Category',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Methylcobalamin vs. Cyanocobalamin: A Still-Emerging Retention Difference',
  ...
  },
  {
    ...
    summary: "Line up everything in this category and potassium reads as a nutrient where both extremes are dangerous, with the cardiac conduction system as the shared point of failure on either end: hypokalemia and hyperkalemia both produce their specific, named, staged ECG changes, and both can independently trigger fatal arrhythmias. Hypokalemia is more common than its better-known opposite, hyperkalemia is a medical emergency where the SPEED of the rise matters as much as the number itself, and the CKD/PCOS/medication research covers several of the specific reasons the two most common blood pressure and hormone medications, ACE inhibitors/ARBs and spironolactone, carry a documented hyperkalemia risk worth monitoring. The better-evidenced practical answer sits underneath all of it: potassium and sodium work best addressed together through whole foods, not sodium restriction alone and not a popular-culture banana-only view of potassium, and food-based potassium carries essentially none of supplementation's hyperkalemia risk.",
    citations: [
      { source: 'Hyperkalemia, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK470284/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary: "Line up everything in this category and iodine reads as an exception to how most nutrients work. It's required, step one, for the thyroid to make hormone at all, global deficiency remains a leading, preventable cause of fetal brain damage, and a historic public-health fix (iodized salt) already solved this at scale in the US a century ago. And yet, unlike almost every other nutrient covered in this category, more isn't simply better past a specific point: excess carries its documented risks, from acute GI-then-neurological toxicity to a paradox where too much iodine can push a vulnerable thyroid toward either hypothyroidism or hyperthyroidism depending on the person. The condition-specific research already carries the sharpest, most practical version of this exact tension: Hashimoto's iodine entry names it directly as a two-edged nutrient, Graves' disease has its full iodine entry, pregnancy raises the stakes on both ends at once, and the kelp-specific caution names exactly where that risk shows up in an everyday food choice. This entry is the universal biochemistry underneath all of those, not a replacement for any of them.",
    citations: [
      { source: 'Diffuse Toxic Goiter, StatPearls, National Library of Medicine', url: 'https://pubmed.ncbi.nlm.nih.gov/32491782/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary:
      "Vitamin C carries a high tolerance compared to most nutrients covered in this category, but it isn't a complete non-issue the way B12's toxicity entry describes. At elevated doses, GI symptoms (diarrhea, nausea, abdominal cramps) are the most common consequence, generally self-limiting once the dose is reduced. The more specific, important risk: excessive vitamin C intake has been linked to kidney stone formation, specifically in men with a prior history of kidney stones or existing kidney conditions, through a documented mechanism, increased urinary oxalate excretion, since the body partly metabolizes excess vitamin C into oxalate. This is a targeted risk for a specific, identifiable group, not a reason for general population-wide caution. The clinical literature doesn't specify one universal numeric toxicity threshold, framing this instead as a dose-and-person-dependent risk rather than a fixed cutoff, worth a conversation with a doctor specifically for anyone with a personal or family kidney-stone history before taking high-dose vitamin C supplements.",
    citations: [
      { source: 'Vitamin C Deficiency, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK493187/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary: "Vitamin C content pulled directly from the 22,022-food reference database. Acerola cherries lead by an enormous margin at roughly 1,690mg per 100g, dwarfing every citrus fruit's popular reputation as the top vitamin C source. Among more everyday foods, red bell pepper carries a meaningful 171mg per 100g, actually higher than an orange's 145mg per 100g, a worth-knowing correction to citrus fruit's outsized reputation. Broccoli carries roughly 90-130mg per 100g, and strawberries carry 76-98mg per 100g, both substantial sources well above the standard adult RDA of 75-90mg daily in a single serving.",
    citations: [],
    overallTier: 'strong',
    chart: {
  ...
  // revisiting once Vitamin K gets its own deep-dive.
  {
    ...
    category: 'basicHealth',
    title: "Vitamin E: the Body's Lipid-Membrane Bodyguard",
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Vitamin E's Toxicity Story: a Documented Bleeding Risk, Through Three Separate Mechanisms",
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "ALA-to-DHA Conversion Is Inefficient: Under 5% in the Whole Body",
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Omega-3 at High Doses: a Mild Version of the Same Bleeding-Risk Story as Vitamin E and K',
  ...
  },
  {
    ...
    summary: "Chromium sits in a different place from most of this series' other entries: not a nutrient with a severe, well-characterized deficiency disease (magnesium, iron, zinc), and not one with a clean null result either (the SELECT trial's correction on selenium and prostate cancer). Instead, chromium's evidence shows a modest, statistically effect on some insulin-resistance markers without translating into the longer-term marker (HbA1c) that matters most, and without a clear, settled answer on who actually benefits. It's a minor, second-tier lever, alongside myo-inositol and Nigella sativa in the PCOS and Hashimoto's research, neither dismissed nor oversold.",
    citations: [
      { source: 'Current concepts about chromium supplementation in type 2 diabetes and insulin resistance, PMID 20425574', url: 'https://pubmed.ncbi.nlm.nih.gov/20425574/' },
    ],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Fiber\'s Quantified Benefits: Lower LDL, Better Blood Sugar, and Reduced Risk Across Several Major Diseases',
