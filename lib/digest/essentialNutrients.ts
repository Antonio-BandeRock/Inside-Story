...
export const ESSENTIAL_NUTRIENTS_ENTRIES: DigestEntry[] = [
  {
    ...
    title: 'Magnesium Is a Foundational Mineral Behind Over 600 Enzyme Reactions',
    ...
    summary:
      "Magnesium is a required cofactor for a specific, and large number of enzymatic reactions throughout the body, over 600 by direct count, spanning energy production, nerve signal regulation, muscle contraction and relaxation, DNA and RNA synthesis, and blood glucose and blood pressure regulation. The single most literal reason for its reach: ATP, the molecule every cell in the body spends as its usable energy currency, exists inside cells almost entirely as a magnesium-bound complex (Mg-ATP), not as free ATP, meaning virtually every ATP-dependent enzyme in the body is, in a biochemical sense, also a magnesium-dependent one. What follows covers what's specific and well-studied about magnesium: staged deficiency and toxicity symptoms with actual measured thresholds, a comparison of supplemental forms by their tested absorption rates, a quantified drug interaction with levothyroxine identified for the first time in a 2025 trial, and self-advocacy around a well-documented limitation in how magnesium status gets tested.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Roughly a Third of People Worldwide Don\'t Get Enough Magnesium',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Toxicity Is Rare in Healthy Kidneys, and Has Staged, Measured Thresholds",
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'The Body Absorbs Magnesium Through Two Named Channels, With a Dose-Dependent Limit',
    ...
    summary:
      "Magnesium absorption happens mainly in the small intestine, through two specifically named ion channels, TRPM6 and TRPM7, that actively transport magnesium across the intestinal lining, alongside a smaller, simpler passive route between cells at higher intake levels. A useful practical fact follows directly from this: absorption efficiency is dose-dependent, meaning the percentage of a dose absorbed drops as the total amount taken at once goes up, part of the reason splitting a larger daily magnesium dose into two or three smaller ones across the day, rather than taking it all at once, improves how much gets absorbed rather than passing through unused. The kidneys handle the other half of the balance, real-time regulating how much magnesium the body keeps versus excretes, with bone acting as the body's large, slow-release storage reserve.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Magnesium Glycinate Absorbed Roughly Twice as Well as Magnesium Oxide in a Head-to-Head Test',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Magnesium Deficiency Can Show Up as a Potassium or Calcium Problem',
  ...
  },
  {
    ...
    summary:
      "Calcium and iron have well-documented histories as levothyroxine-absorption interferers, but until a randomized crossover trial published in November 2025, magnesium's effect on levothyroxine absorption had never actually been directly studied. The quantified result: magnesium aspartate reduced levothyroxine's absorption (measured as total drug exposure, AUC) by a statistically significant 12%, while magnesium citrate produced a smaller, 7% reduction that didn't reach statistical significance in this particular trial. Magnesium aspartate also measurably lowered peak drug concentration and delayed how quickly that peak was reached. The trial's authors stated the effect is smaller than the already-documented effect of calcium or iron, and gave a direct clinical recommendation: hypothyroid patients should still take levothyroxine separated from magnesium-containing products, especially if a narrow TSH target matters, and if the two are taken together anyway, magnesium citrate looks like the better-tolerated choice of the two forms tested.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Acid Reducers and Certain Antibiotics Are Two More Magnesium Drug Interactions',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Magnesium for Muscle Cramps, Its Most Popular Use, Mostly Doesn\'t Hold Up',
    ...
    summary: "Muscle cramps are very likely the single most common reason people take a magnesium supplement in the first place, on popular, widely repeated advice. The evidence behind it, though, doesn't hold up under close review. A 2020 Cochrane review (the update to an earlier 2012 review reaching a similar conclusion) found it unlikely that magnesium supplementation provides benefit for skeletal muscle cramps. That is a correction to one of magnesium's most common uses. Its well-documented roles in blood pressure, glucose metabolism, and hundreds of other enzyme reactions are covered in the other magnesium entries. Muscle cramps specifically just isn't where the strongest evidence for magnesium sits.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Magnesium Food Sources, Pulled Directly From the Database',
    ...
    chart: {
      ...
      sourceNote: "This app's reference database (USDA-sourced values)",
    },
  },
  {
    id: 'magnesium-tying-together',
    category: 'basicHealth',
    title: 'Magnesium, Pulled Together',
    teaser: "Over 600 enzyme reactions, a global deficiency gap, a new 2025 drug-interaction finding, and one popular use that doesn't hold up.",
    summary: "Line up everything about magnesium and it reads as a foundational mineral with strong evidence in some areas and weaker evidence in others, not uniform across the board. The well-established side: over 600 enzyme reactions, a global deficiency gap affecting roughly a third of people worldwide, a measured, if modest, blood pressure and glucose-metabolism benefit, and a brand-new 2025 finding that it measurably (if modestly) reduces levothyroxine absorption too, a reason to separate a levothyroxine dose from it. The correction: muscle cramps, probably magnesium's single most common use, doesn't hold up under the best available evidence. And the practical side: tested differences between supplemental forms (glycinate's doubled absorption over oxide, citrate's usefulness for concurrent constipation), food sources pulled directly from the data, and a limitation in how magnesium status gets tested, covered directly in the self-advocacy research. \"Take magnesium\" means something different depending on which specific finding applies.",
    citations: [
      { source: "Magnesium, StatPearls, National Library of Medicine", url: 'https://www.ncbi.nlm.nih.gov/books/NBK519036/' },
    ],
    overallTier: 'strong',
  ...
  // disease-specific entries already assume: what vitamin D is,
  ...
  // never seen, which turns out to say something genuinely more
  // conservative than the "everyone should take vitamin D" reflex most
  // popular advice repeats.
  {
    id: 'vitamind-overview',
    category: 'basicHealth',
    title: 'Vitamin D Is Technically a Hormone, Not Just a Vitamin',
    ...
    summary: "Vitamin D is an outlier among vitamins: it's a functional hormone precursor the skin can manufacture from sunlight, using a cholesterol-derived compound as the starting material, then activating in two further specific steps, first in the liver, then in the kidneys, before it becomes the active hormone (calcitriol) that does the work. That work reaches further than most people expect: vitamin D helps the body absorb calcium for bone health, supports muscle function, allows nerve signals to pass between the brain and the rest of the body, and helps the immune system respond to infection. The vitamin D entries cover what's universal about it, deficiency and toxicity thresholds, how the three sources (skin, food, supplement) compare, and a current (2024) clinical guideline that recommends something more conservative than most popular advice suggests. Disease-specific vitamin D research (Hashimoto's, lupus, psoriasis, and more) lives in the per-condition areas, cross-linked from the vitamin D entries.",
    citations: [
      { source: 'Vitamin D, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/vitamind.html' },
    ],
    overallTier: 'strong',
    relatedIds: ['vitamind-tying-together', 'glossary-tight-junction', 'body-tying-together', 'body-skin-integumentary'],
  },
  {
    ...
    summary:
      "A current (2023) pooled analysis of population-based studies from 2000 to 2022, spanning nearly 8 million participants worldwide, found a staged shortfall: 15.7% had severe deficiency (below 30 nmol/L), 47.9% had deficiency (below 50 nmol/L), and 76.6% fell short of full sufficiency (below 75 nmol/L), with the Eastern Mediterranean region and lower-income countries showing measurably higher rates, and winter-spring readings running roughly 1.7 times higher in deficiency than summer-autumn ones, a seasonal pattern tied directly to the skin-synthesis mechanism. A separate, US-specific study (2001-2010 data) found 28.9% of American adults deficient and 41.4% insufficient, with specific predictor groups identified: people who are Black, less physically active, rare milk consumers, current smokers, and people with obesity (a separate mechanism with an entry of its own) all showed measurably higher rates. A global-scale nutritional gap, not a rare or fringe concern, though as the entry on current clinical guidance covers, a low number on a lab test doesn't automatically mean supplementation is the right next step for everyone.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The first fact about vitamin D deficiency: most people who have it feel completely normal. The symptoms only show up once it's already severe.",
    summary:
  ...
  },
  {
    ...
    summary:
      "Vitamin D reaches the body through three distinct routes. Skin synthesis, triggered by UVB sunlight converting a cholesterol-derived compound in the skin, has historically been the dominant source for most people, but unreliable as a sole strategy: it varies by latitude, season, time of day, skin tone (more melanin measurably reduces synthesis), age (older skin synthesizes less efficiently), and sunscreen use, and carries a separate skin-cancer and skin-aging tradeoff that pushes many people toward covering up or limiting exposure regardless. Dietary sources are limited to a short, specific list, fatty fish, egg yolks, and UV-exposed mushrooms among the few whole foods that naturally carry meaningful amounts (see the vitamin D food-sources entry), which is exactly why fortified foods (milk, some plant-milk alternatives, some cereals and orange juice) became a deliberate public-health strategy in many countries rather than an accident of nature. Supplementation is the one source unaffected by season, skin tone, or sun exposure, a reason it's often the most practical choice for reliably correcting a confirmed low level, though the entry on current clinical guidance covers the limits on who needs to supplement in the first place.",
    citations: [
      { source: 'Vitamin D, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/vitamind.html' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'D3 Beats D2 by a Measured Margin, Most Pronounced at Higher, Less-Frequent Doses',
  ...
  },
  {
    ...
    summary:
      "Population-level data in the deficiency-prevalence research found obesity associated with a roughly threefold higher rate of vitamin D deficiency. The proposed mechanism behind that gap: vitamin D is fat-soluble, and research (so far demonstrated directly in animal models, with human population data consistent with the same effect) found it gets sequestered inside fat tissue itself, reducing how much stays available in the bloodstream to do its job, a case of the nutrient being present in the body but functionally unavailable, not simply absent. This has a practical, already-recognized clinical consequence: bariatric-surgery guidelines from major medical societies recommend meaningfully higher vitamin D doses, up to several times a standard dose, specifically for patients with obesity, acknowledging that standard dosing under-corrects in this population, a factor for anyone with obesity whose vitamin D level doesn't seem to respond to an ordinary supplemental dose the way it does for other people.",
    citations: [
  ...
  },
  {
    ...
    teaser: "Over 25,000 people, a randomized trial, and a null result for two of the biggest disease categories vitamin D is popularly credited with preventing.",
    summary: "The VITAL trial, a large (25,871 participants), rigorously designed randomized controlled trial, tested a standard 2,000 IU daily dose of vitamin D3 specifically to answer whether supplementation reduces cancer or cardiovascular disease risk in people without a prior diagnosis of either. The result: it didn't, at least not to a statistically or clinically meaningful degree for either primary outcome, a well-powered null finding rather than a small or ambiguous trial easy to dismiss. That is a direct, evidence-based reason behind the entry on the 2024 Endocrine Society guideline's conservative stance on supplementing healthy adults broadly. Vitamin D's well-established roles are in bone health and the specific, named groups the other vitamin D entries describe, not a broad, general-purpose disease-prevention supplement for cancer or cardiovascular disease in an otherwise healthy adult.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin D Food Sources, Pulled Directly From the Database',
    teaser: "A short list, and mushrooms belong on it right alongside fatty fish, but only the specific kind treated with UV light.",
    summary: "Vitamin D's dietary sources are few compared to most other nutrients, pulled directly here from the 22,022-food reference database. Cod liver oil leads by a wide margin at 250mcg per 100g, a historic reason it was once given directly to children before fortified foods became common. UV-treated (\"vitamin D enhanced\") mushrooms are a useful and often-overlooked source at roughly 24mcg per 100g, a specific distinction: ordinary, non-UV-treated mushrooms carry only trace amounts, so the label matters here more than for almost any other vitamin D food. Canned salmon and cooked trout both carry roughly 19-22mcg per 100g. Alongside this short whole-food list: fortified foods (milk, many plant-milk alternatives, some breakfast cereals and orange juice) are a deliberate public-health addition specifically because so few whole foods naturally carry meaningful vitamin D on their own, not a lesser or artificial source.",
    citations: [],
    overallTier: 'strong',
    chart: {
      ...
      sourceNote: "This app's reference database (USDA/Australia_AFCD-sourced values)",
    },
  },
  {
    id: 'vitamind-tying-together',
    category: 'basicHealth',
    title: 'Vitamin D, Pulled Together',
    ...
    summary: "Line up everything about vitamin D and it reads as a two-sided story. The well-established side: a global deficiency gap affecting a majority of people by some measure, specific deficiency and toxicity thresholds, a measured difference between D2 and D3 supplemental forms, and a specific reason (fat-tissue sequestration) obesity tracks with lower levels. The correction: a large, rigorous 2019 trial found vitamin D didn't prevent cancer or cardiovascular disease, and a current 2024 clinical guideline recommends against routine testing and against supplementing most healthy adults under 75 above the standard target, reserving targeted supplementation for specific, named groups instead. The disease-specific vitamin D research, Hashimoto's mixed correlation-vs-RCT picture, the gut-barrier mechanism, lupus's sun-exposure catch-22, and more, builds directly on top of this same universal foundation.",
    citations: [
      { source: 'Vitamin D, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/vitamind.html' },
    ],
    overallTier: 'strong',
    relatedIds: ['vitamind-deficiency-symptoms-staged', 'vitamind-2024-guideline-honest-correction', 'vitamind-vital-trial-non-skeletal', 'vitamind-obesity-bioavailability', 'vitamind-overview', 'sjogrens-vitamin-d-dry-eye-severity', 'pcos-vitamin-d-deficiency-real-data'],
  },
  ...
  // belongs in that disease's own category.
  {
    id: 'iron-overview',
    category: 'basicHealth',
    title: 'Iron Carries Oxygen in Every Red Blood Cell, With No Way for the Body to Excrete It',
    ...
    summary:
      "Iron's best-known job is building hemoglobin, the protein inside red blood cells that carries oxygen from the lungs to every other tissue, and myoglobin, the same job inside muscle itself. Beyond oxygen transport, iron is a required cofactor for enzymes involved in DNA synthesis, energy production in the mitochondria, and immune cell function, which is why both deficiency and overload show up as such a wide, seemingly unrelated list of symptoms. The single fact that shapes most of the rest of the iron story: the human body has no active mechanism to excrete excess iron. Iron balance is controlled almost entirely by regulating absorption in the small intestine, not by getting rid of what's already been taken in. That one-way design is efficient for a nutrient the body cannot do without, and it's also exactly why chronic overload (see the hemochromatosis entry below) is a distinct medical problem rather than something the body simply corrects on its over time.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Roughly 14% of US Adults Have Iron-Deficiency Anemia, Heavily Skewed by Age and Sex',
  ...
  },
  {
    ...
    summary:
      "Iron deficiency progresses through three distinct phases rather than appearing all at once. First, the body's stored iron (measured as serum ferritin) is drawn down as the primary reserve. Second, once storage is exhausted, circulating iron itself starts to decline, which shows up as falling transferrin saturation and rising total iron-binding capacity (TIBC), the blood's way of signaling it wants more iron than it's getting. Third, only once both of those buffers are used up does the body's ability to build new hemoglobin fail, producing the microcytic, hypochromic red blood cells that define iron-deficiency anemia on a standard blood count. The clinically important part: symptoms, including fatigue, cognitive impairment, and restless leg syndrome, can appear during that second stage, before anemia itself is present at all, meaning a normal hemoglobin result doesn't rule out a symptomatic iron problem. Anemia itself is formally defined as hemoglobin under 13 g/dL in men or under 12 g/dL in non-pregnant women, and a serum ferritin under 45 ng/mL is the threshold that gives the best balance of sensitivity and specificity for catching iron deficiency itself, well above the much lower cutoffs (often 12-15 ng/mL) some labs still use as their default reference range.",
    citations: [
      { source: 'Iron Deficiency Anemia, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK448065/' },
    ],
    overallTier: 'strong',
    relatedIds: ['iron-tying-together', 'ibd-iron-deficiency-anemia'],
  },
  {
    id: 'iron-toxicity-acute-overdose',
    category: 'basicHealth',
    title: 'Acute Iron Overdose Is a Medical Emergency With a Named Five-Stage Course',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Hereditary Hemochromatosis Makes the Body Absorb Too Much Iron for Decades, Quietly',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Heme Iron Absorbs at About 25%, Non-Heme as Low as 5%, and Hepcidin Controls Both',
    teaser: 'About 25% of the iron in meat gets absorbed. From plant sources, it can be as low as 5%, so a vegetarian diet needs deliberate attention to iron.',
    summary:
      "Dietary iron comes in two chemically different forms with different absorption rates. Heme iron, found only in meat, poultry, and seafood (bound inside hemoglobin and myoglobin from the animal's tissue), is absorbed at roughly 25%. Non-heme iron, the form found in plants, grains, and fortified foods, is absorbed at 17% or less, and can run as low as 5% depending on what else is eaten alongside it. Averaged across a diet, someone eating animal products absorbs an estimated 14-18% of their dietary iron, versus roughly 5-12% for someone eating a fully plant-based diet, which is exactly why vegetarian and vegan diets call for deliberate attention to iron intake and food pairing, not just eating 'enough' iron-containing plants. Despite making up only 10-15% of total dietary iron in a typical Western diet, heme iron accounts for a disproportionate 40% of all iron absorbed, because of that absorption-rate gap. Non-heme absorption can be measurably boosted: vitamin C converts iron to a more absorbable form and meaningfully increases uptake, and eating meat, fish, or poultry alongside a plant-iron source (the named 'MFP factor') increases non-heme absorption 2-3 fold on its own. Working against absorption: phytates in whole grains and legumes, polyphenols in tea, coffee, and red wine, and calcium from dairy, all of which bind iron in the gut before it can be taken up. Governing all of this from the inside is hepcidin, a hormone made by the liver that acts as the body's master iron-regulation switch: when iron stores run high, hepcidin rises and shuts down further absorption; when stores run low, hepcidin drops and absorption increases. This is the reason iron absorption is adaptive rather than fixed, and also why iron status itself, not just how much iron someone eats, determines how much of a given meal's iron gets taken up.",
    citations: [
      { source: 'Dietary Iron, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK540969/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Ferrous Sulfate and Iron Bisglycinate Absorb Comparably and Differ in How the Gut Tolerates Them',
  ...
  },
  {
    ...
    chart: {
      ...
      sourceNote: "This app's reference database (USDA/Canada_CNF-sourced values)",
    },
  },
  {
    id: 'iron-tying-together',
    category: 'basicHealth',
    title: 'Iron, Pulled Together',
    ...
    summary: "Line up everything about iron and it reads as a nutrient defined by one structural fact: the body has no active way to excrete it, so absorption itself, governed by hepcidin, is the only lever controlling how much accumulates. That single design choice explains both failure modes. Too little, and the shortfall shows up in predictable stages, from depleted stores to measurable fatigue and restless legs to full anemia, skewed heavily toward menstruating women, pregnancy, and young children. Too much, whether from a single large acute dose or decades of a genetic over-absorption tendency like hereditary hemochromatosis, causes serious, and sometimes irreversible organ damage, precisely because there's no built-in release valve. In between those two extremes sits a practical, everyday layer: heme absorbs roughly twice as well as non-heme, vitamin C and meat both boost non-heme uptake, tea and calcium both blunt it, and even the choice of cookware makes a small, measurable difference. The Hashimoto's-specific research goes one step further, covering iron's direct, measured relationship to TSH and thyroid hormone levels, and a standing recommendation for a full iron panel, not ferritin alone.",
    citations: [
      { source: 'Iron Deficiency Anemia, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK448065/' },
    ],
    overallTier: 'strong',
    relatedIds: ['iron-deficiency-symptoms-staged', 'iron-hemochromatosis-overload', 'iron-absorption-mechanism',  'ckd-anemia-erythropoietin'],
  },
  ...
  // the established WebFetch-against-StatPearls/PubMed fallback.
  {
    id: 'zinc-overview',
    category: 'basicHealth',
    title: 'Zinc Is a Structural and Catalytic Mineral in Hundreds of Enzymes at Once',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Taste and Smell Loss Are Zinc Deficiency\'s Tell, Before Almost Anything Else',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Zinc Picolinate, Citrate, Gluconate and Oxide Differ in Measured Absorption',
    ...
    summary: "The reference data carries cited head-to-head comparisons between zinc's most common supplement forms. Zinc citrate and zinc gluconate both showed fractional absorption around 60-61% in a matched-dose crossover trial, meaningfully better than zinc oxide's roughly 50% at the same 10mg elemental zinc dose, despite oxide remaining the most common form in inexpensive multivitamins specifically because it's cheap to manufacture. Zinc picolinate was studied separately: one crossover trial found it was the only form of three tested (against citrate and gluconate) that significantly raised zinc levels in hair, urine, and red blood cells compared to placebo, though serum zinc itself didn't differ significantly between forms in that same trial, a smaller (n=15) and older (1987) piece of evidence, tiered here as emerging rather than established for that reason. All three of the better-absorbed forms are generally well tolerated. Checking a supplement's label for citrate, gluconate, or picolinate rather than oxide is a low-effort way to get more zinc from the same stated dose.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Zinc Lozenges Shorten the Common Cold by a Measured Amount, From a Small Body of Evidence',
    ...
    summary:
      "Zinc for the common cold is one of the most commonly repeated pieces of everyday health advice, and it turns out to have a modest-sized body of evidence behind it rather than being pure folklore. A 2016 individual patient data meta-analysis (pooling raw data from three randomized trials, not just their published summary statistics, a more rigorous approach than a standard meta-analysis) found zinc acetate lozenges shortened colds by 2.73-2.94 days compared to placebo, a substantial fraction of a typical week-long cold. The caveat: the total pooled sample was just 199 people, predominantly female and aged 20-50, and the review's authors said the optimal lozenge composition and dosing frequency still need further investigation, which is why this is tiered moderate rather than strong despite the consistent effect size across the three trials. The zinc form matters here specifically: this evidence is for zinc acetate lozenges taken at the first sign of a cold, not zinc supplementation generally or zinc taken after a cold has already run its course.",
    citations: [
  ...
  },
  {
    ...
    summary: "Line up everything about zinc and it reads as a nutrient where the risk sits at both extremes, and the safe middle ground is wide. Deficiency is globally common (an estimated 2 billion people), with a distinctive symptom picture (taste and smell loss, specific skin and hair changes) that's more specific and easier to recognize than most other nutrient deficiencies. The absorption story centers on phytates as the dominant blocker, meaning plant-based eaters face a documented extra challenge. On the other end, toxicity is nearly always self-inflicted, either a large acute overdose or, more commonly and more insidiously, well-intentioned long-term high-dose supplementation quietly causing a secondary copper deficiency with sometimes lasting neurological consequences. In between sits useful, moderate-strength evidence for zinc lozenges shortening a common cold, and measured differences between supplement forms. The Hashimoto's-specific research covers zinc's overlap with thyroid symptoms directly, one more reason a full lab panel, not assumption, is the right call when fatigue, hair thinning, or brain fog show up.",
    citations: [
      { source: 'Zinc Deficiency, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK493231/' },
    ],
    overallTier: 'strong',
    relatedIds: ['zinc-deficiency-symptoms-staged', 'zinc-toxicity-acute-chronic', 'zinc-absorption-mechanism', 'zinc-overview', 'iron-overview', 'b12-overview', 'interaction-zinc-copper', 'prostate-zinc-connection', 'prostate-zinc-testosterone-deficiency'],
  },
  ...
  // cross-linked from here.
  {
    id: 'b12-overview',
    category: 'basicHealth',
    title: 'Vitamin B12 Needs a Working Stomach and a Multi-Step Relay to Be Absorbed',
    teaser: "Unlike almost every other nutrient, B12 absorption depends on a whole multi-step relay.",
    summary:
      "Vitamin B12 (cobalamin) is required for DNA synthesis, red blood cell formation, and maintaining the protective myelin sheath around nerve cells, which is why deficiency produces both a blood problem (anemia) and a nervous-system problem (neuropathy) at once, a combination uncommon among nutrient deficiencies. What sets B12 apart from almost every other nutrient is how convoluted its absorption is: it's not enough to eat B12-containing food, the body also needs a working stomach, a working pancreas, and a working terminal ileum, all functioning in sequence, covered directly in the absorption-mechanism entry below. That multi-step dependency is exactly why B12 deficiency can show up even in someone eating plenty of it, if any one step in that chain is disrupted, and it's the reason B12 deficiency investigation is more involved than 'are you eating enough meat and dairy.'",
    citations: [
  ...
  },
  {
    ...
    summary: "B12 deficiency traces back to four distinct causes, and diet is only one of them. Autoimmune (pernicious anemia): the immune system produces antibodies against intrinsic factor itself, the stomach protein B12 absorption depends on, a second, separate autoimmune process, not a dietary gap at all. Malabsorption: gastric bypass surgery, Crohn's disease, celiac disease, or a specific parasitic cause (the fish tapeworm, Diphyllobothrium latum) can all block absorption even with adequate dietary intake. Dietary insufficiency: a strict vegan diet with no B12-fortified foods or supplements, though this takes around three years to cause deficiency, since the liver stores several years worth of B12 at once, a notable exception to how quickly most nutrient deficiencies can develop. Medication/toxin-related: nitrous oxide exposure and, directly relevant to the research, metformin, a documented cause of B12 deficiency in long-term users. Older adults are disproportionately affected regardless of the underlying cause, and B12 deficiency is more prevalent in people of Northern European ancestry specifically, tracking with pernicious anemia's genetic risk pattern.",
    citations: [
      { source: 'Vitamin B12 (Cobalamin) Deficiency, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK441923/' },
    ],
    overallTier: 'strong',
    relatedIds: ['folate-b12-masking-danger', 'labs-absorption-interferers-beyond-food'],
  },
  {
    id: 'b12-deficiency-symptoms-staged',
    category: 'basicHealth',
    title: 'B12 Deficiency Shows Up as Blood Problems First, Then Nerve Damage in Severe, Prolonged Cases',
    ...
    summary:
      "B12 deficiency progresses along two somewhat separate tracks. The hematologic track shows up first and more commonly: fatigue, pale skin, and jaundice, from the large, immature red blood cells (megaloblastic anemia) B12 deficiency produces. The neurological track develops in more severe, longer-standing cases, and is more serious: peripheral neuropathy, loss of coordination (ataxia), loss of proprioception (the sense of where the body is in space), and in severe cases, dementia-like cognitive decline. The most severe, specifically named neurological complication is subacute combined degeneration of the spinal cord, direct damage to the spinal cord's dorsal columns and corticospinal tracts. Neurological symptoms can appear even without anemia being present, meaning a normal blood count doesn't fully rule out an ongoing B12 problem. Diagnostically, serum B12 above 300 pg/mL is considered normal, 200-300 pg/mL is borderline and worth further testing, and below 200 pg/mL is considered deficient.",
    citations: [
      { source: 'Vitamin B12 (Cobalamin) Deficiency, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK441923/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'B12 Has No Known Toxicity, an Exception Among Nutrients',
    teaser: "No established upper limit exists, and the medical literature states directly: no overdose occurs.",
    summary:
      "Magnesium, vitamin D, iron and zinc each carry a toxicity risk at high enough doses. B12 is an exception, not covered by a generic caution that doesn't apply here. The clinical literature states directly that no overdose occurs with cyanocobalamin, and there's no established tolerable upper intake level, since excess B12 is efficiently cleared through the kidneys rather than accumulating to toxic levels the way iron or vitamin A can. That doesn't mean literally zero considerations exist. A small number of people are allergic to cobalt (the metal at B12's molecular core) and can have an allergic reaction, including anaphylaxis in rare cases, particularly with injectable forms. Starting B12 treatment for a confirmed deficiency can also trigger hypokalemia (low potassium) as the anemia itself starts correcting and red blood cell production ramps up quickly, using up potassium faster than usual, a consideration for someone just starting treatment for a significant deficiency, not a reason to avoid supplementation itself.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "B12 Absorption Runs Through Saliva, Stomach, and Small Intestine in Sequence",
  ...
  },
  {
    ...
    summary: "B12 content pulled directly from the 22,022-food reference database. Clams lead by a wide margin at roughly 99mcg per 100g. Lamb liver and beef liver both carry exceptionally high amounts, commonly 40-90mcg per 100g depending on preparation, the same organ-meat pattern already seen in the iron research. Salmon carries a more moderate 8-29mcg per 100g depending on preparation and cut. Tuna carries roughly 9-11mcg per 100g. Every meaningful B12 source is animal-derived (meat, seafood, eggs, dairy), with no meaningful naturally-occurring plant source. That is why a fully plant-based diet needs a deliberate B12 plan (fortified foods or a supplement), and why the roughly three-year depletion timeline covered in the deficiency-causes entry above matters: stored B12 doesn't run out slowly and announce itself early.",
    citations: [],
    overallTier: 'strong',
    chart: {
  ...
  },
  {
    ...
    summary: "Line up everything about B12 and it reads as a different kind of nutrient story from magnesium, vitamin D, iron, or zinc. The risk sits almost entirely on the deficiency side, not the excess side; toxicity here is a non-issue, with no established upper limit and the literature stating directly that no overdose occurs. Deficiency, though, has four distinct causes (autoimmune, malabsorption, diet, medication-related), each needing a different fix rather than a single blanket answer. The absorption mechanism itself is the throughline explaining why so many different conditions (gastric surgery, Crohn's, celiac, pernicious anemia, even long-term metformin use) can each independently cause the same deficiency: a multi-step relay through the salivary glands, stomach, pancreas, and terminal ileum, where a single broken link is enough to cause a problem regardless of how much B12 someone eats. The Hashimoto's-specific research covers the measured overlap between autoimmune thyroid disease and pernicious anemia directly, a second, separate autoimmune process.",
    citations: [
      { source: 'Vitamin B12 (Cobalamin) Deficiency, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK441923/' },
    ],
    overallTier: 'strong',
    relatedIds: ['b12-deficiency-prevalence-causes', 'b12-absorption-mechanism', 'folate-b12-masking-danger', 'zinc-overview', 'iron-overview', 'b12-overview'],
  },
  ...
  // Meds work.
  {
    id: 'folate-overview',
    category: 'basicHealth',
    title: 'Folate and B12 Share One DNA-Synthesis Pathway, So Either Can Mask a Shortage of the Other',
    ...
    summary:
      "Folate, like B12, is required for DNA synthesis and red blood cell formation, and the two nutrients are chemically linked closely enough in the same metabolic pathway that a deficiency in either one produces the identical hematologic problem: megaloblastic anemia, large, immature red blood cells that can't function normally. That shared endpoint is exactly why the two are always worth checking together rather than separately, covered directly in the entry below on folate's specific danger of masking a B12 problem. Folate exists naturally in food as several related compounds, collectively absorbed and converted into its active form, while folic acid, the synthetic form used in supplements and fortified food, follows a slightly different metabolic path, covered in the supplement-forms entry below.",
    citations: [
  ...
  },
  {
    ...
    overallTier: 'strong',
    relatedIds: ['ra-methotrexate-folate', 'folate-b12-masking-danger'],
  },
  {
    id: 'folate-b12-masking-danger',
    category: 'basicHealth',
    title: 'Folic Acid Can Correct B12-Deficiency Anemia While Nerve Damage Keeps Progressing Unrecognized',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'L-Methylfolate and Folic Acid Differ in a Way That Matters More for Some People Than Others',
    ...
    summary: "The reference data carries a cited comparison between folate's two most common supplement forms. Folic acid is the synthetic, most-studied, and most-fortified form, the one used in the US mandatory fortification program specifically because it measurably reduces neural tube defects at a whole-population level, and it's generally well tolerated at standard RDA-level doses. L-methylfolate (5-MTHF) is already in the metabolically active form the body uses, meaning it doesn't require the MTHFR enzyme to activate it first, a practically relevant distinction for the substantial share of people who carry a common genetic variant reducing that enzyme's activity. Head-to-head trials found L-methylfolate produces higher, faster peak plasma folate levels than folic acid. Both forms are generally well tolerated; the practical choice mainly comes down to whether MTHFR variant status is a known factor.",
    citations: [
  ...
  },
  {
    ...
    chart: {
      ...
      sourceNote: "This app's reference database (USDA/Canada_CNF-sourced values); yeast extract spread (~3,786mcg/100g) omitted from the chart as an outlier that would flatten every other bar",
    },
  },
  {
    id: 'folate-tying-together',
    category: 'basicHealth',
    title: 'Folate, Pulled Together',
    ...
    summary: "Line up everything about folate and it reads as a nutrient defined by two connected stories. The first is a public-health win: mandatory fortification measurably reduced neural tube defects at a population level, settled evidence strong enough to change the food supply itself. The second is an important caution that runs directly against how folate often gets marketed and self-supplemented: because folate and B12 deficiency look identical on a basic blood count, folic acid can mask an underlying B12 problem, correcting the visible anemia while B12's separate, more serious neurological damage keeps progressing unrecognized. That's the practical reason B12 and folate belong together on any lab request. The Hashimoto's-specific research covers folate's thinner, more observational link to thyroid antibody levels, and rheumatoid arthritis's methotrexate-folate timing rule builds on the identical antifolate mechanism.",
    citations: [
      { source: 'Folic Acid Deficiency, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK535377/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Hypocalcemia Runs a Graded Symptom Course and Links Directly to Thyroid Surgery',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Hypercalcemia\'s Mnemonic Is Stones, Bones, Groans, Thrones and Psychiatric Overtones',
    teaser: 'Hyperthyroidism is a documented cause on its own, and excess antacid-style calcium carbonate can independently cause it too, a condition with its name: milk-alkali syndrome.',
    summary: "High blood calcium (hypercalcemia) has a classic, memorable symptom mnemonic covering every organ system it touches: stones (kidney stones), bones (bone pain), groans (abdominal pain, constipation, nausea), thrones (polyuria from the kidneys trying to excrete the excess), and psychiatric overtones (confusion, depression, in severe cases outright psychosis). Diagnostic severity bands: mild is 10.5-11.9 mg/dL, moderate is 12.0-13.9 mg/dL, and a hypercalcemic crisis is 14.0-16.0 mg/dL. Causes span several different mechanisms. Primary hyperparathyroidism and malignancy together account for a 90%+ of cases. Directly relevant to the research: hyperthyroidism itself is a documented cause, since excess thyroid hormone accelerates bone turnover, and lithium (covered in the Graves'-adjacent medication research) alters the body's calcium set point, requiring a higher blood calcium level before PTH release is suppressed. A specific, self-inflicted cause: excessive use of calcium carbonate antacids (the same over-the-counter form covered in the supplement-forms research) for reflux or indigestion can cause milk-alkali syndrome, a named hypercalcemia syndrome from over-supplementation, not a rare medical curiosity.",
    citations: [
  ...
  },
  {
    ...
    summary: "The reference data carries specific, cited detail on how calcium absorption works. Vitamin D is an absolute requirement: without it, dietary calcium largely passes through unabsorbed regardless of how much is eaten, the reason the vitamin D research and calcium research are inseparable from each other. Absorption efficiency also has a hard ceiling per single dose: taken above roughly 500mg of elemental calcium at once, the fraction absorbed drops sharply, which is the practical reason splitting a daily target (say, 1,000mg) into two separate 500mg doses absorbs measurably better than taking it all in one sitting. Calcium also competes directly with iron and zinc for absorption (both covered in the Nutrient Interactions research) and needs a 4+ hour separation from levothyroxine, the same well-established interaction covered in the Labs & Medication Timing research. Magnesium and vitamin K2 round out calcium's regulatory picture, governing where absorbed calcium gets deposited (bone versus soft tissue), covered in full in the Nutrient Interactions category.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Calcium binds oxalate together in the gut before either one is absorbed, so eating enough calcium at the same meal as an oxalate-containing food keeps that oxalate from ever reaching the bloodstream or the kidneys. Restrict dietary calcium instead, and the opposite happens: unbound oxalate gets absorbed more efficiently, raising urinary oxalate by a documented 16 to 56 percent. A prospective cohort of over 45,000 men with no prior stone history confirmed this plays out as measured risk: those in the highest quintile of dietary calcium intake had roughly 44 percent lower kidney stone risk than those in the lowest quintile over four years of follow-up. This protective effect is specific to dietary calcium, calcium eaten as food, alongside the meal that also contains the oxalate. Calcium supplements do not show the same benefit, and several studies found the opposite: women taking calcium supplements, especially between meals rather than with food, showed a measurably higher kidney stone risk in some trials. Pairing a high-oxalate food with a calcium-containing food at the same meal, tahini, a dairy product, or a calcium-fortified plant milk, is the version of this finding to act on.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Calcium Carbonate Needs Stomach Acid to Dissolve, Calcium Citrate Does Not',
    ...
    summary: "The reference data already carries a specific comparison between calcium's two most common supplement forms. Calcium carbonate is the cheapest, most common form, and carries the highest elemental calcium by weight (roughly 40%), but it requires stomach acid to dissolve before it can be absorbed at all. That's a practical problem for two overlapping groups: people with achlorhydria (reduced stomach acid, more common with age) and anyone taking acid-suppressing medication (proton pump inhibitors or H2 blockers), where carbonate's absorption drops sharply. Calcium citrate absorbs roughly 22-27% better on average and doesn't require stomach acid to dissolve at all, meaning its absorption holds up in both of those exact situations where carbonate's doesn't. The practical trade-off: carbonate is cheaper and can be taken with or without food (though food helps, since eating stimulates stomach acid), while citrate is more forgiving of timing and medical circumstance, at a somewhat higher cost. Carbonate is also more likely to cause gas or constipation, especially at higher doses, than the gentler citrate form.",
    citations: [
      { source: 'NIH Office of Dietary Supplements, Calcium Health Professional Fact Sheet', url: 'https://ods.od.nih.gov/factsheets/Calcium-HealthProfessional/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    chart: {
      ...
      sourceNote: "This app's reference database (USDA/Japan_MEXT-sourced values)",
    },
  },
  {
    id: 'calcium-tying-together',
    category: 'basicHealth',
    title: 'Calcium, Pulled Together',
    ...
    summary:
      "Line up everything about calcium and it reads as a nutrient where the most important lesson is that a normal blood calcium result doesn't mean the underlying supply is fine. Because the body actively defends that small circulating 1% by pulling from bone reserves first, a chronic dietary shortfall can drain bone density for years while blood calcium itself stays perfectly normal, only showing up as hypocalcemia once bone reserves themselves are exhausted, which is a different failure pattern from most other nutrients. Both extremes, hypocalcemia and hypercalcemia, have their graded symptom courses and their specific causes, including a direct, worth-remembering connection to thyroid surgery and hyperthyroidism itself. The practical layer underneath all of it is actionable: vitamin D is a hard absorption requirement, not optional; doses above roughly 500mg absorb worse in one sitting; and the right supplement form depends on individual factors like stomach acid and medication use, not a single universal answer.",
    citations: [
      { source: 'Hypocalcemia, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK430912/' },
    ],
    overallTier: 'strong',
  ...
  // PCOS-specific spironolactone caution -- both cross-linked instead.
  {
    ...
    category: 'basicHealth',
    title: "Potassium Holds the Charge Inside Cells That Lets Nerves and Muscles Fire",
    teaser: 'The sodium-potassium pump moving potassium into cells (and sodium out) runs constantly, in essentially every cell, and is directly responsible for how nerves and muscles, including the heart, fire.',
    summary: "Potassium is the body's primary intracellular positive ion, meaning most of it sits inside cells rather than in the blood, the opposite distribution from sodium. That inside/outside gradient, actively maintained by the sodium-potassium pump (the same Na+/K+-ATPase covered in the magnesium research, since magnesium is a required cofactor for that same pump to function), is what generates the electrical signal nerves and muscles use to fire, including the heart's electrical conduction system. That's the direct reason both too little and too much circulating potassium show up as dangerous cardiac and neuromuscular problems, covered in the two entries directly below. Potassium is also the direct counterbalance to sodium in blood pressure regulation, covered in its entry below.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Hypokalemia Has a Graded Severity Scale and Is More Common Than Its Better-Known Opposite',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Hyperkalemia Is a Medical Emergency Where the Speed of the Rise Matters as Much as the Number',
    ...
    summary: "High blood potassium (hyperkalemia), defined as above roughly 5.0-5.5 mEq/L, is a medical emergency at its more severe end, not a mild electrolyte quirk. Three mechanisms cause it: impaired kidney excretion (the most common cause, especially in kidney disease), excessive intake (dietary or intravenous), and potassium shifting out of cells into the blood (cell injury, metabolic acidosis, rhabdomyolysis). The staged ECG progression tracks disturbingly precisely with severity: 5.5-6.5 mEq/L produces tall, peaked T waves; 6.5-7.5 mEq/L flattens or erases the P wave; 7-8 mEq/L widens the QRS complex; and 8-10 mEq/L risks severe arrhythmias, a dangerous sine-wave ECG pattern, and cardiac arrest. How FAST potassium rises matters more for cardiac risk than the absolute number alone, meaning a rapid rise can be dangerous at a lower number than a slow, chronic one. Acute, severe hyperkalemia left unmanaged carries a mortality rate approaching two-thirds. The CKD research covers the specific reason ACE inhibitors and ARBs (both common, protective kidney/heart medications) need potassium monitoring, since they directly reduce the kidney's ability to excrete potassium, covered directly in the dedicated entry on that exact interaction.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Potassium Citrate and Potassium Chloride Raise Blood Levels Similarly, and Citrate Carries an Extra Benefit',
    teaser: "Potassium chloride is the common salt-substitute form. Citrate's alkalinizing effect does something chloride can't: lower kidney stone risk directly.",
    summary: "The reference data carries a cited comparison between potassium's two most common supplement forms. Potassium chloride is the most common over-the-counter and salt-substitute form, readily absorbed, and roughly matched to potassium citrate on how much it raises blood potassium in head-to-head testing. Potassium citrate has an additional benefit chloride doesn't: a randomized controlled trial found it produced significantly higher intracellular (red blood cell) potassium uptake and higher urinary excretion at an equivalent oral dose, and its alkalinizing citrate anion independently improves acid-base balance, reduces urinary calcium loss, and increases urinary citrate, which lowers kidney stone risk. Both forms carry the identical hyperkalemia caution as any potassium supplement, and neither should be combined with ACE inhibitors, ARBs, or potassium-sparing diuretics without medical supervision.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Potassium and Sodium Affect Blood Pressure Together, So Cutting Sodium Alone Falls Short',
  ...
  },
  {
    ...
    summary: "Potassium content pulled directly from the 22,022-food reference database. White beans lead this everyday list at roughly 561mg per 100g. Avocado carries a high 550mg per 100g. Salmon carries roughly 490mg per 100g, a meaningful amount for a food not usually thought of as a potassium source first. Sweet potato carries about 475mg per 100g. Banana, the food most commonly associated with potassium in popular culture, carries a more modest 358mg per 100g in the verified data, lower than each of the other four foods on this same list, a direct correction to banana's outsized reputation.",
    citations: [],
    overallTier: 'strong',
    chart: {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Potassium, Pulled Together',
    teaser: "A sharp, dangerous edge on both sides, and a more careful, food-first, both-electrolytes-together answer than 'just eat a banana' or 'just cut salt.'",
    summary: "Line up everything about potassium and it reads as a nutrient where both extremes are dangerous, with the cardiac conduction system as the shared point of failure on either end: hypokalemia and hyperkalemia both produce their specific, named, staged ECG changes, and both can independently trigger fatal arrhythmias. Hypokalemia is more common than its better-known opposite, hyperkalemia is a medical emergency where the SPEED of the rise matters as much as the number itself, and the CKD/PCOS/medication research covers several of the specific reasons the two most common blood pressure and hormone medications, ACE inhibitors/ARBs and spironolactone, carry a documented hyperkalemia risk worth monitoring. Potassium and sodium work best addressed together through whole foods, and food-based potassium carries essentially none of supplementation's hyperkalemia risk.",
    citations: [
      { source: 'Hyperkalemia, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK470284/' },
    ],
    overallTier: 'strong',
  ...
  // linked to all of the above rather than repeating any of it.
  {
    ...
    category: 'basicHealth',
    title: 'How the Thyroid Turns Iodine Into a Hormone, Step by Step',
  ...
  },
  {
    ...
    chart: {
      ...
      sourceNote: "This app's reference database (USDA/Japan_MEXT-sourced values); kombu-family kelp omitted as a six-figure outlier covered in Problem Foods & Swaps",
    },
  },
  {
    id: 'iodine-tying-together',
    category: 'basicHealth',
    title: 'Iodine, Pulled Together',
    ...
    summary: "Line up everything about iodine and it reads as an exception to how most nutrients work. It's required, step one, for the thyroid to make hormone at all, global deficiency remains a leading, preventable cause of fetal brain damage, and a historic public-health fix (iodized salt) already solved this at scale in the US a century ago. And yet, unlike almost every other nutrient, more isn't simply better past a specific point: excess carries its documented risks, from acute GI-then-neurological toxicity to a paradox where too much iodine can push a vulnerable thyroid toward either hypothyroidism or hyperthyroidism depending on the person. The condition-specific research carries the practical version of this tension: Hashimoto's iodine entry names it directly as a two-edged nutrient, Graves' disease has its full iodine entry, pregnancy raises the stakes on both ends at once, and the kelp-specific caution names exactly where that risk shows up in an everyday food choice.",
    citations: [
      { source: 'Diffuse Toxic Goiter, StatPearls, National Library of Medicine', url: 'https://pubmed.ncbi.nlm.nih.gov/32491782/' },
    ],
    overallTier: 'strong',
    relatedIds: ['iodine-thyroid-synthesis-mechanism', 'graves-iodine', 'pregnancy-iodine-needs', 'problem-excess-iodine-kelp'],
  },
  ...
  // entry) or `interaction-vitaminc-iron` -- both cross-linked instead.
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin C Builds Collagen, and Humans Lost the Ability to Make It',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin C Is Tolerated at High Doses, With One Specific Risk for a Specific Group',
    ...
    summary:
      "Vitamin C carries a high tolerance compared to most nutrients, but it isn't a complete non-issue the way B12's toxicity entry describes. At elevated doses, GI symptoms (diarrhea, nausea, abdominal cramps) are the most common consequence, generally self-limiting once the dose is reduced. The more specific, important risk: excessive vitamin C intake has been linked to kidney stone formation, specifically in men with a prior history of kidney stones or existing kidney conditions, through a documented mechanism, increased urinary oxalate excretion, since the body partly metabolizes excess vitamin C into oxalate. This is a targeted risk for a specific, identifiable group, not a reason for general population-wide caution. The clinical literature doesn't specify one universal numeric toxicity threshold, framing this instead as a dose-and-person-dependent risk rather than a fixed cutoff, worth a conversation with a doctor specifically for anyone with a personal or family kidney-stone history before taking high-dose vitamin C supplements.",
    citations: [
      { source: 'Vitamin C Deficiency, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK493187/' },
    ],
    overallTier: 'strong',
  },
  {
    ...
    summary: "Vitamin C absorption follows a different pattern from a simple 'more in, more absorbed' relationship. At ordinary dietary intake levels, up to around 100mg per day, absorption is efficient. Past that point, the fraction absorbed starts declining, and once a single dose climbs above roughly 1,500mg, absorption efficiency drops to 50% or less, meaning a large chunk of a mega-dose is never taken up by the body at all, simply passing through. For anyone taking high-dose vitamin C specifically to maximize absorbed amount, splitting a large daily total into smaller, more frequent doses absorbs measurably better than taking it all at once, the identical principle covered in the calcium research for a completely different nutrient.",
    citations: [
      { source: 'Vitamin C Deficiency, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK493187/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary: "Vitamin C content pulled directly from the 22,022-food reference database. Acerola cherries lead by an enormous margin at roughly 1,690mg per 100g, dwarfing every citrus fruit's popular reputation as the top vitamin C source. Among more everyday foods, red bell pepper carries a meaningful 171mg per 100g, higher than an orange's 145mg per 100g. Broccoli carries roughly 90-130mg per 100g, and strawberries carry 76-98mg per 100g, both substantial sources well above the standard adult RDA of 75-90mg daily in a single serving.",
    citations: [],
    overallTier: 'strong',
    chart: {
      ...
      sourceNote: "This app's reference database (USDA/French_Ciqual-sourced values)",
    },
  },
  {
    id: 'vitaminc-tying-together',
    category: 'basicHealth',
    title: 'Vitamin C, Pulled Together',
    teaser: "An absolute dietary requirement (the body cannot make its own), a still-modern deficiency disease, and a dose-dependent absorption curve that makes mega-dosing less efficient than it sounds.",
    summary: "Line up everything about vitamin C and it reads as a nutrient defined by a biological non-negotiable: unlike most mammals, humans cannot synthesize it at all, making dietary intake an absolute requirement. Deficiency (scurvy) is still modern, with prevalence varying enormously by measured population, and a distinctive staged symptom progression. Toxicity is narrow, concentrated almost entirely in kidney-stone risk for a specific, identifiable group, alongside a practically useful absorption quirk: efficiency drops sharply above roughly 1,500mg in one dose, the identical single-dose-ceiling pattern already seen in the calcium research. The gout-specific research covers a RCT finding vitamin C measurably lowers uric acid, and its iron-interaction research covers the well-established boost vitamin C gives non-heme iron absorption, both specific, practical applications built on top of the universal biochemistry.",
    citations: [
      { source: 'Vitamin C Deficiency, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK493187/' },
    ],
    overallTier: 'strong',
  ...
  // toxicity story.
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin A Comes From Two Chemically Different Sources With Two Different Safety Profiles',
    ...
    summary:
      "Vitamin A is required for vision (specifically, forming rhodopsin, the light-sensing pigment in the retina), immune function, cell differentiation, and reproduction. The single most important fact to understand about vitamin A, more than almost any other nutrient, is that it exists in two chemically distinct dietary forms with two different safety profiles. Preformed vitamin A (retinol and its esters), found in animal foods like liver, fish oil, and dairy, is efficiently absorbed and stored in the liver without tight regulation, meaning intake can accumulate to toxic levels, covered in specific detail in the toxicity entry below. Provitamin A carotenoids (beta-carotene and related compounds), found in orange and dark leafy plant foods, undergo a regulated conversion process with built-in feedback control, and rarely cause toxicity even at high intake. That distinction, not a single blanket 'vitamin A is dangerous in excess' rule, is the practical thing worth understanding before the vitamin A deficiency and toxicity entries make sense.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin A Deficiency Is a Leading Cause of Preventable Childhood Blindness Worldwide',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin A, Pulled Together',
    ...
    summary: "Line up everything about vitamin A and it reads as a nutrient where the single most important lesson isn't 'how much,' it's 'which form.' Preformed retinol, from liver and fish oil, is efficiently absorbed and stored without tight regulation, making toxicity possible at concentrated doses, with a specific, no-safe-level warning during pregnancy. Provitamin A carotenoids, from carrots and sweet potatoes, undergo a self-limiting conversion process and rarely cause toxicity even at high intake. Deficiency, meanwhile, is severe at the other end, a leading, preventable cause of childhood blindness worldwide, with a staged, recognizable eye-symptom progression. The zinc research covers a separate mechanistic link, zinc is required to convert and transport vitamin A itself.",
    citations: [
      { source: 'Vitamin A Toxicity, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK532916/' },
    ],
    overallTier: 'strong',
  ...
  // revisiting once Vitamin K gets its own deep-dive.
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin E Is the Body\'s Lipid-Membrane Bodyguard',
    ...
    summary: "Vitamin E is a major lipid-soluble antioxidant, obtained exclusively from the diet, meaning the body has no way to synthesize it, just as it can't synthesize vitamin C. Its core job is protecting cell membranes, which are built largely from fat, from oxidative damage caused by free radicals, the same oxidation-risk mechanism covered elsewhere in the food-scoring research. Vitamin E exists as eight chemically related compounds (four tocopherols, four tocotrienols), with alpha-tocopherol being the specific form the body preferentially retains and the one measured on a standard blood test. Because it's fat-soluble, absorption depends on dietary fat being present and on the same basic fat-digestion machinery (bile, pancreatic enzymes) covered in the vitamin A and vitamin K research, which is exactly why vitamin E deficiency, covered below, traces almost entirely to fat-malabsorption problems rather than simply not eating enough of it.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin E at High Doses Carries a Documented Bleeding Risk Through Three Separate Mechanisms',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin E, Pulled Together',
    teaser: "An exclusively-dietary antioxidant whose deficiency almost always means an absorption problem, not a diet problem, and whose toxicity risk is bleeding, not organ damage.",
    summary: "Line up everything about vitamin E and it reads as a nutrient whose story runs almost entirely through fat absorption, on both ends. Deficiency is rare from diet alone in the developed world; when it does happen, it's almost always an identifiable malabsorption condition (cystic fibrosis, cholestatic liver disease, Crohn's, abetalipoproteinemia, short-bowel syndrome) rather than simple dietary insufficiency, producing a staged neurological progression (ataxia is the single most common finding). Toxicity, on the other end, is different in kind from most other nutrients: a three-mechanism bleeding risk rather than organ damage, which compounds directly and dangerously with warfarin, at drug-interaction doses (300mg+) well below where symptoms would otherwise appear on their own (roughly 1,000mg+). The vitamin K2 research covers a parallel warfarin interaction from the opposite direction, together two separate reasons anyone on blood thinners needs medical guidance before starting either supplement.",
    citations: [
      { source: 'Vitamin E Toxicity, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK564373/' },
    ],
    overallTier: 'strong',
  ...
  // real food-sources chart.
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin K Is One Name for Two Forms With Two Different Jobs',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Natural Vitamin K Has No Toxicity, With One Important Exception',
    teaser: "Unlike vitamin A, D, or E, natural vitamin K carries no established upper intake limit. The one exception is warfarin.",
    summary: "Natural vitamin K (both K1 and K2, from food or standard supplements) has no established tolerable upper intake level, and no documented toxicity syndrome the way vitamin A, D, or E each carry their specific one. The exception is a direct medication interaction: warfarin and other vitamin-K-dependent anticoagulants work specifically by blocking the vitamin K recycling pathway, so vitamin K intake and warfarin dosing are directly, mechanically linked. The practical fix is consistency rather than timing separation (the calcium, iron and levothyroxine approach): the danger is a sudden change in vitamin K intake (starting, stopping, or changing a supplement), since a warfarin dose is calibrated against a steady daily amount. Alongside the vitamin E research: two different vitamins, interacting with the exact same medication, through opposite mechanisms (vitamin E antagonizes clotting, vitamin K supports it), both serious reasons anyone on warfarin needs their prescriber directly involved before changing either one.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'K1, MK-4 and MK-7 Are Three Forms With Three Different Half-Lives',
    teaser: "MK-7's much longer half-life is exactly why it's the form most bone/cardiovascular-focused K2 supplements use, even though MK-4 has its separate, high-dose trial evidence.",
    summary: "The reference data carries a specific comparison across vitamin K's three most relevant forms. Vitamin K1 (phylloquinone), the primary dietary form from leafy greens, has the shortest half-life of the three, clearing from blood fastest, and is the standard form used in most large population studies of vitamin K intake. Vitamin K2 as MK-4 is structurally closer to K1, with a much shorter half-life than MK-7, meaning it needs more frequent dosing to maintain stable levels, though it carries established bone-health evidence, typically studied at much higher doses (often 45mg/day in Japanese osteoporosis trials) than MK-7 ever uses. Vitamin K2 as MK-7 has a substantially longer half-life than either, producing much more stable blood levels and 7-8x higher accumulation over sustained daily use, practical reasons it's the form most K2 supplements marketed for bone and cardiovascular health contain today. All three are generally well tolerated, and all three need dietary fat present in the same meal to absorb well, the identical fat-solubility requirement covered in the vitamin A, D, and E research.",
    citations: [
      { source: 'Schurgers LJ, et al. 2007: Vitamin K-containing dietary supplements: comparison of synthetic vitamin K1 and natto-derived menaquinone-7, Blood, PMID 17158229', url: 'https://pubmed.ncbi.nlm.nih.gov/17158229/' },
    ],
    overallTier: 'strong',
  },
  {
    ...
    teaser: "Kale and parsley both dominate the K1 side of the ranking. Natto, a specifically fermented soybean product, is the outlier that delivers the K2 form instead.",
    summary: "Vitamin K content pulled directly from the 22,022-food reference database, split by form since K1 and K2 come from different food categories. Kale carries a substantial 1,174-1,890mcg per 100g (K1), and parsley carries a similarly high 1,360-1,640mcg per 100g (K1), both classic leafy-green sources. Spinach carries 540-716mcg per 100g (K1). Natto, a specifically fermented soybean product (the same fermentation family covered in the Fermented Foods research), stands apart as a K2 source, carrying up to 930mcg per 100g of the menaquinone form specifically, the practical reason it's so often named as the single best whole-food K2 source in nutrition research.",
    citations: [],
    overallTier: 'strong',
    chart: {
  ...
  // repeating any of it.
  {
    id: 'omega36-overview',
    category: 'basicHealth',
    title: 'Omega-3 and Omega-6 Are Two Families of Fat the Body Cannot Make on Its Own',
    teaser: "Both are essential fats, the same 'the body cannot synthesize this' status covered for vitamin C and vitamin E, just applied to fat instead of a vitamin.",
    summary:
      "Omega-3 and omega-6 fatty acids are both essential polyunsaturated fats: the body lacks the enzymes needed to build either one from scratch, meaning both must come from diet, the identical 'cannot synthesize it' status covered for vitamin C. Each family includes several distinct fats, not one interchangeable category. Omega-3 includes ALA (alpha-linolenic acid, the plant form, found in flaxseed and walnuts), EPA, and DHA (the two longer-chain, more biologically active forms, found preformed in fatty fish). Omega-6 includes linoleic acid, the dominant form in most common vegetable and seed oils. Both families get converted, once eaten, into biologically active signaling molecules that regulate inflammation, though in opposite directions, covered in the ratio entry below.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'ALA Converts to DHA Inefficiently, Under 5% in the Whole Body',
  ...
  },
  {
    ...
    teaser: "Omega-6 fats are the literal raw material for the body's pro-inflammatory signaling molecules. Omega-3s are the raw material for the anti-inflammatory ones. It's the balance between the two that the research tracks, not omega-6 treated as simply 'bad.'",
    summary: "The Problem Foods research covers the practical, food-swap side of this ratio directly (refined vegetable and seed oils, and the historical drift from roughly an even 1:1 omega-6-to-omega-3 ratio to often 15:1 or higher in a modern diet). This entry covers the biochemical mechanism underneath that food-level advice: omega-6 fatty acids are the literal biochemical raw material the body uses to build its pro-inflammatory signaling molecules (a class called eicosanoids), while omega-3s are the raw material for a separate set of anti-inflammatory and inflammation-resolving compounds. Because both families are processed by overlapping conversion machinery inside the body, research consistently tracks the RATIO between the two, not omega-6 intake in isolation, the same point the food-swap entry makes about not treating omega-6 as simply 'bad.' A lower-omega-6, higher-omega-3 dietary pattern is the practical target this mechanism points toward, not omega-6 elimination.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'High-Dose Omega-3 Carries a Mild Version of the Same Bleeding Risk as Vitamin E and K',
    ...
    summary: "Omega-3 fatty acids carry a milder version of the same bleeding-risk theme covered in the vitamin E and vitamin K research. The FDA's guidance sets a combined EPA+DHA upper limit of 3g per day, with no more than 2g of that coming from supplements specifically. Clinical trials with omega-3 supplementation did find measurably prolonged bleeding time, the physiological reason this caution exists at all, but the same trials found that prolongation did not exceed normal limits or produce clinically significant bleeding episodes, a more reassuring finding than the headline 'omega-3 thins blood' claim usually implies on its own. Standard clinical guidance still recommends periodic monitoring for anyone combining high-dose omega-3 with an actual anticoagulant or antiplatelet medication, the same sensible caution covered for vitamin E and warfarin, just a milder, less mechanistically direct version of it here. Very high intake has also been separately associated with theoretical immune-function changes from shifting the body's inflammatory balance too far, though the condition-specific research (RA, Sjögren's) found measured benefit at the doses those actual trials used, well within this same safe range.",
    citations: [
      { source: 'Essential Fatty Acids, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK564314/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Omega-3 and Omega-6, Pulled Together',
    ...
    summary: "Line up everything about omega-3 and omega-6 and they read as an essential, universally-needed fat family whose evidence depends on which condition and which outcome someone is asking about, more than almost any other nutrient. The condition-specific research bears that out: Rheumatoid Arthritis's omega-3 evidence is strong (a quantified reduction in NSAID use at a specific dosing threshold), Sjögren's research found a positive, double-blind trial improving both dry eye AND dry mouth in the same study, while Psoriasis and Lupus both carry mixed evidence, and Cardiovascular Disease's research covers a large, rigorous trial finding a null result for primary prevention. Underneath all five sits the same universal biochemistry: an inefficient plant-to-fish conversion pathway, a ratio-based inflammatory mechanism, and a mild bleeding-risk profile shared in kind, if not in degree, with vitamin E and vitamin K.",
    citations: [
      { source: 'Essential Fatty Acids, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK564314/' },
    ],
    overallTier: 'strong',
  ...
  // naming contrast to almost everything else in this entry.
  {
    id: 'protein-overview',
    category: 'basicHealth',
    title: 'Nine of the 20 Amino Acids in Protein Are Ones the Body Cannot Build',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Marasmus and Kwashiorkor Are Two Different Diseases, Not Two Names for the Same Thing',
    ...
    summary:
      "Severe protein-energy malnutrition splits into two distinct conditions, still affecting millions of children worldwide, not a single generic 'malnutrition' picture. Marasmus results from an overall calorie deficiency (not protein specifically), producing the classic severe wasting most people picture: visible loss of fat and muscle mass, diagnosed by a specific threshold (weight-for-height more than 3 standard deviations below the mean, or a mid-upper arm circumference of 115mm or less in children 6-59 months). Kwashiorkor is a different condition, caused specifically by severe dietary protein deficiency despite adequate or near-adequate total calorie intake, and its defining sign is the opposite of what marasmus produces: bilateral body-wide edema (swelling), often with minimal or no visible wasting at all, a counterintuitive presentation that can look less severe than it is. A mixed form (marasmic-kwashiorkor) combines features of both. Both conditions involve concurrent deficiencies in iron, zinc, vitamin A, and iodine, all, compounding growth impairment, cognitive impact, and infection risk well beyond the protein/calorie shortfall alone.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Rabbit Starvation Is a Named, Potentially Fatal Syndrome From Too Much Protein and Too Little Else',
    ...
    summary:
      "Too much protein is a risk, not a theoretical one, and it has a historically documented name: rabbit starvation, first recorded among explorers and travelers eating a diet of only very lean meat (rabbit being notoriously low in fat), a potentially fatal syndrome from protein excess combined with too little fat or carbohydrate. The underlying mechanism runs through two physiological bottlenecks: the gastrointestinal tract can only absorb amino acids at a limited rate (roughly 1.3-10g per hour), and the liver's capacity to deaminate excess protein and convert the resulting nitrogen into urea for excretion is itself finite. A specific research-based threshold: protein constituting more than 35% of total energy intake is where documented adverse effects (hyperaminoacidemia, hyperammonemia, hyperinsulinemia, GI symptoms, and in severe cases the rabbit-starvation syndrome itself) start showing up. Proposed safe-maximum guidance sits at roughly 2-2.5g of protein per kilogram of body weight per day (about 176g daily for an 80kg/176lb person), well below the theoretical maximum the body's digestive/hepatic capacity could handle (285-365g daily for that same person), a substantial safety margin most people never need to think about, but a worth-knowing ceiling for anyone following an extreme high-protein diet.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Protein, Pulled Together',
    teaser: "A nutrient where 'more is better' holds for most people up to a specific, quantified point, with one direct exception.",
    summary: "Line up everything about protein and it reads as a structurally essential nutrient (9 specific amino acids the body cannot make on its own) where both extremes matter, but the shape is lopsided compared to most other nutrients: deficiency (marasmus, kwashiorkor) is severe and still globally significant, but overwhelmingly a resource/food-security problem rather than a risk facing someone with reliable access to food, while excess (rabbit starvation, a named, historically documented syndrome) requires an extreme intake, above 35% of total energy, to cause harm, a wide safety margin most people never approach. A growing research base suggests the standard RDA undershoots what older adults specifically need to preserve muscle, a different problem (insufficient targeting, not insufficient safety margin) from either extreme. The one direct exception to this whole 'more protein is generally fine' picture lives elsewhere: Chronic Kidney Disease, where an established 0.6-0.8g/kg/day ceiling, not a higher target, is the actual goal, since damaged kidneys can't clear the nitrogen waste higher protein intake produces the same way this entry's healthy-kidney safety margin assumes.",
    citations: [
      { source: 'Bilsborough S, Mann N 2006: A review of issues of dietary protein intake in humans, PMID 16779921', url: 'https://pubmed.ncbi.nlm.nih.gov/16779921/' },
    ],
    overallTier: 'strong',
  ...
  // others in this family don't share.
  {
    ...
    category: 'basicHealth',
    title: 'Thiamine Turns Carbohydrate Into Energy, and Its Deficiency Disease Is Beriberi',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Beriberi and Wernicke-Korsakoff Syndrome Are Two Faces of the Same Thiamine Deficiency',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Riboflavin (B2) Is a Low-Risk Vitamin With One Well-Evidenced Clinical Use',
  ...
  },
  {
    ...
    summary: "This is riboflavin's best-evidenced use, also covered in the Migraine category. A landmark randomized controlled trial found 400mg of riboflavin daily reduced migraine attack frequency by roughly 50% compared to placebo, with a 59% responder rate against 15% for placebo, a strong effect size for a single, cheap, well-tolerated nutrient. The proposed mechanism ties to riboflavin's core function: migraine is increasingly understood to involve mitochondrial energy-production deficits in susceptible people, and riboflavin's central role in the electron-transport chain gives it a plausible route to helping. Both the American Academy of Neurology and the American Headache Society now list riboflavin as an evidence-supported complementary migraine therapy, formal recognition from two major professional bodies.",
    citations: [
      { source: 'Supplementation with Riboflavin (Vitamin B2) for Migraine Prophylaxis in Adults and Children: A Review, PMID 26780280', url: 'https://pubmed.ncbi.nlm.nih.gov/26780280/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    id: 'niacin-overview',
    category: 'basicHealth',
    title: 'Niacin (B3) Has a Deficiency Disease That Reshaped a Diet and a Supplement Form That Comes With Risk',
  ...
  },
  {
    ...
    teaser: 'A severe deficiency disease with its documented food-preparation cause, and a dose-dependent toxicity risk confined almost entirely to supplementation.',
    summary:
  ...
  },
  {
    id: 'biotin-overview',
    category: 'basicHealth',
    title: 'Biotin (B7) Deficiency Is Rare, and Its Lab-Test Interference Is Common',
    ...
    summary: "Biotin is a required cofactor for several carboxylase enzymes central to fatty-acid, amino-acid, and glucose metabolism. Clinically significant deficiency is uncommon in the general population, occurring mainly with prolonged antibiotic use, certain anticonvulsant medications, or total parenteral nutrition (IV feeding bypassing the gut entirely), with symptoms including hair loss, a scaly rash, and, in severe cases, neurological symptoms. The more common biotin issue today is high-dose supplementation interfering with certain thyroid and other lab-test assays, covered in full in the Labs & Medication Timing category.",
    citations: [
  ...
  },
  {
    ...
    summary: "Biotin's deficiency picture is narrow and specific: rare outside a handful of identifiable causes, with raw-egg-white avidin binding as its one distinctive, well-understood dietary mechanism. The far more practically relevant biotin story for most people today isn't a deficiency at all, it's supplementation, and the Labs & Medication Timing category covers that side in depth (high-dose biotin supplements skewing certain thyroid and cardiac lab assays). Biotin has two separate stories, not one, and most people are far more likely to encounter the second.",
    citations: [
      { source: 'Biotin Deficiency, StatPearls, NCBI Bookshelf', url: 'https://www.ncbi.nlm.nih.gov/books/NBK547751/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Pantothenic Acid (B5) Is Named for the Greek Word for From Everywhere, and Deficiency Is Hard to Reach',
  ...
  // Magnesium, Vitamin D, Iron, and Zinc.
  {
    id: 'b6-overview',
    category: 'basicHealth',
    title: 'Vitamin B6 Runs Over 100 Enzyme Reactions and Has a Two-Sided Neurological Story',
  ...
  // independently verified via WebSearch.
  {
    ...
    category: 'basicHealth',
    title: "Chromium's Blood-Sugar Evidence Is Mixed, Despite How It Is Marketed",
    teaser: 'Widely sold as a blood-sugar supplement, chromium\'s evidence base is mixed, not the clean, settled story the supplement aisle implies.',
    summary:
      "Chromium is a trace mineral long theorized to enhance insulin's action at the cellular level, the basis for its wide popularity as a blood-sugar and weight-management supplement, most commonly sold as chromium picolinate. Published research states this directly: controversy exists as to whether chromium supplementation should be routinely recommended in people without a documented, confirmed deficiency, and results across well-designed clinical trials point in different directions depending on the specific population studied (lean vs. Obese, insulin-sensitive vs. Insulin-resistant). This is the starting point the more specific finding in the next entry builds on: chromium's supplement reputation runs ahead of how settled the underlying science is.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A modest supplement effect on some blood-sugar markers, with uncertain clinical significance, a moderate-tier entry in this series, not a strong or a weak one.',
    summary: "Chromium's evidence shows a modest, statistically significant effect on some insulin-resistance markers without translating into the longer-term marker (HbA1c) that matters most, and without a clear, settled answer on who benefits. Unlike magnesium, iron or zinc, it has no severe, well-characterized deficiency disease, and unlike selenium and prostate cancer (the SELECT trial's correction), it has no clean null result either. It's a minor, second-tier lever, alongside myo-inositol and Nigella sativa in the PCOS and Hashimoto's research.",
    citations: [
      { source: 'Current concepts about chromium supplementation in type 2 diabetes and insulin resistance, PMID 20425574', url: 'https://pubmed.ncbi.nlm.nih.gov/20425574/' },
    ],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Manganese Is a Required Antioxidant Cofactor Whose Risk Runs Almost Entirely on the Toxicity Side',
    teaser: 'A trace mineral needed for bone formation and the body\'s primary mitochondrial antioxidant enzyme, but deficiency is so rare it\'s barely been documented in humans at all.',
    summary:
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Manganism Is a Neurotoxic Syndrome That Looks Like Parkinson\'s Disease',
  ...
  },
  {
    id: 'copper-overview',
    category: 'basicHealth',
    title: 'Copper Partners Iron Metabolism, and Two Opposite Genetic Diseases Bear Its Name',
  ...
  },
  {
    ...
    teaser: 'A direct partner to iron metabolism, with a common, well-documented supplement-driven deficiency pathway covered in the zinc-copper research.',
    summary: "Copper's two named genetic extremes (Menkes, Wilson disease) are rare, but the far more practically relevant risk for most people is the acquired, supplement-driven deficiency covered in the zinc-copper antagonism entry: sustained high-dose zinc supplementation, often taken with good intentions for immune support or cold prevention, can quietly cause a copper deficiency with hematologic and neurological consequences. That is the likeliest way an ordinary person encounters a copper problem.",
    citations: [
      { source: 'Inherited Copper Transport Disorders: Biochemical Mechanisms, Diagnosis, and Treatment', url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3290776/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    id: 'choline-overview',
    category: 'basicHealth',
    title: 'The Body Makes Some Choline Itself, and Not Nearly Enough',
    teaser: "The liver produces some choline on its own, just not enough to meet daily needs, which is exactly why it's still classified as an essential nutrient.",
    summary:
      "Choline is an unusual nutrient: the liver can synthesize a small amount on its own, but not nearly enough to meet the body's daily requirement, which is why it's still formally classified as essential and carries its Adequate Intake value (550mg/day for men, 425mg/day for women). It serves several distinct functions: the body converts it into acetylcholine, a neurotransmitter involved in muscle contraction, pain signaling, and memory; the majority gets converted into phosphatidylcholine, the predominant structural lipid in cell membranes and a required component for packaging and exporting fat out of the liver; and it acts as a methyl donor after conversion to betaine, a direct link to the same folate-driven methylation chemistry covered elsewhere in this series.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A two-sided nutrient with evidence at both extremes: too little measurably backs up fat in the liver, and too much, sustained over decades, carries a quantified cancer-risk finding.',
    summary: "Choline is a structurally interesting nutrient in this series: partly self-made by the liver, but not enough to avoid needing dietary intake, with a well-demonstrated deficiency mechanism (impaired fat export from the liver) and a well-quantified high-intake risk (the prostate-cancer/TMAO finding covered in the Prostate Health research) sitting at opposite ends of the same nutrient, both entries together forming one complete picture.",
    citations: [
      { source: 'Choline, Health Professional Fact Sheet, NIH Office of Dietary Supplements', url: 'https://ods.od.nih.gov/factsheets/Choline-HealthProfessional/' },
    ],
    overallTier: 'strong',
  ...
  // independently verified via WebSearch.
  {
    ...
    category: 'basicHealth',
    title: 'Soluble Fiber Forms a Gel and Insoluble Fiber Stays Intact, Doing Opposite Jobs',
    ...
    summary: "Carbohydrates are the body's primary, most readily available energy source, but fiber, the carbohydrate the body can't digest, does a different job depending on its type. Soluble fiber (found in oats, barley, legumes, and many fruits) dissolves in water to form a gel that slows gastric emptying, increases satiety, and binds bile acids in the gut, directly lowering LDL cholesterol as a documented result. Insoluble fiber (found in whole grains, bran, nuts, and vegetable skins) stays structurally intact through digestion, adding bulk and speeding intestinal transit, the mechanism behind its role in digestive regularity. Soluble fiber is also the more readily fermentable of the two, meaning it's the primary substrate for the short-chain-fatty-acid production the Gut & Microbiome research covers as one of the most directly food-controllable dietary levers.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Fiber Lowers LDL, Improves Blood Sugar and Reduces Risk Across Several Major Diseases',
    ...
    summary:
      "Fiber's evidence base is broad and consistent, not confined to one narrow benefit. Soluble fiber specifically is documented to significantly reduce LDL cholesterol, an established, direct cardiovascular-risk-reduction mechanism through bile-acid binding. Research also finds inadequate fiber intake closely associated with a higher risk of cardiovascular disease, several cancers (colon cancer most prominently), gastrointestinal disorders, and type 2 diabetes, across large, population studies, not a single small trial. Fiber's effect on satiety and appetite regulation (slowed gastric emptying, a feeling of fullness) also carries systematic-review support for aiding weight management, a food-first lever rather than a supplement-dependent one.",
    citations: [
      { source: 'The Role of Dietary Fiber in Health Promotion and Disease Prevention: A Practical Guide for Clinicians, StatPearls', url: 'https://www.ncbi.nlm.nih.gov/books/NBK559033/' },
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Roughly 94% of Americans Don\'t Meet the Recommended Fiber Intake',
    teaser: 'The RDA is 25-38 grams a day depending on sex and age. Almost nobody is getting there.',
    summary:
  ...
  },
  {
    id: 'water-overview',
    category: 'basicHealth',
    title: 'Water Has No Official US Government Intake Recommendation',
  ...
  // database (fat_total/fat_monounsaturated nutrient codes).
  {
    id: 'dietfat-overview',
    category: 'basicHealth',
    title: 'Dietary Fat Carries Twice the Calories per Gram and Is Required to Absorb A, D, E, and K',
    ...
    summary:
      "Fat provides roughly 9 kcal per gram, more than double protein's or carbohydrate's 4 kcal per gram, making it the body's most energy-dense macronutrient and its primary long-term energy reserve. Beyond energy, fat is a structural building block: monounsaturated and polyunsaturated fats are integral components of every cell membrane in the body, directly affecting membrane fluidity and cell signaling. The practical fact: vitamins A, D, E, and K (all four covered in their deep-dives in this series) are fat-soluble, meaning adequate absorption requires some dietary fat present in the same meal, eating a vitamin-A-rich salad with a fat-free dressing measurably undercuts how much of that vitamin gets absorbed, a concrete reason \"pair it with a source of fat\" is an evidence-based piece of practical advice, not a vague suggestion.",
    citations: [
  ...
  },
  {
    ...
    summary: "A major meta-analysis of long-term randomized trials (11 trials, 53,300 participants) found reducing saturated fat intake cut combined cardiovascular events by a 21%. The more complicated part: that same analysis found no significant difference in benefit between replacing saturated-fat calories with polyunsaturated fat versus carbohydrate, while data specifically isolating monounsaturated fat as the replacement was too limited to draw a firm conclusion from at all. This doesn't undermine the separately well-established Mediterranean-diet and olive-oil evidence covered elsewhere (PREDIMED and its corrected re-analysis), those trials tested a whole dietary PATTERN, not monounsaturated fat as an isolated nutrient swapped in for saturated fat one-for-one, a different, and less directly comparable, kind of evidence. \"Replace saturated fat with monounsaturated fat specifically\" is a weaker, thinner evidence claim than \"eat an overall Mediterranean dietary pattern\" or \"replace saturated fat with polyunsaturated fat,\" even though popular nutrition advice often treats all three as interchangeable.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A required, energy-dense macronutrient with a practical role in vitamin absorption, and a reminder that "replace saturated fat with X" is a more complicated claim than any single headline usually allows.',
    summary: "Fat closes out this series' macronutrients on an appropriate note: an essential, energy-dense nutrient with concrete, practical consequences (fat-soluble vitamin absorption) most people never connect to their plate composition, and an evidence-based case for reducing saturated fat that gets less crisp, not more, the closer the actual trial data is examined for what specifically should replace it. The already-built Omega-3/6 balance research, food-industry history (the documented margarine-vs-butter story), and cholesterol research all connect directly to this same macronutrient, worth reading as one connected picture rather than four separate, unrelated fat-related topics.",
    citations: [
      { source: 'Dietary Fat, ScienceDirect Topics (Neuroscience)', url: 'https://www.sciencedirect.com/topics/neuroscience/dietary-fat' },
    ],
    overallTier: 'strong',
