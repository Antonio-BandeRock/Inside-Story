...
export const ESSENTIAL_NUTRIENTS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Calcium and iron have well-documented histories as levothyroxine-absorption interferers, but until a randomized crossover trial published in November 2025, magnesium's effect on levothyroxine absorption had never actually been directly studied. The quantified result: magnesium aspartate reduced levothyroxine's absorption (measured as total drug exposure, AUC) by a statistically significant 12%, while magnesium citrate produced a smaller, 7% reduction that didn't reach statistical significance in this particular trial. Magnesium aspartate also measurably lowered peak drug concentration and delayed how quickly that peak was reached. The trial's authors stated the effect is real but smaller than the already-documented effect of calcium or iron, and gave a direct clinical recommendation: hypothyroid patients should still take levothyroxine separated from magnesium-containing products, especially if a narrow TSH target matters, and if the two are taken together anyway, magnesium citrate looks like the better-tolerated choice of the two forms tested.",
    citations: [
  ...
  },
  {
    ...
    summary: "The VITAL trial, a large (25,871 participants), rigorously designed randomized controlled trial, tested a standard 2,000 IU daily dose of vitamin D3 specifically to answer whether supplementation reduces cancer or cardiovascular disease risk in people without a prior diagnosis of either. The honest result: it didn't, at least not to a statistically or clinically meaningful degree for either primary outcome, a well-powered null finding rather than a small or ambiguous trial easy to dismiss. This is worth reporting exactly as directly as a positive finding would be, and it's a direct, evidence-based reason behind this category's dedicated entry on the 2024 Endocrine Society guideline's conservative stance on supplementing healthy adults broadly. Vitamin D's well-established roles are in bone health and the specific, named groups covered elsewhere in this category, not a broad, general-purpose disease-prevention supplement for cancer or cardiovascular disease in an otherwise healthy adult.",
    citations: [
  ...
  },
  {
    ...
    teaser: "MK-7's own much longer half-life is exactly why it's the form most bone/cardiovascular-focused K2 supplements actually use, even though MK-4 has its separate, high-dose trial evidence.",
  ...
  },
  {
    ...
    teaser: "A physiological risk at the very start of life, a functional split between its two forms most people never realize exists, and an honest non-issue for everyone else except one specific, serious medication interaction.",
  ...
  // independently verified via WebSearch.
  {
    ...
    teaser: 'Widely sold as a blood-sugar supplement, chromium\'s evidence base is honestly mixed, not the clean, settled story the supplement aisle implies.',
    summary:
  ...
  },
  {
    ...
    summary: "Chromium sits in a different place from most of this series' other entries: not a nutrient with a severe, well-characterized deficiency disease (magnesium, iron, zinc), and not one with a clean null result either (the SELECT trial's honest correction on selenium and prostate cancer). Instead, chromium's evidence shows a modest, statistically effect on some insulin-resistance markers without translating into the longer-term marker (HbA1c) that matters most, and without a clear, settled answer on who actually benefits. It's a minor, second-tier lever, alongside myo-inositol and Nigella sativa in the PCOS and Hashimoto's research, neither dismissed nor oversold.",
    citations: [
      { source: 'Current concepts about chromium supplementation in type 2 diabetes and insulin resistance, PMID 20425574', url: 'https://pubmed.ncbi.nlm.nih.gov/20425574/' },
    ],
    overallTier: 'moderate',
