...
export const ESSENTIAL_NUTRIENTS_ENTRIES: DigestEntry[] = [
  ...
  // PCOS-specific spironolactone caution -- both cross-linked instead.
  {
    ...
    category: 'basicHealth',
    title: "Potassium: The Cell's Primary Positive Charge",
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Iodine's Safe Upper Range, and What Happens Past It",
  ...
  },
  {
    ...
    chart: {
      ...
      sourceNote: "This app's reference database (USDA/Japan_MEXT-sourced values); kombu-family kelp omitted as a six-figure outlier already covered in Problem Foods & Swaps",
    },
  },
  {
  ...
  },
  {
    ...
    teaser: "Biotin's deficiency is rare enough that most people will never encounter it, but a completely separate biotin issue, lab-test interference, is common and already covered in the Labs & Medication Timing category.",
  ...
  },
  {
    ...
    teaser: 'Egg yolk and liver both carry high, concentrated choline, which matters given the "how much is too much" question the prostate research already covers.',
