...
export const ESSENTIAL_NUTRIENTS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "Two More Drug Interactions Worth Knowing: Acid Reducers and Certain Antibiotics",
  ...
  },
  {
    ...
    summary: "Line up everything in this category and magnesium reads as a foundational mineral with strong evidence in some areas and honestly weaker evidence in others, worth knowing the difference between rather than treating uniformly. The well-established side: over 600 enzyme reactions, a global deficiency gap affecting roughly a third of people worldwide, a measured, if modest, blood pressure and glucose-metabolism benefit, and a brand-new 2025 finding that it measurably (if modestly) reduces levothyroxine absorption too, worth separating a levothyroxine dose from. The more honest correction: muscle cramps, probably magnesium's single most common real-world use, doesn't hold up under the best available evidence. And the practical, actionable side: tested differences between supplemental forms (glycinate's doubled absorption over oxide, citrate's usefulness for concurrent constipation), food sources pulled directly from the data, and an honest limitation in how magnesium status actually gets tested, covered directly in the self-advocacy research. Worth treating as an individually-verified deep dive rather than one flat recommendation, since \"take magnesium\" means something different depending on which specific, finding actually applies.",
    citations: [
      { source: "Magnesium, StatPearls, National Library of Medicine", url: 'https://www.ncbi.nlm.nih.gov/books/NBK519036/' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary: "Line up everything in this category and vitamin D reads as a two-sided story worth holding both halves of at once. The well-established side: a global deficiency gap affecting a majority of people by some measure, specific deficiency and toxicity thresholds worth knowing by number, a measured difference between D2 and D3 supplemental forms, and a specific reason (fat-tissue sequestration) obesity tracks with lower levels. The more honest correction: a large, rigorous 2019 trial found vitamin D didn't prevent cancer or cardiovascular disease, and a current 2024 clinical guideline recommends against routine testing and against supplementing most healthy adults under 75 above the standard target, reserving targeted supplementation for specific, named groups instead. The disease-specific vitamin D research, Hashimoto's own honestly-mixed correlation-vs-RCT picture, the gut-barrier mechanism, lupus's own sun-exposure catch-22, and more, builds directly on top of this same universal foundation rather than repeating it. Worth treating vitamin D the way this whole category treats every nutrient: important in specific, well-evidenced ways, not a single flat recommendation that applies the same way to everyone.",
    citations: [
      { source: 'Vitamin D, MedlinePlus, U.S. National Library of Medicine', url: 'https://medlineplus.gov/vitamind.html' },
    ],
    overallTier: 'strong',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Hypocalcemia: A Graded Symptom Course, and a Direct Link to Thyroid Surgery Worth Knowing',
  ...
  },
  {
    ...
    summary: "Calcium content pulled directly from the 22,022-food reference database. Tofu prepared with a calcium-based coagulant (calcium sulfate) leads by a wide margin at roughly 2,134mg per 100g, a fact specifically tied to the manufacturing process, not soy itself; tofu made with a different coagulant carries meaningfully less. Sesame seeds carry a high 1,200mg per 100g. Parmesan, a concentrated hard cheese, carries roughly 980mg per 100g, well above most other dairy. Sardines (eaten with their edible bones) carry a 240-382mg per 100g. Almonds carry a more modest 210-260mg per 100g. For context, the standard adult RDA is 1,000-1,200mg daily, meaning a serving of calcium-set tofu or sesame seeds alone can cover a substantial share of a full day's need, worth knowing directly for anyone limiting dairy for any reason.",
    citations: [],
    overallTier: 'strong',
    chart: {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin C Absorption Changes Shape at High Doses, a Distinct Mechanism Worth Knowing',
  ...
  },
  {
    ...
    summary: "Line up everything in this category and vitamin E reads as a nutrient whose story runs almost entirely through fat absorption, on both ends. Deficiency is rare from diet alone in the developed world; when it does happen, it's almost always an identifiable malabsorption condition (cystic fibrosis, cholestatic liver disease, Crohn's, abetalipoproteinemia, short-bowel syndrome) rather than simple dietary insufficiency, producing a staged neurological progression worth recognizing by its own specific signs (ataxia as the single most common finding). Toxicity, on the other end, is different in kind from most other nutrients covered in this category: not organ damage, but a three-mechanism bleeding risk that compounds directly and dangerously with warfarin, at drug-interaction doses (300mg+) well below where symptoms would otherwise appear on their own (roughly 1,000mg+). The vitamin K2 research covers a parallel warfarin interaction from the opposite direction, worth reading together as two separate, reasons anyone on blood thinners needs medical guidance before starting either supplement, not an assumption that a fat-soluble vitamin is automatically safe just because it's 'natural.'",
    citations: [
      { source: 'Vitamin E Toxicity, StatPearls, National Library of Medicine', url: 'https://www.ncbi.nlm.nih.gov/books/NBK564373/' },
    ],
    overallTier: 'strong',
  ...
  // real food-sources chart.
  {
    ...
    summary: "Vitamin K's central biochemical job is activating a specific set of proteins through a process called carboxylation, converting them into their functional, calcium-binding form. The practical split worth understanding: vitamin K1 (phylloquinone, the plant form) is used almost entirely by the liver to activate clotting factors (II, VII, IX, X), while vitamin K2 (menaquinone, the form in fermented foods and animal products) reaches tissues throughout the rest of the body and activates a different set of calcium-directing proteins, most notably osteocalcin (bone) and matrix Gla protein (soft tissue, including blood vessel walls). That functional split is exactly why the Nutrient Interactions research already covers vitamin D, K2, and magnesium as an interdependent trio for bone health specifically, not vitamin K in general: it's the K2 form doing that particular job, distinct from K1's own liver-focused clotting role.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: "The Reason Newborns Routinely Get a Vitamin K Shot, and a Rising Risk Worth Knowing",
  ...
  // independently verified via WebSearch.
  {
    ...
    summary:
      "Chromium is a trace mineral long theorized to enhance insulin's own action at the cellular level, the basis for its wide popularity as a blood-sugar and weight-management supplement, most commonly sold as chromium picolinate. Published research states this directly: controversy exists as to whether chromium supplementation should be routinely recommended in people without a documented, confirmed deficiency, and results across well-designed clinical trials point in different directions depending on the specific population studied (lean vs. Obese, insulin-sensitive vs. Insulin-resistant). This is an honest starting point worth holding onto through the more specific finding in the next entry: chromium's own supplement reputation runs ahead of how settled the underlying science actually is.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Egg yolk and liver both carry high, concentrated choline, worth knowing directly, given the "how much is too much" question the prostate research already covers.',
  ...
  },
  {
    ...
    summary: "Direct data from the 22,022-food reference database confirms the popular reputation: olive oil is the single most concentrated monounsaturated-fat source available, at roughly 70g per 100g, with almonds and whole avocado both sources at meaningfully lower concentration. Worth reading directly alongside the honest evidence entry above: a food being a concentrated source of monounsaturated fat doesn't automatically mean isolated monounsaturated-fat replacement carries the same strength of trial evidence as reducing saturated fat overall or eating a whole Mediterranean dietary pattern.",
    citations: [],
    overallTier: 'strong',
  },
  {
