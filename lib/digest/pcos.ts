...
export const PCOS_ENTRIES: DigestEntry[] = [
  {
    ...
    teaser: 'The most common hormonal condition in women of childbearing age, and a genuinely different kind of condition from every other one.',
  ...
  },
  {
    ...
    category: 'pcos',
    title: 'Myo-Inositol and D-Chiro-Inositol: A Real, Well-Studied 40:1 Ratio, Already in The Reference Data',
    teaser: 'One of the better-evidenced supplements in the whole research base for any condition, at the exact ratio a real trial found best.',
  ...
  // citation independently verified via WebSearch.
  {
    ...
    summary: "PCOS carries a real, striking comorbidity with metabolic dysfunction-associated steatotic liver disease (MASLD, already covered in real depth in the dedicated fatty-liver-disease research), worth knowing about directly rather than treating the two as unrelated diagnoses. Real, current, racially and ethnically diverse worldwide data finds MASLD in 51.56% of women with PCOS compared to 29.64% of women without it, with a real meta-analysis finding a pooled prevalence around 43% and a real, roughly 2.5-fold higher odds (odds ratio 2.54) of MASLD in PCOS. Genuinely important: real research finds this connection independent of body weight, high androgen levels and insulin resistance, PCOS's own real, already-covered core mechanisms, appear to drive liver injury directly, not merely through obesity as a middle step. Real research specifically finds women with PCOS who have hyperandrogenism (the classic phenotype) show a higher MASLD prevalence than PCOS without hyperandrogenism, even after accounting for other confounding factors. Worth knowing directly: this is a real, concrete, worth-raising reason for anyone with PCOS to ask about liver health as part of routine screening, since the already-established MASLD research (weight-loss thresholds, exercise's independent benefit, the real FIB-4 fibrosis-screening tool) applies directly and usefully to this real, common PCOS comorbidity, not just to fatty liver disease encountered on its own.",
    citations: [
