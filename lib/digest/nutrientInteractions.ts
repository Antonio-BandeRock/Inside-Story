...
export const NUTRIENT_INTERACTIONS_ENTRIES: DigestEntry[] = [
  {
    ...
    title: 'Calcium Blocks Iron Only at Higher Doses Than the Old Advice Assumes',
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin C Improves Iron Absorption, a Well-Established Synergy With One Caveat',
    teaser: 'One of the more useful food pairings for anyone managing iron levels: chemistry, not folk wisdom.',
    summary:
  ...
  },
  {
    ...
    overallTier: 'strong',
    relatedIds: ['zinc-supplement-forms-compared', 'zinc-toxicity-acute-chronic'],
  },
  {
    id: 'interaction-vitamind-k2-magnesium',
    category: 'basicHealth',
    title: 'Vitamin D, K2 and Magnesium Work as a Three-Way Team',
    teaser: 'Taking vitamin D alone, without its teammates, may not do what most people expect it to do.',
    summary:
      "Vitamin D gets taken as a standalone supplement more often than almost anything else in these pairings. The biochemistry says it was never meant to work alone. Vitamin D increases how much calcium the gut absorbs, but it's vitamin K2 that activates the proteins directing that calcium into bone rather than into arteries, and magnesium that's required to activate vitamin D itself inside the body in the first place. A systematic review of controlled trials found this combination behaves as an interdependent system for bone health outcomes: insufficient levels of any one of the three can blunt the benefit of supplementing with the other two. The practical takeaway: someone supplementing high-dose vitamin D alone, without adequate magnesium or K2 intake (magnesium from leafy greens, nuts, and seeds; K2 from fermented foods and animal fats), may be getting a meaningfully incomplete version of vitamin D's benefit.",
    citations: [
    ...
    relatedIds: ['vitamind-overview', 'magnesium-synergies-antagonists', 'calcium-absorption-mechanism', 'vitamink-overview', 'vitamink-tying-together'],
  },
  {
    id: 'interaction-selenium-iodine',
    category: 'hashimotos',
    title: 'Selenium & Iodine: Both a Synergy and an Antagonism, Depending on the Order',
    teaser: 'The single most directly thyroid-relevant nutrient interaction covered anywhere here, and it cuts both ways.',
    summary:
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin A and Zinc Are Linked by Mechanism, With Mixed Human Evidence',
    teaser: 'A biochemical dependency at the cellular level that doesn\'t always translate cleanly into a measurable human effect.',
    summary:
      "Not every interaction comes with an equally clean, actionable answer. This one is an example of biochemistry outrunning practical proof. Zinc is a required cofactor for the enzyme that converts retinol (vitamin A) into its active forms, and for the protein that transports vitamin A out of the liver into the bloodstream where it's needed. In zinc deficiency, vitamin A can measurably build up unused in the liver rather than reaching the rest of the body. The complication: despite this well-characterized mechanism, human trials have inconsistently shown zinc supplementation improving vitamin A status in practice, and the public-health significance of the interaction in otherwise well-nourished people remains unclear. Included as an example of solid biochemistry that hasn't yet cleanly translated into a proven practical recommendation.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Phytates in Grains and Legumes Block Minerals, and Traditional Food Preparation Undoes It',
    teaser: "Soaking, sprouting, and fermenting aren't just old kitchen habits. They measurably work.",
    summary: "A diet built around whole grains and legumes looks mineral-rich on paper. The amount that gets absorbed is often a different story. Phytic acid, found throughout whole grains, legumes, nuts, and seeds, binds tightly to iron, zinc, calcium, and magnesium, forming complexes the body can't absorb. The fix is what traditional food preparation does. Soaking wheat bran destroyed nearly all its phytate and raised soluble iron from under 5% to over 50% in one study. Sprouting and germinating activates the plant's phytate-degrading enzyme, cutting phytic acid by up to 87% in as little as 4 days. Combining soaking, sprouting, and fermentation together cut the phytate-to-zinc ratio by 81% and the phytate-to-iron ratio by 85% in one study. The same preparation methods recommended for other reasons solve this problem too.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Black Pepper Multiplies Turmeric\'s Absorption, a Kitchen-Level Synergy',
    teaser: 'One of the largest bioavailability boosts from any everyday food pairing ever measured: a 2000% increase in humans.',
    summary:
      "\"Add black pepper to turmeric\" sounds like exactly the kind of folk pairing that turns out, on closer inspection, to be more superstition than science. This one is the exception. Curcumin, turmeric's active compound, is poorly absorbed on its own, rapidly broken down by the liver and gut wall before it can do much. A landmark human trial found that adding just 20mg of piperine, black pepper's active compound, roughly the amount in a pinch of fresh-ground pepper, alongside curcumin increased its bioavailability by 2000%. Piperine slows the liver and gut enzymes that would otherwise break curcumin down almost immediately. A direct, checkable reason this specific pairing isn't just folk wisdom. It's one of the most dramatic, well-documented food-level bioavailability boosts in nutrition science.",
    citations: [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Nutrient Absorption Works as a System',
    ...
    summary: "The throughline of these pairings is that nutrient absorption is a system. The same food choice can help or block a completely different nutrient depending on timing and combination alone. Tea, coffee, and cocoa can cut iron absorption by up to 94% simply by being consumed too close to a meal, and moving that same cup an hour away removes nearly the entire effect, no elimination required, just timing, the same lesson the Labs & Medication Timing category reaches independently for levothyroxine. Soaking, sprouting, and fermenting measurably unlock minerals phytates would otherwise block, connecting nutrient interactions to the Fermented Foods research. The complications matter too: selenium and iodine both help and hurt each other depending on sequencing, and vitamin A and zinc's biochemistry hasn't yet translated into a clean human recommendation. Not every interaction comes with an equally clean fix. The practical habit: pay less attention to which nutrients are on the plate in isolation, and more to when and alongside what they're eaten.",
    citations: [
      { source: 'Inhibition of non-haem iron absorption in man by polyphenolic-containing beverages', url: 'https://pubmed.ncbi.nlm.nih.gov/10999016/' },
      {
        source: 'Enhancing iron and zinc bioavailability in maize through phytate reduction: the impact of fermentation alone and in combination with soaking and germination',
