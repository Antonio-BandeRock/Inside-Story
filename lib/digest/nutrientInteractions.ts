...
export const NUTRIENT_INTERACTIONS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Phytates in Grains & Legumes: A Mineral Blocker With Traditional Food Fixes',
    teaser: "Soaking, sprouting, and fermenting aren't just old kitchen habits. They measurably work.",
    summary: "A diet built around whole grains and legumes looks mineral-rich on paper. The amount that actually gets absorbed is often a different story. Phytic acid, found throughout whole grains, legumes, nuts, and seeds, binds tightly to iron, zinc, calcium, and magnesium, forming complexes the body can't absorb. A well-documented reason a diet heavy in unprocessed grains and legumes can under-deliver on mineral nutrition despite looking mineral-rich on paper. The practical fix is exactly what traditional food preparation already does. Soaking wheat bran destroyed nearly all its phytate and raised soluble iron from under 5% to over 50% in one study. Sprouting and germinating activates the plant's phytate-degrading enzyme, cutting phytic acid by up to 87% in as little as 4 days. Combining soaking, sprouting, and fermentation together cut the phytate-to-zinc ratio by 81% and the phytate-to-iron ratio by 85% in one study. A direct, evidence-backed reason the Fermented Foods research connects to mineral nutrition, not just gut health. The same traditional preparation methods already recommended for other reasons solve this problem too.",
    citations: [
      {
