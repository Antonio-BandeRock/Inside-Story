...
export const LIFESTYLE_ENVIRONMENT_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    overallTier: 'moderate',
    stageNote:
      "A single, well-designed trial with FDR-corrected statistical significance, not yet independently replicated. Group sizes ran 20 to 33 people each, meaningful but modest, not yet a settled, universal recommendation.",
  ...
  },
  {
    ...
    teaser: 'Included as a comparatively modest finding. Not every entry needs to be alarming to be worth knowing.',
    summary: "This category has covered some striking findings: a 94% reduction in iron absorption elsewhere, a counterintuitive smoking split, a drug in Phase III trials. This closing entry is a deliberately quieter one. Extended sedentary time is independently associated with modestly elevated inflammatory markers in observational research, separate from and additional to whatever formal exercise someone does elsewhere in the day, a comparatively modest finding. Included deliberately alongside this category's stronger entries as an example of a lower-confidence lifestyle factor, consistent with the standing practice of tiering every claim by its actual evidence strength rather than its intuitive plausibility.",
    citations: [
