...
export const LIFESTYLE_ENVIRONMENT_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Cortisol and the HPA axis show up, by name, across alcohol, chronic stress, sleep disruption, and high-intensity exercise (see Mitochondria & Metabolism), not as four separate warnings, but as one repeated pathway: cortisol suppresses the deiodinase enzymes that convert T4 into active T3. That single mechanism is worth understanding once, rather than as four unrelated lifestyle rules. Separately, this category's honest corrections (the coffee-and-milk antioxidant claim, sedentary behavior's comparatively modest effect) are as much the point as its strongest findings, NSAIDs and gut permeability, antibiotic disruption. Not everything commonly repeated about lifestyle and Hashimoto's holds up equally well under a direct check. The practical shape of this whole category: a handful of everyday, non-food choices (how coffee gets brewed, how food gets reheated, how consistently sleep happens, how hard a workout runs) turn out to route through the same small set of hormonal and gut mechanisms this entire Digest keeps returning to.",
    citations: [
      { source: 'Stephens & Wand 2012, Alcohol Research: Current Reviews: stress and the HPA axis (NIAAA)', url: 'https://pubmed.ncbi.nlm.nih.gov/23584113/' },
    ],
    overallTier: 'moderate',
