...
export const LIFESTYLE_ENVIRONMENT_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "TSH's diurnal rhythm is one small piece of a much bigger picture most Hashimoto's food/diet content skips entirely.",
    summary:
  ...
  },
  {
    ...
    teaser: "An emerging research area, less mature than most of the other environmental findings, and labeled as such.",
    summary: "Not every entry in the research base carries the same weight of evidence, and this one is an example of that difference. Fine particulate matter (PM2.5) exposure is an emerging area of autoimmune disease research, with some studies linking higher long-term exposure to increased autoimmune disease risk broadly, plausibly through systemic inflammatory pathways. This research area is less mature than most other entries in this category, included as an emerging signal, not an established finding on the same footing as, say, the calcium-levothyroxine interaction.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Sitting still for long stretches tracks with higher inflammatory markers on its own, separately from whatever exercise the same day includes.',
    summary: "Extended sedentary time is independently associated with modestly elevated inflammatory markers in observational research, separate from and additional to whatever formal exercise someone does elsewhere in the day. An hour at the gym does not cancel out nine hours in a chair: the two are measured as distinct exposures rather than as one activity balance. The effect size is modest and the evidence is observational, so this sits at the weak tier: it is a reason to break up long sitting stretches, not a reason to treat sitting as a cause of disease.",
    citations: [
  ...
  },
  {
    ...
    summary: "Most of the viral/infectious research works by inference, a statistical association, a plausible mechanism. This finding is more direct than that. A study examined actual thyroid tissue samples from Hashimoto's thyroiditis patients and found genetic evidence of Epstein-Barr virus (EBV, the same virus behind mononucleosis, and one of the most common viral infections in adults worldwide) present in 80.7% of samples via one marker (EBER nuclear expression), and a second, more specific marker of active viral activity (LMP1) in 34.5% of Hashimoto's tissue, compared to 0% in Graves' disease tissue from the same study, a meaningful contrast between two different autoimmune thyroid diseases, not just \"virus present somewhere near the thyroid.\" The proposed mechanism is specific too. Rather than the molecular-mimicry route covered elsewhere, the researchers suggest EBV's active infection of thyroid follicular cells directly triggers local inflammatory signaling that recruits immune cells into the tissue, a still-theoretical proposed first domino. This isn't actionable, there's nothing to do differently about a common, usually-dormant childhood/young-adult viral infection nearly everyone has already had, but it's a concrete example of how a virus can end up physically present inside the exact tissue an autoimmune disease attacks, not just statistically associated with it from a distance.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "A systematic review specifically searched for documented cases of thyroid autoimmunity connected to COVID-19 infection and found an uncommon but documented pattern: 20 cases of new or reactivated autoimmune thyroid disease following COVID-19 (14 Graves' disease, 5 Hashimoto's thyroiditis, and 1 postpartum thyroiditis). A telling detail: 8 of those 14 Graves' cases had pre-existing, previously stable thyroid disease, suggesting COVID-19 can reactivate a dormant autoimmune process, not just trigger entirely new cases. The reassuring majority finding: most affected patients reached remission within 3 months. The sobering minority: two of the documented cases were fatal (one thyroid storm, one myxedema coma), both severe complications of thyroid dysfunction left unrecognized. The review's practical recommendation is the actionable takeaway here: routinely checking thyroid function both during the acute phase of a serious COVID-19 infection and again during recovery, especially for anyone with pre-existing autoimmune thyroid disease. A reason a bout of COVID-19 is worth a follow-up thyroid check, not just monitoring for the more commonly discussed respiratory or cardiovascular effects.",
    citations: [
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: "Sleep Apnea and the Thyroid: A Documented Association, With the Mechanism Still Unsettled",
    teaser: "A connection shows up in the data. What's actually causing it is still an open question.",
    summary: "This category covers ordinary sleep disruption's link to inflammation elsewhere. Obstructive sleep apnea specifically deserves a separate look, since it's a distinct, often undiagnosed condition rather than just poor sleep habits. A recent review confirms significant epidemiological associations between obstructive sleep apnea and thyroid disorders, but states directly, in its words, that \"discrepancies and contradictory results remain\" across the studies it reviewed, and that the specific underlying mechanism connecting the two \"is not clear.\" That's an admission worth respecting rather than papering over with a tidier-sounding explanation that can't actually be verified. What's worth knowing regardless of the unsettled mechanism: sleep apnea is both underdiagnosed and treatable (typically via a standard CPAP evaluation), and given how much the research elsewhere already ties poor sleep to measurable inflammation and thyroid-hormone-conversion effects, ruling out sleep apnea specifically, not just \"trying to sleep more,\" is a concrete step worth raising with a doctor for anyone with persistent fatigue, especially alongside snoring or witnessed breathing pauses, rather than assuming every sleep-related symptom is explained by Hashimoto's alone.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Cortisol and the HPA axis show up, by name, across alcohol, chronic stress, sleep disruption, and high-intensity exercise (see Mitochondria & Metabolism), not as four separate warnings, but as one repeated pathway: cortisol suppresses the deiodinase enzymes that convert T4 into active T3. That single mechanism is worth understanding once, rather than as four unrelated lifestyle rules. Separately, this category's corrections (the coffee-and-milk antioxidant claim, sedentary behavior's comparatively modest effect) are as much the point as its strongest findings, NSAIDs and gut permeability, antibiotic disruption. Not everything commonly repeated about lifestyle and Hashimoto's holds up equally well under a direct check. The practical shape of this whole category: a handful of everyday, non-food choices (how coffee gets brewed, how food gets reheated, how consistently sleep happens, how hard a workout runs) turn out to route through the same small set of hormonal and gut mechanisms this entire app keeps returning to.",
    citations: [
      { source: 'Stephens & Wand 2012, Alcohol Research: Current Reviews: stress and the HPA axis (NIAAA)', url: 'https://pubmed.ncbi.nlm.nih.gov/23584113/' },
    ],
    overallTier: 'moderate',
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: "Hashimoto's Prevalence Tracks With Iodine Intake, and China's National Program Proved It Directly",
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: "China's Selenium-Deficient Farming Belt Is a Second National-Scale Thyroid Case Study",
    teaser: "A geographic band running northeast to southwest across China has selenium-poor soil, and Hashimoto's cited selenium research suggests this same belt likely carries an elevated thyroid-autoimmunity burden.",
    summary: "This category's iodine/China entry covers one national-scale natural experiment; a second, different one sits inside the same country. A documented selenium-deficient soil belt runs from China's northeast to its southwest, first identified because it also causes Keshan disease, a rare, selenium-deficiency heart condition discovered in Keshan County in 1935. The already-cited selenium research establishes a direct mechanism: selenium is a required component of the deiodinase enzymes and glutathione peroxidase the thyroid-hormone-conversion and antioxidant research covers, and even mild-to-moderate selenium deficiency has been linked to measurable increases in thyroid autoimmunity, with research finding an inverse relationship between blood selenium levels and autoimmune thyroiditis specifically in mildly deficient regions. Someone living inside this same documented selenium-poor belt carries a geographically-determined risk factor layered directly on top of the existing selenium research, distinct from and additional to the iodine story covered elsewhere, a second example of how a single country's uneven soil chemistry can shape thyroid-autoimmunity risk region by region, not just country by country.",
    citations: [
