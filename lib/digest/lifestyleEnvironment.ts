...
export const LIFESTYLE_ENVIRONMENT_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Every entry so far about endocrine disruptors has been about what's eaten. There's a second, completely separate route into the body that has nothing to do with food at all. Parabens and certain fragrance compounds in lotion, shampoo, and cosmetics are absorbed through skin and have their own documented endocrine-disrupting properties, a genuinely separate exposure pathway from the food-focused EDC concern above. Reading ingredient lists and choosing fragrance-free or paraben-free options where practical is a low-effort reduction step, included here specifically because the mission is food-focused, and it's worth naming directly that food isn't the only lever.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: "An emerging research area, genuinely less mature than most of the other environmental findings, and honestly labeled as such.",
