...
export const LUPUS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'lupus',
    title: 'Echinacea, and a Broader List of "Immune-Boosting" Herbs Worth Caution',
  ...
  },
  {
    ...
    category: 'lupus',
    title: "Lupus Pregnancy: A Reassuring Finding for Stable Disease, and a Specific Antibody Risk to the Baby Worth Knowing in Advance",
  ...
  // verified via WebSearch.
  {
    ...
    summary: "Drug-induced lupus is a distinct, medication-triggered illness that mimics systemic lupus erythematosus but behaves in a different, more reassuring way, it's usually fully reversible. Historical estimates put the risk as high as 20-30% for long-term procainamide use and 5-10% for hydralazine, with drug-induced cases accounting for a 6-12% of all lupus diagnoses and an estimated 15,000 to 30,000 new cases a year in the United States. The mechanism centers on how a person metabolizes these drugs: people who are genetically \"slow acetylators\" clear procainamide and hydralazine more slowly, letting the parent compound accumulate and trigger immune dysregulation, with hydralazine's own risk additionally tied to higher daily doses (above 200mg/day) and greater cumulative exposure over time. Documented host risk factors include being female, being a slow acetylator, and carrying specific genetic markers (HLA-DR4, complement C4 null alleles). Worth knowing directly, and reassuring: research finds drug-induced lupus generally resolves once the triggering medication is stopped, a meaningful contrast to the already-covered chronic, ongoing lupus management research. This is a practical, worth-raising question for anyone newly diagnosed with lupus-like symptoms while on a long-term medication, since identifying and stopping the actual trigger can mean the difference between a temporary illness and a lifelong one.",
    citations: [
  ...
  },
  {
    ...
    summary: "Complement proteins C3 and C4, part of the immune system's own normal defense machinery, are useful, and practical blood markers for tracking lupus disease activity, worth knowing directly alongside the SLEDAI scoring system already covered in the lupus research. Research finds low C3 and C4 levels commonly seen during an active lupus flare, since the disease process itself consumes these complement proteins faster than the body can replace them. Useful in practice: research finds falling C3 over the course of weeks can precede an actual clinical flare by days to weeks, giving a measurable early-warning signal before symptoms fully develop. Research also finds C3 specifically appears more sensitive than C4 for this purpose, with C3 tending to normalize with high specificity during remission, while C4 shows no comparably reliable pattern. In lupus nephritis specifically (already covered in the nephritis-monitoring research), research finds complement levels correlating directly with kidney disease activity and rising back toward normal after 6 months of effective treatment. Worth stating honestly: research also finds these traditional markers can reflect disease activity imperfectly on their own, and newer complement-based biomarkers are being studied as potentially more sensitive tools. Worth knowing directly: this is a worth-naming-by-name pair of tests to ask about as part of routine lupus monitoring, giving a complementary signal alongside symptom tracking and the SLEDAI score itself.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Lupus is often pictured as a young woman's disease, but a meaningful share of cases, 20% by one estimate, are diagnosed at age 50 or later, and this late-onset form has its own distinct clinical shape. Comparative data finds late-onset lupus produces lower disease-activity scores on average, with significantly less fever, fewer of the classic skin and mucous-membrane findings, and fewer positive antibody results than lupus diagnosed earlier in life. The practical risk this creates: late-onset lupus often lacks the textbook butterfly rash and is less likely to involve the kidneys at the outset, instead presenting as pleurisy or pericarditis (inflammation around the lungs or heart), persistent dry eyes and mouth, or joint and muscle aches that get chalked up to ordinary osteoarthritis or general wear and tear. Serologically, late-onset patients are less likely to test positive for anti-dsDNA and RNP antibodies, and more likely to test positive for rheumatoid factor, a pattern that can point evaluation toward the wrong diagnosis. Worth knowing directly: cohort data does describe a milder overall disease course with less frequent kidney involvement in this later-onset group, honest reassurance that softens, but does not erase, the risk of a slower, harder-to-recognize diagnosis in this age group.",
    citations: [
  ...
  },
  {
    ...
    summary: "This category's own already-covered belimumab and anifrolumab research targets B cells and a broad interferon pathway; litifilimab works through a more specific target, blood dendritic cell antigen 2 (BDCA2), found on the exact immune cells most directly implicated in lupus's own skin disease. Two separate, Phase 2 trials, LILAC (published in the New England Journal of Medicine) and the more recent AMETHYST, both found litifilimab meeting its primary endpoint, a significant reduction in skin disease activity, with more patients on the drug reaching clear or almost-clear skin than on placebo. It's direct significance is stated plainly by the field itself: if confirmed in larger trials, it could become the first new, innovative therapy specifically approved for cutaneous lupus erythematosus in 70 years, evidence strong enough that it has already earned FDA Breakthrough Therapy designation, a formal signal the FDA reserves for drugs showing substantial improvement over existing treatment in early testing. Worth knowing directly: this is twice-replicated Phase 2 evidence, stronger than most single-trial results covered elsewhere in the Research Horizon entries, though Phase 3 confirmation is still the next required step before approval.",
    citations: [
