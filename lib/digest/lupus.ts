...
export const LUPUS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Alfalfa sprouts and alfalfa seeds contain L-canavanine, a real, naturally occurring compound structurally similar to the amino acid arginine, closely enough that the body's own protein-building machinery can mistakenly use it in place of real arginine. The resulting proteins, containing this substituted amino acid, are recognized by the immune system as foreign, and real research in human volunteers and in cynomolgus monkeys has shown alfalfa sprout intake can induce a genuine lupus-like syndrome, complete with antinuclear antibodies, anti-dsDNA antibodies, and reduced complement levels, the same real markers the self-advocacy research already covers for actual lupus monitoring. L-canavanine has real, documented effects on immune regulatory cells, reducing normal suppressor-cell function and increasing antibody production. This is real, specific, well-established enough that a major academic lupus center recommends avoiding alfalfa in the diet of anyone with lupus, one of the very few individual foods in the entire research base with this direct and this well-documented a connection to actually triggering disease activity, rather than just a general dietary pattern.",
    citations: [
  ...
  },
  {
    ...
    summary: "Belimumab was the first medication approved specifically for lupus in more than 50 years, a real, genuinely notable gap in this disease's own treatment history, first approved in 2011 and later extended to lupus nephritis specifically, including for children. Its real, specific mechanism: belimumab is a monoclonal antibody that binds to and neutralizes BLyS (B-lymphocyte stimulator), a real signaling protein found at elevated levels in lupus, which normally helps keep antibody-producing B cells, including the misdirected ones driving lupus itself, alive. By blocking this survival signal, belimumab reduces the survival of these B cells and their differentiation into antibody-producing cells, without binding to B cells directly itself. This is worth knowing as a real, genuine treatment option beyond the more familiar older medications (hydroxychloroquine, steroids, broader immunosuppressants) covered elsewhere in the research, and a real, concrete example of lupus-specific drug development finally catching up after a real, decades-long gap.",
    citations: [
  ...
  },
  {
    ...
    summary: "Lupus's own real history moves in real, sequential steps, each building on the last. In 1846, Ferdinand von Hebra first described the disease's now-iconic facial rash as \"butterfly\"-shaped, and separately identified that lupus could stay dormant for real, extended periods, a genuinely early recognition of its own real, variable course. In 1850, Pierre Cazenave coined the term \"lupus erythemateux\" (the real origin of today's \"erythematosus\") and documented hair loss as a real symptom. The real, pivotal turning point came in 1872, when Moriz Kaposi published the first description of lupus as a genuinely systemic, potentially life-threatening disease, specifically noting it disproportionately affected young women, still true in real, modern epidemiology today. Osler independently confirmed this systemic nature in 1904. The real, modern treatment breakthrough came decades later, in 1951, when the antimalarial drug quinacrine was first used for discoid lupus, the real, direct precursor to hydroxychloroquine (already covered in the medication research), which remains one of the single most important lupus medications in use today.",
    citations: [
