...
export const LUPUS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Alfalfa sprouts and alfalfa seeds contain L-canavanine, a naturally occurring compound structurally similar to the amino acid arginine, closely enough that the body's protein-building machinery can mistakenly use it in place of arginine. The resulting proteins, containing this substituted amino acid, are recognized by the immune system as foreign, and research in human volunteers and in cynomolgus monkeys has shown alfalfa sprout intake can induce a lupus-like syndrome, complete with antinuclear antibodies, anti-dsDNA antibodies, and reduced complement levels, the same markers the self-advocacy research covers for actual lupus monitoring. L-canavanine has documented effects on immune regulatory cells, reducing normal suppressor-cell function and increasing antibody production. This is specific, well-established enough that a major academic lupus center recommends avoiding alfalfa in the diet of anyone with lupus, one of the very few individual foods in the entire research base with this direct and this well-documented a connection to actually triggering disease activity, rather than just a general dietary pattern.",
    citations: [
  ...
  },
  {
    ...
    category: 'lupus',
    title: 'Vitamin D Supplementation in Lupus: An Inconsistent Trial Record',
  ...
  },
  {
    ...
    summary:
      "A meta-analysis pooling five randomized controlled trials (274 SLE patients total) found omega-3 fatty acid supplementation associated with a statistically significant reduction in disease activity, equivalent to about a 0.9-point drop on the standard SLEDAI disease-activity scale, alongside individual trial findings of improved fatigue, quality of life, and endothelial function. The meta-analysis's authors rate the certainty of this evidence as low, since the individual trials were small and varied in quality. A different, separate line of research complicates the picture further: a Mendelian randomization study, using genetic variants as a different tool for testing cause and effect rather than a supplementation trial, found genetically predicted higher circulating omega-3 levels causally associated with an increased risk of developing lupus in the first place. These are two different questions, whether omega-3 helps someone who already has lupus (the trial evidence, cautiously positive) versus whether higher lifetime omega-3 levels affect the risk of developing lupus at all (the genetic evidence, pointing the other way), and both deserve stating rather than picking the more flattering one.",
    citations: [
  ...
  },
  {
    ...
    category: 'lupus',
    title: 'Hydroxychloroquine: An Eye Exam Schedule for the Field\'s Preferred Lupus Medication',
  ...
  },
  {
    ...
    category: 'lupus',
    title: "Lupus Affects Skin in 70-85% of Patients, Plus the Nervous System and Clotting",
  ...
  },
  {
    ...
    category: 'lupus',
    title: "Lupus's History: Named for a Rash, Understood as Systemic Only After Three Sequential Discoveries",
  ...
  },
  {
    ...
    teaser: "Research finds stable, well-controlled lupus carries a low flare risk during pregnancy, but two specific antibodies (anti-Ro/anti-La) carry a separate risk directly to the baby's heart.",
    summary: "Lupus pregnancy outcomes trace closely to disease control going into it, the same preconception-timing principle covered in the Rheumatoid Arthritis and IBD research. Research finds that when lupus is stable before conception, pregnancy is unlikely to trigger a flare at all; even among a broader population, severe flares requiring hospitalization or a major medication change occurred in only about 3% during the second and third trimesters. Separate risks still deserve direct attention: roughly 2 in 10 pregnant people with lupus develop preeclampsia, with higher risk specifically in those with a history of kidney involvement (covered in the nephritis-monitoring research). The most specific and important finding to know in advance: anti-Ro/SS-A and anti-La/SS-B antibodies, specific antibodies some lupus patients carry, can cross the placenta and cause neonatal lupus in the baby, including, in serious cases, a congenital heart block requiring lifelong monitoring or even a pacemaker. This is a direct reason antibody status (not just disease-activity score) belongs in preconception planning, since it changes the entire monitoring plan for the pregnancy that follows.",
    citations: [
  ...
  },
  {
    ...
    category: 'lupus',
    title: "Long-Term Steroid Treatment Carries a Bone-Health Cost, and a Normal Scan Doesn't Rule It Out",
  ...
  },
  {
    ...
    summary:
      "This category's research covers belimumab, the first lupus-specific biologic in over 50 years, targeting a B-cell survival signal. Anifrolumab is a different, more recently approved biologic, targeting a separate part of the immune system entirely: the type I interferon receptor, blocking a signaling pathway that's specifically overactive in a large share of lupus patients. Its landmark trial (TULIP-2), a randomized, placebo-controlled study of 362 patients, found 47.8% of the anifrolumab group reached a validated composite measure of improvement (BICLA response) at 52 weeks, compared with 31.5% on placebo, a statistically significant difference. Anifrolumab was FDA-approved in 2021 based on this and a companion trial, and more recently gained approval as a more convenient once-weekly self-administered injection rather than only an infusion. Having two mechanistically different biologic options (belimumab targeting B cells, anifrolumab targeting interferon signaling) matters, since lupus itself varies person to person in which immune pathway is driving the most disease activity, and a doctor can help match a specific medication to a specific person's disease pattern rather than treating every biologic option as functionally interchangeable.",
    citations: [
  ...
  },
  {
    ...
    category: 'lupus',
    title: "A New Drug Could Become the First Advance for Lupus's Skin Symptoms in 70 Years",
  ...
  },
  {
    ...
    summary:
      "The skin, joint, kidney, and blood findings are all measurable, but cohort research consistently finds fatigue is the single most commonly reported lupus symptom of all, with 53 to 80 percent of patients naming it as a primary concern across multiple studies, and one Malta-based cohort finding 56.5 percent scoring in the abnormal-fatigue range on a validated scale. The counterintuitive finding: a large multiethnic cohort study (the LUMINA cohort, 515 patients across 2,609 visits) found fatigue was NOT associated with standard disease-activity or organ-damage scores, the same measures covered elsewhere in this category for tracking lupus's severity. Instead, research found fatigue tracked more closely with pain, feelings of helplessness, and constitutional symptoms, and a separate, well-documented bidirectional relationship with poor sleep and depression, both. This means a lupus patient can have fatigue severe enough to be disabling while lab work and standard disease-activity scores look reassuring, evidence that fatigue deserves direct attention and treatment, not dismissal just because bloodwork doesn't explain it.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The nephritis monitoring names progression risk, current transplant data finds patient survival matching non-lupus transplant recipients, with a low recurrence rate.",
    summary:
      "The lupus nephritis and ISN/RPS staging research names serious kidney damage risk, and for the minority who progress to end-stage kidney disease, transplant outcomes have transformed. Current data directly contradicts an older assumption that lupus made transplant too risky: one study found patient survival at 98 percent at 1, 10, and even 15 years post-transplant, statistically comparable to age- and sex-matched controls without lupus, and a separate cohort found graft survival rates of 98, 98, 88, 85, and 78 percent at 1, 5, 10, 15, and 20 years respectively. Research directly explains why survival improved: transplant itself was found to carry a survival benefit over remaining on dialysis, driven mainly by reduced cardiovascular and infection-related deaths, both covered elsewhere in this category as lupus complications. The worth-knowing caveat: a systematic review and meta-analysis found lupus nephritis transplant recipients showing somewhat lower survival than transplant recipients with other causes of kidney failure, particularly with deceased-donor kidneys, context rather than an unqualified success story. A reassuring, additional finding: lupus nephritis actually recurring in the new, transplanted kidney is rare, just 0.94 percent per person-year. Transplant, once viewed with caution in lupus specifically, is now current, guideline-supported best practice for eligible patients with end-stage lupus nephritis.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The hydroxychloroquine-retinopathy entry names a rare eye-safety risk from long-term use, the drug's quantified flare-prevention benefit is tied to how consistently it's actually taken, and data finds adherence a common problem.",
    summary:
      "The hydroxychloroquine-retinopathy research names a rare, monitorable safety risk from this same drug's long-term use, and the direct flare-prevention benefit deserves direct coverage, alongside the problem of adherence that can undercut it. Evidence finds hydroxychloroquine reduces major lupus flares by a substantial 57 percent, one of this disease's most consistently demonstrated treatment effects, and research finds an even more specific, actionable detail: lower hydroxychloroquine blood levels track with a two-to-six-fold higher risk of a flare, meaning the benefit is dose- and consistency-dependent, not an all-or-nothing effect of simply being prescribed the drug. The complication: adherence to hydroxychloroquine is a well-documented, common clinical problem, with research finding poor adherence declining further over just the first year of use, and Medicaid-beneficiary data confirming this pattern directly. Research names the practical stakes plainly: poor adherence is associated with a higher risk of flares, disease-related morbidity, hospitalizations, and worse kidney outcomes specifically, serious consequences from something as simple as inconsistent pill-taking. A more actionable finding follows directly from this: monitoring hydroxychloroquine BLOOD LEVELS directly, rather than assuming a prescription equals consistent use, is a practical way to catch and correct low adherence before a flare happens. This well-established drug's benefit depends on consistent use, worth a direct conversation about any barriers to taking it as prescribed, not just whether it was originally prescribed at all.",
    citations: [
  ...
  // WebSearch.
  {
    ...
    summary: "Lupus is one of the three autoimmune conditions the Health Literacy hormones research names as most directly studied for leptin's pro-inflammatory role, and this is the specific study behind that. Leptin is documented as abnormally elevated in lupus, and in a study using lupus-prone mice, leptin directly promoted the survival and proliferation of autoreactive T cells (the ones that attack the body's own tissue) while suppressing regulatory T-cell activity, the same Th17-promoting, Treg-suppressing mechanism covered in the shared hormones research, demonstrated here specifically in a lupus disease model rather than just observed as a correlation. This doesn't mean body fat causes lupus, lupus is an autoimmune disease with its genetic and environmental triggers, only that leptin is one mechanistically demonstrated input into how aggressively an already-present lupus immune response runs.",
    citations: [
