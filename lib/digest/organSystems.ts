...
export const ORGAN_SYSTEMS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "The prior entry honestly notes hypothyroid \"brain fog\" isn't fully mapped mechanistically yet. One real, specific, and directly demonstrated piece of that mechanism does exist, covered here as its entry rather than folded into the broader, more general Basic Health neurogenesis topic, since this connection is specific enough to Hashimoto's core mechanism (hypothyroidism) to deserve its direct coverage. A real study found that inducing hypothyroidism in adult rats reduced hippocampal progenitor cell proliferation by roughly 30 percent, along with a decline in the number of young, developing neurons and reduced complexity of their connections, changes that directly correlated with a measurable depressive-like behavior in the same animals. The genuinely encouraging, practical part of this finding: this reduction is fully reversible, restoring normal thyroid hormone levels reverses the reduced proliferation back toward normal. The actual molecular mechanism has since been worked out in real detail: active thyroid hormone (T3) functions as what researchers describe as a genuine \"neurogenic switch,\" directly suppressing specific genes (Sox2, CyclinD1, c-Myc) that keep neural stem cells in a dividing, undifferentiated state, pushing them instead toward becoming mature, functioning neurons. This gives hypothyroid \"brain fog\" a real, specific, and reversible biological mechanism, not just a vague, unmeasurable complaint, and it's a direct, concrete reason consistent thyroid management matters for more than lab numbers alone.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Thyroid hormone doesn't act on one organ. It regulates cellular metabolism nearly everywhere in the body, which is exactly why Hashimoto's shows up in the liver, heart, brain, kidneys, muscles, skin, and reproductive system all at once, not because the disease is spreading, but because one hormone deficit touches that many metabolic processes simultaneously. The encouraging thread running through this whole category: most of these organ-level effects are documented as reversible with treatment (liver enzymes normalizing within months, kidney filtration rate recovering, coronary microvascular function improving, hair and muscle symptoms resolving) because the underlying cause in each case is often the shared hormone deficit itself, not separate, independent organ damage. The liver gets the most attention here for a reason: it does the largest single share of the body's own T4-to-T3 conversion, making it less a bystander and more a second organ actually running the thyroid's own job.",
    citations: [
      {
        source: 'Role of hepatic deiodinases in thyroid hormone homeostasis and liver metabolism, inflammation, and fibrosis (European Thyroid Journal)',
        url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC10160546/',
