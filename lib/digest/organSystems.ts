...
export const ORGAN_SYSTEMS_ENTRIES: DigestEntry[] = [
  {
    ...
    category: 'hashimotos',
    title: 'The Liver Runs Much of Thyroid Hormone Production',
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'The Heart: Coronary Risk, and a Treatable Reason Why',
    teaser: "A nationwide cohort study found higher coronary heart disease risk in Hashimoto's, and treatment measurably lowers it.",
    summary:
      "Thyroid disease and heart disease can seem like two unrelated systems, one hormonal, one mechanical. The research says the connection is closer, and more actionable, than that assumption suggests. A large nationwide cohort study found people with Hashimoto's thyroiditis carry a higher risk of coronary heart disease than the general population, and separately, both subclinical and overt hypothyroidism are linked to worsening cholesterol levels and impaired coronary microvascular function as TSH rises. The encouraging half of this finding: L-thyroxine treatment measurably improves coronary microvascular function and is associated with reduced coronary heart disease risk. A treatable contributor to cardiovascular risk, not a fixed one.",
    citations: [
      {
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'The Specific Mechanism Behind "Brain Fog": Thyroid Hormone Directly Controls New-Neuron Growth',
    ...
    summary:
      "The prior entry notes hypothyroid \"brain fog\" isn't fully mapped mechanistically yet. One specific, directly demonstrated piece of that mechanism does exist, covered here as a separate entry rather than folded into the broader, more general Basic Health neurogenesis topic, since this connection is specific enough to Hashimoto's core mechanism (hypothyroidism) to deserve direct coverage. A study found that inducing hypothyroidism in adult rats reduced hippocampal progenitor cell proliferation by roughly 30 percent, along with a decline in the number of young, developing neurons and reduced complexity of their connections, changes that directly correlated with a measurable depressive-like behavior in the same animals. The encouraging, practical part of this finding: this reduction is fully reversible, restoring normal thyroid hormone levels reverses the reduced proliferation back toward normal. The actual molecular mechanism has since been worked out in detail: active thyroid hormone (T3) functions as what researchers describe as a \"neurogenic switch,\" directly suppressing specific genes (Sox2, CyclinD1, c-Myc) that keep neural stem cells in a dividing, undifferentiated state, pushing them instead toward becoming mature, functioning neurons. This gives hypothyroid \"brain fog\" a specific, reversible biological mechanism, not just a vague, unmeasurable complaint, and it's a direct, concrete reason consistent thyroid management matters for more than lab numbers alone.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Fatigue and low blood pressure alongside Hashimoto's usually get attributed to the thyroid by default. Sometimes there's a second, separate autoimmune process hiding behind the same symptoms. Distinct from the HPA-axis/cortisol-dysregulation mechanism covered under Lifestyle & Environment (which is about ordinary chronic stress, not autoimmunity), a separate autoimmune process can directly attack the adrenal glands in someone who already has Hashimoto's. The combination is a recognized clinical entity, Autoimmune Polyglandular Syndrome Type 2, historically \"Schmidt syndrome,\" first described in 1926, diagnosed when at least two of primary adrenal insufficiency (Addison's disease), autoimmune thyroid disease, and type 1 diabetes occur together. In one cohort of 151 APS-2 patients, roughly a third had Hashimoto's specifically as their thyroid component. An uncommon but reason unexplained fatigue or low blood pressure alongside Hashimoto's is worth an adrenal-function conversation with a doctor, not just attributed to the thyroid alone by default.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A meta-analysis found higher depression and anxiety rates in Hashimoto\'s patients whose thyroid levels are already normal on treatment, not just in people who are actively hypothyroid.',
    summary:
      'A systematic review and meta-analysis (694 Hashimoto\'s patients vs. 671 controls, 11 pooled studies) found euthyroid Hashimoto\'s patients, people whose TSH and thyroid hormone levels are already normal on treatment, still showed a higher rate of anxiety and depression symptoms than matched healthy controls. Some research finds this risk tracks specifically with higher anti-TPO antibody levels, suggesting the underlying autoimmune process itself, not just hormone levels, may be doing some of this work, with neuroinflammation proposed as one plausible mechanism (a mouse study found neuroinflammation and emotional changes in euthyroid Hashimoto\'s mice specifically). The current evidence is mixed, not settled: a separate, large study of 2,897 euthyroid adults found no significant depression-score difference by antibody status at all. The practical takeaway either way: a normal TSH result doesn\'t automatically rule out a connected mood symptom, even when the labs themselves look fully controlled.',
    citations: [
