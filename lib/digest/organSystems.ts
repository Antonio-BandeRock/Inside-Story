...
export const ORGAN_SYSTEMS_ENTRIES: DigestEntry[] = [
  {
    ...
    summary:
      "It would be reasonable to assume the thyroid gland does the real work of making thyroid hormone, start to finish. It doesn't -- not even close. Only about 20% of circulating T3, the active thyroid hormone the body actually uses, comes directly from the thyroid gland itself. The remaining 80% is produced by deiodinase enzymes converting T4 into T3 elsewhere in the body, and the liver's own type 1 deiodinase (DIO1) is the most abundant deiodinase of them all -- making the liver one of the two or three largest real contributors to how much active thyroid hormone actually reaches the body's cells. A liver under real metabolic stress isn't just a bystander to Hashimoto's. It's one of the organs directly responsible for finishing the job the thyroid gland only starts.",
    citations: [
      {
  ...
  },
  {
    ...
    teaser: 'Up to 55% of untreated hypothyroid patients show real, measurable liver enzyme abnormalities -- through two distinct, real mechanisms.',
    summary:
      'A hypothyroidism diagnosis rarely comes with a warning about the liver. It probably should. Thyroid hormone directly regulates the structural integrity of liver cell membranes -- in hypothyroidism, altered membrane lipid composition and reduced sodium-potassium pump activity make liver cells measurably "leakier," allowing liver enzymes (ALT, AST) to escape into the bloodstream even without real cell death taking place. A second, separate mechanism compounds it: reduced hepatic blood flow creates a mild, chronic oxygen-deprived state in the liver, adding real cellular stress on top of the membrane effect. Both mechanisms are genuinely reversible: correcting the underlying hypothyroidism with appropriate levothyroxine therapy normalizes liver enzymes in the large majority of patients within 3-6 months. Damage, in this specific case, isn\'t the same thing as permanent damage.',
    citations: [
  ...
  },
  {
    ...
    summary:
      "Fatty liver disease and thyroid disease can sound like two unrelated diagnoses landing on the same unlucky person by coincidence. Real, large-scale data says otherwise. A 2025 UK Biobank cohort study found hypothyroidism associated with 1.68 times higher odds of MASLD -- metabolic dysfunction-associated steatotic liver disease, the current clinical name for what used to be called NAFLD -- with metabolic disturbance (insulin resistance, dyslipidemia) accounting for about 41% of that risk. A real but partial mechanism, not the whole story. The underlying reason for the rest: thyroid hormone directly regulates how the liver processes fat, and reduced thyroid hormone availability shifts the liver toward storing triglycerides rather than burning them, favoring fat accumulation in liver cells over time. Not a coincidence, and not simply \"both diseases happen to be common\" -- a real, measured, mechanistically explained connection.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "Everything in this liver sequence so far has run one direction: thyroid disease affecting the liver. Real intervention studies show the relationship actually runs both ways. A 6-month lifestyle intervention producing a greater reduction in intrahepatic (liver) fat was directly linked to better oxidative-stress and inflammatory-marker outcomes in NAFLD patients. Separately, and just as tellingly, 15 months of levothyroxine treatment in patients with both NAFLD and subclinical hypothyroidism cut the prevalence of fatty liver disease by almost half. Real, bidirectional evidence that a genuinely healthier liver and a genuinely better-managed thyroid reinforce each other, rather than being two separate, unrelated problems that happen to share a patient -- a real, concrete reason gut- and liver-supportive eating, this app's own core focus, is directly relevant to thyroid outcomes, not just a general wellness gesture.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Thyroid disease and heart disease can seem like two unrelated systems, one hormonal, one mechanical. The real research says the connection is closer, and more actionable, than that assumption suggests. A large, real nationwide cohort study found people with Hashimoto's thyroiditis carry a genuinely higher risk of coronary heart disease than the general population, and separately, both subclinical and overt hypothyroidism are linked to worsening cholesterol levels and impaired coronary microvascular function as TSH rises. The real, encouraging half of this finding: L-thyroxine treatment measurably improves coronary microvascular function and is associated with reduced coronary heart disease risk -- a real, treatable contributor to cardiovascular risk, not a fixed one.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "Kidney function doesn't usually come up in a conversation about thyroid disease. A large, real population study suggests it should. A real, large cross-sectional study of 74,356 adults found average kidney filtration rate (eGFR) declining stepwise from euthyroid (88.0) to subclinical hypothyroid (83.5) to overt hypothyroid (72.2) -- a real, measurable, dose-graded relationship, not just a loose association. Real case reports and pediatric studies both confirm this is genuinely reversible: kidney function documented to normalize once the underlying thyroid dysfunction is corrected with treatment, making unexplained creatinine elevation or proteinuria a real, worthwhile reason to screen thyroid function specifically.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "Thyroid autoimmunity's connection to fertility difficulty is one of the more directly consequential findings in this whole category -- and one of the more genuinely complicated to act on. It's genuinely linked to real reproductive difficulty through several distinct mechanisms: subtle thyroid hormone imbalance, reduced ovarian reserve, altered endometrial receptivity, and the autoimmune process itself -- with real data showing anti-thyroid-antibody-positive women carry a 2 to 4 times higher risk of miscarriage and preterm delivery. The real, honest complication: several real studies have found levothyroxine treatment alone is no more effective than placebo at correcting these obstetric outcomes in antibody-positive women who are otherwise thyroid-hormone-normal. That means antibody positivity itself, not just measurable hormone deficiency, appears to be doing real independent harm that hormone replacement alone doesn't fully address -- a genuinely open problem, not a solved one.",
    citations: [
      {
  ...
  },
  {
    ...
    summary:
      "Muscle aches and weakness rarely make anyone's shortlist of classic thyroid symptoms. The real research says they probably should. Hypothyroid myopathy -- real muscle weakness, aching, and stiffness, typically affecting the muscles closest to the trunk -- shows up in a genuinely wide 30 to 80 percent range of hypothyroid patients depending on severity. Real case reports document creatine kinase, a muscle-damage marker, rising into the tens of thousands in severe, undiagnosed cases -- occasionally severe enough to initially look like a primary muscle disease rather than a thyroid problem at all. Real, direct confirmation of reversibility: thyroid hormone replacement resolves both the clinical weakness and the elevated CK level in documented cases, underscoring unexplained muscle pain or weakness as a real, worthwhile reason to check thyroid function specifically.",
    citations: [
