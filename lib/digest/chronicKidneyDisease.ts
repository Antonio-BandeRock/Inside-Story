...
export const CHRONIC_KIDNEY_DISEASE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Beyond the protein, sodium, and mineral concerns this category already covers, research finds a symptom that's common but often goes unrecognized as CKD-related at all: chronic kidney disease-associated pruritus, persistent, whole-body or localized itching with no other clear skin cause. Prevalence data finds it affecting roughly 20 percent of people with earlier-stage CKD, climbing to 40 percent (and, in some studies, up to 80 percent) of people on hemodialysis, with roughly 40 percent of dialysis patients reporting the itching as moderate to severe rather than mild. The direct mechanism isn't fully settled, but it's now understood to involve systemic changes, an imbalance in the body's opioid-receptor signaling, low-grade inflammation, and mineral/bone changes already covered elsewhere in this category, not simply dry skin. The practical stakes go beyond comfort: research directly links CKD-associated pruritus to worse sleep quality, and the itching itself is independently associated with a higher mortality risk in dialysis patients. This is a name-able, discussable symptom, not something to quietly tolerate as an unavoidable part of kidney disease, and dedicated treatments (including an FDA-approved medication specifically for it) now exist.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's already-covered anemia entry names iron deficiency as a common driver, head-to-head trials find intravenous iron correcting it faster and more reliably than oral iron pills in non-dialysis CKD.",
    summary:
      "This category's already-covered anemia and erythropoietin research names iron deficiency as a common contributor, and controlled trials directly comparing how to correct it find a consistent gap between two delivery methods. The FIND-CKD trial, a 56-week, 626-patient randomized study, compared intravenous ferric carboxymaltose against oral iron in non-dialysis CKD patients with iron-deficiency anemia and found the IV group reached higher hemoglobin levels faster and required fewer additional treatments, evidence of an efficacy gap, not just a convenience difference. A separate 351-patient trial comparing iron isomaltoside against oral iron sulfate found the IV formulation not just non-inferior but superior in sustained hemoglobin increase from week 3 through the end of the 8-week study. The likely mechanism connects directly to this category's already-covered gut research: CKD's inflammatory state can impair how well the gut actually absorbs oral iron, meaning a pill that works fine for iron deficiency in a healthy gut may simply not be absorbed as reliably once kidney-disease-related inflammation is present. Alongside this advantage, oral iron remains a reasonable first option for milder deficiency given its lower cost and no infusion visit required, but trial evidence supports asking directly about IV iron when oral iron isn't correcting anemia as expected, rather than assuming a higher oral dose alone will eventually work.",
    citations: [
  ...
  },
  {
    ...
    teaser: "This category's already-covered NSAID and contrast-dye research names specific medication risks, a 49-study systematic review across 23 countries finds a much broader problem: renally-excreted drugs prescribed without proper dose adjustment, affecting up to 81% of hospitalized CKD patients in some settings.",
    summary:
      "This category's already-covered NSAID and contrast-induced-nephropathy research already names specific medication risks, and a much broader problem, medications prescribed at a standard dose without accounting for reduced kidney clearance, deserves direct coverage. A systematic review of 49 studies across 23 countries found inappropriate prescribing of renally-excreted drugs (medications the kidneys are meant to clear, which can accumulate to dangerous levels when kidney function is reduced) common across every care setting studied: 9.4 to 81.1 percent in hospital settings, 13 to 80.5 percent in ambulatory (outpatient) care, and 16 to 37.9 percent in long-term care facilities. This is a wide range reflecting variation across different studies and populations, but even the low end represents a meaningful share of patients affected. The serious stakes: the same review found inappropriate prescribing associated with increased hospital stays and a 40 percent higher mortality risk, a serious consequence from something as preventable as a standard, unadjusted dose. Matching this category's already-covered example (opioid accumulation in end-stage kidney disease requiring dose reduction), this is a systemic, common problem, not a rare prescribing mistake, worth directly and proactively asking any new prescriber whether a given medication's dose has been checked against current kidney function (eGFR, already covered elsewhere in this category's self-advocacy research), rather than assuming every prescription automatically accounts for it.",
    citations: [
