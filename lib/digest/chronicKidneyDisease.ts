...
export const CHRONIC_KIDNEY_DISEASE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'chronicKidneyDisease',
    title: 'Blanket Potassium Restriction: A Correction to Some of the Most Common CKD Dietary Advice',
    ...
    summary:
      "Restricting high-potassium foods (bananas, oranges, potatoes, tomatoes) is some of the most commonly repeated dietary advice given to CKD patients, and a direct check of the evidence behind it turns up a surprise: a 2017 review conducted for clinical guidelines found no actual trials evaluating dietary potassium restriction for managing hyperkalemia in CKD, and separate, more recent observational research found no association between dietary potassium intake and blood potassium levels in CKD populations at all. The 2020 KDIGO guidelines themselves went so far as to state the evidence was insufficient to support a graded recommendation either way. An emerging, more specific picture has taken its place: some research now suggests a liberalized, plant-based, high-fiber dietary pattern may actually support healthier potassium regulation, since dietary fiber and other food-matrix factors can help shift potassium into cells and increase its excretion through the bowel rather than the kidneys. This is not a claim that potassium never matters in CKD, hyperkalemia is a serious risk, especially in more advanced disease or when combined with certain medications (see this category's dedicated entry). It's a correction: the specific, individual amount of dietary potassium restriction that's actually appropriate varies by person and by how advanced someone's CKD is, and a blanket \"avoid these foods\" list isn't well supported as a universal rule.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Low-protein diets are a standard part of managing moderate-to-advanced CKD, with research linking them to reduced proteinuria, better blood pressure control, and a slower decline in kidney function in both diabetic and non-diabetic CKD. The specific, commonly recommended range is 0.6 to 0.8 grams of protein per kilogram of body weight per day, a meaningful reduction from typical intake, not just a vague \"cut back\" suggestion. A more recent and specific finding adds a further layer: research comparing plant-based to animal-based low-protein diets finds plant-based approaches superior on several measured outcomes in advanced CKD, better nitrogen balance, better acid-base regulation, fewer uremic toxins produced, and a more favorable ratio of unsaturated to saturated fat. An ongoing randomized trial (the PLADO protocol) is specifically testing a plant-dominant low-protein diet (at least half of protein from plant sources) against standard renal-diet care in CKD stages 3 through 5. A low-protein diet done well is a specific, structured intervention, best undertaken with a dietitian's guidance given the risk of malnutrition if protein is reduced without enough total calories or the right food choices to fill the gap.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "SGLT2 inhibitors (a class of medication originally developed to lower blood sugar in type 2 diabetes) turned out to carry an independent, significant kidney-protective effect of their own, one of the more important recent developments in CKD treatment. The CREDENCE trial found canagliflozin reduced the combined risk of kidney failure, doubling of creatinine, or kidney/cardiovascular death by 30% in CKD patients with type 2 diabetes, the first SGLT2 inhibitor trial specifically built around a kidney-disease outcome. The landmark DAPA-CKD trial then found dapagliflozin produced a 39% relative risk reduction in kidney-disease progression, and, notably, this benefit held in CKD patients without diabetes too, not just those with it, meaning the kidney-protective effect is independent of the drug's original blood-sugar-lowering purpose. Further trials (EMPA-KIDNEY) have since confirmed this same kidney benefit with a second drug in the same class. This marks a major recent shift: the medication class is now recommended kidney-protective therapy in its own right for many CKD patients, not just a diabetes medication that happens to also help the kidneys as a side benefit.",
    citations: [
  ...
  // independently verified via WebSearch.
  {
    ...
    teaser: "The KDIGO \"heat map\" combines a G-stage (1 through 5) with an A-stage (1 through 3) into a color-coded risk zone, both numbers, not just one.",
    summary: "CKD's staging goes further than the eGFR/ACR monitoring covered in the self-advocacy content: KDIGO's classification combines a GFR category (G1: eGFR 90+; G2: 60-89; G3a: 45-59; G3b: 30-44; G4: 15-29; G5: under 15 or on dialysis) with an albuminuria category (A1: under 30 mg/g; A2: 30-300; A3: over 300) into a formal grid. In the KDIGO \"heat map\", rather than either number alone, the COMBINATION lands in a color-coded risk zone (green, yellow, orange, or red) that independently predicts all-cause mortality, cardiovascular mortality, kidney failure, and acute kidney injury risk better than eGFR alone. A practical example: someone with a normal G1 eGFR but high A3 albuminuria already sits in the orange zone, elevated risk despite a filtration number that might otherwise look reassuring on its own, a direct reason both numbers matter together, not just the one more commonly discussed.",
    citations: [
  ...
  },
  {
    ...
    category: 'chronicKidneyDisease',
    title: "CKD's Reach Into Bone and Heart: A 3-Fold Fracture Risk and a 10-Fold Cardiovascular Risk",
  ...
  },
  {
    ...
    category: 'chronicKidneyDisease',
    title: "CKD's History: A Machine Built From Sausage Casings and a Washing Machine, During Wartime Scarcity",
    teaser: "1943, 1960, before dialysis existed, a CKD diagnosis was a near-certain death sentence; Willem Kolff's improvised wartime invention changed that.",
    summary:
      "Before 1943, advanced CKD was almost universally fatal, with no treatment able to do the kidneys' own job once they failed. Dutch physician Willem Kolff, after watching a young patient die slowly of kidney failure, spent the late 1930s developing an artificial kidney, and during wartime material scarcity, built his working device from improvised parts: sausage-casing cellophane tubing (20 meters of it), orange juice cans, and a washing-machine mechanism. In March 1943, using this improvised device, patient Janny Schroder became one of the first people treated, regaining consciousness from a uremic coma on April 4, 1943, the first documented recovery via hemodialysis. Kolff's device still had a serious limitation: it required sacrificing a blood vessel for every single treatment, making repeated, ongoing dialysis impractical. That problem wasn't solved until 1960, when Wayne Quinton and Belding Scribner developed a reusable vascular access method in Seattle, the final piece that made CHRONIC (not just emergency) dialysis possible, opening the door to the ongoing kidney-replacement therapy still used today.",
    citations: [
  ...
  },
  {
    ...
    summary: "Chronic kidney disease has a direct gut-microbiome connection that goes beyond diet alone: two specific compounds, indoxyl sulfate and p-cresyl sulfate, are gut-bacteria-manufactured uremic toxins, produced when certain gut bacteria (from families like Enterobacteriaceae and Clostridiaceae) ferment protein, and they accumulate in the blood as declining kidney function loses the ability to clear them. Research finds their accumulation directly promotes oxidative stress, systemic inflammation, and endothelial dysfunction, contributing to vascular damage and elevated cardiovascular risk in CKD, connecting directly to the CKD cardiovascular-risk research. A related finding: CKD patients also show reduced levels of beneficial bacteria families, including Lactobacillaceae and Bifidobacteriaceae, the same bacterial families covered favorably elsewhere in the gut-microbiome and fermented-foods research, alongside the rise in toxin-producing bacteria. Emerging interventions being studied to modulate this gut-kidney axis include dietary changes, prebiotics, probiotics, and fecal microbiota transplantation, though none are yet standard clinical practice. This gives a mechanistic explanation for why the plant-forward, fiber-supportive dietary pattern already recommended elsewhere in the CKD protein-restriction research does double duty, supporting the same beneficial gut bacteria that compete against the toxin-producing ones, not just managing protein intake on its own.",
    citations: [
  ...
  // independently verified via WebSearch.
  {
    ...
    teaser: 'Research finds contrast-induced kidney injury uncommon overall, developing in 3.7% of one large CKD cohort, but risk rises sharply below a specific eGFR threshold.',
    summary: "Contrast dye, used to sharpen the images in a CT scan, carries a kidney injury risk specifically for anyone with existing chronic kidney disease, defined as a measurable worsening of kidney function within 24 to 48 hours of the procedure. First, the reassuring part: research finds the overall risk of this happening is minimal for most people undergoing routine CT imaging, one study of 1,666 subjects found contrast-induced nephropathy developing in just 3.7% of cases, even among a CKD population. Research finds the risk concentrates specifically as kidney function drops further, rising noticeably once eGFR (covered in the self-advocacy research) falls below roughly 36.8 mL/min/1.73m², with diabetes and low blood albumin identified as additional risk factors. Practical reassurance: a prophylaxis program (proper hydration protocols before and after the scan) run over 8 years found contrast-induced nephropathy manageable in stable CKD patients when this prevention step was followed. Research finds contrast-induced nephropathy itself didn't increase mortality, but patients who did develop it were significantly more likely to need dialysis within the following 6 months. This is worth raising before any contrast-enhanced CT scan for someone with CKD: hydration protocols and, in some cases, choosing a non-contrast alternative imaging method are established ways to manage this risk rather than avoid necessary imaging altogether.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'Research finds depression tied directly to worse CKD progression, more hospitalizations, and higher mortality, yet clinical practice still gives it far less attention than the disease\'s physical management.',
    summary:
      "Depression is a common and underrecognized companion to chronic kidney disease, carrying measurable consequences for the disease itself, not just quality of life. Research finds depression prevalence ranging from roughly a quarter to half of CKD patients depending on the study, with major depressive disorder specifically affecting about 20% of people with CKD or kidney failure. Research finds this burden rises with disease severity, one study found depression in 29.9% of people on chronic hemodialysis versus 18.5% in earlier, pre-dialysis stages. Important: research finds depressive symptoms an underrecognized but potentially modifiable risk factor independently associated with faster CKD progression, kidney transplant failure, more hospitalizations, more cardiovascular events, and higher mortality, a direct link between mental health and physical disease outcome, not a separate, parallel concern. Research finds a plausible, concrete mechanism behind part of this: depression can undermine a person's ability to stick with the dietary, fluid, and medication requirements CKD management demands. Clinical guidance explicitly calls depression a priority that current CKD management still doesn't give adequate attention to, someone with CKD experiencing persistent low mood, hopelessness, or loss of motivation for their self-care has an evidence-backed reason to raise it directly with their nephrology team, not treat it as a separate issue for a different doctor.",
    citations: [
  ...
  },
  {
    ...
    category: 'chronicKidneyDisease',
    title: "An Unsettled Debate: Should 'Normal' Kidney Function Be Judged Differently by Age?",
  ...
  },
  {
    ...
    category: 'chronicKidneyDisease',
    title: 'A Kidney Transplant Carries a Large Survival Advantage Over Dialysis',
    ...
    summary:
      "For advanced kidney failure, dialysis and transplant are often framed as two roughly equal ways to manage the same disease. Matched survival data says otherwise. An analysis pooling multiple studies found kidney transplantation carrying a hazard ratio of 0.45 against dialysis, meaning a roughly 55% lower risk of death, and direct, matched comparisons confirm it in concrete numbers: 92% of transplant recipients were alive at 5 years and 87% at 10 years, against 88% and 74% for closely matched dialysis patients over the same periods. One complication: this benefit isn't immediate. In the first months after surgery, transplant recipients actually face a higher short-term mortality risk than dialysis patients, driven mainly by infection risk from the immune-suppressing medications transplant requires, before the survival curves cross and transplant's large advantage takes over, typically becoming clearly apparent by around 9 months out. The benefit holds even in older adults, one study of patients over 70 found 38% lower mortality and 80% five-year survival for transplant recipients versus 53% for those who stayed on dialysis. This is concrete evidence for anyone evaluating their treatment options as CKD progresses toward kidney failure, transplant, where medically eligible, carries a substantial survival advantage over remaining on dialysis long-term, not just a lifestyle preference.",
    chart: {
  ...
  },
  {
    ...
    category: 'chronicKidneyDisease',
    title: 'This Category\'s Transplant/Dialysis Research Assumes Access That Most of the World Doesn\'t Have',
  ...
  },
  {
    id: 'horizon-ckd',
    category: 'chronicKidneyDisease',
    title: 'A New Drug Class Blocks a Second Blood-Vessel Pathway This Category\'s ACE/ARB Research Doesn\'t Reach',
    teaser: 'Sparsentan, blocking both the endothelin and angiotensin pathways at once, reduced proteinuria 40% more than a standard ACE/ARB-family drug alone in a Phase 3 trial, and finerenone is now being tested beyond its original diabetic-CKD approval.',
    summary:
      "The ACE inhibitor and ARB research targets one blood-vessel pathway (angiotensin) already well-established in slowing CKD progression. Sparsentan represents a newer approach: a single drug blocking BOTH that same angiotensin pathway AND a second, separate one (endothelin), which research finds independently contributes to kidney damage. In a Phase 3 trial (PROTECT) in IgA nephropathy, sparsentan reduced protein leakage into urine by 40% more than irbesartan, an ARB-family drug, alone, and a separate Phase 2b trial (DUET) found it produced remission in 28% of a genetically-driven kidney disease (FSGS) versus 9% on irbesartan alone. A second, already-more-established drug, finerenone, works through yet another distinct pathway (blocking a hormone receptor tied to inflammation and scarring) and is already FDA-approved specifically for CKD in people who also have Type 2 diabetes, based on two large trials; it's now being tested in trials for non-diabetic CKD too, where it isn't yet approved. Both drugs represent this category's active direction, combining or diversifying beyond the single angiotensin pathway most current CKD treatment still relies on.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "The CKD research (potassium, protein, ACE inhibitors) applies broadly, but a specific, genetically-driven form of the disease has never had a treatment aimed at its actual cause until now. Two variants in the APOL1 gene, present almost exclusively in people of recent West African ancestry, drive a distinct form of kidney disease affecting an estimated 100,000 people in the US and Europe who carry two copies of the risk variant. Inaxaplin, a first-of-its-kind oral drug, is described directly by the field as the first genotype-targeted therapy in all of nephrology, working specifically to block the harmful protein the APOL1 variant produces. An early proof-of-concept trial found it reducing protein leakage into urine (a direct marker of kidney damage) by a statistically significant 47.6% after just 13 weeks. It's now in the Phase 3 portion of a global trial intended to support approval, expanded to include adolescents as young as 10. This is novel precision medicine for a specific genetic cause of CKD this category's general research doesn't otherwise address, not yet an approved treatment, but with a planned interim analysis that could lead to accelerated US approval if the results hold.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Beyond the protein, sodium, and mineral concerns, research finds a symptom that's common but often goes unrecognized as CKD-related at all: chronic kidney disease-associated pruritus, persistent, whole-body or localized itching with no other clear skin cause. Prevalence data finds it affecting roughly 20 percent of people with earlier-stage CKD, climbing to 40 percent (and, in some studies, up to 80 percent) of people on hemodialysis, with roughly 40 percent of dialysis patients reporting the itching as moderate to severe rather than mild. The direct mechanism isn't fully settled, but it's now understood to involve systemic changes, an imbalance in the body's opioid-receptor signaling, low-grade inflammation, and mineral/bone changes, not simply dry skin. The practical stakes go beyond comfort: research directly links CKD-associated pruritus to worse sleep quality, and the itching itself is independently associated with a higher mortality risk in dialysis patients. This is a name-able, discussable symptom, not something to quietly tolerate as an unavoidable part of kidney disease, and dedicated treatments (including an FDA-approved medication specifically for it) now exist.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "The potassium research found blanket restriction thinner on evidence than assumed, sodium is a different story. A double-blind, placebo-controlled crossover trial in adults with stage 3-4 CKD and hypertension found that restricting dietary sodium produced a statistically significant average blood-pressure reduction of 10 systolic and 4 diastolic points, alongside measured reductions in fluid retention and albuminuria (protein leaking into urine, an marker of kidney damage). The study's authors found this effect size larger than what's typically reported in sodium-restriction trials in people without CKD, direct evidence that CKD patients tend to be more salt-sensitive than the general population, not equally so. A separate self-management-support trial found a practical result too: coaching patients to manage their sodium intake dropped systolic blood pressure from an average of 140 to 132 over three months. Alongside this category's potassium correction: unlike potassium, sodium-restriction evidence in CKD specifically is solid, not just extrapolated from general population data.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The anemia entry names iron deficiency as a common driver, head-to-head trials find intravenous iron correcting it faster and more reliably than oral iron pills in non-dialysis CKD.",
    summary:
      "The anemia and erythropoietin research names iron deficiency as a common contributor, and controlled trials directly comparing how to correct it find a consistent gap between two delivery methods. The FIND-CKD trial, a 56-week, 626-patient randomized study, compared intravenous ferric carboxymaltose against oral iron in non-dialysis CKD patients with iron-deficiency anemia and found the IV group reached higher hemoglobin levels faster and required fewer additional treatments, evidence of an efficacy gap, not just a convenience difference. A separate 351-patient trial comparing iron isomaltoside against oral iron sulfate found the IV formulation not just non-inferior but superior in sustained hemoglobin increase from week 3 through the end of the 8-week study. The likely mechanism connects directly to the gut research: CKD's inflammatory state can impair how well the gut actually absorbs oral iron, meaning a pill that works fine for iron deficiency in a healthy gut may simply not be absorbed as reliably once kidney-disease-related inflammation is present. Alongside this advantage, oral iron remains a reasonable first option for milder deficiency given its lower cost and no infusion visit required, but trial evidence supports asking directly about IV iron when oral iron isn't correcting anemia as expected, rather than assuming a higher oral dose alone will eventually work.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The ACE/ARB monitoring names potassium as a limiting side effect, newer drugs, patiromer and sodium zirconium cyclosilicate, are directly built to solve that problem so the protective medication can keep being used.",
    summary:
      "The ACE-inhibitor and ARB research names hyperkalemia (dangerously high blood potassium) as a limiting side effect that sometimes forces reducing or stopping these otherwise kidney-protective drugs. Two newer medications, patiromer and sodium zirconium cyclosilicate (SZC), were built directly to solve this exact tradeoff: both are oral potassium binders working in the gastrointestinal tract to remove excess potassium, letting the underlying RAAS-inhibitor therapy continue rather than being scaled back. A systematic review and meta-analysis found both drugs effective and reasonably safe for treating hyperkalemia, with evidence patiromer specifically associated with lower rates of recurrent hyperkalemia compared to standard care, and some research suggesting a possible mortality benefit in CKD patients with hyperkalemia. The NEUTRALIZE trial, testing SZC specifically in non-dialysis CKD patients with both hyperkalemia and metabolic acidosis, found direct evidence supporting its use in this exact overlapping population. This is a practical, structural solution to a clinical tension this category's research already names, someone whose protective ACE-inhibitor or ARB dose was reduced due to potassium concerns now has an evidence-backed alternative, rather than accepting a lower dose of kidney protection as the only option.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The SHARP trial names the dialysis exception, further trial and observational data finds a different, more specific distinction: it's about STARTING new vs. CONTINUING an existing statin.",
    summary:
      "The SHARP trial found statin benefit not holding up once someone is already on dialysis, and further research finds a more specific, actionable distinction hiding underneath that finding. Two dedicated randomized trials, 4D and AURORA, both specifically tested STARTING a statin in patients already on dialysis and found no cardiovascular benefit from doing so, direct confirmation of the SHARP trial's dialysis-specific null result. The more specific finding comes from separate research: observational data finds that CONTINUING a statin someone was ALREADY taking before starting dialysis is associated with improved cardiovascular and survival outcomes, a meaningfully different question from whether to start one fresh once dialysis has already begun. Research directly frames this as continuation mattering specifically, not just presence, which changes the practical question someone facing dialysis should actually ask: not 'should I start a statin now that I'm on dialysis' (evidence says no benefit), but 'should I stop the statin I'm already on now that I'm starting dialysis' (evidence increasingly says no, keep taking it). This is a meaningful, easy-to-miss distinction, worth confirming directly with a nephrologist rather than assuming the SHARP trial's dialysis exception means all statin use should stop once dialysis begins.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The depression entry names an underrecognized burden, research finds anxiety affecting 21-26% of CKD patients too, with the same measurable quality-of-life impact showing up even in children and adolescents.",
    summary:
      "The depression research names a direct link to worse CKD progression and outcomes, and research finds anxiety carrying a similar, distinct burden worth covering separately. Research finds anxiety prevalence ranging from 21 to 26 percent across CKD patient populations, substantial numbers in their own right, alongside depression rather than a lesser concern. Research names the same direct downstream risks covered for depression, functional impairment, sleep disruption, and compromised nutritional status, evidence the two conditions travel together and compound each other's impact on disease management. A direct pediatric study found this same pattern extending to children and adolescents with CKD specifically, not just adults: standardized quality-of-life scores were significantly lower in children with CKD (63.3) compared with healthy controls (72.7), with elevated depression and anxiety measured directly in the affected children, and separately in their primary caregivers too. Clinical research explicitly names both depression and anxiety in CKD as commonly underdiagnosed and undertreated, direct reason to raise anxiety symptoms specifically, not just low mood, with a nephrology team, and reason a child's CKD diagnosis is worth watching for the same mental-health burden this category's adult research already establishes.",
    citations: [
  ...
  },
  {
    ...
    category: 'chronicKidneyDisease',
    title: 'Restless Legs Syndrome Affects a Striking Share of Dialysis Patients, and Carries a Mortality Link',
    teaser: "The depression and anxiety research names common psychological burdens, restless legs syndrome is a distinct, physical complication affecting over a quarter of hemodialysis patients globally, with a direct link to worse cardiovascular outcomes.",
    summary:
      "The depression and anxiety research names common psychological complications of CKD, and restless legs syndrome (RLS, an uncomfortable urge to move the legs, often worse at rest or at night) is a distinct, physical complication deserving direct coverage. A global systematic review and meta-analysis found a pooled RLS prevalence of 27.2 percent among hemodialysis patients, striking evidence this affects more than a quarter of that population, well above general-population estimates. The useful detail: prevalence varies meaningfully by measured factors, higher in women (29.7 percent) than men (23.5 percent), and by region (Africa 39.0 percent, Europe 29.8 percent, Asia 25.7 percent), population-level variation rather than one flat, universal number. The direct mechanism connects to the anemia and iron research: reduced kidney clearance and inflammation elevate iron-regulating hormones in hemodialysis patients, direct evidence lowering serum iron levels and impairing how the brain itself uses iron, a plausible pathway to RLS specifically. The most serious finding: RLS in this population isn't just an uncomfortable symptom, research links it to insomnia, fatigue, anxiety, and depression, and, more seriously, to an increased risk of cardiovascular events and death. This common, physically distinct complication is worth raising directly with a nephrology team, especially since the iron research (IV versus oral iron) may address a shared underlying cause.",
    citations: [
  ...
  },
  {
    ...
    teaser: "The NSAID and contrast-dye research names specific medication risks, a 49-study systematic review across 23 countries finds a much broader problem: renally-excreted drugs prescribed without proper dose adjustment, affecting up to 81% of hospitalized CKD patients in some settings.",
    summary:
      "The NSAID and contrast-induced-nephropathy research already names specific medication risks, and a much broader problem, medications prescribed at a standard dose without accounting for reduced kidney clearance, deserves direct coverage. A systematic review of 49 studies across 23 countries found inappropriate prescribing of renally-excreted drugs (medications the kidneys are meant to clear, which can accumulate to dangerous levels when kidney function is reduced) common across every care setting studied: 9.4 to 81.1 percent in hospital settings, 13 to 80.5 percent in ambulatory (outpatient) care, and 16 to 37.9 percent in long-term care facilities. This is a wide range reflecting variation across different studies and populations, but even the low end represents a meaningful share of patients affected. The serious stakes: the same review found inappropriate prescribing associated with increased hospital stays and a 40 percent higher mortality risk, a serious consequence from something as preventable as a standard, unadjusted dose. Matching the example (opioid accumulation in end-stage kidney disease requiring dose reduction), this is a systemic, common problem, not a rare prescribing mistake, worth directly and proactively asking any new prescriber whether a given medication's dose has been checked against current kidney function (eGFR, covered elsewhere in this category's self-advocacy research), rather than assuming every prescription automatically accounts for it.",
    citations: [
  ...
  // place.
  {
    ...
    teaser: 'Pooled data on nearly 122,000 people, followed for over a decade on average, found a meaningful reduction in the odds of ever developing chronic kidney disease.',
    summary:
      "A 2025 systematic review and meta-analysis pooled data on 121,927 people aged 18 to 74, followed for a weighted average of 11.2 years, and found that adopting a plant-based diet tracked with significantly lower odds of developing CKD at all (odds ratio 0.75, 95% confidence interval 0.65 to 0.86), meaning the people eating the most plant-based diets had roughly a quarter lower odds of ever being diagnosed. This is a prevention-focused finding, a different question from this category's existing research on managing protein source once CKD is already diagnosed. The proposed mechanism runs through several already-familiar pathways: a lower dietary acid load, reduced production of the uremic toxins gut bacteria generate from animal protein, and better blood pressure and glycemic control, all of which reduce the ongoing strain on kidney filtration over time. This is observational, pooled cohort data, large but not a randomized trial, so it shows a strong association rather than definitive proof that diet alone determines who develops CKD.",
    citations: [
  ...
  },
  {
    ...
    summary:
      "Calcium oxalate is the single most common kidney stone type in the general population, and recurrent stones are a documented contributor to progressive kidney damage through repeated obstruction and infection risk, not an unrelated event that happens to occur in the same organ. This app's food-scoring already tracks a cited oxalate rank per food (Use Carefully versus High Risk, distinct from a food's raw oxalate measurement) and an actionable cooking note, covered in full in this app's Health Literacy kidney-stone research: boiling a high-oxalate food and discarding the water reduces its oxalate load by 30 to 87 percent, while steaming, roasting, and baking do not meaningfully help. Pairing a high-oxalate food with a calcium source at the same meal is the other half of the same mechanism, calcium binds oxalate together in the gut before either reaches the kidneys, also covered in full in this app's Calcium research. Neither of these is a reason to avoid oxalate-containing whole foods outright; both are citable ways to manage the risk while still eating them.",
    citations: [
  ...
  // Added 2026-09-23. This one exists to head off a misreading rather
  // than to recommend anything: the 2023 sulfur-amino-acid feeding trial
  // lowered BUN, which reads as kidney-relevant to anybody scanning the
  // results, and CKD is the one condition in this app where lowering
  // protein is already part of the conversation. The entry says what the
  // trial measured and what it did not, and points back at
  // ckd-protein-restriction-plant-based for the actual guidance.
  {
    id: 'ckd-methionine-restriction-diet-urea-caution',
    category: 'chronicKidneyDisease',
    title: 'A Low-Sulfur-Amino-Acid Diet Lowered Blood Urea Nitrogen in Healthy Adults, Which Is Not a Kidney Treatment',
    teaser:
      'Blood urea nitrogen fell in a four-week feeding trial, and so did uric acid and IGF-1. Nobody in the trial had kidney disease, and no kidney outcome was measured.',
    summary:
      "A controlled feeding study put 20 healthy adults (11 women, 9 men) through three four-week periods, restricting either methionine alone or methionine together with cysteine. Restricting both lowered body weight, total cholesterol, LDL, uric acid, leptin, insulin, blood urea nitrogen and IGF-1, and raised body temperature and plasma FGF-21. Restricting methionine alone moved fewer markers, with blood urea nitrogen, uric acid and 8-isoprostane falling and FGF-21 rising. The researchers reported no adverse effects and declared no conflicts of interest. The blood urea nitrogen result is the one worth being careful about. Urea is what the body makes when it breaks protein down, so blood urea nitrogen falls when protein intake falls whether or not anything about the kidney has changed. It is a marker that moves with diet, not a measurement of how well a kidney is filtering, and eGFR and the albumin-to-creatinine ratio are what answer that question. Nobody in this trial had chronic kidney disease, the trial ran four weeks, every meal came from a research kitchen, and no kidney outcome was followed. The 2026 mouse work in the same area points at the risk in the other direction: when methionine was dropped to the lowest level tested, the animals lost weight fast enough that the researchers had to step in, and the study settled on a higher level to keep weight stable. In chronic kidney disease the protein target is set with a nephrology team, because too little protein carries a documented cost in muscle loss and frailty, and the evidence that does exist is about the level and the source rather than about one amino acid.",
    citations: [
