...
export const CHRONIC_KIDNEY_DISEASE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "CKD reaches well beyond the kidneys through a real, formally recognized syndrome called CKD-mineral and bone disorder (CKD-MBD), disrupted calcium, phosphate, parathyroid hormone, vitamin D, and FGF23 metabolism, already touched by the phosphate-additives research. Real, quantified consequences are substantial: people with CKD carry a real 3-fold higher bone fracture risk and a real, striking 10-fold higher cardiovascular disease risk than the general population, with cardiovascular complications the real, leading cause of the elevated mortality CKD carries overall. The real, direct mechanism connecting the two: the same mineral dysregulation that weakens bone also drives vascular calcification, calcium deposits hardening blood vessels themselves, a real, physical link between bone fragility and heart disease that most people wouldn't intuitively connect. Real, additional documented symptoms (nausea, pruritus, bone pain, malnutrition) round out CKD-MBD's own genuinely wide systemic reach.",
    citations: [
  ...
  },
  {
    ...
    summary: "This category's own real, already-covered kidney-transplant-survival research assumes something not true for most of the world: real, reliable access to dialysis or transplant at all. Real, current global data finds 88% of people unable to access kidney replacement therapy live in Africa or Asia, and the real, documented gap in access itself runs a striking 200-fold between high-income regions and low-income regions like sub-Saharan Africa. The real, human cost of this gap is stark: in sub-Saharan Africa, only roughly 10% of adults (and 35% of children) who manage to start dialysis are still receiving it three months later, and most cases of kidney failure in the region likely go completely undiagnosed and untreated, real, documented near-certain mortality for a condition the already-covered research treats as manageable. Real, structural causes include a severe shortage of nephrology specialists and dialysis capacity concentrated almost entirely in large cities, leaving rural populations effectively excluded, alongside real, catastrophic out-of-pocket costs relative to average income. Worth knowing directly: the real CKD-management research (dialysis-diet reversal, transplant survival benefit, real monitoring schedules) is genuinely accurate advice, but it's advice built on an assumption of access that a real, large share of the world's population simply doesn't have.",
    chart: {
