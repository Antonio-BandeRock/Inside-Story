...
export const CHRONIC_KIDNEY_DISEASE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'A honest correction to some of the most repeated dietary advice out there, a hidden additive, and a medication class that turned out to protect the kidneys directly, not just as a side effect.',
    summary:
  ...
  },
  {
    ...
    summary:
      "Beyond the protein, sodium, and mineral concerns this category already covers, research finds a symptom that's common but often goes unrecognized as CKD-related at all: chronic kidney disease-associated pruritus, persistent, whole-body or localized itching with no other clear skin cause. Prevalence data finds it affecting roughly 20 percent of people with earlier-stage CKD, climbing to a 40 percent (and, in some studies, up to 80 percent) of people on hemodialysis, with roughly 40 percent of dialysis patients reporting the itching as moderate to severe rather than mild. The direct mechanism isn't fully settled, but it's now understood to involve systemic changes, an imbalance in the body's own opioid-receptor signaling, low-grade inflammation, and mineral/bone changes already covered elsewhere in this category, not simply dry skin. The practical stakes go beyond comfort: research directly links CKD-associated pruritus to worse sleep quality, and the itching itself is independently associated with a higher mortality risk in dialysis patients. This is a name-able, discussable symptom, not something to quietly tolerate as an unavoidable part of kidney disease, and dedicated treatments (including a FDA-approved medication specifically for it) now exist.",
    citations: [
