...
export const CLIMATE_SCIENCE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'earthMatters',
    title: 'Solar Power Has Gotten Cheap Enough to Drive Most of the World\'s New Renewable Capacity, a Change Since the Film Released',
