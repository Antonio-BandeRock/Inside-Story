...
export const CLIMATE_SCIENCE_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'earthMatters',
    title: 'The Mauna Loa CO2 Record Featured in Decoding the Weather Machine Has Risen Every Year Since, From 316 ppm in 1959 to 427 in 2025',
    teaser: "The continuous Mauna Loa CO2 record featured in NOVA's Decoding the Weather Machine (PBS, 2019) has climbed from roughly 316 parts per million in 1959 to 427 in 2025, with every single year higher than the one before it.",
    summary: "Ralph Keeling, whose father Charles David Keeling started this measurement in 1958, appears directly in NOVA's Decoding the Weather Machine (PBS, 2019) discussing the continuous atmospheric CO2 record kept at the Mauna Loa Observatory in Hawaii. That record has not paused or reversed since the film's 2019 vantage point: the annual average climbed from about 316 parts per million in 1959, the first full year of data, to roughly 427 ppm in 2025, with the May 2025 seasonal peak reaching about 432 ppm, and 2026's annual average is forecast to land near 429 ppm. Every single year on record has measured higher than the year before it. It is an unbroken physical air sample measured the same way for nearly seven decades, not a model output or a proxy reconstruction.",
    citations: [
  ...
  },
  {
    ...
    category: 'earthMatters',
    title: 'Antarctic Ice Cores Now Reach Back 1.2 Million Years, Past the 800,000 Decoding the Weather Machine Could Show',
    teaser: "NOVA's Decoding the Weather Machine (PBS, 2019) describes ice-core climate records reaching about 800,000 years into the past. A drilling project reached bedrock in January 2025 and recovered ice more than 1.2 million years old.",
    summary: 'Polar ice sheets trap tiny bubbles of ancient air as snow compacts into ice year by year, so a drilled ice core is a physical archive of the atmosphere\'s past composition, layer by layer, going back further the deeper the core reaches. At the time NOVA\'s Decoding the Weather Machine filmed, the deepest continuous ice-core record reached roughly 800,000 years into the past. The Beyond EPICA - Oldest Ice project, drilling at a remote site called Little Dome C in Antarctica, reached bedrock in January 2025 after a multi-year campaign and recovered a 2,800-meter core containing ice more than 1.2 million years old, the oldest ice ever extracted, with the possibility of even older ice preserved near the base. Full laboratory analysis of what this new, older ice actually reveals about that period\'s climate is still ongoing as of this writing, a limitation on how much can be said about it today beyond the age itself.',
    citations: [
  ...
  },
  {
    ...
    teaser: 'Extreme event attribution science, still young when NOVA\'s Decoding the Weather Machine filmed in 2019, has since matured into a repeatable method that can estimate how much more likely or intense a specific hurricane, drought, or heat wave was because of human-caused warming, often within days of the event itself.',
    summary: "The hurricane, drought, wildfire, and extreme-rainfall segments of NOVA's Decoding the Weather Machine (PBS, 2019) describe a warming climate loading the dice toward worse weather, without always being able to attribute any one specific event to that warming. That science has matured since the film released. World Weather Attribution, founded in 2015, has since completed more than 100 rapid studies on individual heat waves, floods, droughts, and wildfires around the world, using a standard, peer-reviewed methodology (26 of these studies have also gone through separate, full journal peer review) to estimate how much more likely, or how much more intense, a specific event was made by human-caused warming, typically published within days to weeks of the event rather than the months or years a full academic study takes. The speed comes at a cost: individual rapid studies are released before undergoing the same peer review as most other science in this app, even though the underlying method has been peer-reviewed and validated separately.",
    citations: [
  ...
  },
  {
    ...
    category: 'earthMatters',
    title: "Solar Power Has Become Cheap Enough to Drive About 80% of the World's New Renewable Capacity, a Change Since Decoding the Weather Machine Aired",
