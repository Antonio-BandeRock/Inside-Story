...
export const NEURODIVERGENCE_CROSSOVER_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Across 29 pooled articles, maternal hyperthyroidism was associated with offspring ADHD at an odds ratio of 1.18 (1.04 to 1.34) and with epilepsy at 1.19 (1.08 to 1.31). The autism signal in that analysis was clearer on the underactive side than the overactive one. An 18 percent proportional increase on an outcome a few percent of children receive is a small shift in an already small chance, and stating it that way is not minimizing it, it is the only way to read it accurately. The proposed mechanism is the same as for hypothyroidism, thyroid hormone steering brain development before the fetus makes any, with the added complication particular to Graves' that both hormone levels and TRAb antibodies cross the placenta, and the antibodies can act on the fetal thyroid independently of how the mother feels. What follows is what this category already asks for: hold levels in the trimester-appropriate range on the lowest antithyroid dose that does it, and monitor TRAb. Treatment being unstable is the part anybody can act on. The diagnosis itself is not.",
    citations: [
      {
        source: 'Meta-analysis of 29 articles, maternal thyroid dysfunction and offspring neurodevelopment',
        url: 'https://pubmed.ncbi.nlm.nih.gov/32810262/',
  ...
  },
  {
    ...
    summary:
      "A 2025 meta-analysis pooled 11 studies covering 3,851,163 individuals, 175,806 of them with ADHD, and found irritable bowel syndrome associated with ADHD at an odds ratio of 1.63 (1.45 to 1.83). The same analysis found nothing for Crohn's disease, ulcerative colitis, celiac disease or constipation. That is what makes this result interesting rather than a general observation that neurodivergent people accumulate more diagnoses, because if that were all it was, the others would have moved too. IBS is classified as a disorder of gut-brain interaction, defined by how signalling between the two behaves rather than by damage visible on a scan, so overlap with a condition of attention and arousal regulation is not surprising, though the shared mechanism has not been pinned down. Three things follow that anybody can use. Irregular, rushed or skipped meals are common with ADHD and are also among the reliable triggers for IBS symptoms, which is one condition making the other harder rather than either causing the other. Stimulant medication has digestive effects of its own that are worth telling apart from the IBS instead of blaming one for the other. And a low-FODMAP trial is a structured elimination with a reintroduction phase and an end date, which is exactly the kind of multi-week protocol that needs to live outside somebody's head. Meal logging and reminders help with that, and that is a support claim about structure, not a claim that any diet treats ADHD.",
    citations: [
      {
  ...
  },
  {
    ...
    title: 'Type 2 Diabetes and ADHD, and What a Sibling Comparison Showed',
    teaser:
    ...
    summary:
      'A systematic review with meta-analysis covering four studies and 5,738,287 participants reported type 2 diabetes associated with ADHD at an adjusted odds ratio of 2.29 (1.48 to 3.55), and a Taiwanese longitudinal study within it reported a hazard ratio of 3.28 (1.41 to 7.63). The same paper also carried a population-based sibling comparison, which holds family background roughly constant by comparing siblings who do and do not have ADHD, and that comparison indicated ADHD by itself has a negligible effect on type 2 diabetes risk once familial factors are accounted for. Both halves belong in the same paragraph. The association exists and would show up for anyone looking at population numbers; the causal reading of it mostly does not survive a design built to test it. What survives is indirect and unsurprising: irregular eating, disrupted sleep and less movement each associate with metabolic risk on their own, and all three are harder to hold steady with ADHD. That is an argument for putting the routine somewhere outside the head, which is what this app is built to do, and not an argument for treating an ADHD diagnosis as a diabetes forecast.',
    citations: [
      {
