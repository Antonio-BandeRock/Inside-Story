...
export const SELF_ADVOCACY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Magnesium: A Reasonable Test to Order, With One Limitation First',
  ...
  },
  {
    id: 'advocacy-cbc',
    category: 'basicHealth',
    title: 'Complete Blood Count (CBC): What a Condition-Specific Panel Misses',
  ...
  },
  {
    ...
    teaser: 'Some practitioners treat it as an early-warning test years ahead of an A1c change. The research on how well it actually predicts that is more mixed than the pitch suggests.',
    summary:
  ...
  },
  {
    ...
    summary: "Research on patient self-management found something consistently practical: patients who prepare specific, written questions ahead of a visit get more of those questions actually answered than patients who raise the same concerns verbally, in the moment, under time pressure. That's one of the single most actionable pieces of self-advocacy advice covered anywhere here: not a script for confrontation, just a short, specific, written list (the Bio-Compass symptom log is a ready-made source for exactly this) naming the actual tests relevant to a specific situation, handed over or read from directly rather than described from memory. Framing matters too. \"I'd like to also check my [specific test] this visit, given my [condition]\" lands very differently from an open-ended \"can you test everything.\" It's also worth knowing which tests are realistically a same-visit primary-care request (a condition's core panel, CBC, CMP, lipids, vitamin D, B12, ferritin) versus ones that more often need a referral to a specialist or a functional-medicine practitioner to access at all (a more contested or less standardized test, a full sex-hormone panel, a nutrient without a routine lab pathway), a matter of ordering habits and lab access differing by specialty rather than a PCP being unwilling. Insurance coverage is a separate constraint worth asking about directly rather than assuming; some of the less-routine tests may need a specific documented reason to be covered.",
    citations: [
      { source: 'Bodenheimer T, Lorig K, Holman H, Grumbach K 2002: Patient self-management of chronic disease in primary care (JAMA)', url: 'https://pubmed.ncbi.nlm.nih.gov/12435261/' },
  ...
  },
  {
    ...
    summary: "There's a specific term in the medical literature for a pattern many people with a chronic condition eventually recognize in their medicine cabinet: the prescribing cascade. An authoritative definition states it plainly. It begins when a drug's side effect gets misinterpreted as a new medical condition in its own right, leading to a second drug being started to treat what was actually the first drug's side effect all along, sometimes repeating again from there. This isn't a fringe idea. It's an established concept in clinical pharmacology, tracing back to a classic 1997 paper on optimizing drug treatment. The hopeful flip side, backed by trial data rather than just intuition: when an underlying driver of a problem (in the core framing, chronic inflammation and metabolic health) improves, some medications originally started for a downstream symptom can be medically-supervised candidates for reduction. A well-known trial (DiRECT) found that among people who achieved diabetes remission through a structured weight-loss intervention (a mean weight loss of 11.4 kg), 28% remained completely off blood pressure medication at 24 months, a quantified, if partial, success rate, not a guaranteed outcome for everyone. This is emphatically not a case for stopping any medication without medical supervision. It's an evidence-backed reason to ask a doctor directly, as underlying health measurably improves, whether a medication started for a downstream symptom is still actually needed, rather than assuming a prescription written years ago is permanent by default.",
    citations: [
