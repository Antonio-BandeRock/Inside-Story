...
export const SELF_ADVOCACY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    category: 'hashimotos',
    title: 'Selenium: The Best-Evidenced Supplement, and the Hardest One to Get Tested',
