...
export const SELF_ADVOCACY_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary: "Two different things both get called \"cortisol testing,\" and telling them apart matters. A 2025 review states this about as plainly as a medical paper ever does: the terms \"adrenal fatigue,\" \"adrenal asthenia,\" and \"adrenal burnout,\" often attached to mail-order salivary cortisol test kits marketed directly to consumers, \"are not a part of the medical or endocrine lexicon,\" meaning they aren't a diagnosis a real endocrinologist would treat as one. That's worth knowing before spending money on one of those kits. What IS worth testing through an actual doctor: the Organs & Body Systems category covers Autoimmune Polyglandular Syndrome Type 2, a documented autoimmune attack on the adrenal glands that can occur alongside Hashimoto's, diagnosed with an AM serum cortisol test or an ACTH stimulation test, not a saliva kit. It's worth raising directly with a doctor only when there's a real reason to (unexplained low blood pressure, unusual skin darkening, severe unremitting fatigue with other red flags), not something to test on a fixed schedule without one of those signs present.",
    citations: [
