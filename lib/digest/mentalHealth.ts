...
export const MENTAL_HEALTH_ENTRIES: DigestEntry[] = [
  {
    ...
    summary: 'The research already documents depression and anxiety comorbidity across several individual conditions, rheumatoid arthritis, celiac disease, chronic kidney disease, psoriasis, PCOS, and IBS each carry their cited entry. This topic covers the general biology underneath all of those specific findings: a measurable link between inflammation and depression, randomized-trial evidence that diet itself can measurably improve depressive symptoms, nutrient-specific findings (omega-3s, B vitamins), and current evidence on exercise\'s role, including where the evidence doesn\'t support an overstated claim. None of this replaces professional mental health care, it\'s the biological groundwork underneath why food, sleep, and movement are worth treating as relevant to mood, not adjacent to it.',
    citations: [
      {
  ...
  },
  {
    ...
    summary: 'Every finding in this topic (diet, omega-3s, exercise, B vitamins) is an evidence-backed contributor to mood, and every one of them works alongside professional mental health care, not instead of it, the SMILES trial itself, this topic\'s strongest single piece of evidence, tested dietary counseling as an ADJUNCT approach in a research setting with clinical support built in, not a self-directed replacement for treatment. In the US, the 988 Suicide & Crisis Lifeline (call or text 988) is available 24/7, free, and confidential, for anyone in crisis or supporting someone who is, regardless of whether it\'s ever needed. A persistent low mood, anxiety, or loss of interest in things that used to matter is worth bringing directly to a doctor or mental health professional, the same way the condition-specific research already treats a physical symptom as worth a direct conversation rather than something to self-manage alone.',
    citations: [
      {
