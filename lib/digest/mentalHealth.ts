...
export const MENTAL_HEALTH_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: 'From RA and celiac to Graves\' and gout, every single condition already covered now carries its cited depression/anxiety finding, this topic is the shared physiology underneath all of them.',
