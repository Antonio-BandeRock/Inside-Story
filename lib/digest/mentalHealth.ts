...
export const MENTAL_HEALTH_ENTRIES: DigestEntry[] = [
  {
    ...
    summary: 'The research already documents depression and anxiety comorbidity across several individual conditions, rheumatoid arthritis, celiac disease, chronic kidney disease, psoriasis, PCOS, and IBS each carry their cited entry. This topic covers the general biology underneath all of those specific findings: a measurable link between inflammation and depression, randomized-trial evidence that diet itself can measurably improve depressive symptoms, nutrient-specific findings (omega-3s, B vitamins), and honest, current evidence on exercise\'s role, including where the evidence doesn\'t support an overstated claim. None of this replaces professional mental health care, it\'s the biological groundwork underneath why food, sleep, and movement are worth treating as relevant to mood, not adjacent to it.',
    citations: [
      {
