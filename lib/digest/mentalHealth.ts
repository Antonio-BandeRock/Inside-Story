...
export const MENTAL_HEALTH_ENTRIES: DigestEntry[] = [
  {
    ...
    summary: 'The research documents depression and anxiety comorbidity across several individual conditions: rheumatoid arthritis, celiac disease, chronic kidney disease, psoriasis, PCOS, and IBS each carry a cited entry. These entries cover the general biology underneath all of those specific findings: a measurable link between inflammation and depression, randomized-trial evidence that diet itself can measurably improve depressive symptoms, nutrient-specific findings (omega-3s, B vitamins), and current evidence on exercise\'s role, including where the evidence doesn\'t support an overstated claim. None of this replaces professional mental health care. It\'s the biological groundwork underneath why food, sleep, and movement are relevant to mood.',
    citations: [
      {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Elevated CRP and IL-6 in Depression Often Precede the Illness Rather Than Follow It',
  ...
  },
  {
    ...
    summary: 'The existing Omega-3 & Omega-6 research covers the two fatty acids\' general roles, this entry covers a specific, depression-focused finding: EPA and DHA are NOT interchangeable for this particular use. Repeated meta-analyses find formulas that are DHA-pure or DHA-majority show no significant antidepressant effect, while formulas with EPA at 60 percent or more of total omega-3 content do show a measurable benefit, most consistently at a specific dose of 1 gram of EPA a day or less, research also finds doses of 2 grams a day or more stop showing the same benefit, a dose-response window rather than "more is better." The proposed mechanisms are multiple: EPA and DHA both influence neuron cell-membrane properties and neurotransmitter signaling, but also carry anti-inflammatory, pro-resolving effects, tying this finding directly back to the inflammation-depression link.',
    citations: [
      {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Exercise Helps Depression, but the Evidence Doesn\'t Support "Better Than Medication"',
    ...
    summary:
      'Randomized controlled trials comparing exercise directly to antidepressant medication for nonsevere depression find the two comparable in effect, and meta-analyses find exercise added on top of existing antidepressant treatment produces a further, significant improvement. Neuroscience gives this a plausible mechanism: exercise is linked to measurable increases in hippocampal and prefrontal cortex volume, brain regions antidepressant medication is also thought to affect through overlapping pathways. One caveat: a 2024 published correction in the Journal of Physical Activity and Health directly challenges the stronger, more widely repeated claim that exercise is simply BETTER than medication or therapy, arguing the underlying evidence doesn\'t support that specific framing even though the "comparably effective, especially for mild-to-moderate depression" claim does hold up. Where that leaves it: exercise is an evidence-backed option, especially as an add-on to existing treatment, not a proven replacement for medication or therapy in more severe depression.',
    citations: [
      {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Nutrition Never Replaces Professional Mental Health Care',
    teaser: 'Diet, sleep, and exercise are evidence-backed contributors to mood, and none of them are a substitute for professional care when it\'s needed.',
    summary: 'Every finding in these entries (diet, omega-3s, exercise, B vitamins) is an evidence-backed contributor to mood, and every one of them works alongside professional mental health care. The SMILES trial itself, the strongest single piece of evidence here, tested dietary counseling as an adjunct approach in a research setting with clinical support built in, not a self-directed replacement for treatment. In the US, the 988 Suicide & Crisis Lifeline (call or text 988) is available 24/7, free, and confidential, for anyone in crisis or supporting someone who is, regardless of whether it\'s ever needed. A persistent low mood, anxiety, or loss of interest in things that used to matter is worth bringing directly to a doctor or mental health professional, the same way the condition-specific research treats a physical symptom as worth a direct conversation rather than something to self-manage alone.',
    citations: [
      {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Mental Health Is a Documented Comorbidity Across All 19 Conditions',
    teaser: 'From RA and celiac to Graves\' and gout, every condition carries a cited depression or anxiety finding; these entries are the shared physiology underneath all of them.',
    summary: 'The condition-specific research now documents an individually-cited depression and/or anxiety finding for every one of its 19 conditions: Hashimoto\'s, RA, psoriasis, Graves\', Type 1 Diabetes, celiac, IBD, MS, lupus, Sjögren\'s, PCOS, CKD, MASLD, Type 2 Diabetes, IBS, migraine, cardiovascular disease, gout, and prostate health each have a distinct entry. These entries are the shared, general biology underneath all of them: the same inflammation-mood link, the same dietary-intervention evidence, the same nutrient and exercise findings, applicable regardless of which specific condition someone is managing.',
    citations: [
      {
        source: 'Frontiers in Behavioral Neuroscience, "Exploring the role of inflammation in major depressive disorder"',
        url: 'https://www.frontiersin.org/journals/behavioral-neuroscience/articles/10.3389/fnbeh.2023.1282242/full',
  ...
  // rather than this specific brain mechanism.
  {
    ...
    summary:
      "A 2022 systematic review and meta-analysis pooled 17 observational studies covering 385,541 people and found greater ultra-processed food intake cross-sectionally associated with higher odds of depressive symptoms (odds ratio 1.44), anxiety symptoms (odds ratio 1.48), and the two combined (odds ratio 1.53). The same review's pooled prospective studies, which track people forward in time rather than measuring diet and mood at a single moment, found higher ultra-processed food intake predicted a 22% increased risk of later depression. A separate 2022 meta-analysis of 26 studies and 260,385 people confirmed the depression link (a 28% increased risk) but found no statistically significant anxiety link in its pooled data, a disagreement between meta-analyses on the anxiety half specifically that this entry reports rather than smooths over. Every number above comes from observational research, association and prediction, not a randomized trial proving ultra-processed food itself causes depression or anxiety, the same limitation the inflammation-CRP entry already flags for that adjacent body of evidence. Tiered moderate for exactly that reason, alongside the SMILES trial's randomized, controlled evidence that improving diet quality measurably treats depression.",
    citations: [
  ...
  },
  {
    ...
    overallTier: 'moderate',
    relatedIds: ['ibs-gut-serotonin-mechanism', 'mentalhealth-overview', 'glossary-scfa', 'glossary-treg'],
  },
  {
  ...
  },
  {
    ...
    category: 'basicHealth',
    title: 'Vitamin D and Depression Have a Documented Biological Rationale and a Still-Mixed Evidence Base',
  ...
  // research ties to any of them specifically.
  {
    ...
    category: 'basicHealth',
    title: "Diet Does Not Cause ADHD or OCD, Though It Can Change Symptom Severity",
  ...
  },
  {
    ...
    summary:
      "A 2017 systematic review and meta-analysis (Neuropsychopharmacology) pooled seven randomized controlled trials covering 534 youth with ADHD and found omega-3 polyunsaturated fatty acid supplementation improved clinical symptom scores, with a separate pooled set of 3 trials (214 youth) also finding improved attention-related cognitive measures. The EPA-versus-DHA depression entry already establishes that these two fatty acids aren't interchangeable, and the caveat applies here too: the most comprehensive reviews of this same evidence find the effect on ADHD's core diagnostic symptoms specifically more limited than the broader symptom-score improvement suggests. The proposed mechanism connects to zinc: zinc acts as a cofactor in dopamine synthesis and directly regulates how the dopamine transporter clears dopamine from synapses, and omega-3 deficiency has been shown to disrupt zinc metabolism in brain tissue, tying the two nutrients to the same dopamine pathway rather than working through separate mechanisms. Separately, a 2025 Frontiers in Nutrition study mapping the biochemical nutrient profiles of neurodivergent children and adults against standard intake references found baseline deficiencies in omega-3s, zinc, vitamin D, and B vitamins more common in this population than in the general one. On blood sugar specifically, a 2026 systematic review of dietary carbohydrates and ADHD symptoms found a mixed, heterogeneous evidence base, refined carbohydrates and added sugar track with worse symptom severity in most, not all, of the studies reviewed, the glycemic-instability entry covers the shared blood-sugar-to-mood mechanism in more depth.",
    citations: [
