...
export const APP_HELPS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for Graves' disease, an honest, two-nutrient lens: selenium (with cited eye-disease-specific trial evidence) and iodine (framed for Graves' own excess-risk direction, the opposite emphasis from this app's Hashimoto's research). My Meds & Interactions tracks methimazole, propylthiouracil, and propranolol, with cited reference content built directly in for the two warning signs that matter most (agranulocytosis, PTU-related liver injury) and how iodine intake can reduce antithyroid drug effectiveness. The app's functional age-rules engine already flags an easy-to-miss presentation directly: 'apathetic thyrotoxicosis,' an atypical Graves' pattern more common after 60, checked against your own birth date in Profile. The app's Digest carries a full, dedicated Graves' category: remission-rate data, cardiac risk, a history of the disease, pregnancy guidance, self-advocacy content on TRAb/TSI testing, international research (including a Denmark-vs-Iceland iodine study), this same Prevention & Lifestyle guidance, and a running Research Horizon. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    teaser: 'A purpose-built carbohydrate-density food score, insulin tracked with a delayed-hypoglycemia alcohol warning, and a pediatric-specific DKA alert built directly into the app\'s age-rules engine.',
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for T1D through a purpose-built sub-criterion this app created from scratch, Carbohydrate Density Relative to Fiber, computed directly from each food's measured carb and fiber content, not a guess. My Meds & Interactions tracks insulin and glucagon, with a cited warning built directly in for alcohol's delayed hypoglycemia risk, an easy-to-miss danger this app names explicitly. The app's functional age-rules engine flags a serious risk directly: cerebral edema, an almost exclusively pediatric DKA complication, checked automatically against anyone under 18 in Profile. The app's Digest carries a full, dedicated Type 1 Diabetes category: presymptomatic staging (detectable years before diagnosis), long-term complication data, a history of insulin's discovery, pregnancy guidance, self-advocacy content on the 4-antibody diagnostic panel, international research (including Finland's world-highest incidence), this same Prevention & Lifestyle guidance, and a running Research Horizon covering teplizumab, stem-cell islet therapy, and verapamil. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for celiac disease across three dimensions: gluten content directly (the core concern), a whole-food-versus-processed-gluten-free-substitute lens (since this app's research found commercial gluten-free products often run lower in fiber and protein than their gluten-containing equivalents), and fiber content specifically, countering a documented nutritional gap this app's research names directly. My Meds & Interactions tracks no celiac-specific medication, because none currently exists, no FDA-approved drug treats celiac disease itself, strict gluten avoidance remains the only treatment, and the app doesn't pretend otherwise. The app's Digest carries a full, dedicated Celiac category: Marsh histological staging, systemic effects reaching well beyond the gut, a history of the disease's discovery, pregnancy and fertility data, self-advocacy content including exactly why first-degree relatives should be screened, international research (including Western Sahara's striking prevalence), this same Prevention & Lifestyle guidance, and a running Research Horizon covering drug candidates (ZED1227, TAK-101, latiglutenase) still meant to sit alongside the diet, not replace it. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    teaser: 'IBD-specific food scoring built around this app\'s direct correction to the "avoid fiber" advice, biologics and immunomodulators tracked with serious interaction rules, and a full research library.',
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for IBD across three dimensions: additive load (tied directly to a documented emulsifier mechanism), whole-food-versus-processed intake, and a nuanced fiber-and-roughage lens built around this app's direct correction to the common 'avoid fiber during a flare' advice, research the app cites finding no support for that restriction at all. My Meds & Interactions tracks mesalamine, azathioprine, and vedolizumab (plus shared medications from this app's RA research where applicable, adalimumab, prednisone, methotrexate), with cited interaction rules built directly in for two serious combinations, azathioprine with allopurinol, and azathioprine with a biologic. The app's Digest carries a full, dedicated IBD category: Montdisease classification, extraintestinal effects, a history of the disease, pregnancy guidance emphasizing remission-at-conception data, self-advocacy content, international research (including a second-generation-migrant finding), this same Prevention & Lifestyle guidance, and a running Research Horizon covering precision-medicine biomarkers and stem-cell fistula therapy. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for MS across three dimensions, built directly from this app's already-cited WAVES trial research: saturated fat (the core of the decades-long Swank diet evidence), omega-3 balance (a shared thread across both major MS diets), and whole-food-versus-processed intake, the one recommendation both competing diets agree on. My Meds & Interactions tracks natalizumab, fingolimod, dimethyl fumarate, and glatiramer acetate, with a serious, cited safety rule built directly in for natalizumab's documented PML risk when combined with other immunosuppressants, plus a practical dietary-fat reminder for dimethyl fumarate's flushing side effect. The app's Digest carries a full, dedicated MS category: disease-course classification, bladder/bowel/cognitive effects beyond mobility, a history of the disease, pregnancy and postpartum-relapse data, self-advocacy content, international research (including the Sardinia exception to the latitude gradient), this same Prevention & Lifestyle guidance, and a running Research Horizon covering ocrelizumab, tolebrutinib, and clemastine. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    teaser: "Sjögren's-specific food scoring for the nutrient with this app's most consistently positive trial evidence, saliva-stimulating medications tracked directly, and a full research library built around everyday hydration habits.",
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for Sjögren's through an omega-3 dimension, this app's research found fairly consistent, positive trial evidence here, including measured improvement in both dry eye and dry mouth in the same trial. My Meds & Interactions tracks pilocarpine and cevimeline (plus hydroxychloroquine, shared from this app's lupus research), both gland-stimulating medications rather than simple moisture replacements. The app's Digest carries a full, dedicated Sjögren's category: primary-versus-secondary classification, lung and neurological effects beyond dryness, a history of the disease, pregnancy guidance covering congenital heart block risk, self-advocacy content on the labial salivary gland biopsy, international research (including documented geographic and ethnic variation in symptom presentation itself), this same Prevention & Lifestyle guidance built around same-day hydration habits, and a running Research Horizon covering dazodalibep and iscalimab, two drugs succeeding on exactly the core symptoms this app's research found rituximab didn't move. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    teaser: "PCOS-specific food scoring built around its central insulin-resistance mechanism, spironolactone tracked with a potassium-safety rule, and a full research library covering quantified weight-loss thresholds.",
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for PCOS through a carbohydrate-and-fiber dimension, reusing the same purpose-built sub-criterion this app originally created for Type 1 diabetes, since PCOS's central mechanism runs through the identical carbohydrate/insulin axis. My Meds & Interactions tracks spironolactone, letrozole, and clomiphene (plus metformin, shared from this app's diabetes research), with a cited safety rule built directly in for spironolactone's potassium risk. The app's Digest carries a full, dedicated PCOS category: Rotterdam phenotype classification, cardiovascular and NAFLD comorbidities, a history of the diagnosis itself, pregnancy guidance covering letrozole-over-clomiphene evidence, self-advocacy content on why a full glucose tolerance test matters, international research (including a Gulf-region consanguinity finding), this same Prevention & Lifestyle guidance built around the quantified BAMBINI weight-loss trial, and a running Research Horizon covering fezolinetant, a drug correcting the actual brain signal driving PCOS. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for MASLD across two dimensions this app's research ties directly to the condition's lipid-metabolism mechanism: fat processing, and additive load, a direct predictor of liver-fat change in MASLD specifically, not a generic processed-food warning borrowed from elsewhere. My Meds & Interactions tracks resmetirom, semaglutide, pioglitazone, and vitamin E, current medication options for a condition that, until recently, had no approved drug treatment at all. The app's Digest carries a full, dedicated MASLD category: F0-F4 fibrosis staging, cardiovascular and kidney comorbidities, a history of the condition's name changing twice, pregnancy guidance, self-advocacy content on the FIB-4 fibrosis-screening tool, international research (including a striking 'lean MASLD' pattern in Asian populations), this same Prevention & Lifestyle guidance built around a graded weight-loss staircase (3% helps, 10% can reverse fibrosis), and a running Research Horizon covering efruxifermin and survodutide. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for T2D through the same purpose-built carbohydrate-and-fiber sub-criterion this app originally created for Type 1 diabetes, reused directly here since T2D's central mechanism runs through the identical carbohydrate/insulin relationship. My Meds & Interactions tracks glipizide and glyburide (plus metformin, semaglutide, dapagliflozin, and insulin, shared across this app's diabetes and kidney research), with a cited safety rule built directly in for sulfonylureas and reduced kidney function, plus an age-aware caution specifically naming glyburide for anyone 65 and older. The app's Digest carries a full, dedicated Type 2 Diabetes category: prediabetes progression data, cognitive and liver effects, a history of metformin's surprising origin, pregnancy guidance, self-advocacy content on individualized HbA1c targets, international research (including China and India's combined share of the world's diabetes burden), this same Prevention & Lifestyle guidance built around the DiRECT remission trial, and a running Research Horizon covering retatrutide and orforglipron. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    teaser: "IBS-specific food scoring matched directly to its definition, rifaximin and linaclotide tracked directly, and a full research library naming delayed food triggers most people never connect to their symptoms.",
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for IBS across two dimensions built directly around the condition's actual mechanism: fiber load, matched to IBS's digestive-tolerance sensitivity, and gut irritants, a direct match given how this app's research defines the condition in the first place. My Meds & Interactions tracks rifaximin and linaclotide, the two medications this app's IBS research covers directly. The app's Digest carries a full, dedicated IBS category: Rome IV subtype classification, a fibromyalgia overlap, a history of how the diagnostic criteria themselves have evolved, pregnancy guidance, self-advocacy content on the red-flag symptoms that mean it isn't IBS after all, international research (including an honest complication in how diagnostic-criteria choice itself changes reported prevalence), this same Prevention & Lifestyle guidance naming delayed triggers like coffee and artificial sweeteners most people never connect to their symptoms, and a running Research Horizon covering psychobiotics and a wearable vagus-nerve-stimulation device. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    teaser: "An honest choice: no forced food score for migraine, since this app's research found the old tyramine trigger-food theory doesn't hold up, but medications, trigger research, and a full library exist here instead.",
    summary:
      "Unlike most other conditions in this app, foods aren't yet given a migraine-specific score in the eleven Food-tab builders. This is a deliberate choice, not an oversight, this app's already-covered research found the old tyramine explanation behind classic trigger foods (aged cheese, red wine) doesn't hold up under closer, more recent scrutiny, and rather than force a food score built on a theory the app's research disputes, nothing was built at all until defensible data exists. What the app already does do: My Meds & Interactions tracks erenumab and sumatriptan (plus propranolol, shared from this app's cardiovascular research), with a cited serotonin-syndrome safety rule built directly in for sumatriptan combined with SSRIs. The app's Digest carries a full, dedicated Migraine category: episodic-versus-chronic classification, a history of migraine treatment, pregnancy guidance covering a striking 87% third-trimester improvement rate, self-advocacy content on red-flag headache symptoms, international research (including Belgium's highest-in-the-world prevalence), this same Prevention & Lifestyle guidance built around consistency habits rather than a disputed trigger-food list, and a running Research Horizon covering CGRP gepants, neuromodulation devices, and a newer PACAP-targeted drug. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for cardiovascular risk across three dimensions: whole-food Mediterranean-pattern fit, a lipid-and-oxidative-stress profile, and a purpose-built Sodium Density score this app created from scratch, tiered using the same official DASH-aligned sodium thresholds public health guidance already uses. My Meds & Interactions tracks atorvastatin and aspirin (plus lisinopril, losartan, and propranolol, shared from this app's kidney and thyroid research), with cited interaction rules built directly in for two common real-world combinations, aspirin taken too close to ibuprofen, and atorvastatin with grapefruit. The app's Digest carries a full, dedicated CVD category: ACC/AHA heart-failure staging, kidney and brain effects tied to the same underlying disease process, a history rooted in the landmark Seven Countries Study, pregnancy guidance covering peripartum cardiomyopathy risk, self-advocacy content on lipid-panel testing intervals, international research (including Russia's still-partially-unexplained post-Soviet mortality crisis), this same Prevention & Lifestyle guidance, and a running Research Horizon covering lipoprotein(a)-targeted drugs and colchicine's newly-approved anti-inflammatory use. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary:
      "Foods you build or browse across this app's eleven builders can already be scored specifically for gout through a processed-and-sugar-sweetened-food dimension, built directly around this app's already-cited research tying sugar-sweetened beverages, not purine-rich vegetables or total protein, to measured gout risk. My Meds & Interactions tracks allopurinol, febuxostat, and colchicine (plus prednisone and ibuprofen, shared from this app's broader medication research), with cited interaction rules built directly in for two serious combinations, allopurinol with azathioprine, and colchicine with atorvastatin. The app's Digest carries a full, dedicated Gout category: a four-stage natural history, kidney and cardiovascular comorbidities, an over-4,000-year-old history of the disease, an honest note on pregnancy rarity, self-advocacy content on HLA-B*58:01 genetic screening before starting allopurinol, international research (including Oceania's genetically-driven world-highest prevalence, and China's diet-driven rising rate), this same Prevention & Lifestyle guidance built around a dairy-is-protective finding, and a running Research Horizon covering gut-microbiome-targeted urate therapy and pegloticase improvements. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
