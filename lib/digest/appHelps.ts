...
export const APP_HELPS_ENTRIES: DigestEntry[] = [
  {
    ...
    summary:
      "Hashimoto's is this app's own original focus, and its own depth reflects that directly. Every food you build or browse across the app's eleven Food-tab builders can be scored against the full 6 Dimensions of Food-Friendliness (6-DFF) rubric, goitrogenic load, gluten, additives, processing, fat quality, and more, each sub-criterion individually cited, not a black-box number. The app's own Purple Digest carries a dedicated Hashimoto's category built out to depth: staging and disease progression, organ-by-organ effects beyond the thyroid itself, a history of how the disease has been understood, pregnancy and fertility guidance, and self-advocacy content naming exactly which labs to ask for and how often, plus this same Prevention & Lifestyle guidance and a running Research Horizon tracking experimental treatment. My Meds & Interactions already tracks levothyroxine directly, with cited timing rules for calcium, iron, coffee, soy, and high-fiber meals, plus an age-adjusted TSH-target note for anyone over 65. Worth knowing honestly: this list keeps growing as more of the app gets built, treat it as a current snapshot, not a fixed, final promise.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary:
      "Foods you build or browse across this app's own eleven builders can already be scored specifically for Graves' disease, an honest, two-nutrient lens: selenium (with cited eye-disease-specific trial evidence) and iodine (framed for Graves' own excess-risk direction, the opposite emphasis from this app's own Hashimoto's research). My Meds & Interactions tracks methimazole, propylthiouracil, and propranolol, with cited reference content built directly in for the two warning signs that matter most (agranulocytosis, PTU-related liver injury) and how iodine intake can reduce antithyroid drug effectiveness. The app's own functional age-rules engine already flags an easy-to-miss presentation directly: 'apathetic thyrotoxicosis,' an atypical Graves' pattern more common after 60, checked against your own birth date in Profile. The app's own Purple Digest carries a full, dedicated Graves' category: remission-rate data, cardiac risk, a history of the disease, pregnancy guidance, self-advocacy content on TRAb/TSI testing, international research (including a Denmark-vs-Iceland iodine study), this same Prevention & Lifestyle guidance, and a running Research Horizon. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary:
      "Foods you build or browse across this app's own eleven builders can already be scored specifically for PCOS through a carbohydrate-and-fiber dimension, reusing the same purpose-built sub-criterion this app originally created for Type 1 diabetes, since PCOS's own central mechanism runs through the identical carbohydrate/insulin axis. My Meds & Interactions tracks spironolactone, letrozole, and clomiphene (plus metformin, shared from this app's own diabetes research), with a cited safety rule built directly in for spironolactone's own potassium risk. The app's own Purple Digest carries a full, dedicated PCOS category: Rotterdam phenotype classification, cardiovascular and NAFLD comorbidities, a history of the diagnosis itself, pregnancy guidance covering letrozole-over-clomiphene evidence, self-advocacy content on why a full glucose tolerance test matters, international research (including a Gulf-region consanguinity finding), this same Prevention & Lifestyle guidance built around the quantified BAMBINI weight-loss trial, and a running Research Horizon covering fezolinetant, a drug correcting the actual brain signal driving PCOS. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
  ...
  },
  {
    ...
    summary:
      "Foods you build or browse across this app's own eleven builders can already be scored specifically for gout through a processed-and-sugar-sweetened-food dimension, built directly around this app's own already-cited research tying sugar-sweetened beverages, not purine-rich vegetables or total protein, to measured gout risk. My Meds & Interactions tracks allopurinol, febuxostat, and colchicine (plus prednisone and ibuprofen, shared from this app's own broader medication research), with cited interaction rules built directly in for two serious combinations, allopurinol with azathioprine, and colchicine with atorvastatin. The app's own Purple Digest carries a full, dedicated Gout category: a four-stage natural history, kidney and cardiovascular comorbidities, an over-4,000-year-old history of the disease, an honest note on pregnancy rarity, self-advocacy content on HLA-B*58:01 genetic screening before starting allopurinol, international research (including Oceania's own genetically-driven world-highest prevalence, and China's own diet-driven rising rate), this same Prevention & Lifestyle guidance built around a dairy-is-protective finding, and a running Research Horizon covering gut-microbiome-targeted urate therapy and pegloticase improvements. This list keeps growing as more of the app gets built.",
    citations: [],
    overallTier: 'strong',
