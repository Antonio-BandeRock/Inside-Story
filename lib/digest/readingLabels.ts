...
export const READING_LABELS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    summary:
      'US federal law requires nine specific major allergens (milk, eggs, fish, shellfish, tree nuts, peanuts, wheat, soybean, and, since January 1, 2023 under the FASTER Act, sesame) to be disclosed in one of two specific formats: named directly in parentheses right after an ingredient that doesn\'t obviously reveal it ("natural flavor (sesame)"), or grouped together in a plain "Contains" statement immediately after the ingredient list. Sesame\'s 2023 addition is a recent example of how this list itself can change, it took an act of Congress (the FASTER Act, signed 2021) specifically because sesame allergy reactions were not being reliably caught under the eight-allergen list that existed before it. This mechanism exists for exactly the situation an unfamiliar-sounding ingredient name creates: an allergen hiding inside a name that gives no obvious clue on its own.',
    citations: [
      {
