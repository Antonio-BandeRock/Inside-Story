...
export const IBS_ENTRIES: DigestEntry[] = [
  ...
  },
  {
    ...
    teaser: "The Glossary already explains what FODMAPs are. Here's the real, direct trial evidence for why they matter this much specifically for IBS.",
    summary: "The low-FODMAP diet has the strongest real dietary evidence of any intervention covered in this whole IBS category, and the real numbers behind it are genuinely striking. A real systematic review and network meta-analysis of 24 randomized trials found the low-FODMAP diet significantly more likely to improve global IBS symptoms than a habitual diet. Individual real trials report real, substantial responder rates, one Mediterranean-style low-FODMAP trial found 84.6% of participants meeting a real, meaningful symptom-severity-reduction threshold at first follow-up, and broader real reviews report improvement in up to 86% of IBS patients across abdominal pain, bloating, constipation, and diarrhea symptoms alike. The Glossary already explains the real mechanism (fermentable carbohydrates the small intestine can't fully digest, fermented by colonic bacteria into gas), and Problem Foods & Swaps already covers garlic and onion as two of the most concentrated real FODMAP sources. Worth knowing directly: the low-FODMAP diet is genuinely meant as a structured, temporary elimination-and-reintroduction process, not a permanent restrictive diet, real, careful reintroduction is what actually identifies which specific FODMAP subtypes a given person's own gut is sensitive to.",
    citations: [
  ...
  },
  {
    ...
    summary: "One of the most genuinely surprising real facts about IBS's own underlying biology: roughly 90-95% of the body's total serotonin is made not in the brain, but in the gut, by specialized cells called enterochromaffin (EC) cells, even though these cells make up only about 1% of the gut's own lining. Real research finds this gut-made serotonin performs real, direct local jobs, regulating gut motility, coordinating digestive reflexes, and activating the vagus nerve, the same nerve already covered elsewhere in the gut-brain-axis research. Real, current research finds gut serotonin production is directly regulated by the gut microbiome itself, through short-chain fatty acids and other microbial metabolites, tying this directly to the already-established fermentation and gut-health research. Real research finds dysregulation in this exact serotonin-signaling system a genuine contributor to IBS, alongside other real signaling molecules already implicated (bacterial byproducts, stress-related catecholamines like dopamine and norepinephrine). Worth knowing directly: this gives a real, concrete biological reason IBS is genuinely a brain-gut condition and not \"just in someone's head,\" and it directly explains why the real, established treatments already covered in the IBS research, from dietary changes that reshape the gut microbiome to CBT and hypnotherapy that work through brain-gut signaling, both have a real, physiological pathway to actually help.",
    citations: [
  ...
  },
  {
    ...
    summary: "The biopsychosocial model is a real, well-established framework worth understanding directly, since it explains the actual mechanism behind why the CBT and gut-directed hypnotherapy already covered in the IBS research genuinely work, and why stress reliably makes IBS symptoms worse without that meaning the condition itself is imaginary. Real research finds genetic and environmental factors, early-life experiences, trauma, and social learning among them, real, directly shaping both brain and gut function, which then interact bidirectionally through the autonomic nervous system and the HPA axis (the same stress-hormone system already covered elsewhere in the research). Real research names psychosocial stress the single most widely acknowledged risk factor for IBS developing in the first place, or relapsing once symptoms have improved. The real, underlying gut pathophysiology involves disturbed motility, visceral hypersensitivity, and altered brain-gut signaling, and real research finds psychosocial stress directly affects gut microbial composition itself, both through stress-altered gut transit/secretion and through direct signaling effects on microbial gene expression, a real, concrete mechanistic bridge tying the broader gut-microbiome research directly to IBS specifically. Worth knowing directly: understanding this real model reframes stress management not as a secondary, \"soft\" add-on to IBS treatment, but as a real, evidence-backed, mechanistically central piece of it, on equal footing with dietary approaches like low-FODMAP already covered elsewhere in the IBS research.",
    citations: [
  ...
  },
  {
    ...
    teaser: 'A real, pooled systematic review found functional gut disorders affecting roughly 22% of children, with IBS one of four real, named subtypes under the same Rome IV framework the adult IBS research already uses.',
    summary:
