...
const SUB_CRITERION_SOURCES: Record<string, string> = {
  ...
  'Oxalate Level':
    'Wake Forest University Health Sciences’ oxalate list and the Oxalosis and Hyperoxaluria Foundation’s 2024 oxalate list -- two real cited reference sources, cross-checked against each other.',
  'Oxalate Load Rank': 'Same two cited sources as Oxalate Level (Wake Forest University Health Sciences; Oxalosis and Hyperoxaluria Foundation, 2024).',
  'Mineral Binding Risk': 'Same two cited sources as Oxalate Level (Wake Forest University Health Sciences; Oxalosis and Hyperoxaluria Foundation, 2024).',
  'Oxalate Tolerance Note': 'Same two cited sources as Oxalate Level (Wake Forest University Health Sciences; Oxalosis and Hyperoxaluria Foundation, 2024).',
  Gluten:
