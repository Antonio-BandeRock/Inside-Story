...
export function getCeliacStageAdvisory(scores: FoodScore[], stage: CeliacStage | null): CeliacStageAdvisory | null {
  ...
  return {
    ...
    message:
      reasons.join('\n\n') +
      "\n\nThis is advisory only. Nothing in Inside Story hides or blocks a food based on your stage. See Celiac Disease in Life > Conditions for the full, cited healing timeline.",
  };
}
