...
// fish, or a soft-cooked egg are all common, often safe
...
// against CDC/USDA FSIS/FDA primary sources, not repeated from a secondary
...
Specific safe minimum internal temperatures (USDA FSIS):
...
- Whole cuts (steaks, chops, roasts) of beef, pork, lamb, or veal: 145°F, lower because bacteria on an intact cut are mostly on the surface.
 ...
 * egg, AND the person's selected Cook Prep for this ingredient is
