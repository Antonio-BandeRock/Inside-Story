...
export function getIbdStageAdvisory(scores: FoodScore[], stage: IbdStage | null): IbdStageAdvisory | null {
  ...
  return {
    ...
    message:
      reasons.join('\n\n') +
      "\n\nThis is advisory only. Nothing in Inside Story hides or blocks a food based on your stage. See Inflammatory Bowel Disease in Life > Conditions for the full, cited evidence.",
  };
}
