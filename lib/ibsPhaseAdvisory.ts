...
export function getIbsPhaseAdvisory(scores: FoodScore[], phase: IbsPhase | null): IbsPhaseAdvisory | null {
  ...
  return {
    ...
    message:
      reasons.join('\n\n') +
      "\n\nThis app doesn't tag FODMAP content directly, so this is a general digestive-tolerance flag, not a confirmed FODMAP hit. This is advisory only. Nothing in Inside Story hides or blocks a food based on your phase. See IBS in Life > Conditions for the full, cited low-FODMAP protocol.",
  };
}
